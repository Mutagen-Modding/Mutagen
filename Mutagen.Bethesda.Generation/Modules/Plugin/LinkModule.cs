...
public class LinkModule : GenerationModule
{
    ...
    public static async Task GenerateInterfaceImplementation(ObjectGeneration obj, StructuredStringBuilder sb, bool getter)
    {
        ...
        sb.AppendLine($"public{await obj.FunctionOverride(shouldAlwaysOverride, async (o) => await HasLinks(o, includeBaseClass: true) != Case.No)}IEnumerable<{nameof(IFormLinkGetter)}> {nameof(IFormLinkContainerGetter.EnumerateFormLinks)}(bool iterateNestedRecords = true) => {obj.CommonClass(LoquiInterfaceType.IGetter, CommonGenerics.Class)}.Instance.EnumerateFormLinks(this, iterateNestedRecords);");
