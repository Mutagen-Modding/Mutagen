    ...
    public class DataTypeModule : GenerationModule
    {
        public override async Task PostLoad(ObjectGeneration obj)
        {
            ...
            foreach (var field in obj.IterateFields(expandSets: SetMarkerType.ExpandSets.FalseAndInclude))
            {
                ...
                elem.Add(new XAttribute(Loqui.Generation.Constants.INTERNAL_GET_INTERFACE, "true"));
                elem.Add(new XAttribute(Loqui.Generation.Constants.INTERNAL_SET_INTERFACE, "true"));
