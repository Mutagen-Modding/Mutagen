...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class RegionDataMapNameMixIn
    {
        ...
        public static RegionDataMapName Copy(
            ...
            RegionDataMapName def = null)
        {
            return ((RegionDataMapNameSetterCommon)((IRegionDataMapNameGetter)item).CommonSetterInstance()).Copy(
                item: item,
                copyMask: copyMask,
                def: def);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class RegionDataMapName_DeepCopyMask : RegionData_DeepCopyMask
    {
        public RegionDataMapName_DeepCopyMask()
        {
        }

        public RegionDataMapName_DeepCopyMask(bool defaultOn)
        {
            this.MapName = defaultOn;
        }
