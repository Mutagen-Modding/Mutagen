...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class AlphaLayerMixIn
    {
        ...
        public static AlphaLayer Copy(
            ...
            AlphaLayer def = null)
        {
            return ((AlphaLayerSetterCommon)((IAlphaLayerGetter)item).CommonSetterInstance()).Copy(
                item: item,
                copyMask: copyMask,
                def: def);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class AlphaLayer_DeepCopyMask : BaseLayer_DeepCopyMask
    {
        public AlphaLayer_DeepCopyMask()
        {
        }

        public AlphaLayer_DeepCopyMask(bool defaultOn)
        {
            this.AlphaLayerData = defaultOn;
        }
