...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class IdleAnimation_DeepCopyMask : OblivionMajorRecord_DeepCopyMask
    {
        public IdleAnimation_DeepCopyMask()
        {
        }

        public IdleAnimation_DeepCopyMask(bool defaultOn)
        {
