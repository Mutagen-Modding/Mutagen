...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        {
            get => _hasBeenSetTracker[(int)SoulGem_FieldIndex.Script];
            set => _hasBeenSetTracker[(int)SoulGem_FieldIndex.Script] = value;
        }
        bool ISoulGemGetter.Script_IsSet => Script_IsSet;
        ...
        {
            _Script = value;
            _hasBeenSetTracker[(int)SoulGem_FieldIndex.Script] = markSet;
        }
