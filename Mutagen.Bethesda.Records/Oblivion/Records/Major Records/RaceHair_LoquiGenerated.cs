...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class RaceHairMixIn
    {
            ...
            bool doMasks = true)
        {
            ...
            ((RaceHairSetterCopyCommon)((IRaceHairGetter)lhs).CommonSetterCopyInstance()).CopyFieldsFrom(
                item: lhs,
                rhs: rhs,
                def: def,
                errorMask: errorMaskBuilder,
        ...
        public static RaceHair Copy(
            ...
            RaceHair def = null)
        {
            return ((RaceHairSetterCommon)((IRaceHairGetter)item).CommonSetterInstance()).Copy(
                item: item,
                copyMask: copyMask,
                def: def);
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class RaceHair
    {
        ...
        object IRaceHairGetter.CommonSetterCopyInstance()
        {
