...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class RankMixIn
    {
        ...
        public static Rank Copy(
            ...
            Rank def = null)
        {
            return ((RankSetterCommon)((IRankGetter)item).CommonSetterInstance()).Copy(
                item: item,
                copyMask: copyMask,
                def: def);
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class Rank
    {
        ...
        object IRankGetter.CommonSetterCopyInstance()
        {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class Rank_DeepCopyMask
    {
        public Rank_DeepCopyMask()
        {
        }

        public Rank_DeepCopyMask(bool defaultOn)
        {
            this.RankNumber = defaultOn;
            this.MaleName = defaultOn;
            this.FemaleName = defaultOn;
