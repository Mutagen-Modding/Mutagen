...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public class WorldspaceSubBlock_Mask<T> : IMask<T>, IEquatable<WorldspaceSubBlock_Mask<T>>
    {
            ...
            T Items)
        {
            ...
            this.Items = new MaskItem<T, IEnumerable<MaskItemIndexed<T, Cell_Mask<T>>>>(Items, null);
        }
        #endregion
        ...
        protected void Translate_InternalFill<R>(WorldspaceSubBlock_Mask<R> obj, Func<T, R> eval)
        {
            ...
            if (Items != null)
            {
                obj.Items = new MaskItem<R, IEnumerable<MaskItemIndexed<R, Cell_Mask<R>>>>(eval(this.Items.Overall), default);
