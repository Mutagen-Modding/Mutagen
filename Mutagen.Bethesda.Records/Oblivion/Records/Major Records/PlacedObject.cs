...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    namespace Internals
    {
        ...
        {
            static partial void FillBinaryOpenByDefaultCustom(MutagenFrame frame, IPlacedObjectInternal item, MasterReferences masterReferences, ErrorMaskBuilder errorMask)
            {
