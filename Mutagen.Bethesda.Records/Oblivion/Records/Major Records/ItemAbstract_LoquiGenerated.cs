...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class ItemAbstract_DeepCopyMask : OblivionMajorRecord_DeepCopyMask
    {
        public ItemAbstract_DeepCopyMask()
        {
        }

        public ItemAbstract_DeepCopyMask(bool defaultOn)
        {
        }
