...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        IRaceGetter IRaceRelationGetter.Race => this.Race_Property.Item;
        IFormIDLinkGetter<IRaceGetter> IRaceRelationGetter.Race_Property => this.Race_Property;
        #endregion
        #region Modifier
        ...
        IBinaryItem
    {
        ...
        #region Race
        IRaceGetter Race { get; }
        IFormIDLinkGetter<IRaceGetter> Race_Property { get; }
    ...
    public static class RaceRelationMixIn
    {
            ...
            bool doMasks = true)
        {
            ...
            ((RaceRelationSetterCopyCommon)((IRaceRelationGetter)lhs).CommonSetterCopyInstance()).CopyFieldsFrom(
                item: lhs,
                rhs: rhs,
                def: def,
                errorMask: errorMaskBuilder,
        ...
        public static RaceRelation Copy(
            ...
            RaceRelation def = null)
        {
            return ((RaceRelationSetterCommon)((IRaceRelationGetter)item).CommonSetterInstance()).Copy(
                item: item,
                copyMask: copyMask,
                def: def);
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class RaceRelation
    {
        ...
        object IRaceRelationGetter.CommonSetterCopyInstance()
        {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IRaceRelationGetter
    {
        ...
        #region Race
        public IFormIDLinkGetter<IRaceGetter> Race_Property => new FormIDLink<IRaceGetter>(FormKey.Factory(_package.MasterReferences, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0, 4))));
        public IRaceGetter Race => default;
        #endregion
