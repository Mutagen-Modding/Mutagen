...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class SpellAbstract_DeepCopyMask : OblivionMajorRecord_DeepCopyMask
    {
        public SpellAbstract_DeepCopyMask()
        {
        }

        public SpellAbstract_DeepCopyMask(bool defaultOn)
        {
        }
