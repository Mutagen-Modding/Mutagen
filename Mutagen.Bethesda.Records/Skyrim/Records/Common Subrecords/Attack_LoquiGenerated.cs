...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        #region Mutagen
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public IEnumerable<ILinkGetter> Links => AttackCommon.Instance.GetLinks(this);
        #endregion
    ...
    #region Common MixIn
    public static class AttackMixIn
    {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case 0x444B5441: // ATKD
                {
                    ...
                    item.AttackData = Mutagen.Bethesda.Skyrim.AttackData.CreateFromBinary(
                        frame: frame,
                        recordTypeConverter: null,
                        masterReferences: masterReferences);
    ...
    public partial class AttackCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IAttackGetter obj)
        {
            if (obj.AttackData != null)
            {
                foreach (var item in obj.AttackData.Links)
                {
                    yield return item;
                }
            }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IAttackGetter
    {
        ...
        public String? AttackEvent => _AttackEventLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _AttackEventLocation.Value, _package.Meta)) : default(string?);
        #endregion
        partial void CustomCtor(
