...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        public UInt16 EventFunction { get; set; }
        #endregion
        #region EventMember
        public UInt16 EventMember { get; set; }
        #endregion
        #region Parameter3
        public IFormIDLink<SkyrimMajorRecord> Parameter3 { get; set; }
        IFormIDLinkGetter<ISkyrimMajorRecordGetter> IGetEventDataGetter.Parameter3 => this.Parameter3;
        #endregion
        #region RunOnType
        public Condition.RunOnType RunOnType { get; set; }
        #endregion
        #region Reference
        public IFormIDLink<SkyrimMajorRecord> Reference { get; set; }
        IFormIDLinkGetter<ISkyrimMajorRecordGetter> IGetEventDataGetter.Reference => this.Reference;
        #endregion
        #region Unknown3
            ...
            MissingCreate missing = MissingCreate.New)
        {
            switch (missing)
            {
                ...
                case MissingCreate.Null:
                    if (node == null) return missing == MissingCreate.New ? new GetEventData() : null;
                    break;
                default:
                    break;
            }
        ...
        {
            switch ((GetEventData_FieldIndex)index)
            {
        ...
        [DebuggerStepThrough]
        public static GetEventData CreateFromBinary(
            MutagenFrame frame,
            MasterReferences masterReferences)
        {
        ...
        internal static GetEventData GetNew()
        {
        ...
        ILoquiObjectSetter<IGetEventData>
    {
        ...
        new IFormIDLink<SkyrimMajorRecord> Parameter3 { get; set; }

        new Condition.RunOnType RunOnType { get; set; }

        new IFormIDLink<SkyrimMajorRecord> Reference { get; set; }
        ...
        IBinaryItem
    {
        ...
        #endregion
        #region Parameter3
        IFormIDLinkGetter<ISkyrimMajorRecordGetter> Parameter3 { get; }
    ...
    public static class GetEventDataMixIn
    {
        ...
        {
            var ret = new GetEventData_Mask<bool>();
    ...
    public partial class GetEventDataSetterCommon : ConditionDataSetterCommon
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            ...
            if (Mutagen.Bethesda.Binary.FormLinkBinaryTranslation.Instance.Parse(
                frame: frame,
                masterReferences: masterReferences,
                item: out IFormIDLink<SkyrimMajorRecord> Parameter3Parse))
            {
                item.Parameter3 = Parameter3Parse;
            }
            else
            {
                item.Parameter3 = default(IFormIDLink<SkyrimMajorRecord>);
            }
            ...
            if (Mutagen.Bethesda.Binary.FormLinkBinaryTranslation.Instance.Parse(
                frame: frame,
                masterReferences: masterReferences,
                item: out IFormIDLink<SkyrimMajorRecord> ReferenceParse))
            {
                item.Reference = ReferenceParse;
            }
            else
            {
                item.Reference = default(IFormIDLink<SkyrimMajorRecord>);
            }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public class GetEventData_Mask<T> : ConditionData_Mask<T>, IMask<T>, IEquatable<GetEventData_Mask<T>>
    {
        #region Ctors
    ...
    public class GetEventData_ErrorMask : ConditionData_ErrorMask, IErrorMask<GetEventData_ErrorMask>
    {
        ...
        #region Factory
        public static GetEventData_ErrorMask Factory(ErrorMaskBuilder errorMask)
        {
    ...
    public class GetEventData_TranslationMask : ConditionData_TranslationMask
    {
        ...
        #region Ctors
        public GetEventData_TranslationMask()
            : base()
        {
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class GetEventDataBinaryTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = doMasks ? new ErrorMaskBuilder() : null;
            ((GetEventDataBinaryWriteTranslation)item.BinaryWriteTranslator).Write(
                item: item,
                masterReferences: masterReferences,
                writer: writer,
                recordTypeConverter: null,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class GetEventDataBinaryWrapper :
        ...
        IGetEventDataGetter
    {
        ...
        public IFormIDLinkGetter<ISkyrimMajorRecordGetter> Parameter3 => new FormIDLink<ISkyrimMajorRecordGetter>(FormKey.Factory(_package.MasterReferences, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(6, 4))));
        public Condition.RunOnType RunOnType => (Condition.RunOnType)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(10, 4));
        public IFormIDLinkGetter<ISkyrimMajorRecordGetter> Reference => new FormIDLink<ISkyrimMajorRecordGetter>(FormKey.Factory(_package.MasterReferences, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(14, 4))));
        ...
        protected GetEventDataBinaryWrapper(
        ...
        public static GetEventDataBinaryWrapper GetEventDataFactory(
            BinaryMemoryReadStream stream,
            BinaryWrapperFactoryPackage package,
            RecordTypeConverter recordTypeConverter = null)
        {
            var ret = new GetEventDataBinaryWrapper(
