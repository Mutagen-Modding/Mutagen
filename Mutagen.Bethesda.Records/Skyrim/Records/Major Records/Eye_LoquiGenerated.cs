...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public class Eye_Mask<T> : SkyrimMajorRecord_Mask<T>, IMask<T>, IEquatable<Eye_Mask<T>>
    {
        #region Ctors
        public Eye_Mask()
        {
    ...
    public class Eye_ErrorMask : SkyrimMajorRecord_ErrorMask, IErrorMask<Eye_ErrorMask>
    {
        #region Members
    ...
    public class Eye_TranslationMask : SkyrimMajorRecord_TranslationMask
    {
        #region Members
        public bool Name;
        public bool Icon;
