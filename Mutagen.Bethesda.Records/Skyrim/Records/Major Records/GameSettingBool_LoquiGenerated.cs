...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public class GameSettingBool_DeepCopyMask : GameSetting_DeepCopyMask
    {
        public GameSettingBool_DeepCopyMask()
        {
        }

        public GameSettingBool_DeepCopyMask(bool defaultOn)
        {
            this.Data = defaultOn;
        }
