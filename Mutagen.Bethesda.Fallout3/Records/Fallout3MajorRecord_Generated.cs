...
namespace Mutagen.Bethesda.Fallout3
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, Activator, AmmoEffect, Ammunition, Armor, Book, CaravanCard, CaravanMoney, CasinoChip, Cell, Class, Container, Creature, Debris, Door, EffectShader, Explosion, Eye, Eyes, Faction, FormList, Furniture, GameSetting, Global, Grass, Hair, HeadPart, ImpactDataSet, Ingestible, Ingredient, ItemMod, Key, LandscapeTexture, LeveledItem, Light, MagicEffect, MenuIcon, MiscItem, MoveableStatic, Note, Npc, ObjectEffect, PlaceableWater, PlacedBeam, PlacedCreature, PlacedGrenade, PlacedMissile, PlacedNpc, PlacedObject, Projectile, Race, Region, Script, Sound, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, Tree, VoiceType, Water, Weapon]
    /// </summary>
