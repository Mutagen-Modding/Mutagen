...
namespace Mutagen.Bethesda.Fallout3
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, Activator, Ammunition, Armor, Book, CaravanCard, CasinoChip, CaravanMoney, Cell, Class, Container, Creature, Debris, Door, EffectShader, Explosion, Eye, Eyes, Faction, FormList, GameSetting, Global, Grass, Hair, HeadPart, Ingestible, Ingredient, ItemMod, Key, LandscapeTexture, LeveledItem, Light, MagicEffect, MenuIcon, MiscItem, MoveableStatic, Note, Npc, ObjectEffect, PlaceableWater, PlacedBeam, PlacedCreature, PlacedGrenade, PlacedMissile, PlacedNpc, PlacedObject, Race, Region, Script, Sound, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, VoiceType, Water, Weapon]
    /// </summary>
