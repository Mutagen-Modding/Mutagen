...
namespace Mutagen.Bethesda.Fallout3
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, Activator, ActorValueInformation, AddonNode, Ammunition, AnimatedObject, Armor, ArmorAddon, BodyPartData, Book, CameraPath, CameraShot, Cell, Class, Climate, CombatStyle, ConstructibleObject, Container, Creature, Debris, DefaultObjectManager, DialogResponses, DialogTopic, Door, EffectShader, EncounterZone, Explosion, Eyes, Faction, FormList, Furniture, GameSetting, Global, Grass, Hair, HeadPart, IdleAnimation, IdleMarker, ImageSpace, ImageSpaceAdapter, Impact, ImpactDataSet, Ingestible, Ingredient, ItemMod, Key, Landscape, LandscapeTexture, LeveledCreature, LeveledItem, LeveledNpc, Light, LightingTemplate, LoadScreen, MagicEffect, MenuIcon, Message, MiscItem, MoveableStatic, MusicType, NavigationMesh, NavigationMeshInfoMap, Note, Npc, ObjectEffect, Package, Perk, PlaceableWater, PlacedBeam, PlacedCreature, PlacedGrenade, PlacedMissile, PlacedNpc, PlacedObject, Projectile, Quest, Race, RadiationStage, Ragdoll, Region, Script, Sound, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, Tree, VoiceType, Water, Weapon, Weather, Worldspace]
    /// </summary>
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Fallout3MajorRecordSetterCommon : MajorRecordSetterCommon
    {
        ...
        public virtual IEnumerable<IMajorRecord> EnumerateMajorRecordsLoopLogic(IFallout3MajorRecordInternal obj)
        {
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumeratePotentiallyTypedMajorRecords(
            ...
            bool throwIfUnknown)
        {
            if (type == null) return Fallout3MajorRecordCommon.Instance.EnumerateMajorRecords(obj);
            return Fallout3MajorRecordCommon.Instance.EnumerateMajorRecords(obj, type, throwIfUnknown);
        }
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(
            ...
            bool throwIfUnknown)
        {
            foreach (var item in Fallout3MajorRecordCommon.Instance.EnumerateMajorRecordsLoopLogic(obj, type, throwIfUnknown))
            {
                yield return item;
            }
        }
    ...
    internal partial class Fallout3MajorRecordCommon : MajorRecordCommon
    {
        ...
        public virtual IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(IFallout3MajorRecordGetter obj)
        {
            yield break;
        }
