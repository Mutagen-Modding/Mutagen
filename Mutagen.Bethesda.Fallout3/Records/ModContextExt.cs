...
internal static class ModContextExt
{
    ...
    public static IEnumerable<IModContext<IFallout3Mod, IFallout3ModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
        this IFallout3ListGroupGetter<ICellBlockGetter> cellBlocks,
        ...
        bool throwIfUnknown)
    {
        foreach (var readOnlyBlock in cellBlocks.Records)
        {
            ...
            foreach (var readOnlySubBlock in readOnlyBlock.SubBlocks)
            {
                ...
                {
                    Func<IFallout3Mod, ICellGetter, bool, string?, FormKey?, ICell> cellGetter = (mod, copyCell, dup, edid, newFormKey) =>
                    {
                    ...
                    {
                        yield return new ModContext<IFallout3Mod, IFallout3ModGetter, IMajorRecord, IMajorRecordGetter>(
                            modKey: modKey,
                            record: readOnlyCell,
