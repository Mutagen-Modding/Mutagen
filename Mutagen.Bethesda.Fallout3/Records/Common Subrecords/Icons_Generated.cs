...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Icons>
    {
        ...
        public AssetLink<Fallout3TextureAssetType> LargeIconFilename { get; set; } = new AssetLink<Fallout3TextureAssetType>();
        AssetLinkGetter<Fallout3TextureAssetType> IIconsGetter.LargeIconFilename => this.LargeIconFilename;
        #endregion
        #region SmallIconFilename
        public AssetLink<Fallout3TextureAssetType>? SmallIconFilename { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        AssetLinkGetter<Fallout3TextureAssetType>? IIconsGetter.SmallIconFilename => this.SmallIconFilename;
        #endregion
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Icons_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Icons";
    ...
    internal partial class IconsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IIconsGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
