...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<DestructableData>
    {
        ...
        public Byte VATSTargetable { get; set; } = default(Byte);
        #endregion
        #region Unused
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case DestructableData_FieldIndex.Unused:
                        return Unused;
                    default:
        ...
        ILoquiObjectSetter<IDestructableData>
    {
        ...
        new Byte VATSTargetable { get; set; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class DestructableData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.DestructableData";
    ...
    internal partial class DestructableDataSetterCommon
    {
        ...
        public void Clear(IDestructableData item)
        {
            ...
            item.VATSTargetable = default(Byte);
    ...
    internal partial class DestructableDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IDestructableDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class DestructableDataBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            item.VATSTargetable = frame.ReadUInt8();
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IDestructableDataGetter
    {
        ...
        public Byte VATSTargetable => _structData.Span[0x5];
