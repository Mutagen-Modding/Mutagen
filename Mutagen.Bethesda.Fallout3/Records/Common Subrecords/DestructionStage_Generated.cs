...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<DestructionStage>
    {
        ...
        #region Data
        public DestructionStageData Data { get; set; } = new DestructionStageData();
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IDestructionStageDataGetter IDestructionStageGetter.Data => Data;
        #endregion
        #region Model
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class DestructionStage_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.DestructionStage";
                ...
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)DestructionStage_FieldIndex.Data) ?? true))
                    {
                        item.Data = rhs.Data.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)DestructionStage_FieldIndex.Data),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.DSTD:
                {
                    ...
                    item.Data = Mutagen.Bethesda.Fallout3.DestructionStageData.CreateFromBinary(frame: frame);
