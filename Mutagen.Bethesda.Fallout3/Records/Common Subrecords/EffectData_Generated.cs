...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IEffectDataGetter
    {
        ...
        public Effect.EffectType Type => (Effect.EffectType)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0xC, 0x4));
        public ActorValue ActorValue => (ActorValue)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0x10, 0x4));
