...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Condition>
    {
        ...
        #endregion
        #region RunOnType
        public Condition.RunOn RunOnType { get; set; } = default(Condition.RunOn);
        #endregion
        #region Reference
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkGetter<IPlacedGetter> IConditionGetter.Reference => this.Reference;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Condition_FieldIndex.RunOnType:
                        return RunOnType;
                    case Condition_FieldIndex.Reference:
                        return Reference;
                    default:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Condition_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Condition";
    ...
    internal partial class ConditionCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Condition_FieldIndex.RunOnType) ?? true))
            {
                if (lhs.RunOnType != rhs.RunOnType) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Condition_FieldIndex.Reference) ?? true))
            {
