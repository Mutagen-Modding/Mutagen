...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ContainerEntry_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.ContainerEntry";
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.CNTO:
                {
                    ...
                    item.Item = Mutagen.Bethesda.Fallout3.ContainerItem.CreateFromBinary(frame: frame);
                    return (int)ContainerEntry_FieldIndex.Item;
                }
                case RecordTypeInts.COED:
                {
                    item.Data = Mutagen.Bethesda.Fallout3.ExtraData.CreateFromBinary(frame: frame);
