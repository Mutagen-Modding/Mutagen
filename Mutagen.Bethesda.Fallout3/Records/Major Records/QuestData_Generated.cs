        ...
        IQuestData
    {
            ...
            IMask<TItem>
        {
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.QuestDelay, rhs.QuestDelay)) return false;
                return true;
            }
            ...
            public bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.QuestDelay)) return false;
                return true;
            }
            #endregion
            ...
            public bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.QuestDelay)) return true;
                return false;
            }
            #endregion
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.QuestDelay = eval(this.QuestDelay);
            }
            #endregion
            ...
            public void Print(StructuredStringBuilder sb, QuestData.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    {
                        sb.AppendItem(QuestDelay, "QuestDelay");
                    }
                }
            }
            #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case QuestData_FieldIndex.Versioning:
                        return Versioning;
                    ...
                    case QuestData_FieldIndex.Unused:
                        return Unused;
                    case QuestData_FieldIndex.QuestDelay:
                        return QuestDelay;
                    default:
            ...
            public bool IsInError()
            {
                ...
                if (QuestDelay != null) return true;
                return false;
            }
            #endregion
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.QuestDelay = this.QuestDelay.Combine(rhs.QuestDelay);
                return ret;
            }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class QuestDataCommon
    {
            ...
            QuestData.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.QuestDelay ?? true)
            {
                sb.AppendItem(item.QuestDelay, "QuestDelay");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)QuestData_FieldIndex.Versioning) ?? true))
            {
            ...
            {
                if (!lhs.QuestDelay.EqualsWithin(rhs.QuestDelay)) return false;
            }
            return true;
        }
    ...
    internal partial class QuestDataSetterTranslationCommon
    {
        ...
        public void DeepCopyIn(
            ...
            bool deepCopy)
        {
            if ((copyMask?.GetShouldTranslate((int)QuestData_FieldIndex.Versioning) ?? true))
            {
            ...
            {
                item.QuestDelay = rhs.QuestDelay;
            }
            DeepCopyInCustom(
                item: item,
                rhs: rhs,
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class QuestDataBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            item.QuestDelay = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
        }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IQuestDataGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            {
                ret.Versioning |= QuestData.VersioningBreaks.Break0;
            }
            if (ret._structData.Length <= 0x4)
            {
                ret.Versioning |= QuestData.VersioningBreaks.Break1;
            }
