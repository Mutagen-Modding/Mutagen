...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Container>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IContainerGetter.COED => this.COED;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Container_FieldIndex.COED:
                        return COED;
                    default:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ContainerCommon : Fallout3MajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Container_FieldIndex.COED) ?? true))
            {
    ...
    internal partial class ContainerSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Container_FieldIndex.COED) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.COED:
                {
                    ...
                    return (int)Container_FieldIndex.COED;
                }
                default:
