...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Eye>
    {
        ...
        public Eye(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.EYES)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Eye_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Eye";
        ...
        {
            var all = RecordCollection.Factory(RecordTypes.EYES);
    ...
    #region Common
    internal partial class EyeSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class EyeCommon : Fallout3MajorRecordCommon
    {
        ...
        public static Eye_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public Eye Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Eye(formKey, default(Fallout3Release));
    ...
    internal partial class EyeSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class EyeBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
