...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IMoveableStaticInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectBoundsGetter? IMoveableStaticGetter.ObjectBounds => this.ObjectBounds;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Boolean? IMoveableStaticGetter.OnLocalMap => this.OnLocalMap;
        #endregion
        #region Sound
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<ISoundGetter> IMoveableStaticGetter.Sound => this.Sound;
        #endregion
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case MoveableStatic_FieldIndex.OnLocalMap:
                        return OnLocalMap;
                    case MoveableStatic_FieldIndex.Sound:
                        return Sound;
                    default:
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => MoveableStaticCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public MoveableStatic(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public MoveableStatic(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.MSTT)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class MoveableStatic_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.MoveableStatic";
    ...
    #region Common
    internal partial class MoveableStaticSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class MoveableStaticCommon : Fallout3MajorRecordCommon
    {
        ...
        public static MoveableStatic_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MoveableStatic_FieldIndex.OnLocalMap) ?? true))
            {
                if (lhs.OnLocalMap != rhs.OnLocalMap) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MoveableStatic_FieldIndex.Sound) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMoveableStaticGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public MoveableStatic Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new MoveableStatic(formKey, default(Fallout3Release));
    ...
    internal partial class MoveableStaticSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
                ...
                try
                {
                    if(rhs.ObjectBounds is {} rhsObjectBounds)
                    {
                        item.ObjectBounds = rhsObjectBounds.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)MoveableStatic_FieldIndex.ObjectBounds));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)MoveableStatic_FieldIndex.Sound) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class MoveableStaticBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.SNAM:
                {
                    ...
                    return (int)MoveableStatic_FieldIndex.Sound;
                }
                default:
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IMoveableStaticGetter
    {
        ...
        protected override Type LinkType => typeof(IMoveableStaticGetter);
