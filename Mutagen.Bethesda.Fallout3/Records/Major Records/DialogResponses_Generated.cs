...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<DialogResponses>
    {
        ...
        #region FollowUp
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<IFormLinkGetter<IDialogResponsesGetter>> _FollowUp = new ExtendedList<IFormLinkGetter<IDialogResponsesGetter>>();
        public ExtendedList<IFormLinkGetter<IDialogResponsesGetter>> FollowUp
        {
            get => this._FollowUp;
            init => this._FollowUp = value;
        }
        #region Interface Members
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IFormLinkGetter<IDialogResponsesGetter>> IDialogResponsesGetter.FollowUp => _FollowUp;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                {
                    if (!eval(this.FollowUp.Overall)) return false;
                    if (this.FollowUp.Specific != null)
                    {
                        foreach (var item in this.FollowUp.Specific)
                        {
                            if (!eval(item.Value)) return false;
                        }
                    }
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (this.FollowUp != null)
                {
                    if (eval(this.FollowUp.Overall)) return true;
                    if (this.FollowUp.Specific != null)
                    {
                        foreach (var item in this.FollowUp.Specific)
                        {
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (FollowUp != null)
                {
                    obj.FollowUp = new MaskItem<R, IEnumerable<(int Index, R Value)>?>(eval(this.FollowUp.Overall), []);
                    if (FollowUp.Specific != null)
                    {
                        var l = new List<(int Index, R Item)>();
                        obj.FollowUp.Specific = l;
                        foreach (var item in FollowUp.Specific)
                        {
                            R mask = eval(item.Value);
                            l.Add((item.Index, mask));
                        }
            ...
            public void Print(StructuredStringBuilder sb, DialogResponses.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if ((printMask?.FollowUp?.Overall ?? true)
                        && FollowUp is {} FollowUpItem)
                    {
                        sb.AppendLine("FollowUp =>");
                        using (sb.Brace())
                        {
                            sb.AppendItem(FollowUpItem.Overall);
                            if (FollowUpItem.Specific != null)
                            {
                                foreach (var subItem in FollowUpItem.Specific)
                                {
                                    using (sb.Brace())
                                    {
                                        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case DialogResponses_FieldIndex.LinkFrom:
                        return LinkFrom;
                    case DialogResponses_FieldIndex.FollowUp:
                        return FollowUp;
            ...
            public override void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    ...
                    case DialogResponses_FieldIndex.LinkFrom:
                        ...
                        break;
                    case DialogResponses_FieldIndex.FollowUp:
                        this.FollowUp = new MaskItem<Exception?, IEnumerable<(int Index, Exception Value)>?>(ex, null);
                        break;
                    case DialogResponses_FieldIndex.BeginScript:
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case DialogResponses_FieldIndex.LinkFrom:
                        ...
                        break;
                    case DialogResponses_FieldIndex.FollowUp:
                        this.FollowUp = (MaskItem<Exception?, IEnumerable<(int Index, Exception Value)>?>)obj;
                        break;
                    case DialogResponses_FieldIndex.BeginScript:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class DialogResponsesCommon : Fallout3MajorRecordCommon
    {
            ...
            DialogResponses.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.FollowUp?.Overall ?? true)
            {
                ...
                using (sb.Brace())
                {
                    foreach (var subItem in item.FollowUp)
                    {
                        using (sb.Brace())
                        {
                            sb.AppendItem(subItem.FormKey);
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IDialogResponsesGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.FollowUp)
            {
                yield return FormLinkInformation.Factory(item);
            }
    ...
    internal partial class DialogResponsesSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)DialogResponses_FieldIndex.FollowUp) ?? true))
            {
                errorMask?.PushIndex((int)DialogResponses_FieldIndex.FollowUp);
                try
                {
                    item.FollowUp.SetTo(
                        rhs.FollowUp
        ...
        IDialogResponsesGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.TCFU:
                {
                    this.FollowUp = BinaryOverlayList.FactoryByArray<IFormLinkGetter<IDialogResponsesGetter>>(
                        mem: stream.RemainingMemory,
                        package: _package,
