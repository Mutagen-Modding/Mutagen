...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<CreatureData>
    {
        ...
        #region Type
        public Creature.CreatureType Type { get; set; } = default(Creature.CreatureType);
        #endregion
        #region CombatSkill
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case CreatureData_FieldIndex.Health:
                        return Health;
                    case CreatureData_FieldIndex.Unused:
                        return Unused;
                    case CreatureData_FieldIndex.Damage:
                        return Damage;
                    case CreatureData_FieldIndex.Strength:
                        return Strength;
                    case CreatureData_FieldIndex.Perception:
                        return Perception;
                    case CreatureData_FieldIndex.Endurance:
                        return Endurance;
                    case CreatureData_FieldIndex.Charisma:
                        return Charisma;
    ...
    {
        new Creature.CreatureType Type { get; set; }
        ...
        ILoquiObject<ICreatureDataGetter>
    {
        ...
        Creature.CreatureType Type { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class CreatureData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.CreatureData";
    ...
    internal partial class CreatureDataSetterCommon
    {
        ...
        {
            ClearPartial();
            item.Type = default(Creature.CreatureType);
    ...
    internal partial class CreatureDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Unused) ?? true))
            {
                if (lhs.Unused != rhs.Unused) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Damage) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Perception) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Charisma) ?? true))
            {
    ...
    internal partial class CreatureDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Unused) ?? true))
            {
                item.Unused = rhs.Unused;
            }
            if ((copyMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Damage) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Perception) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)CreatureData_FieldIndex.Charisma) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
    public partial class CreatureDataBinaryWriteTranslation : IBinaryWriteTranslator
    {
        ...
        public static void WriteEmbedded(
            ...
            MutagenWriter writer)
        {
            EnumBinaryTranslation<Creature.CreatureType, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Type,
                length: 1);
    ...
    internal partial class CreatureDataBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.Type = EnumBinaryTranslation<Creature.CreatureType, MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                length: 1);
            item.CombatSkill = frame.ReadUInt8();
            item.MagicSkill = frame.ReadUInt8();
            item.StealthSkill = frame.ReadUInt8();
            item.Health = frame.ReadInt16();
            item.Unused = frame.ReadUInt16();
            item.Damage = frame.ReadInt16();
            item.Strength = frame.ReadUInt8();
            item.Perception = frame.ReadUInt8();
            item.Endurance = frame.ReadUInt8();
            item.Charisma = frame.ReadUInt8();
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ICreatureDataGetter
    {
        ...
        public Creature.CreatureType Type => (Creature.CreatureType)_structData.Span.Slice(0x0, 0x1)[0];
        ...
        public Int16 Health => BinaryPrimitives.ReadInt16LittleEndian(_structData.Slice(0x4, 0x2));
        public UInt16 Unused => BinaryPrimitives.ReadUInt16LittleEndian(_structData.Slice(0x6, 0x2));
        public Int16 Damage => BinaryPrimitives.ReadInt16LittleEndian(_structData.Slice(0x8, 0x2));
        public Byte Strength => _structData.Span[0xA];
        public Byte Perception => _structData.Span[0xB];
        public Byte Endurance => _structData.Span[0xC];
        public Byte Charisma => _structData.Span[0xD];
        public Byte Intelligence => _structData.Span[0xE];
        public Byte Agility => _structData.Span[0xF];
        public Byte Luck => _structData.Span[0x10];
