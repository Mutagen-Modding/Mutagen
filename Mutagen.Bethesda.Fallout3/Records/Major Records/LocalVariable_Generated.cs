...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<LocalVariable>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((LocalVariableCommon)((ILocalVariableGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ILocalVariableGetter? obj)
        {
            return ((LocalVariableCommon)((ILocalVariableGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(LocalVariable.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, LocalVariable.Mask<bool>? printMask = null)
            {
    ...
    public static partial class LocalVariableMixIn
    {
        ...
        {
            return ((LocalVariableCommon)((ILocalVariableGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            LocalVariable.Mask<bool>? printMask = null)
        {
            ((LocalVariableCommon)((ILocalVariableGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class LocalVariable_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.LocalVariable";
    ...
    internal partial class LocalVariableCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LocalVariable_FieldIndex.Data) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Data, rhs.Data, out var lhsData, out var rhsData, out var isDataEqual))
                {
                    if (!((LocalVariableDataCommon)((ILocalVariableDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, equalsMask?.GetSubCrystal((int)LocalVariable_FieldIndex.Data))) return false;
                }
                else if (!isDataEqual) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)LocalVariable_FieldIndex.Name) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILocalVariableGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    {
        public static readonly LocalVariableBinaryWriteTranslation Instance = new();
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.SLSD:
                {
                    ...
                    item.Data = Mutagen.Bethesda.Fallout3.LocalVariableData.CreateFromBinary(frame: frame);
