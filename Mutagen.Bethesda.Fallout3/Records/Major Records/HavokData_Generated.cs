...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<HavokData>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((HavokDataCommon)((IHavokDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IHavokDataGetter? obj)
        {
            return ((HavokDataCommon)((IHavokDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class HavokData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.HavokData";
    ...
    internal partial class HavokDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)HavokData_FieldIndex.Material) ?? true))
            {
                if (lhs.Material != rhs.Material) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)HavokData_FieldIndex.Friction) ?? true))
            {
                if (lhs.Friction != rhs.Friction) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)HavokData_FieldIndex.Restitution) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IHavokDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
