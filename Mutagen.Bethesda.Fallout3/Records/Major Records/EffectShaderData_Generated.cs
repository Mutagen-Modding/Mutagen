...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<EffectShaderData>
    {
        ...
        {
            if (obj is not IEffectShaderDataGetter rhs) return false;
            return ((EffectShaderDataCommon)((IEffectShaderDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IEffectShaderDataGetter? obj)
        {
            return ((EffectShaderDataCommon)((IEffectShaderDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(EffectShaderData.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, EffectShaderData.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    {
                        sb.AppendItem(FillTextureEffectColor, "FillTextureEffectColor");
                    }
                    if (printMask?.FillTextureEffectAlphaFadeInTime ?? true)
                    {
                        sb.AppendItem(FillTextureEffectAlphaFadeInTime, "FillTextureEffectAlphaFadeInTime");
                    }
                    if (printMask?.FillTextureEffectFullAlphaTime ?? true)
                    {
                        sb.AppendItem(FillTextureEffectFullAlphaTime, "FillTextureEffectFullAlphaTime");
                    }
                    if (printMask?.FillTextureEffectAlphaFadeOutTime ?? true)
                    {
                        sb.AppendItem(FillTextureEffectAlphaFadeOutTime, "FillTextureEffectAlphaFadeOutTime");
                    }
                    if (printMask?.FillTextureEffectPersistentAlphaRatio ?? true)
                    {
                        sb.AppendItem(FillTextureEffectPersistentAlphaRatio, "FillTextureEffectPersistentAlphaRatio");
                    }
                    if (printMask?.FillTextureEffectAlphaPulseAmplitude ?? true)
                    {
                        sb.AppendItem(FillTextureEffectAlphaPulseAmplitude, "FillTextureEffectAlphaPulseAmplitude");
                    }
                    if (printMask?.FillTextureEffectAlphaPulseFrequency ?? true)
                    {
                        sb.AppendItem(FillTextureEffectAlphaPulseFrequency, "FillTextureEffectAlphaPulseFrequency");
                    }
                    if (printMask?.FillTextureEffectTextureAnimationSpeedU ?? true)
                    {
                        sb.AppendItem(FillTextureEffectTextureAnimationSpeedU, "FillTextureEffectTextureAnimationSpeedU");
                    }
                    if (printMask?.FillTextureEffectTextureAnimationSpeedV ?? true)
                    {
                        sb.AppendItem(FillTextureEffectTextureAnimationSpeedV, "FillTextureEffectTextureAnimationSpeedV");
                    }
                    ...
                    {
                        sb.AppendItem(FillTextureEffectFullAlphaRatio, "FillTextureEffectFullAlphaRatio");
                    }
                    ...
                    {
                        sb.AppendItem(ParticleShaderSourceBlendMode, "ParticleShaderSourceBlendMode");
                    }
                    if (printMask?.ParticleShaderBlendOperation ?? true)
                    {
                        sb.AppendItem(ParticleShaderBlendOperation, "ParticleShaderBlendOperation");
                    }
                    if (printMask?.ParticleShaderZTestFunction ?? true)
                    {
                        sb.AppendItem(ParticleShaderZTestFunction, "ParticleShaderZTestFunction");
                    }
                    if (printMask?.ParticleShaderDestBlendMode ?? true)
                    {
                        sb.AppendItem(ParticleShaderDestBlendMode, "ParticleShaderDestBlendMode");
                    }
                    if (printMask?.ParticleShaderParticleBirthRampUpTime ?? true)
                    {
                        sb.AppendItem(ParticleShaderParticleBirthRampUpTime, "ParticleShaderParticleBirthRampUpTime");
                    }
                    if (printMask?.ParticleShaderFullParticleBirthTime ?? true)
                    {
                        sb.AppendItem(ParticleShaderFullParticleBirthTime, "ParticleShaderFullParticleBirthTime");
                    }
                    if (printMask?.ParticleShaderParticleBirthRampDownTime ?? true)
                    {
                        sb.AppendItem(ParticleShaderParticleBirthRampDownTime, "ParticleShaderParticleBirthRampDownTime");
                    }
                    if (printMask?.ParticleShaderFullParticleBirthRatio ?? true)
                    {
                        sb.AppendItem(ParticleShaderFullParticleBirthRatio, "ParticleShaderFullParticleBirthRatio");
                    }
                    if (printMask?.ParticleShaderPersistentParticleBirthRatio ?? true)
                    {
                        sb.AppendItem(ParticleShaderPersistentParticleBirthRatio, "ParticleShaderPersistentParticleBirthRatio");
                    }
                    if (printMask?.ParticleShaderParticleLifetime ?? true)
                    {
                        sb.AppendItem(ParticleShaderParticleLifetime, "ParticleShaderParticleLifetime");
                    }
                    if (printMask?.ParticleShaderParticleLifetimePlusMinus ?? true)
                    {
                        sb.AppendItem(ParticleShaderParticleLifetimePlusMinus, "ParticleShaderParticleLifetimePlusMinus");
                    }
                    if (printMask?.ParticleShaderInitialSpeedAlongNormal ?? true)
                    {
                        sb.AppendItem(ParticleShaderInitialSpeedAlongNormal, "ParticleShaderInitialSpeedAlongNormal");
                    }
                    if (printMask?.ParticleShaderAccelerationAlongNormal ?? true)
                    {
                        sb.AppendItem(ParticleShaderAccelerationAlongNormal, "ParticleShaderAccelerationAlongNormal");
                    }
                    if (printMask?.ParticleShaderInitialVelocity1 ?? true)
                    {
                        sb.AppendItem(ParticleShaderInitialVelocity1, "ParticleShaderInitialVelocity1");
                    }
                    if (printMask?.ParticleShaderInitialVelocity2 ?? true)
                    {
                        sb.AppendItem(ParticleShaderInitialVelocity2, "ParticleShaderInitialVelocity2");
                    }
                    if (printMask?.ParticleShaderInitialVelocity3 ?? true)
                    {
                        sb.AppendItem(ParticleShaderInitialVelocity3, "ParticleShaderInitialVelocity3");
                    }
                    if (printMask?.ParticleShaderAcceleration1 ?? true)
                    {
                        sb.AppendItem(ParticleShaderAcceleration1, "ParticleShaderAcceleration1");
                    }
                    if (printMask?.ParticleShaderAcceleration2 ?? true)
                    {
                        sb.AppendItem(ParticleShaderAcceleration2, "ParticleShaderAcceleration2");
                    }
                    if (printMask?.ParticleShaderAcceleration3 ?? true)
                    {
                        sb.AppendItem(ParticleShaderAcceleration3, "ParticleShaderAcceleration3");
                    }
                    if (printMask?.ParticleShaderScaleKey1 ?? true)
                    {
                        sb.AppendItem(ParticleShaderScaleKey1, "ParticleShaderScaleKey1");
                    }
                    if (printMask?.ParticleShaderScaleKey2 ?? true)
                    {
                        sb.AppendItem(ParticleShaderScaleKey2, "ParticleShaderScaleKey2");
                    }
                    if (printMask?.ParticleShaderScaleKey1Time ?? true)
                    {
                        sb.AppendItem(ParticleShaderScaleKey1Time, "ParticleShaderScaleKey1Time");
                    }
                    if (printMask?.ParticleShaderScaleKey2Time ?? true)
                    {
                        sb.AppendItem(ParticleShaderScaleKey2Time, "ParticleShaderScaleKey2Time");
                    }
                    if (printMask?.ColorKey1Color ?? true)
                    {
                        sb.AppendItem(ColorKey1Color, "ColorKey1Color");
                    }
                    if (printMask?.ColorKey2Color ?? true)
                    {
                        sb.AppendItem(ColorKey2Color, "ColorKey2Color");
                    }
                    if (printMask?.ColorKey3Color ?? true)
                    {
                        sb.AppendItem(ColorKey3Color, "ColorKey3Color");
                    }
                    if (printMask?.ColorKey1ColorAlpha ?? true)
                    {
                        sb.AppendItem(ColorKey1ColorAlpha, "ColorKey1ColorAlpha");
                    }
                    if (printMask?.ColorKey2ColorAlpha ?? true)
                    {
                        sb.AppendItem(ColorKey2ColorAlpha, "ColorKey2ColorAlpha");
                    }
                    if (printMask?.ColorKey3ColorAlpha ?? true)
                    {
                        sb.AppendItem(ColorKey3ColorAlpha, "ColorKey3ColorAlpha");
                    }
                    if (printMask?.ColorKey1ColorKeyTime ?? true)
                    {
                        sb.AppendItem(ColorKey1ColorKeyTime, "ColorKey1ColorKeyTime");
                    }
                    if (printMask?.ColorKey2ColorKeyTime ?? true)
                    {
                        sb.AppendItem(ColorKey2ColorKeyTime, "ColorKey2ColorKeyTime");
                    }
    ...
    public static partial class EffectShaderDataMixIn
    {
        ...
        {
            return ((EffectShaderDataCommon)((IEffectShaderDataGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            EffectShaderData.Mask<bool>? printMask = null)
        {
            ((EffectShaderDataCommon)((IEffectShaderDataGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
        ...
        public static bool Equals(
            this IEffectShaderDataGetter item,
            IEffectShaderDataGetter rhs,
            EffectShaderData.TranslationMask? equalsMask = null)
        {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class EffectShaderData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.EffectShaderData";
    ...
    internal partial class EffectShaderDataCommon
    {
            ...
            EffectShaderData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"EffectShaderData =>");
            }
            else
            {
                sb.AppendLine($"{name} (EffectShaderData) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            EffectShaderData.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.FillTextureEffectColor ?? true)
            {
                sb.AppendItem(item.FillTextureEffectColor, "FillTextureEffectColor");
            }
            if (printMask?.FillTextureEffectAlphaFadeInTime ?? true)
            {
                sb.AppendItem(item.FillTextureEffectAlphaFadeInTime, "FillTextureEffectAlphaFadeInTime");
            }
            if (printMask?.FillTextureEffectFullAlphaTime ?? true)
            {
                sb.AppendItem(item.FillTextureEffectFullAlphaTime, "FillTextureEffectFullAlphaTime");
            }
            if (printMask?.FillTextureEffectAlphaFadeOutTime ?? true)
            {
                sb.AppendItem(item.FillTextureEffectAlphaFadeOutTime, "FillTextureEffectAlphaFadeOutTime");
            }
            if (printMask?.FillTextureEffectPersistentAlphaRatio ?? true)
            {
                sb.AppendItem(item.FillTextureEffectPersistentAlphaRatio, "FillTextureEffectPersistentAlphaRatio");
            }
            if (printMask?.FillTextureEffectAlphaPulseAmplitude ?? true)
            {
                sb.AppendItem(item.FillTextureEffectAlphaPulseAmplitude, "FillTextureEffectAlphaPulseAmplitude");
            }
            if (printMask?.FillTextureEffectAlphaPulseFrequency ?? true)
            {
                sb.AppendItem(item.FillTextureEffectAlphaPulseFrequency, "FillTextureEffectAlphaPulseFrequency");
            }
            if (printMask?.FillTextureEffectTextureAnimationSpeedU ?? true)
            {
                sb.AppendItem(item.FillTextureEffectTextureAnimationSpeedU, "FillTextureEffectTextureAnimationSpeedU");
            }
            if (printMask?.FillTextureEffectTextureAnimationSpeedV ?? true)
            {
                sb.AppendItem(item.FillTextureEffectTextureAnimationSpeedV, "FillTextureEffectTextureAnimationSpeedV");
            }
            if (printMask?.EdgeEffectFallOff ?? true)
            {
            ...
            if (printMask?.FillTextureEffectFullAlphaRatio ?? true)
            {
                sb.AppendItem(item.FillTextureEffectFullAlphaRatio, "FillTextureEffectFullAlphaRatio");
            }
            if (printMask?.EdgeEffectFullAlphaRatio ?? true)
            {
            ...
            if (printMask?.ParticleShaderSourceBlendMode ?? true)
            {
                sb.AppendItem(item.ParticleShaderSourceBlendMode, "ParticleShaderSourceBlendMode");
            }
            if (printMask?.ParticleShaderBlendOperation ?? true)
            {
                sb.AppendItem(item.ParticleShaderBlendOperation, "ParticleShaderBlendOperation");
            }
            if (printMask?.ParticleShaderZTestFunction ?? true)
            {
                sb.AppendItem(item.ParticleShaderZTestFunction, "ParticleShaderZTestFunction");
            }
            if (printMask?.ParticleShaderDestBlendMode ?? true)
            {
                sb.AppendItem(item.ParticleShaderDestBlendMode, "ParticleShaderDestBlendMode");
            }
            if (printMask?.ParticleShaderParticleBirthRampUpTime ?? true)
            {
                sb.AppendItem(item.ParticleShaderParticleBirthRampUpTime, "ParticleShaderParticleBirthRampUpTime");
            }
            if (printMask?.ParticleShaderFullParticleBirthTime ?? true)
            {
                sb.AppendItem(item.ParticleShaderFullParticleBirthTime, "ParticleShaderFullParticleBirthTime");
            }
            if (printMask?.ParticleShaderParticleBirthRampDownTime ?? true)
            {
                sb.AppendItem(item.ParticleShaderParticleBirthRampDownTime, "ParticleShaderParticleBirthRampDownTime");
            }
            if (printMask?.ParticleShaderFullParticleBirthRatio ?? true)
            {
                sb.AppendItem(item.ParticleShaderFullParticleBirthRatio, "ParticleShaderFullParticleBirthRatio");
            }
            if (printMask?.ParticleShaderPersistentParticleBirthRatio ?? true)
            {
                sb.AppendItem(item.ParticleShaderPersistentParticleBirthRatio, "ParticleShaderPersistentParticleBirthRatio");
            }
            if (printMask?.ParticleShaderParticleLifetime ?? true)
            {
                sb.AppendItem(item.ParticleShaderParticleLifetime, "ParticleShaderParticleLifetime");
            }
            if (printMask?.ParticleShaderParticleLifetimePlusMinus ?? true)
            {
                sb.AppendItem(item.ParticleShaderParticleLifetimePlusMinus, "ParticleShaderParticleLifetimePlusMinus");
            }
            if (printMask?.ParticleShaderInitialSpeedAlongNormal ?? true)
            {
                sb.AppendItem(item.ParticleShaderInitialSpeedAlongNormal, "ParticleShaderInitialSpeedAlongNormal");
            }
            if (printMask?.ParticleShaderAccelerationAlongNormal ?? true)
            {
                sb.AppendItem(item.ParticleShaderAccelerationAlongNormal, "ParticleShaderAccelerationAlongNormal");
            }
            if (printMask?.ParticleShaderInitialVelocity1 ?? true)
            {
                sb.AppendItem(item.ParticleShaderInitialVelocity1, "ParticleShaderInitialVelocity1");
            }
            if (printMask?.ParticleShaderInitialVelocity2 ?? true)
            {
                sb.AppendItem(item.ParticleShaderInitialVelocity2, "ParticleShaderInitialVelocity2");
            }
            if (printMask?.ParticleShaderInitialVelocity3 ?? true)
            {
                sb.AppendItem(item.ParticleShaderInitialVelocity3, "ParticleShaderInitialVelocity3");
            }
            if (printMask?.ParticleShaderAcceleration1 ?? true)
            {
                sb.AppendItem(item.ParticleShaderAcceleration1, "ParticleShaderAcceleration1");
            }
            if (printMask?.ParticleShaderAcceleration2 ?? true)
            {
                sb.AppendItem(item.ParticleShaderAcceleration2, "ParticleShaderAcceleration2");
            }
            if (printMask?.ParticleShaderAcceleration3 ?? true)
            {
                sb.AppendItem(item.ParticleShaderAcceleration3, "ParticleShaderAcceleration3");
            }
            if (printMask?.ParticleShaderScaleKey1 ?? true)
            {
                sb.AppendItem(item.ParticleShaderScaleKey1, "ParticleShaderScaleKey1");
            }
            if (printMask?.ParticleShaderScaleKey2 ?? true)
            {
                sb.AppendItem(item.ParticleShaderScaleKey2, "ParticleShaderScaleKey2");
            }
            if (printMask?.ParticleShaderScaleKey1Time ?? true)
            {
                sb.AppendItem(item.ParticleShaderScaleKey1Time, "ParticleShaderScaleKey1Time");
            }
            if (printMask?.ParticleShaderScaleKey2Time ?? true)
            {
                sb.AppendItem(item.ParticleShaderScaleKey2Time, "ParticleShaderScaleKey2Time");
            }
            if (printMask?.ColorKey1Color ?? true)
            {
                sb.AppendItem(item.ColorKey1Color, "ColorKey1Color");
            }
            if (printMask?.ColorKey2Color ?? true)
            {
                sb.AppendItem(item.ColorKey2Color, "ColorKey2Color");
            }
            if (printMask?.ColorKey3Color ?? true)
            {
                sb.AppendItem(item.ColorKey3Color, "ColorKey3Color");
            }
            if (printMask?.ColorKey1ColorAlpha ?? true)
            {
                sb.AppendItem(item.ColorKey1ColorAlpha, "ColorKey1ColorAlpha");
            }
            if (printMask?.ColorKey2ColorAlpha ?? true)
            {
                sb.AppendItem(item.ColorKey2ColorAlpha, "ColorKey2ColorAlpha");
            }
            if (printMask?.ColorKey3ColorAlpha ?? true)
            {
                sb.AppendItem(item.ColorKey3ColorAlpha, "ColorKey3ColorAlpha");
            }
            if (printMask?.ColorKey1ColorKeyTime ?? true)
            {
                sb.AppendItem(item.ColorKey1ColorKeyTime, "ColorKey1ColorKeyTime");
            }
            if (printMask?.ColorKey2ColorKeyTime ?? true)
            {
                sb.AppendItem(item.ColorKey2ColorKeyTime, "ColorKey2ColorKeyTime");
            }
            if (printMask?.ColorKey3ColorKeyTime ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.Unused1) ?? true))
            {
                if (!MemoryExtensions.SequenceEqual(lhs.Unused1.Span, rhs.Unused1.Span)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.MembraneShaderSourceBlendMode) ?? true))
            {
                if (lhs.MembraneShaderSourceBlendMode != rhs.MembraneShaderSourceBlendMode) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.MembraneShaderBlendOperation) ?? true))
            {
                if (lhs.MembraneShaderBlendOperation != rhs.MembraneShaderBlendOperation) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.MembraneShaderZTestFunction) ?? true))
            {
                if (lhs.MembraneShaderZTestFunction != rhs.MembraneShaderZTestFunction) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectColor) ?? true))
            {
                if (!lhs.FillTextureEffectColor.ColorOnlyEquals(rhs.FillTextureEffectColor)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectAlphaFadeInTime) ?? true))
            {
                if (!lhs.FillTextureEffectAlphaFadeInTime.EqualsWithin(rhs.FillTextureEffectAlphaFadeInTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectFullAlphaTime) ?? true))
            {
                if (!lhs.FillTextureEffectFullAlphaTime.EqualsWithin(rhs.FillTextureEffectFullAlphaTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectAlphaFadeOutTime) ?? true))
            {
                if (!lhs.FillTextureEffectAlphaFadeOutTime.EqualsWithin(rhs.FillTextureEffectAlphaFadeOutTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectPersistentAlphaRatio) ?? true))
            {
                if (!lhs.FillTextureEffectPersistentAlphaRatio.EqualsWithin(rhs.FillTextureEffectPersistentAlphaRatio)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectAlphaPulseAmplitude) ?? true))
            {
                if (!lhs.FillTextureEffectAlphaPulseAmplitude.EqualsWithin(rhs.FillTextureEffectAlphaPulseAmplitude)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectAlphaPulseFrequency) ?? true))
            {
                if (!lhs.FillTextureEffectAlphaPulseFrequency.EqualsWithin(rhs.FillTextureEffectAlphaPulseFrequency)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectTextureAnimationSpeedU) ?? true))
            {
                if (!lhs.FillTextureEffectTextureAnimationSpeedU.EqualsWithin(rhs.FillTextureEffectTextureAnimationSpeedU)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectTextureAnimationSpeedV) ?? true))
            {
                if (!lhs.FillTextureEffectTextureAnimationSpeedV.EqualsWithin(rhs.FillTextureEffectTextureAnimationSpeedV)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectFallOff) ?? true))
            {
                if (!lhs.EdgeEffectFallOff.EqualsWithin(rhs.EdgeEffectFallOff)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectColor) ?? true))
            {
                if (!lhs.EdgeEffectColor.ColorOnlyEquals(rhs.EdgeEffectColor)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectAlphaFadeInTime) ?? true))
            {
                if (!lhs.EdgeEffectAlphaFadeInTime.EqualsWithin(rhs.EdgeEffectAlphaFadeInTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectFullAlphaTime) ?? true))
            {
                if (!lhs.EdgeEffectFullAlphaTime.EqualsWithin(rhs.EdgeEffectFullAlphaTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectAlphaFadeOutTime) ?? true))
            {
                if (!lhs.EdgeEffectAlphaFadeOutTime.EqualsWithin(rhs.EdgeEffectAlphaFadeOutTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectPersistentAlphaRatio) ?? true))
            {
                if (!lhs.EdgeEffectPersistentAlphaRatio.EqualsWithin(rhs.EdgeEffectPersistentAlphaRatio)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectAlphaPulseAmplitude) ?? true))
            {
                if (!lhs.EdgeEffectAlphaPulseAmplitude.EqualsWithin(rhs.EdgeEffectAlphaPulseAmplitude)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectAlphaPulseFrequency) ?? true))
            {
                if (!lhs.EdgeEffectAlphaPulseFrequency.EqualsWithin(rhs.EdgeEffectAlphaPulseFrequency)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.FillTextureEffectFullAlphaRatio) ?? true))
            {
                if (!lhs.FillTextureEffectFullAlphaRatio.EqualsWithin(rhs.FillTextureEffectFullAlphaRatio)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.EdgeEffectFullAlphaRatio) ?? true))
            {
                if (!lhs.EdgeEffectFullAlphaRatio.EqualsWithin(rhs.EdgeEffectFullAlphaRatio)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.MembraneShaderDestBlendMode) ?? true))
            {
                if (lhs.MembraneShaderDestBlendMode != rhs.MembraneShaderDestBlendMode) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderSourceBlendMode) ?? true))
            {
                if (lhs.ParticleShaderSourceBlendMode != rhs.ParticleShaderSourceBlendMode) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderBlendOperation) ?? true))
            {
                if (lhs.ParticleShaderBlendOperation != rhs.ParticleShaderBlendOperation) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderZTestFunction) ?? true))
            {
                if (lhs.ParticleShaderZTestFunction != rhs.ParticleShaderZTestFunction) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderDestBlendMode) ?? true))
            {
                if (lhs.ParticleShaderDestBlendMode != rhs.ParticleShaderDestBlendMode) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderParticleBirthRampUpTime) ?? true))
            {
                if (!lhs.ParticleShaderParticleBirthRampUpTime.EqualsWithin(rhs.ParticleShaderParticleBirthRampUpTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderFullParticleBirthTime) ?? true))
            {
                if (!lhs.ParticleShaderFullParticleBirthTime.EqualsWithin(rhs.ParticleShaderFullParticleBirthTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderParticleBirthRampDownTime) ?? true))
            {
                if (!lhs.ParticleShaderParticleBirthRampDownTime.EqualsWithin(rhs.ParticleShaderParticleBirthRampDownTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderFullParticleBirthRatio) ?? true))
            {
                if (!lhs.ParticleShaderFullParticleBirthRatio.EqualsWithin(rhs.ParticleShaderFullParticleBirthRatio)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderPersistentParticleBirthRatio) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderParticleLifetime) ?? true))
            {
                if (!lhs.ParticleShaderParticleLifetime.EqualsWithin(rhs.ParticleShaderParticleLifetime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderParticleLifetimePlusMinus) ?? true))
            {
                if (!lhs.ParticleShaderParticleLifetimePlusMinus.EqualsWithin(rhs.ParticleShaderParticleLifetimePlusMinus)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderInitialSpeedAlongNormal) ?? true))
            {
                if (!lhs.ParticleShaderInitialSpeedAlongNormal.EqualsWithin(rhs.ParticleShaderInitialSpeedAlongNormal)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderAccelerationAlongNormal) ?? true))
            {
                if (!lhs.ParticleShaderAccelerationAlongNormal.EqualsWithin(rhs.ParticleShaderAccelerationAlongNormal)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderInitialVelocity1) ?? true))
            {
                if (!lhs.ParticleShaderInitialVelocity1.EqualsWithin(rhs.ParticleShaderInitialVelocity1)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderInitialVelocity2) ?? true))
            {
                if (!lhs.ParticleShaderInitialVelocity2.EqualsWithin(rhs.ParticleShaderInitialVelocity2)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderInitialVelocity3) ?? true))
            {
                if (!lhs.ParticleShaderInitialVelocity3.EqualsWithin(rhs.ParticleShaderInitialVelocity3)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderAcceleration1) ?? true))
            {
                if (!lhs.ParticleShaderAcceleration1.EqualsWithin(rhs.ParticleShaderAcceleration1)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderAcceleration2) ?? true))
            {
                if (!lhs.ParticleShaderAcceleration2.EqualsWithin(rhs.ParticleShaderAcceleration2)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderAcceleration3) ?? true))
            {
                if (!lhs.ParticleShaderAcceleration3.EqualsWithin(rhs.ParticleShaderAcceleration3)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderScaleKey1) ?? true))
            {
                if (!lhs.ParticleShaderScaleKey1.EqualsWithin(rhs.ParticleShaderScaleKey1)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderScaleKey2) ?? true))
            {
                if (!lhs.ParticleShaderScaleKey2.EqualsWithin(rhs.ParticleShaderScaleKey2)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderScaleKey1Time) ?? true))
            {
                if (!lhs.ParticleShaderScaleKey1Time.EqualsWithin(rhs.ParticleShaderScaleKey1Time)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ParticleShaderScaleKey2Time) ?? true))
            {
                if (!lhs.ParticleShaderScaleKey2Time.EqualsWithin(rhs.ParticleShaderScaleKey2Time)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey1Color) ?? true))
            {
                if (!lhs.ColorKey1Color.ColorOnlyEquals(rhs.ColorKey1Color)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey2Color) ?? true))
            {
                if (!lhs.ColorKey2Color.ColorOnlyEquals(rhs.ColorKey2Color)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey3Color) ?? true))
            {
                if (!lhs.ColorKey3Color.ColorOnlyEquals(rhs.ColorKey3Color)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey1ColorAlpha) ?? true))
            {
                if (!lhs.ColorKey1ColorAlpha.EqualsWithin(rhs.ColorKey1ColorAlpha)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey2ColorAlpha) ?? true))
            {
                if (!lhs.ColorKey2ColorAlpha.EqualsWithin(rhs.ColorKey2ColorAlpha)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey3ColorAlpha) ?? true))
            {
                if (!lhs.ColorKey3ColorAlpha.EqualsWithin(rhs.ColorKey3ColorAlpha)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey1ColorKeyTime) ?? true))
            {
                if (!lhs.ColorKey1ColorKeyTime.EqualsWithin(rhs.ColorKey1ColorKeyTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey2ColorKeyTime) ?? true))
            {
                if (!lhs.ColorKey2ColorKeyTime.EqualsWithin(rhs.ColorKey2ColorKeyTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.ColorKey3ColorKeyTime) ?? true))
            {
    ...
    internal partial class EffectShaderDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)EffectShaderData_FieldIndex.Unused1) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    {
        public static readonly EffectShaderDataBinaryWriteTranslation Instance = new();
    ...
    {
        public static readonly EffectShaderDataBinaryCreateTranslation Instance = new EffectShaderDataBinaryCreateTranslation();
            ...
            MutagenFrame frame)
        {
            ...
            item.FillTextureEffectAlphaFadeOutTime = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.FillTextureEffectPersistentAlphaRatio = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.FillTextureEffectAlphaPulseAmplitude = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.FillTextureEffectAlphaPulseFrequency = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.FillTextureEffectTextureAnimationSpeedU = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.FillTextureEffectTextureAnimationSpeedV = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectFallOff = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectColor = frame.ReadColor(ColorBinaryType.Alpha);
            item.EdgeEffectAlphaFadeInTime = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectFullAlphaTime = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectAlphaFadeOutTime = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectPersistentAlphaRatio = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EdgeEffectAlphaPulseAmplitude = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            ...
            item.ParticleShaderFullParticleBirthRatio = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderPersistentParticleBirthRatio = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderParticleLifetime = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderParticleLifetimePlusMinus = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderInitialSpeedAlongNormal = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderAccelerationAlongNormal = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderInitialVelocity1 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderInitialVelocity2 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderInitialVelocity3 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderAcceleration1 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderAcceleration2 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderAcceleration3 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderScaleKey1 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderScaleKey2 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderScaleKey1Time = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ParticleShaderScaleKey2Time = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            ...
            item.ColorKey1ColorAlpha = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ColorKey2ColorAlpha = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ColorKey3ColorAlpha = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IEffectShaderDataGetter
    {
        ...
        public Single ParticleShaderFullParticleBirthRatio => _structData.Slice(0x7C, 0x4).Float();
        public Single ParticleShaderPersistentParticleBirthRatio => _structData.Slice(0x80, 0x4).Float();
        public Single ParticleShaderParticleLifetime => _structData.Slice(0x84, 0x4).Float();
        public Single ParticleShaderParticleLifetimePlusMinus => _structData.Slice(0x88, 0x4).Float();
        public Single ParticleShaderInitialSpeedAlongNormal => _structData.Slice(0x8C, 0x4).Float();
        public Single ParticleShaderAccelerationAlongNormal => _structData.Slice(0x90, 0x4).Float();
        public Single ParticleShaderInitialVelocity1 => _structData.Slice(0x94, 0x4).Float();
        public Single ParticleShaderInitialVelocity2 => _structData.Slice(0x98, 0x4).Float();
        public Single ParticleShaderInitialVelocity3 => _structData.Slice(0x9C, 0x4).Float();
        public Single ParticleShaderAcceleration1 => _structData.Slice(0xA0, 0x4).Float();
        public Single ParticleShaderAcceleration2 => _structData.Slice(0xA4, 0x4).Float();
        public Single ParticleShaderAcceleration3 => _structData.Slice(0xA8, 0x4).Float();
        public Single ParticleShaderScaleKey1 => _structData.Slice(0xAC, 0x4).Float();
        public Single ParticleShaderScaleKey2 => _structData.Slice(0xB0, 0x4).Float();
        public Single ParticleShaderScaleKey1Time => _structData.Slice(0xB4, 0x4).Float();
        public Single ParticleShaderScaleKey2Time => _structData.Slice(0xB8, 0x4).Float();
        public Color ColorKey1Color => _structData.Slice(0xBC, 0x4).ReadColor(ColorBinaryType.Alpha);
        public Color ColorKey2Color => _structData.Slice(0xC0, 0x4).ReadColor(ColorBinaryType.Alpha);
        public Color ColorKey3Color => _structData.Slice(0xC4, 0x4).ReadColor(ColorBinaryType.Alpha);
        public Single ColorKey1ColorAlpha => _structData.Slice(0xC8, 0x4).Float();
        public Single ColorKey2ColorAlpha => _structData.Slice(0xCC, 0x4).Float();
        public Single ColorKey3ColorAlpha => _structData.Slice(0xD0, 0x4).Float();
        ...
        public static IEffectShaderDataGetter EffectShaderDataFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
