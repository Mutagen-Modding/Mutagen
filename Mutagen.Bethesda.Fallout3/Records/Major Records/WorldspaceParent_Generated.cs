...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IWorldspaceParent
    {
        ...
        #endregion
        #region Flags
        public WorldspaceParent.ParentWorldspaceFlag Flags { get; set; } = default(WorldspaceParent.ParentWorldspaceFlag);
        #endregion
        ...
        IWorldspaceParentGetter
    {
        ...
        new WorldspaceParent.ParentWorldspaceFlag Flags { get; set; }
    }
        ...
        ILoquiObject<IWorldspaceParentGetter>
    {
        ...
        WorldspaceParent.ParentWorldspaceFlag Flags { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class WorldspaceParent_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.WorldspaceParent";
    ...
    internal partial class WorldspaceParentSetterCommon
    {
        ...
        public void Clear(IWorldspaceParent item)
        {
            ...
            item.Flags = default(WorldspaceParent.ParentWorldspaceFlag);
        }
...
namespace Mutagen.Bethesda.Fallout3
{
    public partial class WorldspaceParentBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<WorldspaceParent.ParentWorldspaceFlag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Flags,
                length: 2,
    ...
    internal partial class WorldspaceParentBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<WorldspaceParent.ParentWorldspaceFlag, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IWorldspaceParentGetter
    {
        ...
        public WorldspaceParent.ParentWorldspaceFlag Flags => EnumBinaryTranslation<WorldspaceParent.ParentWorldspaceFlag, MutagenFrame, MutagenWriter>.Instance.ParseRecord(_FlagsLocation, _recordData, _package, 2);
        #endregion
