...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<GlobalInt>
    {
        ...
        public GlobalInt(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public GlobalInt(IFallout3Mod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GlobalInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.GlobalInt";
    ...
    internal partial class GlobalIntCommon : GlobalCommon
    {
        ...
        public static new GlobalInt_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GlobalInt Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GlobalInt(formKey, default(Fallout3Release));
