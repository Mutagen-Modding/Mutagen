...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<CasinoChip>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IModelGetter? ICasinoChipGetter.Model => this.Model;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IIconsGetter? ICasinoChipGetter.Icons => this.Icons;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IDestructibleGetter? ICasinoChipGetter.Destructible => this.Destructible;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<ISoundGetter> ICasinoChipGetter.PickUpSound => this.PickUpSound;
        #endregion
        #region DropSound
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<ISoundGetter> ICasinoChipGetter.DropSound => this.DropSound;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case CasinoChip_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case CasinoChip_FieldIndex.Name:
                        return Name;
                    case CasinoChip_FieldIndex.Model:
                        return Model;
                    ...
                    case CasinoChip_FieldIndex.PickUpSound:
                        return PickUpSound;
                    case CasinoChip_FieldIndex.DropSound:
                        return DropSound;
                    default:
        ...
        public override void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => CasinoChipSetterCommon.Instance.RemapLinks(this, mapping);
        public CasinoChip(
            FormKey formKey,
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class CasinoChip_Registration : ILoquiRegistration
    {
        ...
        {
            var triggers = RecordCollection.Factory(RecordTypes.CHIP);
    ...
    internal partial class CasinoChipCommon : Fallout3MajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.ObjectBounds) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.ObjectBounds, rhs.ObjectBounds, out var lhsObjectBounds, out var rhsObjectBounds, out var isObjectBoundsEqual))
                {
                    if (!((ObjectBoundsCommon)((IObjectBoundsGetter)lhsObjectBounds).CommonInstance()!).Equals(lhsObjectBounds, rhsObjectBounds, equalsMask?.GetSubCrystal((int)CasinoChip_FieldIndex.ObjectBounds))) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.Model) ?? true))
            {
                ...
                {
                    if (!((ModelCommon)((IModelGetter)lhsModel).CommonInstance()!).Equals(lhsModel, rhsModel, equalsMask?.GetSubCrystal((int)CasinoChip_FieldIndex.Model))) return false;
                }
                else if (!isModelEqual) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.Icons) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.Destructible) ?? true))
            {
                ...
                {
                    if (!((DestructibleCommon)((IDestructibleGetter)lhsDestructible).CommonInstance()!).Equals(lhsDestructible, rhsDestructible, equalsMask?.GetSubCrystal((int)CasinoChip_FieldIndex.Destructible))) return false;
                }
                else if (!isDestructibleEqual) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.PickUpSound) ?? true))
            {
                if (!lhs.PickUpSound.Equals(rhs.PickUpSound)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.DropSound) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ICasinoChipGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class CasinoChipSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)CasinoChip_FieldIndex.Model);
                try
                {
                    if(rhs.Model is {} rhsModel)
                    {
                        item.Model = rhsModel.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)CasinoChip_FieldIndex.Model));
                    }
                    else
                    {
                        item.Model = default;
            ...
            if ((copyMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.Icons) ?? true))
            {
                errorMask?.PushIndex((int)CasinoChip_FieldIndex.Icons);
                try
                {
                    if(rhs.Icons is {} rhsIcons)
                    {
                        item.Icons = rhsIcons.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)CasinoChip_FieldIndex.Icons));
                    }
                    else
                    {
                        item.Icons = default;
            ...
            {
                errorMask?.PushIndex((int)CasinoChip_FieldIndex.Destructible);
                try
                {
                    if(rhs.Destructible is {} rhsDestructible)
                    {
                        item.Destructible = rhsDestructible.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)CasinoChip_FieldIndex.Destructible));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.PickUpSound) ?? true))
            {
                item.PickUpSound.SetTo(rhs.PickUpSound.FormKeyNullable);
            }
            if ((copyMask?.GetShouldTranslate((int)CasinoChip_FieldIndex.DropSound) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.OBND:
                {
                    ...
                    return (int)CasinoChip_FieldIndex.ObjectBounds;
                }
                ...
                case RecordTypeInts.MODD:
                {
                    ...
                    return (int)CasinoChip_FieldIndex.Model;
                }
