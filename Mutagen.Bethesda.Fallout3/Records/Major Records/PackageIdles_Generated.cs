...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IPackageIdles
    {
        ...
        protected MemorySlice<Byte>? _AnimationCount;
        public MemorySlice<Byte>? AnimationCount
        {
            get => this._AnimationCount;
            set => this._AnimationCount = value;
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IPackageIdlesGetter.AnimationCount => this.AnimationCount;
        #endregion
        #region TimerSetting
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class PackageIdles_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.PackageIdles";
    ...
    internal partial class PackageIdlesCommon
    {
            ...
            PackageIdles.Mask<bool>? printMask = null)
        {
            ...
            {
                sb.AppendLine($"AnimationCount => {SpanExt.ToHexString(AnimationCountItem)}");
            }
            if (printMask?.TimerSetting ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!MemorySliceExt.SequenceEqual(lhs.AnimationCount, rhs.AnimationCount)) return false;
            }
    ...
    internal partial class PackageIdlesSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                if(rhs.AnimationCount is {} AnimationCountrhs)
                {
                    item.AnimationCount = AnimationCountrhs.ToArray();
                }
                else
                {
                    item.AnimationCount = default;
    ...
    internal partial class PackageIdlesBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.AnimationCount = ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
                    return (int)PackageIdles_FieldIndex.AnimationCount;
                }
        ...
        IPackageIdlesGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.IDLC:
                {
                    _AnimationCountLocation = (stream.Position - offset);
                    return (int)PackageIdles_FieldIndex.AnimationCount;
                }
                case RecordTypeInts.IDLT:
                {
