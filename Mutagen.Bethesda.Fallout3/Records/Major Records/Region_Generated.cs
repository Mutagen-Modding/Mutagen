...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IRegionInternal
    {
        ...
        public RegionImposters? Imposters
        {
            get => _Imposters;
            set => _Imposters = value;
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IRegionImpostersGetter? IRegionGetter.Imposters => this.Imposters;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (Imposters != null)
                {
                    ...
                    if (this.Imposters.Specific != null && !this.Imposters.Specific.All(eval)) return false;
                }
                return true;
            }
            #endregion
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (Imposters != null)
                {
                    ...
                    if (this.Imposters.Specific != null && this.Imposters.Specific.Any(eval)) return true;
                }
                return false;
            }
            #endregion
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class RegionCommon : Fallout3MajorRecordCommon
    {
            ...
            Region.Mask<bool>? printMask = null)
        {
            ...
            {
                ImpostersItem?.Print(sb, "Imposters");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (EqualsMaskHelper.RefEquality(lhs.Imposters, rhs.Imposters, out var lhsImposters, out var rhsImposters, out var isImpostersEqual))
                {
                    if (!((RegionImpostersCommon)((IRegionImpostersGetter)lhsImposters).CommonInstance()!).Equals(lhsImposters, rhsImposters, equalsMask?.GetSubCrystal((int)Region_FieldIndex.Imposters))) return false;
                }
                else if (!isImpostersEqual) return false;
            }
            return true;
        }
    ...
    internal partial class RegionSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Region_FieldIndex.Imposters) ?? true))
            {
                errorMask?.PushIndex((int)Region_FieldIndex.Imposters);
                try
                {
                    if(rhs.Imposters is {} rhsImposters)
                    {
                        item.Imposters = rhsImposters.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Region_FieldIndex.Imposters));
                    }
                    else
                    {
