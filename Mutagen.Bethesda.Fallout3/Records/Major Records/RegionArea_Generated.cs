...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class RegionArea_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.RegionArea";
    ...
    internal partial class RegionAreaCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRegionAreaGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
