...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<GlobalShort>
    {
        ...
        public GlobalShort(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public GlobalShort(IFallout3Mod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GlobalShort_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.GlobalShort";
    ...
    internal partial class GlobalShortCommon : GlobalCommon
    {
        ...
        public static new GlobalShort_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GlobalShort Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GlobalShort(formKey, default(Fallout3Release));
