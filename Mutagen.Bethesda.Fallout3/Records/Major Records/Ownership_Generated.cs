...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Ownership_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Ownership";
    ...
    internal partial class OwnershipCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Ownership_FieldIndex.FactionRank) ?? true))
            {
    ...
    internal partial class OwnershipBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)Ownership_FieldIndex.Owner, translationParams)) return ParseResult.Stop;
                ...
                {
                    if (lastParsed.ShortCircuit((int)Ownership_FieldIndex.FactionRank, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
