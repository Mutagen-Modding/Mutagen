...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<LeveledItemEntry>
    {
        ...
        #region Data
        public LeveledItemEntryData Data { get; set; } = new LeveledItemEntryData();
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ILeveledItemEntryDataGetter ILeveledItemEntryGetter.Data => Data;
        #endregion
        #region ExtraData
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class LeveledItemEntry_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.LeveledItemEntry";
                ...
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.Data) ?? true))
                    {
                        item.Data = rhs.Data.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)LeveledItemEntry_FieldIndex.Data),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.LVLO:
                {
                    ...
                    item.Data = Mutagen.Bethesda.Fallout3.LeveledItemEntryData.CreateFromBinary(frame: frame);
