...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GlobalFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.GlobalFloat";
    ...
    internal partial class GlobalFloatCommon : GlobalCommon
    {
        ...
        public static new GlobalFloat_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
