...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        INoteVoice
    {
        ...
        IFormLinkNullableGetter<IDialogTopicGetter> INoteVoiceGetter.Topic => this.Topic;
        #endregion
        #region Speaker
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<INpcSpawnGetter> INoteVoiceGetter.Speaker => this.Speaker;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case NoteVoice_FieldIndex.Topic:
                        return Topic;
                    case NoteVoice_FieldIndex.Speaker:
                        return Speaker;
                    default:
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => NoteVoiceCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class NoteVoice_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.NoteVoice";
    ...
    internal partial class NoteVoiceCommon : ANoteDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)NoteVoice_FieldIndex.Topic) ?? true))
            {
                if (!lhs.Topic.Equals(rhs.Topic)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NoteVoice_FieldIndex.Speaker) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INoteVoiceGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class NoteVoiceSetterTranslationCommon : ANoteDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)NoteVoice_FieldIndex.Topic) ?? true))
            {
                item.Topic.SetTo(rhs.Topic.FormKeyNullable);
            }
            if ((copyMask?.GetShouldTranslate((int)NoteVoice_FieldIndex.Speaker) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        INoteVoiceGetter
    {
        ...
        public IFormLinkNullableGetter<IDialogTopicGetter> Topic => FormLinkBinaryTranslation.Instance.NullableOverlayFactory<IDialogTopicGetter>(_package, _structData.Span.Slice(0x0, 0x4));
        public IFormLinkNullableGetter<INpcSpawnGetter> Speaker => FormLinkBinaryTranslation.Instance.NullableOverlayFactory<INpcSpawnGetter>(_package, _structData.Span.Slice(0x4, 0x4));
