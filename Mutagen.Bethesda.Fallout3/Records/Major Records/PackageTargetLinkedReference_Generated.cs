        ...
        IPackageTargetLinkedReference
    {
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case PackageTargetLinkedReference_FieldIndex.Unused:
                        return Unused;
                    default:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class PackageTargetLinkedReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.PackageTargetLinkedReference";
    ...
    internal partial class PackageTargetLinkedReferenceCommon : APackageTargetCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PackageTargetLinkedReference_FieldIndex.Unused) ?? true))
            {
    ...
    internal partial class PackageTargetLinkedReferenceSetterTranslationCommon : APackageTargetSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)PackageTargetLinkedReference_FieldIndex.Unused) ?? true))
            {
