...
namespace Mutagen.Bethesda.Fallout3
{
    public static class TypeOptionSolidifierMixIns
    {
        ...
        public static TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter> ICreatureSpawn(this IEnumerable<IModListingGetter<IFallout3ModGetter>> listings)
        {
            return new TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter>(
                (bool includeDeletedRecords) => listings.WinningOverrides<ICreatureSpawnGetter>(includeDeletedRecords: includeDeletedRecords),
                (ILinkCache linkCache, bool includeDeletedRecords) => listings.WinningContextOverrides<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter>(linkCache, includeDeletedRecords: includeDeletedRecords));
        }
        ...
        /// <param name="mods">Mods to query</param>
        /// <returns>A typed object to do further queries on ICreatureSpawn</returns>
        public static TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter> ICreatureSpawn(this IEnumerable<IFallout3ModGetter> mods)
        {
            return new TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter>(
                (bool includeDeletedRecords) => mods.WinningOverrides<ICreatureSpawnGetter>(includeDeletedRecords: includeDeletedRecords),
                (ILinkCache linkCache, bool includeDeletedRecords) => mods.WinningContextOverrides<IFallout3Mod, IFallout3ModGetter, ICreatureSpawn, ICreatureSpawnGetter>(linkCache, includeDeletedRecords: includeDeletedRecords));
        }
        ...
        public static TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter> INpcOrCreatureSpawn(this IEnumerable<IModListingGetter<IFallout3ModGetter>> listings)
        {
            return new TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter>(
                ...
                (ILinkCache linkCache, bool includeDeletedRecords) => listings.WinningContextOverrides<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter>(linkCache, includeDeletedRecords: includeDeletedRecords));
        }
        ...
        /// <param name="mods">Mods to query</param>
        /// <returns>A typed object to do further queries on INpcOrCreatureSpawn</returns>
        public static TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter> INpcOrCreatureSpawn(this IEnumerable<IFallout3ModGetter> mods)
        {
            return new TypedLoadOrderAccess<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter>(
                (bool includeDeletedRecords) => mods.WinningOverrides<INpcOrCreatureSpawnGetter>(includeDeletedRecords: includeDeletedRecords),
                (ILinkCache linkCache, bool includeDeletedRecords) => mods.WinningContextOverrides<IFallout3Mod, IFallout3ModGetter, INpcOrCreatureSpawn, INpcOrCreatureSpawnGetter>(linkCache, includeDeletedRecords: includeDeletedRecords));
        }
