...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Fallout3Mod>
    {
        ...
        #region Recipes
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Fallout3Group<Recipe> _Recipes_Object;
        public Fallout3Group<Recipe> Recipes => _Recipes_Object;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        #region CasinoChips
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Fallout3Group<CasinoChip> _CasinoChips_Object;
        public Fallout3Group<CasinoChip> CasinoChips => _CasinoChips_Object;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Fallout3Group<LoadScreenType> _LoadScreenTypes_Object;
        public Fallout3Group<LoadScreenType> LoadScreenTypes => _LoadScreenTypes_Object;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.Fallout3
{
            ...
            bool throwIfUnknown)
        {
            switch (type.Name)
            {
                ...
                case "ICasinoInternal":
                    ...
                    break;
                case "CasinoChip":
                case "ICasinoChipGetter":
                case "ICasinoChip":
                case "ICasinoChipInternal":
                    obj.CasinoChips.Remove(
                        type: type,
                        keys: keys);
                    break;
                case "Cell":
                ...
                case "IExplodeSpawnGetter":
                    ...
                    Remove(obj, keys, typeof(IPlaceableWaterGetter), throwIfUnknown: throwIfUnknown);
                ...
                case "ILoadScreenInternal":
                    ...
                    break;
                case "LoadScreenType":
                case "ILoadScreenTypeGetter":
                case "ILoadScreenType":
                case "ILoadScreenTypeInternal":
                    obj.LoadScreenTypes.Remove(
                        type: type,
                        keys: keys);
                    break;
                case "MagicEffect":
    ...
    internal partial class Fallout3ModCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.Recipes) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Recipes, rhs.Recipes, out var lhsRecipes, out var rhsRecipes, out var isRecipesEqual))
                {
                    if (!object.Equals(lhsRecipes, rhsRecipes)) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.CasinoChips) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.CasinoChips, rhs.CasinoChips, out var lhsCasinoChips, out var rhsCasinoChips, out var isCasinoChipsEqual))
                {
                    if (!object.Equals(lhsCasinoChips, rhsCasinoChips)) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.LoadScreenTypes) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.LoadScreenTypes, rhs.LoadScreenTypes, out var lhsLoadScreenTypes, out var rhsLoadScreenTypes, out var isLoadScreenTypesEqual))
                {
                    if (!object.Equals(lhsLoadScreenTypes, rhsLoadScreenTypes)) return false;
                }
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IFallout3ModGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.Recipes.EnumerateFormLinks(iterateNestedRecords))
            {
                yield return item;
            }
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(IFallout3ModGetter obj)
        {
            ...
            foreach (var item in obj.CasinoChips.EnumerateMajorRecords())
            {
                yield return item;
            }
            ...
            bool throwIfUnknown)
        {
            switch (type.Name)
            {
                ...
                case "ICasinoChip":
                case "ICasinoChipInternal":
                    foreach (var item in obj.CasinoChips.EnumerateMajorRecords(type, throwIfUnknown: throwIfUnknown))
                    {
                        yield return item;
                    }
                    yield break;
                ...
                case "ILoadScreenType":
                case "ILoadScreenTypeInternal":
                    foreach (var item in obj.LoadScreenTypes.EnumerateMajorRecords(type, throwIfUnknown: throwIfUnknown))
                    {
                        yield return item;
                    }
                    yield break;
            ...
            ILinkCache linkCache)
        {
            ...
            foreach (var item in InterfaceEnumerationHelper.EnumerateGroupContexts<IFallout3Mod, IFallout3ModGetter, CasinoChip, ICasinoChipGetter>(
                ...
                modKey: obj.ModKey,
                group: (m) => m.CasinoChips,
                groupGetter: (m) => m.CasinoChips))
            {
                yield return item;
            }
            ...
            foreach (var item in InterfaceEnumerationHelper.EnumerateGroupContexts<IFallout3Mod, IFallout3ModGetter, LoadScreenType, ILoadScreenTypeGetter>(
                srcGroup: obj.LoadScreenTypes,
                type: typeof(ILoadScreenTypeGetter),
                modKey: obj.ModKey,
                group: (m) => m.LoadScreenTypes,
                groupGetter: (m) => m.LoadScreenTypes))
            {
                yield return item;
            }
            ...
            foreach (var item in InterfaceEnumerationHelper.EnumerateGroupContexts<IFallout3Mod, IFallout3ModGetter, Recipe, IRecipeGetter>(
                srcGroup: obj.Recipes,
                type: typeof(IRecipeGetter),
                modKey: obj.ModKey,
                group: (m) => m.Recipes,
    ...
    internal partial class Fallout3ModSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.Recipes) ?? true))
            {
                errorMask?.PushIndex((int)Fallout3Mod_FieldIndex.Recipes);
                try
                {
                    item.Recipes.DeepCopyIn(
                        rhs: rhs.Recipes,
                        errorMask: errorMask,
                        copyMask: copyMask?.GetSubCrystal((int)Fallout3Mod_FieldIndex.Recipes));
                }
                catch (Exception ex)
                when (errorMask != null)
                {
            ...
            if ((copyMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.CasinoChips) ?? true))
            {
                errorMask?.PushIndex((int)Fallout3Mod_FieldIndex.CasinoChips);
                try
                {
                    item.CasinoChips.DeepCopyIn(
                        rhs: rhs.CasinoChips,
                        errorMask: errorMask,
                        copyMask: copyMask?.GetSubCrystal((int)Fallout3Mod_FieldIndex.CasinoChips));
                }
                catch (Exception ex)
                when (errorMask != null)
                {
            ...
            if ((copyMask?.GetShouldTranslate((int)Fallout3Mod_FieldIndex.LoadScreenTypes) ?? true))
            {
                errorMask?.PushIndex((int)Fallout3Mod_FieldIndex.LoadScreenTypes);
                try
                {
                    item.LoadScreenTypes.DeepCopyIn(
                        rhs: rhs.LoadScreenTypes,
                        errorMask: errorMask,
                        copyMask: copyMask?.GetSubCrystal((int)Fallout3Mod_FieldIndex.LoadScreenTypes));
                }
                catch (Exception ex)
                when (errorMask != null)
                {
...
namespace Mutagen.Bethesda.Fallout3
{
    public partial class Fallout3ModBinaryWriteTranslation
    {
            ...
            TypedWriteParams translationParams = default)
        {
            ...
            if (importMask?.Recipes ?? true)
            {
                var RecipesItem = item.Recipes;
                if (RecipesItem.RecordCache.Count > 0)
                {
            ...
            if (importMask?.CasinoChips ?? true)
            {
                var CasinoChipsItem = item.CasinoChips;
                if (CasinoChipsItem.RecordCache.Count > 0)
                {
            ...
            if (importMask?.LoadScreenTypes ?? true)
            {
                var LoadScreenTypesItem = item.LoadScreenTypes;
                if (LoadScreenTypesItem.RecordCache.Count > 0)
                {
    ...
    internal partial class Fallout3ModBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.RCPE:
                {
                    if (importMask?.Recipes ?? true)
                    {
                        item.Recipes.CopyInFromBinary(
                            frame: frame,
                            translationParams: null);
                    }
                    else
                ...
                case RecordTypeInts.CHIP:
                {
                    if (importMask?.CasinoChips ?? true)
                    {
                        item.CasinoChips.CopyInFromBinary(
                            frame: frame,
                            translationParams: null);
                    }
                    else
                ...
                case RecordTypeInts.LSCT:
                {
                    if (importMask?.LoadScreenTypes ?? true)
                    {
                        item.LoadScreenTypes.CopyInFromBinary(
                            frame: frame,
                            translationParams: null);
                    }
                    else
