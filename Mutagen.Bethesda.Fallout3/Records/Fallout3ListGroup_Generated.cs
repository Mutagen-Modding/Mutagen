...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        where T : class, ICellBlock, IBinaryItem
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => Fallout3ListGroupCommon<T>.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => Fallout3ListGroupSetterCommon<T>.Instance.RemapLinks(this, mapping);
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        where T : class, ICellBlockGetter, IBinaryItem
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IFallout3ListGroupGetter<T> obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        where T : class, ICellBlockGetter, IBinaryItem
    {
        ...
        public static IFallout3ListGroupGetter<ICellBlockGetter> Fallout3ListGroupFactory(
            ...
            BinaryOverlayFactoryPackage package)
        {
            ...
            var subs = new IFallout3ListGroupGetter<ICellBlockGetter>[locs.Count];
            ...
            return new Fallout3ListGroupMergedOverlay(subs);
        }
