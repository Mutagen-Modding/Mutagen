...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Light>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectBoundsGetter? ILightGetter.ObjectBounds => this.ObjectBounds;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                ...
                try
                {
                    if(rhs.ObjectBounds is {} rhsObjectBounds)
                    {
                        item.ObjectBounds = rhsObjectBounds.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Light_FieldIndex.ObjectBounds));
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILightGetter
    {
        ...
        public Light.LightFlag Flags => _Flags_IsSet ? (Light.LightFlag)BinaryPrimitives.ReadInt32LittleEndian(_recordData.Span.Slice(_FlagsLocation, 0x4)) : default;
        #endregion
        #region FalloffExponent
