...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Grass>
    {
        ...
        public WaterType UnitFromWaterMode { get; set; } = default(WaterType);
        #endregion
        ...
        IObjectBounded
    {
        ...
        new WaterType UnitFromWaterMode { get; set; }
        ...
        IObjectBoundedGetter
    {
        ...
        UInt16 Unused2 { get; }
        WaterType UnitFromWaterMode { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GrassSetterCommon : Fallout3MajorRecordSetterCommon
    {
        ...
        public void Clear(IGrassInternal item)
        {
            ...
            item.UnitFromWaterMode = default(WaterType);
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            using (HeaderExport.Subrecord(writer, translationParams.ConvertToCustom(RecordTypes.DATA)))
            {
                ...
                EnumBinaryTranslation<WaterType, MutagenFrame, MutagenWriter>.Instance.Write(
                    writer,
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.DATA:
                {
                    ...
                    item.UnitFromWaterMode = EnumBinaryTranslation<WaterType, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: dataFrame,
                        length: 4);
                    if (dataFrame.Remaining < 4) return null;
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IGrassGetter
    {
        ...
        public WaterType UnitFromWaterMode => _UnitFromWaterMode_IsSet ? (WaterType)BinaryPrimitives.ReadInt32LittleEndian(_recordData.Span.Slice(_UnitFromWaterModeLocation, 0x4)) : default;
        #endregion
        #region PositionRange
