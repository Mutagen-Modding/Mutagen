...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IObjectEffectInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte> IObjectEffectGetter.Unused => this.Unused;
        #endregion
        #region Effects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case ObjectEffect_FieldIndex.Type:
                        return Type;
                    case ObjectEffect_FieldIndex.ChargeAmount:
                        return ChargeAmount;
                    case ObjectEffect_FieldIndex.EnchantCost:
                        return EnchantCost;
                    case ObjectEffect_FieldIndex.Flags:
                        return Flags;
                    case ObjectEffect_FieldIndex.Unused:
                        return Unused;
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ObjectEffectCommon : Fallout3MajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.ChargeAmount) ?? true))
            {
                if (lhs.ChargeAmount != rhs.ChargeAmount) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.EnchantCost) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.Unused) ?? true))
            {
    ...
    internal partial class ObjectEffectSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.ChargeAmount) ?? true))
            {
                item.ChargeAmount = rhs.ChargeAmount;
            }
            if ((copyMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.EnchantCost) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)ObjectEffect_FieldIndex.Unused) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ENIT:
                {
                    ...
                    return (int)ObjectEffect_FieldIndex.Unused;
                }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IObjectEffectGetter
    {
        ...
        #endregion
        #region ChargeAmount
        private int _ChargeAmountLocation => _ENITLocation!.Value.Min + 0x4;
        private bool _ChargeAmount_IsSet => _ENITLocation.HasValue;
        public UInt32 ChargeAmount => _ChargeAmount_IsSet ? BinaryPrimitives.ReadUInt32LittleEndian(_recordData.Slice(_ChargeAmountLocation, 4)) : default(UInt32);
        #endregion
        #region EnchantCost
        private int _EnchantCostLocation => _ENITLocation!.Value.Min + 0x8;
        private bool _EnchantCost_IsSet => _ENITLocation.HasValue;
        public UInt32 EnchantCost => _EnchantCost_IsSet ? BinaryPrimitives.ReadUInt32LittleEndian(_recordData.Slice(_EnchantCostLocation, 4)) : default(UInt32);
        #endregion
        #region Flags
        ...
        #endregion
        #region Unused
        private int _UnusedLocation => _ENITLocation!.Value.Min + 0xD;
