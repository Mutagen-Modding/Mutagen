...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<AddonNode>
    {
        ...
        public AddonNode(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public AddonNode(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.ADDN)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class AddonNode_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.AddonNode";
    ...
    #region Common
    internal partial class AddonNodeSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class AddonNodeCommon : Fallout3MajorRecordCommon
    {
        ...
        public static AddonNode_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public AddonNode Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new AddonNode(formKey, default(Fallout3Release));
    ...
    internal partial class AddonNodeSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class AddonNodeBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
