...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IPlacedNpcInternal
    {
        ...
        #endregion
        #region PatrolSCRO
        private readonly IFormLinkNullable<IFallout3MajorRecordGetter> _PatrolSCRO = new FormLinkNullable<IFallout3MajorRecordGetter>();
        public IFormLinkNullable<IFallout3MajorRecordGetter> PatrolSCRO
        {
            get => _PatrolSCRO;
            set => _PatrolSCRO.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IFallout3MajorRecordGetter> IPlacedNpcGetter.PatrolSCRO => this.PatrolSCRO;
        #endregion
        #region Topic
            ...
            IMask<TItem>
        {
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.PatrolSCRO, rhs.PatrolSCRO)) return false;
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.PatrolSCRO)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.PatrolSCRO)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.PatrolSCRO = eval(this.PatrolSCRO);
            ...
            public void Print(StructuredStringBuilder sb, PlacedNpc.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.PatrolSCRO ?? true)
                    {
                        sb.AppendItem(PatrolSCRO, "PatrolSCRO");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case PlacedNpc_FieldIndex.PatrolSCTX:
                        return PatrolSCTX;
                    case PlacedNpc_FieldIndex.PatrolSCRO:
                        return PatrolSCRO;
            ...
            public override bool IsInError()
            {
                ...
                if (PatrolSCRO != null) return true;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.PatrolSCRO = this.PatrolSCRO.Combine(rhs.PatrolSCRO);
        ...
        IPositionRotation
    {
        ...
        new IFormLinkNullable<IFallout3MajorRecordGetter> PatrolSCRO { get; set; }
        ...
        IPositionRotationGetter
    {
        ...
        IFormLinkNullableGetter<IFallout3MajorRecordGetter> PatrolSCRO { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class PlacedNpcCommon : Fallout3MajorRecordCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.PatrolSCRO = item.PatrolSCRO.Equals(rhs.PatrolSCRO);
            ...
            PlacedNpc.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.PatrolSCRO ?? true)
            {
                sb.AppendItem(item.PatrolSCRO.FormKeyNullable, "PatrolSCRO");
            }
            if (printMask?.Topic ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PlacedNpc_FieldIndex.PatrolSCRO) ?? true))
            {
                if (!lhs.PatrolSCRO.Equals(rhs.PatrolSCRO)) return false;
            }
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPlacedNpcGetter obj, bool iterateNestedRecords = true)
        {
            ...
            if (FormLinkInformation.TryFactory(obj.PatrolSCRO, out var PatrolSCROInfo))
            {
                yield return PatrolSCROInfo;
            }
    ...
    internal partial class PlacedNpcSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)PlacedNpc_FieldIndex.PatrolSCRO) ?? true))
            {
                item.PatrolSCRO.SetTo(rhs.PatrolSCRO.FormKeyNullable);
            }
    ...
    internal partial class PlacedNpcBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.PatrolSCRO.SetTo(FormLinkBinaryTranslation.Instance.Parse(reader: frame));
                    return (int)PlacedNpc_FieldIndex.PatrolSCRO;
                }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IPlacedNpcGetter
    {
        ...
        public String? PatrolSCTX => _PatrolSCTXLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, _PatrolSCTXLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        #endregion
        #region PatrolSCRO
        private int? _PatrolSCROLocation;
        public IFormLinkNullableGetter<IFallout3MajorRecordGetter> PatrolSCRO => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IFallout3MajorRecordGetter>(_package, _recordData, _PatrolSCROLocation);
        #endregion
        #region Topic
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.SCRO:
                {
                    _PatrolSCROLocation = (stream.Position - offset);
                    return (int)PlacedNpc_FieldIndex.PatrolSCRO;
                }
                case RecordTypeInts.TNAM:
                {
