...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IMagicEffectInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IIconsGetter? IMagicEffectGetter.Icons => this.Icons;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IScriptGetter> IMagicEffectGetter.Script => this.Script;
        #endregion
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case MagicEffect_FieldIndex.Description:
                        return Description;
                    case MagicEffect_FieldIndex.Icons:
                        return Icons;
                    ...
                    case MagicEffect_FieldIndex.Archetype:
                        return Archetype;
                    case MagicEffect_FieldIndex.Script:
                        return Script;
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class MagicEffectCommon : Fallout3MajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MagicEffect_FieldIndex.Icons) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Icons, rhs.Icons, out var lhsIcons, out var rhsIcons, out var isIconsEqual))
                {
                    if (!((IconsCommon)((IIconsGetter)lhsIcons).CommonInstance()!).Equals(lhsIcons, rhsIcons, equalsMask?.GetSubCrystal((int)MagicEffect_FieldIndex.Icons))) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)MagicEffect_FieldIndex.Script) ?? true))
            {
    ...
    internal partial class MagicEffectSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)MagicEffect_FieldIndex.Icons) ?? true))
            {
                errorMask?.PushIndex((int)MagicEffect_FieldIndex.Icons);
                try
                {
                    if(rhs.Icons is {} rhsIcons)
                    {
                        item.Icons = rhsIcons.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)MagicEffect_FieldIndex.Icons));
                    }
                    else
                    {
                        item.Icons = default;
            ...
            if ((copyMask?.GetShouldTranslate((int)MagicEffect_FieldIndex.Script) ?? true))
            {
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            FormLinkBinaryTranslation.Instance.WriteNullable(
                writer: writer,
                item: item.Script,
                header: translationParams.ConvertToCustom(RecordTypes.SCPT));
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ICON:
                {
                    ...
                    return (int)MagicEffect_FieldIndex.Icons;
                }
                ...
                case RecordTypeInts.SCPT:
                {
                    ...
                    return (int)MagicEffect_FieldIndex.Script;
                }
