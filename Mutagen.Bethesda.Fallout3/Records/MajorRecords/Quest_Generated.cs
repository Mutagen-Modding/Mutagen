...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IQuestInternal
    {
        ...
        public Quest(IFallout3Mod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Quest_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Quest";
    ...
    #region Common
    internal partial class QuestSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class QuestCommon : Fallout3MajorRecordCommon
    {
        ...
        public Quest Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Quest(formKey, default(Fallout3Release));
    ...
    internal partial class QuestSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class QuestBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
