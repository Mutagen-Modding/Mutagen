...
namespace Mutagen.Bethesda.Fallout3
{
    public partial class DialogResponseBinaryWriteTranslation : IBinaryWriteTranslator
    {
        ...
        {
            var ResponseDataItem = item.ResponseData;
            ((DialogResponseDataBinaryWriteTranslation)((IBinaryItem)ResponseDataItem).BinaryWriteTranslator).Write(
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.TRDT:
                {
                    ...
                    item.ResponseData = Mutagen.Bethesda.Fallout3.DialogResponseData.CreateFromBinary(frame: frame);
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IDialogResponseGetter
    {
        ...
        #region ResponseData
        private RangeInt32? _ResponseDataLocation;
        private IDialogResponseDataGetter? _ResponseData => _ResponseDataLocation.HasValue ? DialogResponseDataBinaryOverlay.DialogResponseDataFactory(_recordData.Slice(_ResponseDataLocation!.Value.Min), _package) : default;
        public IDialogResponseDataGetter ResponseData => _ResponseData ?? new DialogResponseData();
        #endregion
        #region ResponseText
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)DialogResponse_FieldIndex.ResponseData, translationParams)) return ParseResult.Stop;
                    _ResponseDataLocation = new RangeInt32((stream.Position - offset), finalPos - offset);
                    return (int)DialogResponse_FieldIndex.ResponseData;
                }
                case RecordTypeInts.NAM1:
                {
