...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Faction>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFactionDataGetter IFactionGetter.Data => Data;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.Data = new MaskItem<TItem, FactionData.Mask<TItem>?>(initialValue, new FactionData.Mask<TItem>(initialValue));
                ...
                Fallout3MajorRecordFlags: Fallout3MajorRecordFlags)
            {
                ...
                this.Data = new MaskItem<TItem, FactionData.Mask<TItem>?>(Data, new FactionData.Mask<TItem>(Data));
            ...
            public MaskItem<TItem, FactionData.Mask<TItem>?>? Data { get; set; }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.Data = this.Data == null ? null : new MaskItem<R, FactionData.Mask<R>?>(eval(this.Data.Overall), this.Data.Specific?.Translate(eval));
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public MaskItem<Exception?, FactionData.ErrorMask?>? Data;
            ...
            public override void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    ...
                    case Faction_FieldIndex.Relations:
                        ...
                        break;
                    case Faction_FieldIndex.Data:
                        this.Data = new MaskItem<Exception?, FactionData.ErrorMask?>(ex, null);
                        break;
                    case Faction_FieldIndex.CrimeGoldMultiplier:
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case Faction_FieldIndex.Relations:
                        ...
                        break;
                    case Faction_FieldIndex.Data:
                        this.Data = (MaskItem<Exception?, FactionData.ErrorMask?>?)obj;
                        break;
                    case Faction_FieldIndex.CrimeGoldMultiplier:
            ...
            ITranslationMask
        {
            ...
            public FactionData.TranslationMask? Data;
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class FactionCommon : Fallout3MajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Faction_FieldIndex.Data) ?? true))
            {
                ...
                {
                    if (!((FactionDataCommon)((IFactionDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, equalsMask?.GetSubCrystal((int)Faction_FieldIndex.Data))) return false;
                }
    ...
    internal partial class FactionSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)Faction_FieldIndex.Data);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)Faction_FieldIndex.Data) ?? true))
                    {
                        item.Data = rhs.Data.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)Faction_FieldIndex.Data),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            ((FactionDataBinaryWriteTranslation)((IBinaryItem)DataItem).BinaryWriteTranslator).Write(
                item: DataItem,
                writer: writer,
                translationParams: translationParams);
    ...
    internal partial class FactionBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Data = Mutagen.Bethesda.Fallout3.FactionData.CreateFromBinary(frame: frame);
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IFactionGetter
    {
        ...
        private IFactionDataGetter? _Data => _DataLocation.HasValue ? FactionDataBinaryOverlay.FactionDataFactory(_recordData.Slice(_DataLocation!.Value.Min), _package) : default;
        public IFactionDataGetter Data => _Data ?? new FactionData();
        #endregion
        #region CrimeGoldMultiplier
