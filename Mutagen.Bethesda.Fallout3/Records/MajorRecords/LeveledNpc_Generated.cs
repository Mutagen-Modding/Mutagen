...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<LeveledNpc>
    {
        ...
        #region Entries
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<LeveledNpcEntry> _Entries = new ExtendedList<LeveledNpcEntry>();
        ...
        public LeveledNpc(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public LeveledNpc(IFallout3Mod mod, string editorID)
            : this(
        ...
        IObjectBounded
    {
        ...
        new ExtendedList<LeveledNpcEntry> Entries { get; }
        /// <summary>
        /// Aspects: IModeled
        /// </summary>
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.LVLN)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class LeveledNpc_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.LeveledNpc";
    ...
    #region Common
    internal partial class LeveledNpcSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class LeveledNpcCommon : Fallout3MajorRecordCommon
    {
        ...
        public static LeveledNpc_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILeveledNpcGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.Entries.WhereCastable<ILeveledNpcEntryGetter, IFormLinkContainerGetter>()
        ...
        public LeveledNpc Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new LeveledNpc(formKey, default(Fallout3Release));
    ...
    internal partial class LeveledNpcSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<ILeveledNpcEntryGetter>.Instance.Write(
                writer: writer,
                items: item.Entries,
    ...
    internal partial class LeveledNpcBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Entries.SetTo(
                        Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<LeveledNpcEntry>.Instance.Parse(
                            reader: frame,
        ...
        ILeveledNpcGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.COED:
                {
                    this.Entries = this.ParseRepeatedTypelessSubrecord<ILeveledNpcEntryGetter>(
                        stream: stream,
                        translationParams: translationParams,
                        trigger: LeveledNpcEntry_Registration.TriggerSpecs,
                        factory: LeveledNpcEntryBinaryOverlay.LeveledNpcEntryFactory);
                    return (int)LeveledNpc_FieldIndex.Entries;
                }
                case RecordTypeInts.MODL:
                case RecordTypeInts.MODB:
