        ...
        IWaterReflection
    {
            ...
            IMask<TItem>
        {
            ...
            public void Print(StructuredStringBuilder sb, WaterReflection.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    if (printMask?.WaterReference ?? true)
                    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => WaterReflectionCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class WaterReflection_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.WaterReflection";
    ...
    internal partial class WaterReflectionSetterCommon
    {
        ...
        {
            obj.WaterReference.Relink(mapping);
        }
    ...
    internal partial class WaterReflectionCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)WaterReflection_FieldIndex.WaterReference) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IWaterReflectionGetter obj, bool iterateNestedRecords = true)
        {
            yield return FormLinkInformation.Factory(obj.WaterReference);
            yield break;
        }
    ...
    internal partial class WaterReflectionSetterTranslationCommon
    {
        ...
        public void DeepCopyIn(
            ...
            bool deepCopy)
        {
            if ((copyMask?.GetShouldTranslate((int)WaterReflection_FieldIndex.WaterReference) ?? true))
            {
