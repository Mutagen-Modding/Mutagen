...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IQuestLogEntry
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IQuestLogEntryGetter.Entry => this.Entry;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IScriptFieldsGetter IQuestLogEntryGetter.EmbeddedScript => _EmbeddedScript_Object;
        #endregion
        #region NextQuest
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case QuestLogEntry_FieldIndex.Entry:
                        return Entry;
                    case QuestLogEntry_FieldIndex.EmbeddedScript:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class QuestLogEntry_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.QuestLogEntry";
    ...
    internal partial class QuestLogEntryCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.EmbeddedScript) ?? true))
            {
                ...
                {
                    if (!((ScriptFieldsCommon)((IScriptFieldsGetter)lhsEmbeddedScript).CommonInstance()!).Equals(lhsEmbeddedScript, rhsEmbeddedScript, equalsMask?.GetSubCrystal((int)QuestLogEntry_FieldIndex.EmbeddedScript))) return false;
                }
    ...
    internal partial class QuestLogEntrySetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.EmbeddedScript) ?? true))
            {
                errorMask?.PushIndex((int)QuestLogEntry_FieldIndex.EmbeddedScript);
                try
                {
                    item.EmbeddedScript.DeepCopyIn(
                        rhs: rhs.EmbeddedScript,
                        errorMask: errorMask,
                        copyMask: copyMask?.GetSubCrystal((int)QuestLogEntry_FieldIndex.EmbeddedScript));
                }
                catch (Exception ex)
                when (errorMask != null)
                {
    ...
    internal partial class QuestLogEntryBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)QuestLogEntry_FieldIndex.EmbeddedScript, translationParams)) return ParseResult.Stop;
                    item.EmbeddedScript.CopyInFromBinary(
                        frame: frame,
                        translationParams: null);
                    return (int)QuestLogEntry_FieldIndex.EmbeddedScript;
                }
