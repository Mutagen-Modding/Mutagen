...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Climate>
    {
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                this.WeatherTypes = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, WeatherType.Mask<TItem>?>>?>(initialValue, []);
            ...
            {
                this.WeatherTypes = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, WeatherType.Mask<TItem>?>>?>(WeatherTypes, []);
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                {
                    obj.WeatherTypes = new MaskItem<R, IEnumerable<MaskItemIndexed<R, WeatherType.Mask<R>?>>?>(eval(this.WeatherTypes.Overall), []);
        ...
        public Climate(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public Climate(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.CLMT)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Climate_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Climate";
    ...
    #region Common
    internal partial class ClimateSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class ClimateCommon : Fallout3MajorRecordCommon
    {
        ...
        public static Climate_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IClimateGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in WeatherTypesItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
        ...
        public Climate Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Climate(formKey, default(Fallout3Release));
    ...
    internal partial class ClimateSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ClimateBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
