...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<GameSettingInt>
    {
        ...
        public GameSettingInt(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public GameSettingInt(IFallout3Mod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GameSettingInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.GameSettingInt";
    ...
    internal partial class GameSettingIntCommon : GameSettingCommon
    {
        ...
        public static new GameSettingInt_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GameSettingInt Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GameSettingInt(formKey, default(Fallout3Release));
