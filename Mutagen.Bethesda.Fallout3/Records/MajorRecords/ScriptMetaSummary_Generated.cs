...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IScriptMetaSummary
    {
        ...
        #endregion
        #region Enabled
        public UInt16 Enabled { get; set; } = default(UInt16);
        #endregion
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ScriptMetaSummaryCommon)((IScriptMetaSummaryGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IScriptMetaSummaryGetter? obj)
        {
            return ((ScriptMetaSummaryCommon)((IScriptMetaSummaryGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case ScriptMetaSummary_FieldIndex.Type:
                        return Type;
                    case ScriptMetaSummary_FieldIndex.Enabled:
                        return Enabled;
                    default:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ScriptMetaSummary_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.ScriptMetaSummary";
    ...
    internal partial class ScriptMetaSummaryCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ScriptMetaSummary_FieldIndex.CompiledSize) ?? true))
            {
                if (lhs.CompiledSize != rhs.CompiledSize) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ScriptMetaSummary_FieldIndex.VariableCount) ?? true))
            {
                if (lhs.VariableCount != rhs.VariableCount) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ScriptMetaSummary_FieldIndex.Type) ?? true))
            {
                if (lhs.Type != rhs.Type) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ScriptMetaSummary_FieldIndex.Enabled) ?? true))
            {
    ...
    internal partial class ScriptMetaSummarySetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)ScriptMetaSummary_FieldIndex.Enabled) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IScriptMetaSummaryGetter
    {
        ...
        public ScriptFields.ScriptType Type => (ScriptFields.ScriptType)BinaryPrimitives.ReadUInt16LittleEndian(_structData.Span.Slice(0x10, 0x2));
        public UInt16 Enabled => BinaryPrimitives.ReadUInt16LittleEndian(_structData.Slice(0x12, 0x2));
