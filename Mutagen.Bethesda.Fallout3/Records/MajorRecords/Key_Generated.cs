...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Key>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IKeyGetter.LargeIconFilename => this.LargeIconFilename;
        #endregion
        #region SmallIconFilename
        public String? SmallIconFilename { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IKeyGetter.SmallIconFilename => this.SmallIconFilename;
        #endregion
        #region Script
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class KeySetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Key_FieldIndex.LargeIconFilename) ?? true))
            {
                item.LargeIconFilename = rhs.LargeIconFilename;
            }
            if ((copyMask?.GetShouldTranslate((int)Key_FieldIndex.SmallIconFilename) ?? true))
            {
