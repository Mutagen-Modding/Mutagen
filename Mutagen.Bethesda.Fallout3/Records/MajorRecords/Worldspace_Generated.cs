...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IWorldspaceInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected MemorySlice<Byte>? _ImpactSwapData;
        public MemorySlice<Byte>? ImpactSwapData
        {
            get => this._ImpactSwapData;
            set => this._ImpactSwapData = value;
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IWorldspaceGetter.ImpactSwapData => this.ImpactSwapData;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.ImpactSwapData = initialValue;
                ...
                Fallout3MajorRecordFlags: Fallout3MajorRecordFlags)
            {
                ...
                this.ImpactSwapData = ImpactSwapData;
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.ImpactSwapData)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.ImpactSwapData)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.ImpactSwapData = eval(this.ImpactSwapData);
            ...
            public void Print(StructuredStringBuilder sb, Worldspace.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.ImpactSwapData ?? true)
                    {
                        sb.AppendItem(ImpactSwapData, "ImpactSwapData");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public Exception? ImpactSwapData;
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case Worldspace_FieldIndex.WaterNoiseTexture:
                        ...
                        break;
                    case Worldspace_FieldIndex.ImpactSwapData:
                        this.ImpactSwapData = (Exception?)obj;
                        break;
                    case Worldspace_FieldIndex.FootstepMaterials:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.ImpactSwapData = this.ImpactSwapData.Combine(rhs.ImpactSwapData);
        ...
        IWorldspaceGetter
    {
        ...
        new MemorySlice<Byte>? ImpactSwapData { get; set; }
        ...
        INamedRequiredGetter
    {
        ...
        ReadOnlyMemorySlice<Byte>? ImpactSwapData { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class WorldspaceCommon : Fallout3MajorRecordCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.ImpactSwapData = MemorySliceExt.SequenceEqual(item.ImpactSwapData, rhs.ImpactSwapData);
            ...
            Worldspace.Mask<bool>? printMask = null)
        {
            ...
            if ((printMask?.ImpactSwapData ?? true)
                && item.ImpactSwapData is {} ImpactSwapDataItem)
            {
                sb.AppendLine($"ImpactSwapData => {SpanExt.ToHexString(ImpactSwapDataItem)}");
            }
            if ((printMask?.FootstepMaterials ?? true)
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!MemorySliceExt.SequenceEqual(lhs.ImpactSwapData, rhs.ImpactSwapData)) return false;
            }
        ...
        public virtual int GetHashCode(IWorldspaceGetter item)
        {
            ...
            if (item.ImpactSwapData is {} ImpactSwapDataItem)
            {
                hash.Add(ImpactSwapDataItem);
            }
    ...
    internal partial class WorldspaceSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                if(rhs.ImpactSwapData is {} ImpactSwapDatarhs)
                {
                    item.ImpactSwapData = ImpactSwapDatarhs.ToArray();
                }
                else
                {
                    item.ImpactSwapData = default;
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Write(
                writer: writer,
                item: item.ImpactSwapData,
                header: translationParams.ConvertToCustom(RecordTypes.IMPS));
            ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Write(
                writer: writer,
    ...
    internal partial class WorldspaceBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.ImpactSwapData = ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IWorldspaceGetter
    {
        ...
        #endregion
        #region ImpactSwapData
        private int? _ImpactSwapDataLocation;
        public ReadOnlyMemorySlice<Byte>? ImpactSwapData => _ImpactSwapDataLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, _ImpactSwapDataLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
        #endregion
        #region FootstepMaterials
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.IMPS:
                {
                    _ImpactSwapDataLocation = (stream.Position - offset);
                    return (int)Worldspace_FieldIndex.ImpactSwapData;
                }
                case RecordTypeInts.IMPF:
                {
