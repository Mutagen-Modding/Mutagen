...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IQuestData
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte> IQuestDataGetter.Remaining => this.Remaining;
        #endregion
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case QuestData_FieldIndex.Priority:
                        return Priority;
                    case QuestData_FieldIndex.Remaining:
                        return Remaining;
                    default:
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class QuestData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.QuestData";
    ...
    internal partial class QuestDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)QuestData_FieldIndex.Remaining) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IQuestDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
    ...
    internal partial class QuestDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)QuestData_FieldIndex.Remaining) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IQuestDataGetter
    {
        ...
        #region Remaining
        public ReadOnlyMemorySlice<Byte> Remaining => _structData.Span.Slice(0x2).ToArray();
