...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<AcousticSpace>
    {
        ...
        #endregion
        #region SoundLooping
        private readonly IFormLinkNullable<ISoundGetter> _SoundLooping = new FormLinkNullable<ISoundGetter>();
        public IFormLinkNullable<ISoundGetter> SoundLooping
        {
            get => _SoundLooping;
            set => _SoundLooping.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<ISoundGetter> IAcousticSpaceGetter.SoundLooping => this.SoundLooping;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.SoundLooping = initialValue;
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.SoundLooping, rhs.SoundLooping)) return false;
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.SoundLooping)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.SoundLooping)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.SoundLooping = eval(this.SoundLooping);
            ...
            public void Print(StructuredStringBuilder sb, AcousticSpace.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.SoundLooping ?? true)
                    {
                        sb.AppendItem(SoundLooping, "SoundLooping");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case AcousticSpace_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case AcousticSpace_FieldIndex.SoundLooping:
                        return SoundLooping;
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    case AcousticSpace_FieldIndex.ObjectBounds:
                        ...
                        break;
                    case AcousticSpace_FieldIndex.SoundLooping:
                        this.SoundLooping = (Exception?)obj;
                        break;
                    case AcousticSpace_FieldIndex.UseSoundFromRegion:
            ...
            public override bool IsInError()
            {
                ...
                if (SoundLooping != null) return true;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.SoundLooping = this.SoundLooping.Combine(rhs.SoundLooping);
        ...
        IReferenceableObject
    {
        ...
        new IFormLinkNullable<ISoundGetter> SoundLooping { get; set; }
        ...
        IReferenceableObjectGetter
    {
        ...
        #endregion
        IFormLinkNullableGetter<ISoundGetter> SoundLooping { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class AcousticSpaceSetterCommon : Fallout3MajorRecordSetterCommon
    {
        ...
        public void RemapLinks(IAcousticSpace obj, IReadOnlyDictionary<FormKey, FormKey> mapping)
        {
            ...
            obj.SoundLooping.Relink(mapping);
    ...
    internal partial class AcousticSpaceCommon : Fallout3MajorRecordCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.SoundLooping = item.SoundLooping.Equals(rhs.SoundLooping);
            ...
            AcousticSpace.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.SoundLooping ?? true)
            {
                sb.AppendItem(item.SoundLooping.FormKeyNullable, "SoundLooping");
            }
            if (printMask?.UseSoundFromRegion ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)AcousticSpace_FieldIndex.SoundLooping) ?? true))
            {
                if (!lhs.SoundLooping.Equals(rhs.SoundLooping)) return false;
            }
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAcousticSpaceGetter obj, bool iterateNestedRecords = true)
        {
            ...
            if (FormLinkInformation.TryFactory(obj.SoundLooping, out var SoundLoopingInfo))
            {
                yield return SoundLoopingInfo;
            }
    ...
    internal partial class AcousticSpaceSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)AcousticSpace_FieldIndex.SoundLooping) ?? true))
            {
                item.SoundLooping.SetTo(rhs.SoundLooping.FormKeyNullable);
            }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.SNAM:
                {
                    ...
                    item.SoundLooping.SetTo(FormLinkBinaryTranslation.Instance.Parse(reader: frame));
                    return (int)AcousticSpace_FieldIndex.SoundLooping;
                }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IAcousticSpaceGetter
    {
        ...
        #endregion
        #region SoundLooping
        private int? _SoundLoopingLocation;
        public IFormLinkNullableGetter<ISoundGetter> SoundLooping => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<ISoundGetter>(_package, _recordData, _SoundLoopingLocation);
        #endregion
        #region UseSoundFromRegion
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.SNAM:
                {
                    _SoundLoopingLocation = (stream.Position - offset);
                    return (int)AcousticSpace_FieldIndex.SoundLooping;
                }
                case RecordTypeInts.RDAT:
                {
