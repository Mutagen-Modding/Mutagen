...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ISoundInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Int16[]? _AttenuationCurve;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Int16>? ISoundGetter.AttenuationCurve => _AttenuationCurve;
        #endregion
        ...
        public Sound(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.SOUN)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Sound_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Sound";
    ...
    #region Common
    internal partial class SoundSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class SoundCommon : Fallout3MajorRecordCommon
    {
            ...
            Sound.Mask<bool>? printMask = null)
        {
            ...
            if ((printMask?.AttenuationCurve?.Overall ?? true)
                && item.AttenuationCurve is {} AttenuationCurveItem)
            {
                sb.AppendLine("AttenuationCurve =>");
                using (sb.Brace())
                {
                    foreach (var subItem in AttenuationCurveItem)
                    {
                        using (sb.Brace())
                        {
                            sb.AppendItem(subItem);
        ...
        public static Sound_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public Sound Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Sound(formKey, default(Fallout3Release));
    ...
    internal partial class SoundSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Sound_FieldIndex.AttenuationCurve) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class SoundBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Data = Mutagen.Bethesda.Fallout3.SoundDataExtended.CreateFromBinary(frame: frame);
                    return (int)Sound_FieldIndex.Data;
                }
        ...
        ISoundGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.ANAM:
                {
                    _AttenuationCurveLocation = (stream.Position - offset);
                    return (int)Sound_FieldIndex.AttenuationCurve;
                }
                case RecordTypeInts.GNAM:
                {
