...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<GameSettingString>
    {
        ...
        public GameSettingString(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public GameSettingString(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.GMST)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class GameSettingString_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.GameSettingString";
    ...
    internal partial class GameSettingStringCommon : GameSettingCommon
    {
        ...
        public static GameSettingString_FieldIndex ConvertFieldIndex(GameSetting_FieldIndex index)
        {
            switch (index)
            {
                ...
                case GameSetting_FieldIndex.Version2:
                    return (GameSettingString_FieldIndex)((int)index);
                case GameSetting_FieldIndex.Fallout3MajorRecordFlags:
                    return (GameSettingString_FieldIndex)((int)index);
                default:
        ...
        public static new GameSettingString_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GameSettingString Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GameSettingString(formKey, default(Fallout3Release));
