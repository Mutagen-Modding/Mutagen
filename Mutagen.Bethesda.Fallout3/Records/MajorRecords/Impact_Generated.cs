...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<Impact>
    {
        ...
        public Impact(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public Impact(IFallout3Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.IPCT)]
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Impact_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Impact";
    ...
    #region Common
    internal partial class ImpactSetterCommon : Fallout3MajorRecordSetterCommon
    {
    ...
    internal partial class ImpactCommon : Fallout3MajorRecordCommon
    {
        ...
        public static Impact_FieldIndex ConvertFieldIndex(Fallout3MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public Impact Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Impact(formKey, default(Fallout3Release));
    ...
    internal partial class ImpactSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class ImpactBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
