...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IProjectileInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectBoundsGetter? IProjectileGetter.ObjectBounds => this.ObjectBounds;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IProjectileGetter.Name => this.Name;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        #endregion
        #region MuzzleFlashModelFilename
        public String MuzzleFlashModelFilename { get; set; } = string.Empty;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.MuzzleFlashModelFilename = initialValue;
            ...
            public Mask(
                ...
                TItem MuzzleFlashModelFilename,
            ...
            public TItem MuzzleFlashModelFilename;
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.MuzzleFlashModelFilename, rhs.MuzzleFlashModelFilename)) return false;
            ...
            public override int GetHashCode()
            {
                ...
                hash.Add(this.MuzzleFlashModelFilename);
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.MuzzleFlashModelFilename)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.MuzzleFlashModelFilename)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.MuzzleFlashModelFilename = eval(this.MuzzleFlashModelFilename);
            ...
            public void Print(StructuredStringBuilder sb, Projectile.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.MuzzleFlashModelFilename ?? true)
                    {
                        sb.AppendItem(MuzzleFlashModelFilename, "MuzzleFlashModelFilename");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public Exception? MuzzleFlashModelFilename;
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Projectile_FieldIndex.MuzzleFlashModelFilename:
                        return MuzzleFlashModelFilename;
            ...
            public override void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    ...
                    case Projectile_FieldIndex.DefaultWeaponSource:
                        ...
                        break;
                    case Projectile_FieldIndex.MuzzleFlashModelFilename:
                        this.MuzzleFlashModelFilename = ex;
                        break;
                    case Projectile_FieldIndex.TextureFilesHashes:
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case Projectile_FieldIndex.DefaultWeaponSource:
                        ...
                        break;
                    case Projectile_FieldIndex.MuzzleFlashModelFilename:
                        this.MuzzleFlashModelFilename = (Exception?)obj;
                        break;
                    case Projectile_FieldIndex.TextureFilesHashes:
            ...
            public override bool IsInError()
            {
                ...
                if (MuzzleFlashModelFilename != null) return true;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.MuzzleFlashModelFilename = this.MuzzleFlashModelFilename.Combine(rhs.MuzzleFlashModelFilename);
            ...
            ITranslationMask
        {
            ...
            public bool MuzzleFlashModelFilename;
                ...
                : base(defaultOn, onOverall)
            {
                ...
                this.MuzzleFlashModelFilename = defaultOn;
            ...
            protected override void GetCrystal(List<(bool On, TranslationCrystal? SubCrystal)> ret)
            {
                ...
                ret.Add((MuzzleFlashModelFilename, null));
        ...
        public Projectile(IFallout3Mod mod)
            : this(
                mod.GetNextFormKey(),
                mod.Fallout3Release)
        {
        ...
        public Projectile(IFallout3Mod mod, string editorID)
            : this(
        ...
        IProjectileGetter
    {
        ...
        new String MuzzleFlashModelFilename { get; set; }
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout3.Internals.RecordTypeInts.PROJ)]
        ...
        IObjectBoundedOptionalGetter
    {
        ...
        String MuzzleFlashModelFilename { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class Projectile_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.Projectile";
    ...
    #region Common
    internal partial class ProjectileSetterCommon : Fallout3MajorRecordSetterCommon
    {
        ...
        public void Clear(IProjectileInternal item)
        {
            ...
            item.MuzzleFlashModelFilename = string.Empty;
    ...
    internal partial class ProjectileCommon : Fallout3MajorRecordCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.MuzzleFlashModelFilename = string.Equals(item.MuzzleFlashModelFilename, rhs.MuzzleFlashModelFilename);
            ...
            Projectile.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.MuzzleFlashModelFilename ?? true)
            {
                sb.AppendItem(item.MuzzleFlashModelFilename, "MuzzleFlashModelFilename");
            }
            if ((printMask?.TextureFilesHashes ?? true)
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Projectile_FieldIndex.MuzzleFlashModelFilename) ?? true))
            {
                if (!string.Equals(lhs.MuzzleFlashModelFilename, rhs.MuzzleFlashModelFilename)) return false;
            }
        ...
        public virtual int GetHashCode(IProjectileGetter item)
        {
            ...
            hash.Add(item.MuzzleFlashModelFilename);
        ...
        public Projectile Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Projectile(formKey, default(Fallout3Release));
    ...
    internal partial class ProjectileSetterTranslationCommon : Fallout3MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
                ...
                try
                {
                    if(rhs.ObjectBounds is {} rhsObjectBounds)
                    {
                        item.ObjectBounds = rhsObjectBounds.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Projectile_FieldIndex.ObjectBounds));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)Projectile_FieldIndex.MuzzleFlashModelFilename) ?? true))
            {
                item.MuzzleFlashModelFilename = rhs.MuzzleFlashModelFilename;
            }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            StringBinaryTranslation.Instance.Write(
                writer: writer,
                item: item.MuzzleFlashModelFilename,
    ...
    internal partial class ProjectileBinaryCreateTranslation : Fallout3MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.MuzzleFlashModelFilename = StringBinaryTranslation.Instance.Parse(
                        reader: frame.SpawnWithLength(contentLength),
                        stringBinaryType: StringBinaryType.NullTerminate,
                        parseWhole: true);
                    return (int)Projectile_FieldIndex.MuzzleFlashModelFilename;
                }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        IProjectileGetter
    {
        ...
        #endregion
        #region MuzzleFlashModelFilename
        private int? _MuzzleFlashModelFilenameLocation;
        public String MuzzleFlashModelFilename => _MuzzleFlashModelFilenameLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, _MuzzleFlashModelFilenameLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : string.Empty;
        #endregion
        #region TextureFilesHashes
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.NAM1:
                {
                    _MuzzleFlashModelFilenameLocation = (stream.Position - offset);
                    return (int)Projectile_FieldIndex.MuzzleFlashModelFilename;
                }
                case RecordTypeInts.NAM2:
                {
