...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ILoquiObjectSetter<CreatureConfiguration>
    {
        ...
        public Creature.TemplateFlag TemplateFlags { get; set; } = default(Creature.TemplateFlag);
        #endregion
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((CreatureConfigurationCommon)((ICreatureConfigurationGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ICreatureConfigurationGetter? obj)
        {
            return ((CreatureConfigurationCommon)((ICreatureConfigurationGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case CreatureConfiguration_FieldIndex.BarterGold:
                        return BarterGold;
                    case CreatureConfiguration_FieldIndex.Level:
                        return Level;
                    case CreatureConfiguration_FieldIndex.CalcMin:
                        return CalcMin;
                    case CreatureConfiguration_FieldIndex.CalcMax:
                        return CalcMax;
                    case CreatureConfiguration_FieldIndex.SpeedMultiplier:
                        return SpeedMultiplier;
                    case CreatureConfiguration_FieldIndex.Karma:
                        return Karma;
                    case CreatureConfiguration_FieldIndex.DispositionBase:
                        return DispositionBase;
                    case CreatureConfiguration_FieldIndex.TemplateFlags:
        ...
        ILoquiObjectSetter<ICreatureConfiguration>
    {
        ...
        new Creature.TemplateFlag TemplateFlags { get; set; }
    }
        ...
        ILoquiObject<ICreatureConfigurationGetter>
    {
        ...
        Creature.TemplateFlag TemplateFlags { get; }
...
namespace Mutagen.Bethesda.Fallout3
{
    ...
    internal partial class CreatureConfiguration_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout3.CreatureConfiguration";
    ...
    internal partial class CreatureConfigurationSetterCommon
    {
        ...
        public void Clear(ICreatureConfiguration item)
        {
            ...
            item.TemplateFlags = default(Creature.TemplateFlag);
        }
    ...
    internal partial class CreatureConfigurationCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Flags) ?? true))
            {
                if (lhs.Flags != rhs.Flags) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Fatigue) ?? true))
            {
                if (lhs.Fatigue != rhs.Fatigue) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.BarterGold) ?? true))
            {
                if (lhs.BarterGold != rhs.BarterGold) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Level) ?? true))
            {
                if (lhs.Level != rhs.Level) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.CalcMin) ?? true))
            {
                if (lhs.CalcMin != rhs.CalcMin) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.CalcMax) ?? true))
            {
                if (lhs.CalcMax != rhs.CalcMax) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.SpeedMultiplier) ?? true))
            {
                if (lhs.SpeedMultiplier != rhs.SpeedMultiplier) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Karma) ?? true))
            {
                if (!lhs.Karma.EqualsWithin(rhs.Karma)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.DispositionBase) ?? true))
            {
                if (lhs.DispositionBase != rhs.DispositionBase) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.TemplateFlags) ?? true))
            {
    ...
    internal partial class CreatureConfigurationSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Level) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.SpeedMultiplier) ?? true))
            {
                item.SpeedMultiplier = rhs.SpeedMultiplier;
            }
            if ((copyMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.Karma) ?? true))
            {
                item.Karma = rhs.Karma;
            }
            if ((copyMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.DispositionBase) ?? true))
            {
                item.DispositionBase = rhs.DispositionBase;
            }
            if ((copyMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.TemplateFlags) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout3
{
    public partial class CreatureConfigurationBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            MutagenWriter writer)
        {
            ...
            EnumBinaryTranslation<Creature.TemplateFlag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.TemplateFlags,
                length: 2);
        }
    ...
    {
        public static readonly CreatureConfigurationBinaryCreateTranslation Instance = new CreatureConfigurationBinaryCreateTranslation();
            ...
            MutagenFrame frame)
        {
            ...
            item.TemplateFlags = EnumBinaryTranslation<Creature.TemplateFlag, MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                length: 2);
        }
...
namespace Mutagen.Bethesda.Fallout3
{
        ...
        ICreatureConfigurationGetter
    {
        ...
        public Creature.CreatureFlag Flags => (Creature.CreatureFlag)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0x0, 0x4));
        ...
        public Creature.TemplateFlag TemplateFlags => (Creature.TemplateFlag)BinaryPrimitives.ReadUInt16LittleEndian(_structData.Span.Slice(0x16, 0x2));
        ...
        public static ICreatureConfigurationGetter CreatureConfigurationFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
