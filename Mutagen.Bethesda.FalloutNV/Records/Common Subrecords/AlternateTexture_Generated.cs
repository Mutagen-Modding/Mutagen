...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<AlternateTexture>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((AlternateTextureCommon)((IAlternateTextureGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IAlternateTextureGetter? obj)
        {
            return ((AlternateTextureCommon)((IAlternateTextureGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(AlternateTexture.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, AlternateTexture.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(AlternateTexture.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    ...
                    {
                        sb.AppendItem(NewTexture, "NewTexture");
                    }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => AlternateTextureCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class AlternateTextureMixIn
    {
        ...
        {
            return ((AlternateTextureCommon)((IAlternateTextureGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            AlternateTexture.Mask<bool>? printMask = null)
        {
            ((AlternateTextureCommon)((IAlternateTextureGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class AlternateTexture_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.AlternateTexture";
    ...
    internal partial class AlternateTextureCommon
    {
            ...
            AlternateTexture.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"AlternateTexture =>");
            }
            else
            {
                sb.AppendLine($"{name} (AlternateTexture) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            AlternateTexture.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.NewTexture ?? true)
            {
                sb.AppendItem(item.NewTexture.FormKey, "NewTexture");
            }
            if (printMask?.Index ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)AlternateTexture_FieldIndex.Name) ?? true))
            {
                if (!string.Equals(lhs.Name, rhs.Name)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AlternateTexture_FieldIndex.NewTexture) ?? true))
            {
                if (!lhs.NewTexture.Equals(rhs.NewTexture)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AlternateTexture_FieldIndex.Index) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAlternateTextureGetter obj, bool iterateNestedRecords = true)
        {
