...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class DestructionStage_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.DestructionStage";
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.DSTD:
                {
                    ...
                    item.Data = Mutagen.Bethesda.FalloutNV.DestructionStageData.CreateFromBinary(frame: frame);
