...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        INpcOwner
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => NpcOwnerCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class NpcOwner_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.NpcOwner";
    ...
    internal partial class NpcOwnerCommon : OwnerTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INpcOwnerGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    {
        public new static readonly NpcOwnerBinaryWriteTranslation Instance = new();
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        INpcOwnerGetter
    {
        ...
        public IFormLinkGetter<INpcGetter> Npc => FormLinkBinaryTranslation.Instance.OverlayFactory<INpcGetter>(_package, _structData.Span.Slice(0x0, 0x4));
        public IFormLinkGetter<IGlobalGetter> Global => FormLinkBinaryTranslation.Instance.OverlayFactory<IGlobalGetter>(_package, _structData.Span.Slice(0x4, 0x4));
