...
public partial class FalloutNVModHeader
{
    ...
    public void SetOverriddenForms(IEnumerable<FormKey>? formKeys)
    {
        ...
        else
        {
            ...
            this.OverriddenForms.SetTo(formKeys.Select(f => f.ToLink<IFalloutNVMajorRecordGetter>()));
        }
    }
}

public partial interface IFalloutNVModHeader : IModHeaderCommon
{
}

partial class FalloutNVModHeaderBinaryCreateTranslation
{
    public static partial void FillBinaryMasterReferencesCustom(MutagenFrame frame, IFalloutNVModHeader item, PreviousParse lastParsed)
    {
...
partial class FalloutNVModHeaderBinaryWriteTranslation
{
    public static partial void WriteBinaryMasterReferencesCustom(MutagenWriter writer, IFalloutNVModHeaderGetter item)
    {
