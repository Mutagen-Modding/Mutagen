...
internal static class ModContextExt
{
    ...
    public static IEnumerable<IModContext<IFalloutNVMod, IFalloutNVModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
        this IFalloutNVListGroupGetter<ICellBlockGetter> cellBlocks,
        ...
        bool throwIfUnknown)
    {
        foreach (var readOnlyBlock in cellBlocks.Records)
        {
            ...
            foreach (var readOnlySubBlock in readOnlyBlock.SubBlocks)
            {
                ...
                {
                    Func<IFalloutNVMod, ICellGetter, bool, string?, FormKey?, ICell> cellGetter = (mod, copyCell, dup, edid, newFormKey) =>
                    {
                    ...
                    {
                        yield return new ModContext<IFalloutNVMod, IFalloutNVModGetter, IMajorRecord, IMajorRecordGetter>(
                            modKey: modKey,
                            record: readOnlyCell,
    ...
    public static IEnumerable<IModContext<IFalloutNVMod, IFalloutNVModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
        ...
        IModContext? parent,
        bool throwIfUnknown,
        Func<IFalloutNVMod, IWorldspaceGetter, IWorldspace> getOrAddAsOverride)
    {
