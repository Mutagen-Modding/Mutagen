...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<Hair>
    {
        ...
        #endregion
        #region Texture
        public AssetLink<FalloutNVTextureAssetType> Texture { get; set; } = new AssetLink<FalloutNVTextureAssetType>();
        AssetLinkGetter<FalloutNVTextureAssetType> IHairGetter.Texture => this.Texture;
        #endregion
        #region Flags
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => HairCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public override void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => HairSetterCommon.Instance.RemapLinks(this, mapping);
        public Hair(
            FormKey formKey,
        ...
        public Hair(IFalloutNVMod mod, string editorID)
            : this(
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType) => HairCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        public override IEnumerable<IAssetLink> EnumerateListedAssetLinks() => HairSetterCommon.Instance.EnumerateListedAssetLinks(this);
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => HairSetterCommon.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => HairSetterCommon.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
        ...
        INamedRequired
    {
        ...
        new AssetLink<FalloutNVTextureAssetType> Texture { get; set; }
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.HAIR)]
        ...
        INamedRequiredGetter
    {
        ...
        #endregion
        AssetLinkGetter<FalloutNVTextureAssetType> Texture { get; }
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Hair_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Hair";
    ...
    #region Common
    internal partial class HairSetterCommon : FalloutNVMajorRecordSetterCommon
    {
        ...
        public IEnumerable<IAssetLink> EnumerateListedAssetLinks(IHair obj)
        {
    ...
    internal partial class HairCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Hair_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Hair_FieldIndex.Texture) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IHairGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IHairGetter obj, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType)
        {
        ...
        public Hair Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Hair(formKey, default(FalloutNVRelease));
    ...
    internal partial class HairSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            item.Texture.GivenPath = rhs.Texture.GivenPath;
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class HairBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Texture.GivenPath = StringBinaryTranslation.Instance.Parse(
                        reader: frame.SpawnWithLength(contentLength),
                        stringBinaryType: StringBinaryType.NullTerminate,
                        parseWhole: true);
                    return (int)Hair_FieldIndex.Texture;
                }
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IHairGetter
    {
        ...
        public AssetLinkGetter<FalloutNVTextureAssetType> Texture => _TextureLocation.HasValue ? new AssetLinkGetter<FalloutNVTextureAssetType>(BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, _TextureLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated)) : AssetLinkGetter<FalloutNVTextureAssetType>.Null;
        #endregion
        #region Flags
