...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<GlobalInt>
    {
        ...
        public GlobalInt(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GlobalInt(IFalloutNVMod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class GlobalInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.GlobalInt";
    ...
    internal partial class GlobalIntCommon : GlobalCommon
    {
        ...
        public static new GlobalInt_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GlobalInt Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GlobalInt(formKey, default(FalloutNVRelease));
