...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ISpellInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte> ISpellGetter.Unused => this.Unused;
        #endregion
        #region Effects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public Spell(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public Spell(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.SPEL)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Spell_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Spell";
    ...
    #region Common
    internal partial class SpellSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class SpellCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Spell_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Spell_FieldIndex.Cost) ?? true))
            {
                if (lhs.Cost != rhs.Cost) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Spell_FieldIndex.Level) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Spell_FieldIndex.Unused) ?? true))
            {
        ...
        public Spell Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Spell(formKey, default(FalloutNVRelease));
    ...
    internal partial class SpellSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Spell_FieldIndex.Cost) ?? true))
            {
                item.Cost = rhs.Cost;
            }
            if ((copyMask?.GetShouldTranslate((int)Spell_FieldIndex.Level) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)Spell_FieldIndex.Unused) ?? true))
            {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class SpellBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.SPIT:
                {
                    ...
                    return (int)Spell_FieldIndex.Unused;
                }
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ISpellGetter
    {
        ...
        #endregion
        #region Cost
        private int _CostLocation => _SPITLocation!.Value.Min + 0x4;
        private bool _Cost_IsSet => _SPITLocation.HasValue;
        public UInt32 Cost => _Cost_IsSet ? BinaryPrimitives.ReadUInt32LittleEndian(_recordData.Slice(_CostLocation, 4)) : default(UInt32);
        #endregion
        #region Level
        private int _LevelLocation => _SPITLocation!.Value.Min + 0x8;
        ...
        #endregion
        #region Unused
        private int _UnusedLocation => _SPITLocation!.Value.Min + 0xD;
        private bool _Unused_IsSet => _SPITLocation.HasValue;
