...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class PackageIdles_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.PackageIdles";
    ...
    internal partial class PackageIdlesBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.TimerSetting = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IPackageIdlesGetter
    {
        ...
        public PackageIdles.Types Type => EnumBinaryTranslation<PackageIdles.Types, MutagenFrame, MutagenWriter>.Instance.ParseRecord(_TypeLocation, _recordData, _package, 4);
        #endregion
        #region TimerSetting
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.IDLT:
                {
                    _TimerSettingLocation = (stream.Position - offset);
                    return (int)PackageIdles_FieldIndex.TimerSetting;
                }
                case RecordTypeInts.IDLC:
                case RecordTypeInts.IDLA:
