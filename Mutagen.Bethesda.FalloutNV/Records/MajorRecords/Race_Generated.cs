...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IRaceInternal
    {
        ...
        public IGenderedItem<Byte> DefaultHairColors { get; set; } = new GenderedItem<Byte>(default(Byte), default(Byte));
        IGenderedItemGetter<Byte> IRaceGetter.DefaultHairColors => this.DefaultHairColors;
        #endregion
        ...
        public Race(IFalloutNVMod mod, string editorID)
            : this(
        ...
        ITranslatedNamedRequired
    {
        ...
        new IGenderedItem<Byte> DefaultHairColors { get; set; }
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.RACE)]
        ...
        ITranslatedNamedRequiredGetter
    {
        ...
        IGenderedItemGetter<Byte> DefaultHairColors { get; }
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Race_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Race";
    ...
    #region Common
    internal partial class RaceSetterCommon : FalloutNVMajorRecordSetterCommon
    {
        ...
        public void Clear(IRaceInternal item)
        {
            ...
            item.DefaultHairColors.Male = default(Byte);
            item.DefaultHairColors.Female = default(Byte);
    ...
    internal partial class RaceCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Race_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public Race Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Race(formKey, default(FalloutNVRelease));
    ...
    internal partial class RaceSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            item.DefaultHairColors = new GenderedItem<Byte>(
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class RaceBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Data = Mutagen.Bethesda.FalloutNV.RaceData.CreateFromBinary(frame: frame);
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.DefaultHairColors = Mutagen.Bethesda.Plugins.Binary.Translations.GenderedItemBinaryTranslation.ParseRequired<Byte>(
                        frame: frame,
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IRaceGetter
    {
        ...
        public IGenderedItemGetter<Byte> DefaultHairColors
        {
            get
            {
                if (!_DefaultHairColorsLocation.HasValue) return new GenderedItem<Byte>(default(Byte), default(Byte));
