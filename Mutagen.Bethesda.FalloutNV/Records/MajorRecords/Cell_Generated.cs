...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<Cell>
    {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Cell_FieldIndex.Flags:
                        return Flags;
                    case Cell_FieldIndex.GridX:
                        return GridX;
                    case Cell_FieldIndex.GridY:
                        return GridY;
        ...
        public Cell(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.CELL)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal enum Cell_FieldIndex
    {
        ...
        GridY = 10,
        Lighting = 11,
        FootstepMaterials = 12,
        LightTemplate = 13,
        LightInheritFlags = 14,
        WaterHeight = 15,
        ...
        Timestamp = 30,
        UnknownGroupData = 31,
        PersistentTimestamp = 32,
        PersistentUnknownGroupData = 33,
        Persistent = 34,
        TemporaryTimestamp = 35,
        TemporaryUnknownGroupData = 36,
        Temporary = 37,
        VisibleWhenDistantTimestamp = 38,
        VisibleWhenDistantUnknownGroupData = 39,
        VisibleWhenDistant = 40,
    }
    #endregion
    ...
    internal partial class Cell_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Cell";
    ...
    #region Common
    internal partial class CellSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class CellCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Cell_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Cell_FieldIndex.GridX) ?? true))
            {
                if (lhs.GridX != rhs.GridX) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Cell_FieldIndex.GridY) ?? true))
            {
        ...
        public IEnumerable<IModContext<IFalloutNVMod, IFalloutNVModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
            ...
            ModKey modKey,
            IModContext? parent,
            Func<IFalloutNVMod, ICellGetter, ICell> getOrAddAsOverride,
            Func<IFalloutNVMod, ICellGetter, string?, FormKey?, ICell> duplicateInto)
        {
            var curContext = new ModContext<IFalloutNVMod, IFalloutNVModGetter, ICell, ICellGetter>(
                modKey,
                record: obj,
                ...
                parent: parent);
            {
                ...
                {
                    yield return new ModContext<IFalloutNVMod, IFalloutNVModGetter, ILandscapeInternal, ILandscapeGetter>(
                        modKey: modKey,
            ...
            foreach (var subItem in obj.NavigationMeshes)
            {
                yield return new ModContext<IFalloutNVMod, IFalloutNVModGetter, INavigationMeshInternal, INavigationMeshGetter>(
                    modKey: modKey,
                    record: subItem,
                    parent: curContext,
                    getOrAddAsOverride: (m, r) =>
            ...
            foreach (var subItem in obj.Persistent)
            {
                yield return new ModContext<IFalloutNVMod, IFalloutNVModGetter, IPlaced, IPlacedGetter>(
                    modKey: modKey,
                    record: subItem,
                    parent: curContext,
                    getOrAddAsOverride: (m, r) =>
            ...
            Func<IFalloutNVMod, ICellGetter, string?, FormKey?, ICell> duplicateInto)
        {
            ...
            switch (type.Name)
            {
                ...
                case "IPlacedObjectInternal":
                    ...
                    yield break;
                default:
                    if (InterfaceEnumerationHelper.TryEnumerateInterfaceContextsFor<ICellGetter, IFalloutNVMod, IFalloutNVModGetter>(
        ...
        public Cell Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Cell(formKey, default(FalloutNVRelease));
    ...
    internal partial class CellSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Cell_FieldIndex.GridX) ?? true))
            {
                item.GridX = rhs.GridX;
            }
            if ((copyMask?.GetShouldTranslate((int)Cell_FieldIndex.GridY) ?? true))
            {
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            using (HeaderExport.Subrecord(writer, translationParams.ConvertToCustom(RecordTypes.XCLC)))
            {
    ...
    internal partial class CellBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.XCLC:
                {
                    ...
                    item.GridX = dataFrame.ReadInt32();
                    if (dataFrame.Remaining < 4) return null;
                    item.GridY = dataFrame.ReadInt32();
                    return (int)Cell_FieldIndex.GridY;
                }
                case RecordTypeInts.XCLL:
                {
                    item.Lighting = Mutagen.Bethesda.FalloutNV.CellLighting.CreateFromBinary(frame: frame);
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ICellGetter
    {
        ...
        #region GridX
        private int _GridXLocation => _XCLCLocation!.Value.Min;
        private bool _GridX_IsSet => _XCLCLocation.HasValue;
        public Int32 GridX => _GridX_IsSet ? BinaryPrimitives.ReadInt32LittleEndian(_recordData.Slice(_GridXLocation, 4)) : default(Int32);
        #endregion
        #region GridY
        private int _GridYLocation => _XCLCLocation!.Value.Min + 0x4;
        private bool _GridY_IsSet => _XCLCLocation.HasValue;
        public Int32 GridY => _GridY_IsSet ? BinaryPrimitives.ReadInt32LittleEndian(_recordData.Slice(_GridYLocation, 4)) : default(Int32);
        #endregion
        #region Lighting
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.XCLC:
                {
                    _XCLCLocation = new((stream.Position - offset) + _package.MetaData.Constants.SubConstants.TypeAndLengthLength, finalPos - offset - 1);
                    return (int)Cell_FieldIndex.GridY;
                }
                case RecordTypeInts.XCLL:
                {
