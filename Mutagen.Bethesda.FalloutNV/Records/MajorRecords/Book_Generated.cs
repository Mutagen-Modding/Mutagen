...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<Book>
    {
        ...
        #endregion
        #region Skill
        public Skill Skill { get; set; } = default(Skill);
        #endregion
        #region Value
        ...
        public Book(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.BOOK)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Book_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Book";
    ...
    #region Common
    internal partial class BookSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class BookCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Book_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public Book Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Book(formKey, default(FalloutNVRelease));
    ...
    internal partial class BookSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class BookBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IBookGetter
    {
        ...
        public Skill Skill => _Skill_IsSet ? (Skill)_recordData.Span.Slice(_SkillLocation, 0x1)[0] : default;
        #endregion
        #region Value
