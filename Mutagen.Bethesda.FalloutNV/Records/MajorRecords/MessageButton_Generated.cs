...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IMessageButton
    {
        ...
        String? IMessageButtonGetter.Text => this.Text;
        #endregion
        #region Conditions
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class MessageButton_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.MessageButton";
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IMessageButtonGetter
    {
        ...
        public String? Text => _TextLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_recordData, _TextLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        #endregion
