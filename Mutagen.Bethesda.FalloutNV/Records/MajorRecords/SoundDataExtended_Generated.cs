...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ISoundDataExtendedInternal
    {
        ...
        private MemorySlice<Byte> _AttenuationCurve = new byte[10];
        public MemorySlice<Byte> AttenuationCurve
        {
            get => _AttenuationCurve;
            set => this._AttenuationCurve = value;
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte> ISoundDataExtendedGetter.AttenuationCurve => this.AttenuationCurve;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                this.AttenuationCurve = initialValue;
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.AttenuationCurve)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.AttenuationCurve)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.AttenuationCurve = eval(this.AttenuationCurve);
            ...
            public void Print(StructuredStringBuilder sb, SoundDataExtended.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    if (printMask?.AttenuationCurve ?? true)
                    {
                        sb.AppendItem(AttenuationCurve, "AttenuationCurve");
                    }
        ...
        {
            #region Members
            public Exception? AttenuationCurve;
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                {
                    case SoundDataExtended_FieldIndex.AttenuationCurve:
                        this.AttenuationCurve = (Exception?)obj;
                        break;
                    case SoundDataExtended_FieldIndex.ReverbAttenuationControl:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.AttenuationCurve = this.AttenuationCurve.Combine(rhs.AttenuationCurve);
    ...
    public partial interface ISoundDataExtended :
        ...
        ISoundDataInternal
    {
        new MemorySlice<Byte> AttenuationCurve { get; set; }
        ...
        ILoquiObject<ISoundDataExtendedInternalGetter>
    {
        ...
        ReadOnlyMemorySlice<Byte> AttenuationCurve { get; }
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class SoundDataExtended_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.SoundDataExtended";
    ...
    internal partial class SoundDataExtendedSetterCommon : SoundDataSetterCommon
    {
        ...
        {
            ClearPartial();
            item.AttenuationCurve = new byte[10];
    ...
    internal partial class SoundDataExtendedCommon : SoundDataCommon
    {
        ...
        public void FillEqualsMask(
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ret.AttenuationCurve = MemoryExtensions.SequenceEqual(item.AttenuationCurve.Span, rhs.AttenuationCurve.Span);
            ...
            SoundDataExtended.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.AttenuationCurve ?? true)
            {
                sb.AppendLine($"AttenuationCurve => {SpanExt.ToHexString(item.AttenuationCurve)}");
            }
            if (printMask?.ReverbAttenuationControl ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!MemoryExtensions.SequenceEqual(lhs.AttenuationCurve.Span, rhs.AttenuationCurve.Span)) return false;
            }
    ...
    internal partial class SoundDataExtendedSetterTranslationCommon : SoundDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                item.AttenuationCurve = rhs.AttenuationCurve.ToArray();
            }
    ...
    internal partial class SoundDataExtendedBinaryCreateTranslation : SoundDataBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            SoundDataBinaryCreateTranslation.FillBinaryStructs(
                item: item,
                frame: frame);
            item.AttenuationCurve = ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(10));
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ISoundDataExtendedInternalGetter
    {
        ...
        public ReadOnlyMemorySlice<Byte> AttenuationCurve => _structData.Span.Slice(0xC, 0xA).ToArray();
