...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IScriptObjectReference
    {
        ...
        IFormLinkGetter<IFalloutNVMajorRecordGetter> IScriptObjectReferenceGetter.Reference => this.Reference;
        #endregion
        ...
        public override void Print(
            ...
            string? name = null)
        {
            ScriptObjectReferenceMixIn.Print(
                item: this,
                sb: sb,
                name: name);
        }
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ScriptObjectReferenceCommon)((IScriptObjectReferenceGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IScriptObjectReferenceGetter? obj)
        {
            return ((ScriptObjectReferenceCommon)((IScriptObjectReferenceGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(ScriptObjectReference.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ScriptObjectReference.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(ScriptObjectReference.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ScriptObjectReferenceCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class ScriptObjectReferenceMixIn
    {
        ...
        {
            return ((ScriptObjectReferenceCommon)((IScriptObjectReferenceGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ScriptObjectReference.Mask<bool>? printMask = null)
        {
            ((ScriptObjectReferenceCommon)((IScriptObjectReferenceGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class ScriptObjectReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.ScriptObjectReference";
        ...
        {
            var all = RecordCollection.Factory(RecordTypes.SCRO);
    ...
    internal partial class ScriptObjectReferenceCommon : AScriptReferenceCommon
    {
            ...
            ScriptObjectReference.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"ScriptObjectReference =>");
            }
            else
            {
                sb.AppendLine($"{name} (ScriptObjectReference) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ScriptObjectReference_FieldIndex.Reference) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IScriptObjectReferenceGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    {
        public new static readonly ScriptObjectReferenceBinaryCreateTranslation Instance = new ScriptObjectReferenceBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IScriptObjectReferenceGetter
    {
        ...
        public IFormLinkGetter<IFalloutNVMajorRecordGetter> Reference => FormLinkBinaryTranslation.Instance.NullableRecordOverlayFactory<IFalloutNVMajorRecordGetter>(_package, _recordData, _ReferenceLocation);
        #endregion
