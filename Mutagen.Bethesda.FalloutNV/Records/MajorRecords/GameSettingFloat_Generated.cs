...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<GameSettingFloat>
    {
        ...
        public GameSettingFloat(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GameSettingFloat(IFalloutNVMod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class GameSettingFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.GameSettingFloat";
    ...
    internal partial class GameSettingFloatCommon : GameSettingCommon
    {
        ...
        public static new GameSettingFloat_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GameSettingFloat Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GameSettingFloat(formKey, default(FalloutNVRelease));
