...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IPlacedBeamInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IFalloutNVMajorRecordGetter> IPlacedBeamGetter.GlobalReference => this.GlobalReference;
        #endregion
        #region Topic
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IFalloutNVMajorRecordGetter> IPlacedBeamGetter.Owner => this.Owner;
        #endregion
        #region FactionRank
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IFalloutNVMajorRecordGetter> IPlacedBeamGetter.LinkedReferenceColor => this.LinkedReferenceColor;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case PlacedBeam_FieldIndex.LinkStartColorRed:
                        return LinkStartColorRed;
                    case PlacedBeam_FieldIndex.LinkStartColorGreen:
                        return LinkStartColorGreen;
                    case PlacedBeam_FieldIndex.LinkStartColorBlue:
                        return LinkStartColorBlue;
                    case PlacedBeam_FieldIndex.LinkStartColorAlpha:
                        return LinkStartColorAlpha;
                    case PlacedBeam_FieldIndex.LinkEndColorRed:
                        return LinkEndColorRed;
                    case PlacedBeam_FieldIndex.LinkEndColorGreen:
                        return LinkEndColorGreen;
                    case PlacedBeam_FieldIndex.LinkEndColorBlue:
                        return LinkEndColorBlue;
                    case PlacedBeam_FieldIndex.LinkEndColorAlpha:
        ...
        public PlacedBeam(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public PlacedBeam(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.PBEA)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class PlacedBeam_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.PlacedBeam";
    ...
    #region Common
    internal partial class PlacedBeamSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class PlacedBeamCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static PlacedBeam_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorRed) ?? true))
            {
                if (lhs.LinkStartColorRed != rhs.LinkStartColorRed) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorGreen) ?? true))
            {
                if (lhs.LinkStartColorGreen != rhs.LinkStartColorGreen) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorBlue) ?? true))
            {
                if (lhs.LinkStartColorBlue != rhs.LinkStartColorBlue) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorAlpha) ?? true))
            {
                if (lhs.LinkStartColorAlpha != rhs.LinkStartColorAlpha) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorRed) ?? true))
            {
                if (lhs.LinkEndColorRed != rhs.LinkEndColorRed) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorGreen) ?? true))
            {
                if (lhs.LinkEndColorGreen != rhs.LinkEndColorGreen) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorBlue) ?? true))
            {
                if (lhs.LinkEndColorBlue != rhs.LinkEndColorBlue) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorAlpha) ?? true))
            {
        ...
        public PlacedBeam Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new PlacedBeam(formKey, default(FalloutNVRelease));
    ...
    internal partial class PlacedBeamSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorRed) ?? true))
            {
                item.LinkStartColorRed = rhs.LinkStartColorRed;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorGreen) ?? true))
            {
                item.LinkStartColorGreen = rhs.LinkStartColorGreen;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorBlue) ?? true))
            {
                item.LinkStartColorBlue = rhs.LinkStartColorBlue;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkStartColorAlpha) ?? true))
            {
                item.LinkStartColorAlpha = rhs.LinkStartColorAlpha;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorRed) ?? true))
            {
                item.LinkEndColorRed = rhs.LinkEndColorRed;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorGreen) ?? true))
            {
                item.LinkEndColorGreen = rhs.LinkEndColorGreen;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorBlue) ?? true))
            {
                item.LinkEndColorBlue = rhs.LinkEndColorBlue;
            }
            if ((copyMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.LinkEndColorAlpha) ?? true))
            {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class PlacedBeamBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.XCLP:
                {
                    ...
                    return (int)PlacedBeam_FieldIndex.LinkEndColorAlpha;
                }
