...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ITerminalInternal
    {
        ...
        public HackingDifficulty BaseHackingDifficulty { get; set; } = default(HackingDifficulty);
        #endregion
        #region Flags
        public Byte Flags { get; set; } = default(Byte);
        #endregion
        #region ServerType
        public Byte ServerType { get; set; } = default(Byte);
        #endregion
        #region Unused
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public Terminal(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public Terminal(IFalloutNVMod mod, string editorID)
            : this(
        ...
        ITerminalGetter
    {
        ...
        new HackingDifficulty BaseHackingDifficulty { get; set; }
        new Byte Flags { get; set; }
        new Byte ServerType { get; set; }
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.TERM)]
        ...
        IObjectBoundedOptionalGetter
    {
        ...
        HackingDifficulty BaseHackingDifficulty { get; }
        Byte Flags { get; }
        Byte ServerType { get; }
        Byte Unused { get; }
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Terminal_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Terminal";
    ...
    #region Common
    internal partial class TerminalSetterCommon : FalloutNVMajorRecordSetterCommon
    {
        ...
        public void Clear(ITerminalInternal item)
        {
            ...
            item.BaseHackingDifficulty = default(HackingDifficulty);
            item.Flags = default(Byte);
            item.ServerType = default(Byte);
    ...
    internal partial class TerminalCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Terminal_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ITerminalGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.MenuItems.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
        ...
        public Terminal Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Terminal(formKey, default(FalloutNVRelease));
    ...
    internal partial class TerminalSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            {
                EnumBinaryTranslation<HackingDifficulty, MutagenFrame, MutagenWriter>.Instance.Write(
                    writer,
                    item.BaseHackingDifficulty,
                    length: 1);
                writer.Write(item.Flags);
                writer.Write(item.ServerType);
    ...
    internal partial class TerminalBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.DNAM:
                {
                    ...
                    item.BaseHackingDifficulty = EnumBinaryTranslation<HackingDifficulty, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: dataFrame,
                        length: 1);
                    if (dataFrame.Remaining < 1) return null;
                    item.Flags = dataFrame.ReadUInt8();
                    if (dataFrame.Remaining < 1) return null;
                    item.ServerType = dataFrame.ReadUInt8();
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ITerminalGetter
    {
        ...
        public HackingDifficulty BaseHackingDifficulty => _BaseHackingDifficulty_IsSet ? (HackingDifficulty)_recordData.Span.Slice(_BaseHackingDifficultyLocation, 0x1)[0] : default;
        #endregion
        #region Flags
        ...
        public Byte ServerType => _ServerType_IsSet ? _recordData.Span[_ServerTypeLocation] : default;
        #endregion
        #region Unused
