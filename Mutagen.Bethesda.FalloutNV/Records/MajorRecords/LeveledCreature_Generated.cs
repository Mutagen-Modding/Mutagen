...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<LeveledCreature>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectBoundsGetter? ILeveledCreatureGetter.ObjectBounds => this.ObjectBounds;
        #region Aspects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        #endregion
        #region Flags
        public LeveledCreature.Flag Flags { get; set; } = default(LeveledCreature.Flag);
        #endregion
        #region Entries
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public LeveledCreature(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public LeveledCreature(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.LVLC)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class LeveledCreature_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.LeveledCreature";
    ...
    #region Common
    internal partial class LeveledCreatureSetterCommon : FalloutNVMajorRecordSetterCommon
    {
        ...
        public void Clear(ILeveledCreatureInternal item)
        {
            ...
            item.Flags = default(LeveledCreature.Flag);
            item.Entries.Clear();
            item.Model = null;
            base.Clear(item);
        }
    ...
    internal partial class LeveledCreatureCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static LeveledCreature_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public LeveledCreature Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new LeveledCreature(formKey, default(FalloutNVRelease));
    ...
    internal partial class LeveledCreatureSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
                ...
                try
                {
                    if(rhs.ObjectBounds is {} rhsObjectBounds)
                    {
                        item.ObjectBounds = rhsObjectBounds.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)LeveledCreature_FieldIndex.ObjectBounds));
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<LeveledCreature.Flag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Flags,
                length: 1,
    ...
    internal partial class LeveledCreatureBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<LeveledCreature.Flag, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILeveledCreatureGetter
    {
        ...
        public LeveledCreature.Flag Flags => EnumBinaryTranslation<LeveledCreature.Flag, MutagenFrame, MutagenWriter>.Instance.ParseRecord(_FlagsLocation, _recordData, _package, 1);
        #endregion
