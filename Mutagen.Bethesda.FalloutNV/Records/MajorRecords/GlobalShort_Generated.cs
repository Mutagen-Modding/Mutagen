...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<GlobalShort>
    {
        ...
        public GlobalShort(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GlobalShort(IFalloutNVMod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class GlobalShort_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.GlobalShort";
    ...
    internal partial class GlobalShortCommon : GlobalCommon
    {
        ...
        public static new GlobalShort_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GlobalShort Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GlobalShort(formKey, default(FalloutNVRelease));
