...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IWorldspaceInternal
    {
        ...
        public Worldspace(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public Worldspace(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.WRLD)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Worldspace_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Worldspace";
    ...
    #region Common
    internal partial class WorldspaceSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class WorldspaceCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Worldspace_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public IEnumerable<IModContext<IFalloutNVMod, IFalloutNVModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
            ...
            Func<IFalloutNVMod, IWorldspaceGetter, string?, FormKey?, IWorldspace> duplicateInto)
        {
            var curContext = new ModContext<IFalloutNVMod, IFalloutNVModGetter, IWorldspace, IWorldspaceGetter>(
                modKey,
                record: obj,
                ...
                parent: parent);
            {
                ...
                {
                    yield return new ModContext<IFalloutNVMod, IFalloutNVModGetter, ICellInternal, ICellGetter>(
                        modKey: modKey,
            ...
            Func<IFalloutNVMod, IWorldspaceGetter, string?, FormKey?, IWorldspace> duplicateInto)
        {
            ...
            switch (type.Name)
            {
                ...
                case "IPlacedObjectInternal":
                    ...
                    yield break;
                default:
                    if (InterfaceEnumerationHelper.TryEnumerateInterfaceContextsFor<IWorldspaceGetter, IFalloutNVMod, IFalloutNVModGetter>(
        ...
        public Worldspace Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Worldspace(formKey, default(FalloutNVRelease));
    ...
    internal partial class WorldspaceSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class WorldspaceBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Parent = Mutagen.Bethesda.FalloutNV.WorldspaceParent.CreateFromBinary(
                        frame: frame,
                ...
                {
                    item.MapData = Mutagen.Bethesda.FalloutNV.WorldspaceMapData.CreateFromBinary(frame: frame);
