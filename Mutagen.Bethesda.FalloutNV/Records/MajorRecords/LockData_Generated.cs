...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<LockData>
    {
        ...
        #endregion
        #region Key
        private readonly IFormLink<IFalloutNVMajorRecordGetter> _Key = new FormLink<IFalloutNVMajorRecordGetter>();
        public IFormLink<IFalloutNVMajorRecordGetter> Key
        {
            get => _Key;
            set => _Key.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkGetter<IFalloutNVMajorRecordGetter> ILockDataGetter.Key => this.Key;
        #endregion
        #region LockFlags
        ...
        ILoquiObjectSetter<ILockData>
    {
        ...
        new IFormLink<IFalloutNVMajorRecordGetter> Key { get; set; }
        ...
        ILoquiObject<ILockDataGetter>
    {
        ...
        IFormLinkGetter<IFalloutNVMajorRecordGetter> Key { get; }
        Byte LockFlags { get; }
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class LockData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.LockData";
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class LockDataBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            item.LockFlags = frame.ReadUInt8();
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILockDataGetter
    {
        ...
        public IFormLinkGetter<IFalloutNVMajorRecordGetter> Key => FormLinkBinaryTranslation.Instance.OverlayFactory<IFalloutNVMajorRecordGetter>(_package, _structData.Span.Slice(0x4, 0x4));
        public Byte LockFlags => _structData.Span[0x8];
        public ReadOnlyMemorySlice<Byte> Unused2 => _structData.Span.Slice(0x9, 0x3).ToArray();
        #region Unknown
        public ReadOnlyMemorySlice<Byte> Unknown => _structData.Span.Slice(0xC).ToArray();
