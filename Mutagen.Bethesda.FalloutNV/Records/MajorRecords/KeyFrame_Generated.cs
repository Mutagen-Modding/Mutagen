...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class KeyFrame_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.KeyFrame";
    ...
    internal partial class KeyFrameCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IKeyFrameGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
