...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<GameSettingString>
    {
        ...
        public GameSettingString(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GameSettingString(IFalloutNVMod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class GameSettingString_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.GameSettingString";
    ...
    internal partial class GameSettingStringCommon : GameSettingCommon
    {
        ...
        public static new GameSettingString_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GameSettingString Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GameSettingString(formKey, default(FalloutNVRelease));
