...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<HeadPart>
    {
        ...
        public HeadPart(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public HeadPart(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.HDPT)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class HeadPart_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.HeadPart";
    ...
    #region Common
    internal partial class HeadPartSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class HeadPartCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static HeadPart_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public HeadPart Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new HeadPart(formKey, default(FalloutNVRelease));
    ...
    internal partial class HeadPartSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class HeadPartBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
