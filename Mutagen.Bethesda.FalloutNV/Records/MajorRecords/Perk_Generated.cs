...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IPerkInternal
    {
        ...
        public Perk(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.PERK)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class Perk_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.Perk";
    ...
    #region Common
    internal partial class PerkSetterCommon : FalloutNVMajorRecordSetterCommon
    {
    ...
    internal partial class PerkCommon : FalloutNVMajorRecordCommon
    {
        ...
        public static Perk_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Perk_FieldIndex.MinLevel) ?? true))
            {
        ...
        public Perk Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Perk(formKey, default(FalloutNVRelease));
    ...
    internal partial class PerkSetterTranslationCommon : FalloutNVMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Perk_FieldIndex.MinLevel) ?? true))
            {
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class PerkBinaryCreateTranslation : FalloutNVMajorRecordBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        IPerkGetter
    {
        ...
        #endregion
        #region MinLevel
        private int _MinLevelLocation => _DATALocation!.Value.Min + 0x1;
