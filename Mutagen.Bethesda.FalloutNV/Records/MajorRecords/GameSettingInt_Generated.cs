...
namespace Mutagen.Bethesda.FalloutNV
{
        ...
        ILoquiObjectSetter<GameSettingInt>
    {
        ...
        public GameSettingInt(IFalloutNVMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GameSettingInt(IFalloutNVMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.FalloutNV.Internals.RecordTypeInts.GMST)]
...
namespace Mutagen.Bethesda.FalloutNV
{
    ...
    internal partial class GameSettingInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.FalloutNV.GameSettingInt";
    ...
    internal partial class GameSettingIntCommon : GameSettingCommon
    {
        ...
        public static GameSettingInt_FieldIndex ConvertFieldIndex(GameSetting_FieldIndex index)
        {
            switch (index)
            {
                ...
                case GameSetting_FieldIndex.Version2:
                    return (GameSettingInt_FieldIndex)((int)index);
                case GameSetting_FieldIndex.FalloutNVMajorRecordFlags:
                    return (GameSettingInt_FieldIndex)((int)index);
                default:
        ...
        public static new GameSettingInt_FieldIndex ConvertFieldIndex(FalloutNVMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public GameSettingInt Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new GameSettingInt(formKey, default(FalloutNVRelease));
