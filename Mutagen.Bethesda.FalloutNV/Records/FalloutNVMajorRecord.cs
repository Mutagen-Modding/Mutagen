...
{
    [Flags]
    public enum FalloutNVMajorRecordFlag
    {
    ...
    public FalloutNVMajorRecordFlag FalloutNVMajorRecordFlags
    {
        get => (FalloutNVMajorRecordFlag)this.MajorRecordFlagsRaw;
...
internal partial class FalloutNVMajorRecordBinaryOverlay
{
    protected override ushort? FormVersionAbstract => null;

    public FalloutNVMajorRecord.FalloutNVMajorRecordFlag FalloutNVMajorRecordFlags
    {
        get => (FalloutNVMajorRecord.FalloutNVMajorRecordFlag)this.MajorRecordFlagsRaw;
    }
}