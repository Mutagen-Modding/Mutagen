...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class Fallout4ModCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IFallout4ModGetter obj)
        {
            ...
            foreach (var item in obj.Classes.ContainedFormLinks)
            {
                yield return item;
            }
            ...
            foreach (var item in obj.StaticCollections.ContainedFormLinks)
            {
                yield return item;
            }
            ...
            ILinkCache linkCache)
        {
            ...
            foreach (var item in InterfaceEnumerationHelper.EnumerateGroupContexts<IFallout4Mod, IFallout4ModGetter, MoveableStatic, IMoveableStaticGetter>(
