...
namespace Mutagen.Bethesda.Fallout4
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, ActionRecord, Activator, ActorValueInformation, AimModel, Ammunition, AnimationSoundTagSet, Armor, ArmorAddon, ArtObject, AttractionRule, BodyPartData, Book, Cell, Class, CollisionLayer, ColorRecord, Component, ConstructibleObject, Container, ADamageType, Debris, Door, DualCastData, EffectShader, EquipType, Explosion, Faction, Flora, Footstep, FootstepSet, FormList, Furniture, GameSetting, Global, GodRays, Grass, Hazard, HeadPart, Holotape, IdleAnimation, IdleMarker, ImageSpaceAdapter, ImpactDataSet, Ingestible, Ingredient, InstanceNamingRule, Key, Keyword, LandscapeTexture, LensFlare, LeveledItem, LeveledNpc, LeveledSpell, Light, LocationReferenceType, MagicEffect, MaterialObject, MaterialSwap, MaterialType, Message, MiscItem, MovableStatic, MovementType, MusicTrack, MusicType, ANavigationMesh, Npc, ObjectEffect, ObjectModification, Outfit, Perk, PlacedNpc, PlacedObject, APlacedTrap, Projectile, Quest, Race, Region, ReverbParameters, SoundDescriptor, SoundMarker, SoundOutputModel, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, Transform, Tree, VisualEffect, VoiceType, Water, Weapon, Weather, Worldspace, Zoom]
    /// </summary>
