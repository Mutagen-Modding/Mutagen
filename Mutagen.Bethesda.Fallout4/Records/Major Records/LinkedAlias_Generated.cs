...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<LinkedAlias>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((LinkedAliasCommon)((ILinkedAliasGetter)this).CommonInstance()!).Equals(this, rhs, crystal: null);
        }

        public bool Equals(ILinkedAliasGetter? obj)
        {
            return ((LinkedAliasCommon)((ILinkedAliasGetter)this).CommonInstance()!).Equals(this, obj, crystal: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class LinkedAliasCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)LinkedAlias_FieldIndex.Keyword) ?? true))
            {
                if (!lhs.Keyword.Equals(rhs.Keyword)) return false;
            }
            if ((crystal?.GetShouldTranslate((int)LinkedAlias_FieldIndex.AliasID) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILinkedAliasGetter
    {
        ...
        public IFormLinkGetter<IKeywordGetter> Keyword => new FormLink<IKeywordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
        public Int32 AliasID => BinaryPrimitives.ReadInt32LittleEndian(_data.Slice(0x4, 0x4));
        ...
        public static LinkedAliasBinaryOverlay LinkedAliasFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
