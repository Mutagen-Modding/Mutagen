...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IRaceWeight
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((RaceWeightCommon)((IRaceWeightGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IRaceWeightGetter? obj)
        {
            return ((RaceWeightCommon)((IRaceWeightGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(RaceWeight.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, RaceWeight.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(RaceWeight.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class RaceWeightMixIn
    {
        ...
        {
            return ((RaceWeightCommon)((IRaceWeightGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            RaceWeight.Mask<bool>? printMask = null)
        {
            ((RaceWeightCommon)((IRaceWeightGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class RaceWeightCommon
    {
            ...
            RaceWeight.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"RaceWeight =>");
            }
            else
            {
                sb.AppendLine($"{name} (RaceWeight) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)RaceWeight_FieldIndex.Thin) ?? true))
            {
                if (!lhs.Thin.EqualsWithin(rhs.Thin)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)RaceWeight_FieldIndex.Muscular) ?? true))
            {
                if (!lhs.Muscular.EqualsWithin(rhs.Muscular)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)RaceWeight_FieldIndex.Fat) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRaceWeightGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public static readonly RaceWeightBinaryWriteTranslation Instance = new();
