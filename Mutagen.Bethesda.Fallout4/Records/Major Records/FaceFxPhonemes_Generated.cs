            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Unknowns != null)
                {
                    ...
                    if (Unknowns.Specific != null)
                    {
                        ...
                        foreach (var item in Unknowns.Specific)
                        {
                            MaskItemIndexed<R, Phoneme.Mask<R>?>? mask = item == null ? null : new MaskItemIndexed<R, Phoneme.Mask<R>?>(item.Index, eval(item.Overall), item.Specific?.Translate(eval));
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class FaceFxPhonemes_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.FaceFxPhonemes";
    ...
    internal partial class FaceFxPhonemesCommon
    {
        ...
        public virtual int GetHashCode(IFaceFxPhonemesGetter item)
        {
            ...
            if (item.Aah_LipBigAah is {} Aah_LipBigAahitem)
            {
                hash.Add(Aah_LipBigAahitem);
            }
            if (item.BigAah_LipDST is {} BigAah_LipDSTitem)
            {
                hash.Add(BigAah_LipDSTitem);
            }
            if (item.BMP_LipEee is {} BMP_LipEeeitem)
            {
                hash.Add(BMP_LipEeeitem);
            }
            if (item.ChJSh_LipFV is {} ChJSh_LipFVitem)
            {
                hash.Add(ChJSh_LipFVitem);
            }
            if (item.DST_LipK is {} DST_LipKitem)
            {
                hash.Add(DST_LipKitem);
            }
            if (item.Eee_LipL is {} Eee_LipLitem)
            {
                hash.Add(Eee_LipLitem);
            }
            if (item.Eh_LipR is {} Eh_LipRitem)
            {
                hash.Add(Eh_LipRitem);
            }
            if (item.FV_LipTh is {} FV_LipThitem)
            {
            ...
            if (item.Oh is {} Ohitem)
            {
                hash.Add(Ohitem);
            }
            if (item.OohQ is {} OohQitem)
            {
                hash.Add(OohQitem);
            }
            if (item.R is {} Ritem)
    ...
    internal partial class FaceFxPhonemesSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.Aah_LipBigAah) ?? true))
            {
                ...
                try
                {
                    if(rhs.Aah_LipBigAah is {} rhsAah_LipBigAah)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.BigAah_LipDST) ?? true))
            {
                ...
                try
                {
                    if(rhs.BigAah_LipDST is {} rhsBigAah_LipDST)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.BMP_LipEee) ?? true))
            {
                ...
                try
                {
                    if(rhs.BMP_LipEee is {} rhsBMP_LipEee)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.ChJSh_LipFV) ?? true))
            {
                ...
                try
                {
                    if(rhs.ChJSh_LipFV is {} rhsChJSh_LipFV)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.DST_LipK) ?? true))
            {
                ...
                try
                {
                    if(rhs.DST_LipK is {} rhsDST_LipK)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.Eee_LipL) ?? true))
            {
                ...
                try
                {
                    if(rhs.Eee_LipL is {} rhsEee_LipL)
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)FaceFxPhonemes_FieldIndex.FV_LipTh) ?? true))
            {
                ...
                try
                {
                    if(rhs.FV_LipTh is {} rhsFV_LipTh)
                    {
