...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMiscItemInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ITranslatedStringGetter? IMiscItemGetter.InventoryImage => this.InventoryImage;
        #endregion
        #region MessageIcon
        public TranslatedString? MessageIcon { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ITranslatedStringGetter? IMiscItemGetter.MessageIcon => this.MessageIcon;
        #endregion
        #region Destructible
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            public void ToString(FileGeneration fg, MiscItem.Mask<bool>? printMask = null)
            {
                ...
                using (new DepthWrapper(fg))
                {
                        ...
                        && Components is {} ComponentsItem)
                    {
                        ...
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(ComponentsItem.Overall);
                        ...
                        && ComponentDisplayIndices is {} ComponentDisplayIndicesItem)
                    {
                        ...
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(ComponentDisplayIndicesItem.Overall);
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case MiscItem_FieldIndex.Model:
                        return Model;
                    case MiscItem_FieldIndex.InventoryImage:
                        return InventoryImage;
                    case MiscItem_FieldIndex.MessageIcon:
                        return MessageIcon;
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    #region Common
    public partial class MiscItemSetterCommon : Fallout4MajorRecordSetterCommon
    {
    ...
    public partial class MiscItemCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.PreviewTransform) ?? true))
            {
            ...
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.InventoryImage) ?? true))
            {
                if (!object.Equals(lhs.InventoryImage, rhs.InventoryImage)) return false;
            }
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.MessageIcon) ?? true))
            {
            ...
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.FeaturedItemMessage) ?? true))
            {
            ...
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.Components) ?? true))
            {
                if (!lhs.Components.SequenceEqualNullable(rhs.Components)) return false;
            }
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.ComponentDisplayIndices) ?? true))
            {
    ...
    public partial class MiscItemSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)MiscItem_FieldIndex.InventoryImage) ?? true))
            {
                item.InventoryImage = rhs.InventoryImage?.DeepCopy();
            }
            if ((copyMask?.GetShouldTranslate((int)MiscItem_FieldIndex.MessageIcon) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MiscItemBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ICON:
                {
                    ...
                    item.InventoryImage = StringBinaryTranslation.Instance.Parse(
                        ...
                        source: StringsSource.DL,
                        stringBinaryType: StringBinaryType.NullTerminate);
                    return (int)MiscItem_FieldIndex.InventoryImage;
                }
                case RecordTypeInts.MICO:
                {
                    ...
                    item.MessageIcon = StringBinaryTranslation.Instance.Parse(
                        ...
                        source: StringsSource.DL,
                        stringBinaryType: StringBinaryType.NullTerminate);
                    return (int)MiscItem_FieldIndex.MessageIcon;
                }
