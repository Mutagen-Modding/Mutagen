...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMorphPreset
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((MorphPresetCommon)((IMorphPresetGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IMorphPresetGetter? obj)
        {
            return ((MorphPresetCommon)((IMorphPresetGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(MorphPreset.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, MorphPreset.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(MorphPreset.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    ...
                    {
                        sb.AppendItem(UnknownMPPM, "UnknownMPPM");
                    }
                    ...
                    {
                        sb.AppendItem(UnknownMPPF, "UnknownMPPF");
                    }
                }
            }
            #endregion
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => MorphPresetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class MorphPresetMixIn
    {
        ...
        {
            return ((MorphPresetCommon)((IMorphPresetGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            MorphPreset.Mask<bool>? printMask = null)
        {
            ((MorphPresetCommon)((IMorphPresetGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class MorphPresetCommon
    {
            ...
            MorphPreset.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"MorphPreset =>");
            }
            else
            {
                sb.AppendLine($"{name} (MorphPreset) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            MorphPreset.Mask<bool>? printMask = null)
        {
            ...
            {
                sb.AppendItem(UnknownMPPMItem, "UnknownMPPM");
            }
            if (printMask?.Texture ?? true)
            {
            ...
            {
                sb.AppendLine($"UnknownMPPF => {SpanExt.ToHexString(UnknownMPPFItem)}");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MorphPreset_FieldIndex.Index) ?? true))
            {
                if (lhs.Index != rhs.Index) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MorphPreset_FieldIndex.Name) ?? true))
            {
                if (!object.Equals(lhs.Name, rhs.Name)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MorphPreset_FieldIndex.UnknownMPPM) ?? true))
            {
                if (!string.Equals(lhs.UnknownMPPM, rhs.UnknownMPPM)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MorphPreset_FieldIndex.Texture) ?? true))
            {
                if (!lhs.Texture.Equals(rhs.Texture)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MorphPreset_FieldIndex.UnknownMPPF) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMorphPresetGetter obj, bool iterateNestedRecords = true)
        {
