...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedBeamInternal
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(StructuredStringBuilder sb, PlacedBeam.Mask<bool>? printMask = null)
            {
        ...
        public PlacedBeam(IFallout4Mod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public PlacedBeam(IFallout4Mod mod, string editorID)
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout4.Internals.RecordTypeInts.PBEA)]
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class PlacedBeam_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "80294c3f-3681-45f5-9ae6-e6af2a05e949";
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.PlacedBeam";
    ...
    internal partial class PlacedBeamCommon : APlacedTrapCommon
    {
        ...
        public static new PlacedBeam_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public PlacedBeam Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new PlacedBeam(formKey);
