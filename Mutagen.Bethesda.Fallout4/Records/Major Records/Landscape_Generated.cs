...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class Landscape_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "94773e0a-2752-4998-8ef2-03e0095cc966";
    ...
    internal partial class LandscapeCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)Landscape_FieldIndex.MPCDs) ?? true))
            {
                if (!lhs.MPCDs.SequenceEqual(rhs.MPCDs, (l, r) => ((LandscapeMPCDCommon)((ILandscapeMPCDGetter)l).CommonInstance()!).Equals(l, r, crystal?.GetSubCrystal((int)Landscape_FieldIndex.MPCDs)))) return false;
            }
            return true;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILandscapeGetter
    {
        ...
        public IReadOnlyList<ILandscapeMPCDGetter> MPCDs { get; private set; } = ListExt.Empty<LandscapeMPCDBinaryOverlay>();
