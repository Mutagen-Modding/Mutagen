    ...
    internal partial class PlacedObjectMapMarkerBinaryCreateTranslation
    {
            ...
            TypedParseParams? translationParams = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.ParsedIndex.HasValue && lastParsed.ParsedIndex.Value >= (int)PlacedObjectMapMarker_FieldIndex.Flags) return ParseResult.Stop;
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedObjectMapMarkerGetter
    {
        ...
        public static PlacedObjectMapMarkerBinaryOverlay PlacedObjectMapMarkerFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
