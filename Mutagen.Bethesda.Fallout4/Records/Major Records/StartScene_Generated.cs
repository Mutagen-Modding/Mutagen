...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class StartScene_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "465c7b5a-deba-4c38-9a89-a25bc7e611a4";
    ...
    internal partial class StartSceneSetterCommon
    {
            ...
            TypedParseParams? translationParams = null)
        {
            PluginUtilityTranslation.SubrecordParse(
                ...
                frame: frame,
                translationParams: translationParams,
                fillStructs: StartSceneBinaryCreateTranslation.FillBinaryStructs,
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public readonly static StartSceneBinaryWriteTranslation Instance = new StartSceneBinaryWriteTranslation();
    ...
    {
        public readonly static StartSceneBinaryCreateTranslation Instance = new StartSceneBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IStartSceneGetter
    {
        ...
        public IFormLinkNullableGetter<ISceneGetter> Scene => _SceneLocation.HasValue ? new FormLinkNullable<ISceneGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _SceneLocation.Value, _package.MetaData.Constants)))) : FormLinkNullable<ISceneGetter>.Null;
        #endregion
        #region PhaseIndex
        private int? _PhaseIndexLocation;
        public UInt16? PhaseIndex => _PhaseIndexLocation.HasValue ? BinaryPrimitives.ReadUInt16LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _PhaseIndexLocation.Value, _package.MetaData.Constants)) : default(UInt16?);
        #endregion
        #region StartPhaseForScene
        private int? _StartPhaseForSceneLocation;
        public String? StartPhaseForScene => _StartPhaseForSceneLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _StartPhaseForSceneLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        #endregion
