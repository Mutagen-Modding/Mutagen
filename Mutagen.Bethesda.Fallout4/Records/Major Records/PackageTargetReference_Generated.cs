...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPackageTargetReferenceGetter
    {
        ...
        public IFormLinkGetter<IFallout4MajorRecordGetter> Reference => new FormLink<IFallout4MajorRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0xC, 0x4))));
