...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class PackageTargetReference_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "4ccb42e2-8ad5-4f3b-85aa-9eb250474667";
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPackageTargetReferenceGetter
    {
        ...
        public IFormLinkGetter<IFallout4MajorRecordGetter> Reference => new FormLink<IFallout4MajorRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0xC, 0x4))));
