...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class NavigationMapInfo_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.NavigationMapInfo";
    ...
    internal partial class NavigationMapInfoCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)NavigationMapInfo_FieldIndex.Parent) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Parent, rhs.Parent, out var lhsParent, out var rhsParent, out var isParentEqual))
                {
                    if (!((ANavigationMapInfoParentCommon)((IANavigationMapInfoParentGetter)lhsParent).CommonInstance()!).Equals(lhsParent, rhsParent, crystal?.GetSubCrystal((int)NavigationMapInfo_FieldIndex.Parent))) return false;
                }
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class NavigationMapInfoBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            MutagenWriter writer)
        {
            ...
            NavigationMapInfoBinaryWriteTranslation.WriteBinaryParent(
                writer: writer,
                item: item);
        }
    ...
    internal partial class NavigationMapInfoBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            NavigationMapInfoBinaryCreateTranslation.FillBinaryParentCustom(
                frame: frame,
                item: item);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INavigationMapInfoGetter
    {
        ...
        public IANavigationMapInfoParentGetter Parent => GetParentCustom(location: IslandEndingPos + 0x4);
        protected int ParentEndingPos;
        partial void CustomParentEndPos();
        #endregion
