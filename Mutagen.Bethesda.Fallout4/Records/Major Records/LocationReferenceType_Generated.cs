...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class LocationReferenceTypeCommon : Fallout4MajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(ILocationReferenceTypeGetter obj)
        {
    ...
    public partial class LocationReferenceTypeBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.TNAM = Mutagen.Bethesda.Records.Binary.Translations.StringBinaryTranslation.Instance.Parse(
