...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ITintTemplateOption
    {
        ...
        public void ToString(
            ...
            string? name = null)
        {
            TintTemplateOptionMixIn.ToString(
                item: this,
                name: name);
        }
            ...
            IMask<TItem>
        {
            ...
            public string ToString(TintTemplateOption.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, TintTemplateOption.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(TintTemplateOption.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendLine("TemplateColors =>");
                        fg.AppendLine("[");
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(TemplateColorsItem.Overall);
        ...
        #region Mutagen
        public static readonly RecordType GrupRecordType = TintTemplateOption_Registration.TriggeringRecordType;
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => TintTemplateOptionCommon.Instance.GetContainedFormLinks(this);
    ...
    public static partial class TintTemplateOptionMixIn
    {
        ...
        {
            return ((TintTemplateOptionCommon)((ITintTemplateOptionGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            TintTemplateOption.Mask<bool>? printMask = null)
        {
            ((TintTemplateOptionCommon)((ITintTemplateOptionGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class TintTemplateOptionCommon
    {
            ...
            TintTemplateOption.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"TintTemplateOption =>");
            }
            else
            {
                fg.AppendLine($"{name} (TintTemplateOption) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            TintTemplateOption.Mask<bool>? printMask = null)
        {
            ...
            {
                fg.AppendItem(BlendOperationItem, "BlendOperation");
            }
            if ((printMask?.TemplateColors?.Overall ?? true)
            ...
            {
                fg.AppendItem(DefaultItem, "Default");
            }
            if (printMask?.TETIDataTypeState ?? true)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(ITintTemplateOptionGetter obj)
        {
            ...
            {
                foreach (var item in TemplateColorsItem.SelectMany(f => f.ContainedFormLinks))
                {
                    yield return FormLinkInformation.Factory(item);
                }
            }
