...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IRuleName
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(RuleName.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, RuleName.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(RuleName.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    ...
                    {
                        sb.AppendItem(PropertyEnum, "PropertyEnum");
                    }
                    if (printMask?.OpEnum ?? true)
                    {
                        sb.AppendItem(OpEnum, "OpEnum");
                    }
                    ...
                    {
                        sb.AppendItem(XNAMDataTypeState, "XNAMDataTypeState");
                    }
                }
            }
            #endregion
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks() => RuleNameCommon.Instance.EnumerateFormLinks(this);
    ...
    public static partial class RuleNameMixIn
    {
        ...
        {
            return ((RuleNameCommon)((IRuleNameGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            RuleName.Mask<bool>? printMask = null)
        {
            ((RuleNameCommon)((IRuleNameGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class RuleNameCommon
    {
            ...
            RuleName.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.PropertyEnum ?? true)
            {
                sb.AppendItem(item.PropertyEnum, "PropertyEnum");
            }
            if (printMask?.OpEnum ?? true)
            {
                sb.AppendItem(item.OpEnum, "OpEnum");
            }
            if ((printMask?.Index ?? true)
            ...
            if (printMask?.XNAMDataTypeState ?? true)
            {
                sb.AppendItem(item.XNAMDataTypeState, "XNAMDataTypeState");
            }
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRuleNameGetter obj)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IRuleNameGetter
    {
        ...
        public static IRuleNameGetter RuleNameFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
