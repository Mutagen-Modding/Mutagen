...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMovementRotationData
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((MovementRotationDataCommon)((IMovementRotationDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IMovementRotationDataGetter? obj)
        {
            return ((MovementRotationDataCommon)((IMovementRotationDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class MovementRotationDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MovementRotationData_FieldIndex.Unused1) ?? true))
            {
                if (lhs.Unused1 != rhs.Unused1) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MovementRotationData_FieldIndex.Walk) ?? true))
            {
                if (!lhs.Walk.EqualsWithin(rhs.Walk)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MovementRotationData_FieldIndex.Run) ?? true))
            {
                if (!lhs.Run.EqualsWithin(rhs.Run)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MovementRotationData_FieldIndex.Unused2) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMovementRotationDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public static readonly MovementRotationDataBinaryWriteTranslation Instance = new();
