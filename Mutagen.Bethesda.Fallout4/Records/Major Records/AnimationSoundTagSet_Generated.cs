...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<AnimationSoundTagSet>
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => AnimationSoundTagSetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class AnimationSoundTagSetCommon : Fallout4MajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAnimationSoundTagSetGetter obj, bool iterateNestedRecords = true)
        {
            foreach (var item in base.EnumerateFormLinks(obj, iterateNestedRecords))
            {
                yield return item;
            }
            foreach (var item in obj.Tags.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
        ...
        public AnimationSoundTagSet Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new AnimationSoundTagSet(formKey, item.FormVersion);
