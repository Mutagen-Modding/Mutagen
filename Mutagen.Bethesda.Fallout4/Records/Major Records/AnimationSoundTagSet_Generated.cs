...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<AnimationSoundTagSet>
    {
        ...
        public override void ToString(
            ...
            string? name = null)
        {
            AnimationSoundTagSetMixIn.ToString(
                item: this,
                name: name);
        }
        ...
        {
            if (!(obj is IAnimationSoundTagSetGetter rhs)) return false;
            return ((AnimationSoundTagSetCommon)((IAnimationSoundTagSetGetter)this).CommonInstance()!).Equals(this, rhs);
        }

        public bool Equals(IAnimationSoundTagSetGetter? obj)
        {
            return ((AnimationSoundTagSetCommon)((IAnimationSoundTagSetGetter)this).CommonInstance()!).Equals(this, obj);
        }
            ...
            IMask<TItem>
        {
            ...
            public string ToString(AnimationSoundTagSet.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, AnimationSoundTagSet.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(AnimationSoundTagSet.Mask<TItem>)} =>");
                fg.AppendLine("[");
    ...
    public static partial class AnimationSoundTagSetMixIn
    {
        ...
        {
            return ((AnimationSoundTagSetCommon)((IAnimationSoundTagSetGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            AnimationSoundTagSet.Mask<bool>? printMask = null)
        {
            ((AnimationSoundTagSetCommon)((IAnimationSoundTagSetGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class AnimationSoundTagSetSetterCommon : Fallout4MajorRecordSetterCommon
    {
        ...
        public virtual void CopyInFromBinary(
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            UtilityTranslation.MajorRecordParse<IAnimationSoundTagSetInternal>(
                record: item,
                frame: frame,
                recordTypeConverter: recordTypeConverter,
    ...
    public partial class AnimationSoundTagSetCommon : Fallout4MajorRecordCommon
    {
            ...
            AnimationSoundTagSet.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"AnimationSoundTagSet =>");
            }
            else
            {
                fg.AppendLine($"{name} (AnimationSoundTagSet) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class AnimationSoundTagSet
    {
        ...
        public new static AnimationSoundTagSet_Registration Registration => AnimationSoundTagSet_Registration.Instance;
        [DebuggerStepThrough]
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(RecordTypes.STAG),
