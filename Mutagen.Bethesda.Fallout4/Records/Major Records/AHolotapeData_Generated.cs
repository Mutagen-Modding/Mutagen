...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<AHolotapeData>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((AHolotapeDataCommon)((IAHolotapeDataGetter)this).CommonInstance()!).Equals(this, rhs, crystal: null);
        }

        public bool Equals(IAHolotapeDataGetter? obj)
        {
            return ((AHolotapeDataCommon)((IAHolotapeDataGetter)this).CommonInstance()!).Equals(this, obj, crystal: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, AHolotapeData.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(AHolotapeData.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        #region Mutagen
        public virtual IEnumerable<IFormLinkGetter> ContainedFormLinks => AHolotapeDataCommon.Instance.GetContainedFormLinks(this);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class AHolotapeDataCommon
    {
            ...
            AHolotapeData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"AHolotapeData =>");
            }
            else
            {
                fg.AppendLine($"{name} (AHolotapeData) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IAHolotapeDataGetter obj)
        {
            yield break;
        }
