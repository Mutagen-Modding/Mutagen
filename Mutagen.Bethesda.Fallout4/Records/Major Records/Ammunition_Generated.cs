            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, Ammunition.Mask<bool>? printMask = null)
            {
                ...
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendItem(CasingModel, "CasingModel");
                    }
                    if (printMask?.ModelInfo ?? true)
                    {
                        fg.AppendItem(ModelInfo, "ModelInfo");
                    }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class Ammunition_Registration : ILoquiRegistration
    {
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.AMMO);
        });
    ...
    public partial class AmmunitionCommon : Fallout4MajorRecordCommon
    {
            ...
            Ammunition.Mask<bool>? printMask = null)
        {
            ...
            {
                fg.AppendItem(CasingModelItem, "CasingModel");
            }
            if ((printMask?.ModelInfo ?? true)
                && item.ModelInfo is {} ModelInfoItem)
            {
                fg.AppendLine($"ModelInfo => {SpanExt.ToHexString(ModelInfoItem)}");
            }
            if (printMask?.DATADataTypeState ?? true)
            {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IAmmunitionGetter
    {
        ...
        public String? CasingModel => _CasingModelLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _CasingModelLocation.Value, _package.MetaData.Constants), encoding: _package.MetaData.Encodings.NonTranslated) : default(string?);
        #endregion
        #region ModelInfo
        private int? _ModelInfoLocation;
        public ReadOnlyMemorySlice<Byte>? ModelInfo => _ModelInfoLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_data, _ModelInfoLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
        #endregion
