...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class DamageTypeIndexedSetterCommon : ADamageTypeSetterCommon
    {
        ...
        public virtual void CopyInFromBinary(
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            UtilityTranslation.MajorRecordParse<IDamageTypeIndexedInternal>(
                record: item,
                frame: frame,
                recordTypeConverter: recordTypeConverter,
    ...
    public partial class DamageTypeIndexedCommon : ADamageTypeCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IDamageTypeIndexedGetter obj)
        {
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            MajorRecordBinaryWriteTranslation.WriteRecordTypes(
                ...
                writer: writer,
                recordTypeConverter: recordTypeConverter);
            Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<UInt32>.Instance.Write(
                writer: writer,
