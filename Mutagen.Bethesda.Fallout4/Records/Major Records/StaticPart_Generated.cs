...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IStaticPart
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(StaticPart.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, StaticPart.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(StaticPart.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    if (printMask?.Static ?? true)
                    {
                        fg.AppendItem(Static, "Static");
                    }
                    if ((printMask?.Placements?.Overall ?? true)
                        && Placements is {} PlacementsItem)
                    {
                        fg.AppendLine("Placements =>");
                        fg.AppendLine("[");
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(PlacementsItem.Overall);
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => StaticPartCommon.Instance.GetContainedFormLinks(this);
    ...
    public static partial class StaticPartMixIn
    {
        ...
        {
            return ((StaticPartCommon)((IStaticPartGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            StaticPart.Mask<bool>? printMask = null)
        {
            ((StaticPartCommon)((IStaticPartGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
{
    #region Field Index
    public enum StaticPart_FieldIndex
    {
        Static = 0,
        Placements = 1,
    }
    ...
    #region Registration
    public partial class StaticPart_Registration : ILoquiRegistration
    {
    ...
    #region Common
    public partial class StaticPartSetterCommon
    {
    ...
    public partial class StaticPartCommon
    {
            ...
            StaticPart.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"StaticPart =>");
            }
            else
            {
                fg.AppendLine($"{name} (StaticPart) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            StaticPart.Mask<bool>? printMask = null)
        {
            if (printMask?.Static ?? true)
            {
                fg.AppendItem(item.Static.FormKeyNullable, "Static");
            }
            if ((printMask?.Placements?.Overall ?? true)
            ...
            TranslationCrystal? crystal)
        {
            ...
            {
                if (!lhs.Placements.SequenceEqualNullable(rhs.Placements)) return false;
            }
            return true;
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IStaticPartGetter obj)
        {
    ...
    public partial class StaticPartSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class StaticPart
    {
        ...
        public static StaticPart_Registration StaticRegistration => StaticPart_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    {
        public readonly static StaticPartBinaryWriteTranslation Instance = new StaticPartBinaryWriteTranslation();
    ...
    public partial class StaticPartBinaryCreateTranslation
    {
        public readonly static StaticPartBinaryCreateTranslation Instance = new StaticPartBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    public partial class StaticPartBinaryOverlay :
        PluginBinaryOverlay,
        IStaticPartGetter
    {
        #region Common Routing
        ...
        public static StaticPartBinaryOverlay StaticPartFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
