...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<FindMatchingRefFromEvent>
    {
        ...
        #endregion
        #region EventData
        public GetEventData.EventMember? EventData { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        GetEventData.EventMember? IFindMatchingRefFromEventGetter.EventData => this.EventData;
        #endregion
        ...
        ILoquiObjectSetter<IFindMatchingRefFromEvent>
    {
        ...
        new GetEventData.EventMember? EventData { get; set; }
    }
        ...
        ILoquiObject<IFindMatchingRefFromEventGetter>
    {
        ...
        GetEventData.EventMember? EventData { get; }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class FindMatchingRefFromEvent_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.FindMatchingRefFromEvent";
    ...
    internal partial class FindMatchingRefFromEventCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IFindMatchingRefFromEventGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class FindMatchingRefFromEventBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<GetEventData.EventMember, MutagenFrame, MutagenWriter>.Instance.WriteNullable(
                writer,
                item.EventData,
                length: 4,
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ALFD:
                {
                    ...
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.EventData = EnumBinaryTranslation<GetEventData.EventMember, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IFindMatchingRefFromEventGetter
    {
        ...
        public GetEventData.EventMember? EventData => EnumBinaryTranslation<GetEventData.EventMember, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(_EventDataLocation, _recordData, _package, 4);
        #endregion
