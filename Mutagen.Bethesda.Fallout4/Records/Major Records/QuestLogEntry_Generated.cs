...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class QuestLogEntry_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "427802a1-7951-4acf-a117-a7ae92c3d960";
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.QuestLogEntry";
    ...
    internal partial class QuestLogEntryCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.Note) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IQuestLogEntryGetter
    {
        ...
        public ITranslatedStringGetter? Entry => _EntryLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_recordData, _EntryLocation.Value, _package.MetaData.Constants), StringsSource.Normal, parsingBundle: _package.MetaData) : default(TranslatedString?);
        #endregion
        #region NextQuest
