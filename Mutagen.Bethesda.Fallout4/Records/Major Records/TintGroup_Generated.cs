...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ITintGroup
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(TintGroup.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, TintGroup.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(TintGroup.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendLine("Options =>");
                        fg.AppendLine("[");
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(OptionsItem.Overall);
                    ...
                    {
                        fg.AppendItem(CategoryIndex, "CategoryIndex");
                    }
                }
                fg.AppendLine("]");
            }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => TintGroupCommon.Instance.GetContainedFormLinks(this);
    ...
    public static partial class TintGroupMixIn
    {
        ...
        {
            return ((TintGroupCommon)((ITintGroupGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            TintGroup.Mask<bool>? printMask = null)
        {
            ((TintGroupCommon)((ITintGroupGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class TintGroupCommon
    {
            ...
            TintGroup.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"TintGroup =>");
            }
            else
            {
                fg.AppendLine($"{name} (TintGroup) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            TintGroup.Mask<bool>? printMask = null)
        {
            ...
            {
                fg.AppendItem(CategoryIndexItem, "CategoryIndex");
            }
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(ITintGroupGetter obj)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ITintGroupGetter
    {
        ...
        #endregion
        #endregion
        public IReadOnlyList<ITintTemplateOptionGetter> Options { get; private set; } = ListExt.Empty<TintTemplateOptionBinaryOverlay>();
        #region CategoryIndex
