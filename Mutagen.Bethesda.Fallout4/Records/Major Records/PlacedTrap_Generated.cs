...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IPlacedTrapInternal
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(StructuredStringBuilder sb, PlacedTrap.Mask<bool>? printMask = null)
            {
        ...
        public PlacedTrap(IFallout4Mod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public PlacedTrap(IFallout4Mod mod, string editorID)
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout4.Internals.RecordTypeInts.PGRE)]
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class PlacedTrap_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "43bb50c7-7a42-495c-a2e9-e32e1e57538e";
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.PlacedTrap";
    ...
    internal partial class PlacedTrapCommon : APlacedTrapCommon
    {
        ...
        public static new PlacedTrap_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public PlacedTrap Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new PlacedTrap(formKey);
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams? translationParams = null)
        {
            using (HeaderExport.Record(
                writer: writer,
                record: translationParams.ConvertToCustom(RecordTypes.PGRE)))
            {
                try
                {
                    WriteEmbedded(
