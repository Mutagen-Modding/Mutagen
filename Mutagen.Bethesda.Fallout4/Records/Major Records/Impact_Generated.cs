...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout4.Internals.RecordTypeInts.IPCT)]
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class Impact_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.Impact";
    ...
    #region Common
    internal partial class ImpactSetterCommon : Fallout4MajorRecordSetterCommon
    {
    ...
    internal partial class ImpactCommon : Fallout4MajorRecordCommon
    {
        ...
        public static Impact_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)Impact_FieldIndex.FootstepExplosion) ?? true))
            {
            ...
            if ((crystal?.GetShouldTranslate((int)Impact_FieldIndex.FootstepParticleMaxDist) ?? true))
            {
    ...
    internal partial class ImpactSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class ImpactBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IImpactGetter
    {
        ...
        public Single? FootstepParticleMaxDist => _FootstepParticleMaxDistLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_data, _FootstepParticleMaxDistLocation.Value, _package.MetaData.Constants).Float() : default(Single?);
        #endregion
