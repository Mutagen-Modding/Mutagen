...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<BookTeachesNothing>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((BookTeachesNothingCommon)((IBookTeachesNothingGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IBookTeachesNothingGetter? obj)
        {
            return ((BookTeachesNothingCommon)((IBookTeachesNothingGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class BookTeachesNothingCommon : BookTeachTargetCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)BookTeachesNothing_FieldIndex.RawContent) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IBookTeachesNothingGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IBookTeachesNothingGetter
    {
        ...
        public UInt32 RawContent => BinaryPrimitives.ReadUInt32LittleEndian(_structData.Slice(0x0, 0x4));
