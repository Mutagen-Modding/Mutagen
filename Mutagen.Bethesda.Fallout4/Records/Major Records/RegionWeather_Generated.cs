...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IRegionWeather
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => RegionWeatherCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class RegionWeatherCommon : RegionDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRegionWeatherGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in WeathersItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
