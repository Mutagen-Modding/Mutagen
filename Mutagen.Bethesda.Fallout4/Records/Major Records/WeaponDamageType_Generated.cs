...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IWeaponDamageType
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, WeaponDamageType.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(WeaponDamageType.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        #region Mutagen
        public static readonly RecordType GrupRecordType = WeaponDamageType_Registration.TriggeringRecordType;
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class WeaponDamageType_Registration : ILoquiRegistration
    {
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.DAMA);
        });
    ...
    public partial class WeaponDamageTypeCommon
    {
            ...
            WeaponDamageType.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"WeaponDamageType =>");
            }
            else
            {
                fg.AppendLine($"{name} (WeaponDamageType) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
