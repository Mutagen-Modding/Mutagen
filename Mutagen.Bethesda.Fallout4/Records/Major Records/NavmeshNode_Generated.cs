...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INavmeshNode
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((NavmeshNodeCommon)((INavmeshNodeGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(INavmeshNodeGetter? obj)
        {
            return ((NavmeshNodeCommon)((INavmeshNodeGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(NavmeshNode.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, NavmeshNode.Mask<bool>? printMask = null)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => NavmeshNodeCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class NavmeshNodeMixIn
    {
        ...
        {
            return ((NavmeshNodeCommon)((INavmeshNodeGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            NavmeshNode.Mask<bool>? printMask = null)
        {
            ((NavmeshNodeCommon)((INavmeshNodeGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class NavmeshNodeCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)NavmeshNode_FieldIndex.NavMesh) ?? true))
            {
                if (!lhs.NavMesh.Equals(rhs.NavMesh)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NavmeshNode_FieldIndex.NodeIndex) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INavmeshNodeGetter obj, bool iterateNestedRecords = true)
        {
