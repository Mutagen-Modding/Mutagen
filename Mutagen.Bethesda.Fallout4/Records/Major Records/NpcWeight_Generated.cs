...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INpcWeight
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, NpcWeight.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(NpcWeight.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        #region Mutagen
        public static readonly RecordType GrupRecordType = NpcWeight_Registration.TriggeringRecordType;
        #endregion
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class NpcWeight_Registration : ILoquiRegistration
    {
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.MWGT);
        });
    ...
    public partial class NpcWeightCommon
    {
            ...
            NpcWeight.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"NpcWeight =>");
            }
            else
            {
                fg.AppendLine($"{name} (NpcWeight) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
