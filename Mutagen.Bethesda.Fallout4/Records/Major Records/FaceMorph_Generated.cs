...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<FaceMorph>
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(FaceMorph.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, FaceMorph.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(FaceMorph.Mask<TItem>)} =>");
                fg.AppendLine("[");
    ...
    public static partial class FaceMorphMixIn
    {
        ...
        {
            return ((FaceMorphCommon)((IFaceMorphGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            FaceMorph.Mask<bool>? printMask = null)
        {
            ((FaceMorphCommon)((IFaceMorphGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class FaceMorphCommon
    {
            ...
            FaceMorph.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"FaceMorph =>");
            }
            else
            {
                fg.AppendLine($"{name} (FaceMorph) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IFaceMorphGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IFaceMorphGetter
    {
        ...
        public static FaceMorphBinaryOverlay FaceMorphFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
