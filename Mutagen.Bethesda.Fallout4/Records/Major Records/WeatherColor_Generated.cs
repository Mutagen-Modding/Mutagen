            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, WeatherColor.Mask<bool>? printMask = null)
            {
                ...
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendItem(EarlySunrise, "EarlySunrise");
                    }
                    if (printMask?.LateSunrise ?? true)
                    {
                        fg.AppendItem(LateSunrise, "LateSunrise");
                    }
                    if (printMask?.EarlySunset ?? true)
                    {
                        fg.AppendItem(EarlySunset, "EarlySunset");
                    }
                    if (printMask?.LateSunset ?? true)
                    {
                        fg.AppendItem(LateSunset, "LateSunset");
                    }
                }
                fg.AppendLine("]");
            }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class WeatherColor_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.WeatherColor";
    ...
    internal partial class WeatherColorCommon
    {
            ...
            WeatherColor.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.EarlySunrise ?? true)
            {
                fg.AppendItem(item.EarlySunrise, "EarlySunrise");
            }
            if (printMask?.LateSunrise ?? true)
            {
                fg.AppendItem(item.LateSunrise, "LateSunrise");
            }
            if (printMask?.EarlySunset ?? true)
            {
                fg.AppendItem(item.EarlySunset, "EarlySunset");
            }
            if (printMask?.LateSunset ?? true)
            {
                fg.AppendItem(item.LateSunset, "LateSunset");
            }
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IWeatherColorGetter obj)
        {
            yield break;
        }
