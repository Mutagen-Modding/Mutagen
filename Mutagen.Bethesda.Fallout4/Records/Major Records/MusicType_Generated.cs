...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMusicTypeInternal
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(MusicType.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, MusicType.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(MusicType.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        public override IEnumerable<IFormLinkGetter> ContainedFormLinks => MusicTypeCommon.Instance.GetContainedFormLinks(this);
    ...
    public static partial class MusicTypeMixIn
    {
        ...
        {
            return ((MusicTypeCommon)((IMusicTypeGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            MusicType.Mask<bool>? printMask = null)
        {
            ((MusicTypeCommon)((IMusicTypeGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MusicType_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "e0e6f665-0d9f-46e4-9418-82320044018b";
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.MUSC);
        });
    ...
    public partial class MusicTypeCommon : Fallout4MajorRecordCommon
    {
            ...
            MusicType.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"MusicType =>");
            }
            else
            {
                fg.AppendLine($"{name} (MusicType) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)MusicType_FieldIndex.Data) ?? true))
            {
                ...
                {
                    if (!((MusicTypeDataCommon)((IMusicTypeDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, crystal?.GetSubCrystal((int)MusicType_FieldIndex.Data))) return false;
                }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IMusicTypeGetter obj)
        {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    {
        public new readonly static MusicTypeBinaryWriteTranslation Instance = new MusicTypeBinaryWriteTranslation();
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IMusicTypeGetter
    {
        ...
        public MusicType.Flag Flags => _FlagsLocation.HasValue ? (MusicType.Flag)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _FlagsLocation!.Value, _package.MetaData.Constants)) : default(MusicType.Flag);
        #endregion
        #region Data
