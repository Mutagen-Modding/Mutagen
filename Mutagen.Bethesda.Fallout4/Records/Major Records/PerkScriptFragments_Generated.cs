...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class PerkScriptFragments_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "b09f7ba7-fe26-4c8b-837e-e5edf96339f0";
    ...
    internal partial class PerkScriptFragmentsCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Script) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Script, rhs.Script, out var lhsScript, out var rhsScript, out var isScriptEqual))
                {
                    if (!((ScriptEntryCommon)((IScriptEntryGetter)lhsScript).CommonInstance()!).Equals(lhsScript, rhsScript, crystal?.GetSubCrystal((int)PerkScriptFragments_FieldIndex.Script))) return false;
                }
                else if (!isScriptEqual) return false;
            }
            if ((crystal?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Fragments) ?? true))
            {
                if (!lhs.Fragments.SequenceEqual(rhs.Fragments, (l, r) => ((PerkScriptFragmentCommon)((IPerkScriptFragmentGetter)l).CommonInstance()!).Equals(l, r, crystal?.GetSubCrystal((int)PerkScriptFragments_FieldIndex.Fragments)))) return false;
            }
            return true;
        }
