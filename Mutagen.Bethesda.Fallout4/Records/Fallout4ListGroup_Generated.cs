...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, ICellBlock, IBinaryItem
    {
        ...
        public void ToString(
            ...
            string? name = null)
        {
            Fallout4ListGroupMixIn.ToString(
                item: this,
                sb: sb,
                name: name);
        }
        ...
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => Fallout4ListGroupCommon<T>.Instance.GetContainedFormLinks(this);
    ...
    public static partial class Fallout4ListGroupMixIn
    {
        ...
        public static string ToString<T>(
            ...
            where T : class, ICellBlockGetter, IBinaryItem
        {
            return ((Fallout4ListGroupCommon<T>)((IFallout4ListGroupGetter<T>)item).CommonInstance(typeof(T))!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString<T>(
            ...
            where T : class, ICellBlockGetter, IBinaryItem
        {
            ((Fallout4ListGroupCommon<T>)((IFallout4ListGroupGetter<T>)item).CommonInstance(typeof(T))!).ToString(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, ICellBlockGetter, IBinaryItem
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IFallout4ListGroupGetter<T> obj)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public readonly static Fallout4ListGroupBinaryWriteTranslation Instance = new Fallout4ListGroupBinaryWriteTranslation();
    ...
    internal partial class Fallout4ListGroupBinaryCreateTranslation<T>
        where T : class, ICellBlock, IBinaryItem
    {
        public readonly static Fallout4ListGroupBinaryCreateTranslation<T> Instance = new Fallout4ListGroupBinaryCreateTranslation<T>();
...
namespace Mutagen.Bethesda.Fallout4
{
    public static class Fallout4ListGroup
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(Fallout4ListGroup.Mask<bool>? printMask = null)
            {
                var sb = new StructuredStringBuilder();
            ...
            public void ToString(StructuredStringBuilder sb, Fallout4ListGroup.Mask<bool>? printMask = null)
            {
