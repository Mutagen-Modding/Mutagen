...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IScriptStringProperty
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ScriptStringPropertyCommon)((IScriptStringPropertyGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IScriptStringPropertyGetter? obj)
        {
            return ((ScriptStringPropertyCommon)((IScriptStringPropertyGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class ScriptStringPropertyCommon : ScriptPropertyCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ScriptStringProperty_FieldIndex.Data) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IScriptStringPropertyGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public new static readonly ScriptStringPropertyBinaryWriteTranslation Instance = new();
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IScriptStringPropertyGetter
    {
        ...
        public static void ScriptStringPropertyParseEndingPositions(
            ScriptStringPropertyBinaryOverlay ret,
            BinaryOverlayFactoryPackage package)
        {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            var ret = new ScriptStringPropertyBinaryOverlay(
                memoryPair: memoryPair,
                package: package);
            ScriptStringPropertyParseEndingPositions(ret, package);
