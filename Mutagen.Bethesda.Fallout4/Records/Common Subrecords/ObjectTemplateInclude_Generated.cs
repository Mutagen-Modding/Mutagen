...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IObjectTemplateInclude
    {
        ...
        #region Mod
        private readonly IFormLink<IObjectModificationGetter> _Mod = new FormLink<IObjectModificationGetter>();
        public IFormLink<IObjectModificationGetter> Mod
        {
            get => _Mod;
            set => _Mod.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkGetter<IObjectModificationGetter> IObjectTemplateIncludeGetter.Mod => this.Mod;
        #endregion
        ...
        public void ToString(
            ...
            string? name = null)
        {
            ObjectTemplateIncludeMixIn.ToString(
                item: this,
                name: name);
        }
            ...
            IMask<TItem>
        {
            ...
            public string ToString(ObjectTemplateInclude.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, ObjectTemplateInclude.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(ObjectTemplateInclude.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    if (printMask?.Mod ?? true)
                    {
                        fg.AppendItem(Mod, "Mod");
                    }
                    if (printMask?.AttachPointIndex ?? true)
                    {
                        fg.AppendItem(AttachPointIndex, "AttachPointIndex");
                    }
                    if (printMask?.Optional ?? true)
                    {
                        fg.AppendItem(Optional, "Optional");
                    }
                    if (printMask?.DontUseAll ?? true)
                    {
                        fg.AppendItem(DontUseAll, "DontUseAll");
                    }
                }
                fg.AppendLine("]");
            }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => ObjectTemplateIncludeCommon.Instance.GetContainedFormLinks(this);
    ...
    {
        new IFormLink<IObjectModificationGetter> Mod { get; set; }
        ...
        ILoquiObject<IObjectTemplateIncludeGetter>
    {
        ...
        IFormLinkGetter<IObjectModificationGetter> Mod { get; }
    ...
    public static partial class ObjectTemplateIncludeMixIn
    {
        ...
        {
            return ((ObjectTemplateIncludeCommon)((IObjectTemplateIncludeGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            ObjectTemplateInclude.Mask<bool>? printMask = null)
        {
            ((ObjectTemplateIncludeCommon)((IObjectTemplateIncludeGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class ObjectTemplateIncludeCommon
    {
            ...
            ObjectTemplateInclude.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"ObjectTemplateInclude =>");
            }
            else
            {
                fg.AppendLine($"{name} (ObjectTemplateInclude) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            ObjectTemplateInclude.Mask<bool>? printMask = null)
        {
            if (printMask?.Mod ?? true)
            {
                fg.AppendItem(item.Mod.FormKey, "Mod");
            }
            if (printMask?.AttachPointIndex ?? true)
            {
                fg.AppendItem(item.AttachPointIndex, "AttachPointIndex");
            }
            if (printMask?.Optional ?? true)
            {
                fg.AppendItem(item.Optional, "Optional");
            }
            if (printMask?.DontUseAll ?? true)
            {
                fg.AppendItem(item.DontUseAll, "DontUseAll");
            }
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IObjectTemplateIncludeGetter obj)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IObjectTemplateIncludeGetter
    {
        ...
        public static ObjectTemplateIncludeBinaryOverlay ObjectTemplateIncludeFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
