...
using System.Text;
using static Mutagen.Bethesda.Fallout4.ConditionData;
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    public partial class ConditionDataMixIn
    {
        public static ConditionData.ParameterCategory GetCategory(this ConditionData.ParameterType type)
        {
            switch (type)
            {
