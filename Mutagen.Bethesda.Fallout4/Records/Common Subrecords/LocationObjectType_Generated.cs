...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<LocationObjectType>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((LocationObjectTypeCommon)((ILocationObjectTypeGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ILocationObjectTypeGetter? obj)
        {
            return ((LocationObjectTypeCommon)((ILocationObjectTypeGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(LocationObjectType.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, LocationObjectType.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(LocationObjectType.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class LocationObjectTypeMixIn
    {
        ...
        {
            return ((LocationObjectTypeCommon)((ILocationObjectTypeGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            LocationObjectType.Mask<bool>? printMask = null)
        {
            ((LocationObjectTypeCommon)((ILocationObjectTypeGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class LocationObjectTypeCommon : ALocationTargetCommon
    {
            ...
            LocationObjectType.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"LocationObjectType =>");
            }
            else
            {
                sb.AppendLine($"{name} (LocationObjectType) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LocationObjectType_FieldIndex.Type) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILocationObjectTypeGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    {
        public new static readonly LocationObjectTypeBinaryWriteTranslation Instance = new();
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILocationObjectTypeGetter
    {
        ...
        public TargetObjectType Type => (TargetObjectType)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0x0, 0x4));
