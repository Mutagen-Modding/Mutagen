...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Destructible>
    {
        ...
        #region Resistances
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<ResistanceDestructible>? _Resistances;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Resistances != null)
                {
                    ...
                    if (Resistances.Specific != null)
                    {
                        ...
                        {
                            MaskItemIndexed<R, ResistanceDestructible.Mask<R>?>? mask = item == null ? null : new MaskItemIndexed<R, ResistanceDestructible.Mask<R>?>(item.Index, eval(item.Overall), item.Specific?.Translate(eval));
        ...
        ILoquiObjectSetter<IDestructible>
    {
        ...
        new ExtendedList<ResistanceDestructible>? Resistances { get; set; }
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class Destructible_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.Destructible";
    ...
    internal partial class DestructibleCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IDestructibleGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in ResistancesItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
    ...
    internal partial class DestructibleSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Destructible_FieldIndex.Resistances) ?? true))
            {
                errorMask?.PushIndex((int)Destructible_FieldIndex.Resistances);
                try
                {
                    if ((rhs.Resistances != null))
                    {
                        item.Resistances = 
                            ...
                            .ToExtendedList<ResistanceDestructible>();
                    }
                    else
                    {
                        item.Resistances = null;
    ...
    public partial class DestructibleBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<IResistanceDestructibleGetter>.Instance.Write(
                ...
                recordType: translationParams.ConvertToCustom(RecordTypes.DAMC),
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.DAMC:
                {
                    ...
                    item.Resistances = 
                        ...
                        .CastExtendedList<ResistanceDestructible>();
