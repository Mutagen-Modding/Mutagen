...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    namespace Internals
    {
            ...
            static partial void WriteBinaryParameterParsingCustom(MutagenWriter writer, IFunctionConditionDataGetter item)
            {
                ...
                switch (paramTypes.Third.GetCategory())
                {
                    ...
                    case ConditionData.ParameterCategory.Number:
                        ...
                        break;
                    case ConditionData.ParameterCategory.Form:
                        FormKeyBinaryTranslation.Instance.Write(writer, item.ParameterThreeRecord.FormKey);
                        break;
                    case ConditionData.ParameterCategory.String:
                        writer.Write(item.ParameterThreeString);
                        break;
                    default:
                        throw new NotImplementedException();
                }
        ...
        public partial class FunctionConditionDataBinaryOverlay
        {
            ...
            private ReadOnlyMemorySlice<byte> _stringParamData3;
            public bool ParameterThreeString_IsSet { get; private set; }
            public string? ParameterThreeString => ParameterThreeString_IsSet ? BinaryStringUtility.ProcessWholeToZString(_stringParamData3) : null;
