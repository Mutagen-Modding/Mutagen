...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class DestructableData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "b29f0a71-098b-4c11-a42a-2f7a5d2a79f6";
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.DEST);
        });
    ...
    public partial class DestructableDataCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)DestructableData_FieldIndex.Flags) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IDestructableDataGetter
    {
        ...
        public Destructible.DestructibleFlag Flags => (Destructible.DestructibleFlag)_data.Span.Slice(0x5, 0x1)[0];
