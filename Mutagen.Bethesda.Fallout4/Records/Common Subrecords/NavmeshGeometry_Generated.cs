...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        INavmeshGeometry
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(FileGeneration fg, NavmeshGeometry.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(NavmeshGeometry.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendLine("Unknown2 =>");
                        fg.AppendLine("[");
                        using (new DepthWrapper(fg))
                        {
                            fg.AppendItem(Unknown2Item.Overall);
        ...
        #region Mutagen
        public static readonly RecordType GrupRecordType = NavmeshGeometry_Registration.TriggeringRecordType;
...
{
    #region Field Index
    public enum NavmeshGeometry_FieldIndex
    {
        NavmeshVersion = 0,
        Magic = 1,
        Parent = 2,
    ...
    #region Registration
    public partial class NavmeshGeometry_Registration : ILoquiRegistration
    {
        ...
        {
            return TriggeringRecordCollection.Factory(RecordTypes.NVNM);
        });
    ...
    #region Common
    public partial class NavmeshGeometrySetterCommon
    {
    ...
    public partial class NavmeshGeometryCommon
    {
            ...
            NavmeshGeometry.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"NavmeshGeometry =>");
            }
            else
            {
                fg.AppendLine($"{name} (NavmeshGeometry) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
    ...
    public partial class NavmeshGeometrySetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class NavmeshGeometry
    {
        ...
        public static NavmeshGeometry_Registration StaticRegistration => NavmeshGeometry_Registration.Instance;
        [DebuggerStepThrough]
