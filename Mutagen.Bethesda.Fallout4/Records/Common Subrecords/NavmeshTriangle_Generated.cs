            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case NavmeshTriangle_FieldIndex.EdgeLink_2_0:
                        return EdgeLink_2_0;
                    case NavmeshTriangle_FieldIndex.Height:
                        return Height;
                    case NavmeshTriangle_FieldIndex.Unknown:
                        return Unknown;
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class NavmeshTriangle_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout4.NavmeshTriangle";
    ...
    public partial class NavmeshTriangleSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)NavmeshTriangle_FieldIndex.Height) ?? true))
            {
                item.Height = rhs.Height;
            }
            if ((copyMask?.GetShouldTranslate((int)NavmeshTriangle_FieldIndex.Unknown) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        INavmeshTriangleGetter
    {
        ...
        public Single Height => _data.Slice(0xC, 0x4).Float();
        public Byte Unknown => _data.Span[0x10];
        public NavmeshTriangle.Flag Flags => (NavmeshTriangle.Flag)BinaryPrimitives.ReadUInt16LittleEndian(_data.Span.Slice(0x11, 0x2));
        public UInt16 CoverFlags => BinaryPrimitives.ReadUInt16LittleEndian(_data.Slice(0x13, 0x2));
            ...
            TypedParseParams? parseParams = null)
        {
            var ret = new NavmeshTriangleBinaryOverlay(
                bytes: stream.RemainingMemory.Slice(0, 0x15),
                package: package);
