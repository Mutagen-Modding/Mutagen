...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class BipedBodyTemplateSetterCommon
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(RecordTypes.BOD2)));
    ...
    public partial class BipedBodyTemplateCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IBipedBodyTemplateGetter obj)
        {
            yield break;
        }
    ...
    public partial class BipedBodyTemplateBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(RecordTypes.BOD2),
