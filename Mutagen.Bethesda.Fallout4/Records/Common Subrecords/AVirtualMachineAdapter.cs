...
partial class AVirtualMachineAdapterBinaryCreateTranslation
{
    ...
    {
        var scriptName = StringBinaryTranslation.Instance.Parse(frame, parseWhole: true, stringBinaryType: StringBinaryType.PrependLengthUShort);
    ...
    {
        var name = StringBinaryTranslation.Instance.Parse(frame, parseWhole: true, stringBinaryType: StringBinaryType.PrependLengthUShort);
