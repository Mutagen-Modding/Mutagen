...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, IFallout4MajorRecordInternal, IBinaryItem
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((Fallout4GroupCommon<T>)((IFallout4GroupGetter<T>)this).CommonInstance(typeof(T))!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IFallout4GroupGetter<T>? obj)
        {
            return ((Fallout4GroupCommon<T>)((IFallout4GroupGetter<T>)this).CommonInstance(typeof(T))!).Equals(this, obj, equalsMask: null);
        }
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => Fallout4GroupCommon<T>.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType) => Fallout4GroupCommon<T>.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => Fallout4GroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => Fallout4GroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
        #endregion
    ...
    public static partial class Fallout4GroupMixIn
    {
        ...
        public static string Print<T>(
            ...
            where T : class, IFallout4MajorRecordGetter, IBinaryItem
        {
            return ((Fallout4GroupCommon<T>)((IFallout4GroupGetter<T>)item).CommonInstance(typeof(T))!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print<T>(
            ...
            where T : class, IFallout4MajorRecordGetter, IBinaryItem
        {
            ((Fallout4GroupCommon<T>)((IFallout4GroupGetter<T>)item).CommonInstance(typeof(T))!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, IFallout4MajorRecordInternal, IBinaryItem
    {
        ...
        public IEnumerable<IMajorRecord> EnumerateMajorRecordsLoopLogic(IFallout4Group<T> obj)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumeratePotentiallyTypedMajorRecords(
            ...
            bool throwIfUnknown)
        {
            if (type == null) return Fallout4GroupCommon<T>.Instance.EnumerateMajorRecords(obj);
            return Fallout4GroupCommon<T>.Instance.EnumerateMajorRecords(obj, type, throwIfUnknown);
        }
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(
            ...
            bool throwIfUnknown)
        {
            foreach (var item in Fallout4GroupCommon<T>.Instance.EnumerateMajorRecordsLoopLogic(obj, type, throwIfUnknown))
            {
                yield return item;
            }
        }
        ...
        {
            PluginUtilityTranslation.GroupParse<IFallout4Group<T>, T>(
                record: item,
                frame: frame,
                translationParams: translationParams,
                expectedRecordType: Fallout4Group<T>.T_RecordType,
        ...
        where T : class, IFallout4MajorRecordGetter, IBinaryItem
    {
            ...
            Fallout4Group.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"Fallout4Group<{typeof(T).Name}> =>");
            }
            else
            {
                sb.AppendLine($"{name} (Fallout4Group<{typeof(T).Name}>) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Fallout4Group_FieldIndex.Type) ?? true))
            {
                if (lhs.Type != rhs.Type) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Fallout4Group_FieldIndex.LastModified) ?? true))
            {
                if (lhs.LastModified != rhs.LastModified) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Fallout4Group_FieldIndex.Unknown) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IFallout4GroupGetter<T> obj, bool iterateNestedRecords = true)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(IFallout4GroupGetter<T> obj)
        {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IFallout4GroupGetter<T> obj, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType)
        {
...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    internal partial class Fallout4GroupBinaryCreateTranslation<T>
        where T : class, IFallout4MajorRecordInternal, IBinaryItem
    {
        public static readonly Fallout4GroupBinaryCreateTranslation<T> Instance = new Fallout4GroupBinaryCreateTranslation<T>();
...
namespace Mutagen.Bethesda.Fallout4
{
    public static class Fallout4Group
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(Fallout4Group.Mask<bool>? printMask = null)
            {
                var sb = new StructuredStringBuilder();
                Print(sb, printMask);
                return sb.ToString();
            ...
            public void Print(StructuredStringBuilder sb, Fallout4Group.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(Fallout4Group.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    if (printMask?.Type ?? true)
                    {
