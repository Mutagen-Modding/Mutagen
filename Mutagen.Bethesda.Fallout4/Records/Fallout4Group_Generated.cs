...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, IFallout4MajorRecordInternal, IBinaryItem
    {
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query) => Fallout4GroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, query);
        #endregion
...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        where T : class, IFallout4MajorRecordInternal, IBinaryItem
    {
        ...
        public void RemapAssetLinks(IFallout4Group<T> obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query)
        {
            obj.RecordCache.RemapAssetLinks(mapping, query);
        }
