...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        #region Type
        public Location.LocationType Type { get; set; } = default;
        #endregion
        #region Data
    ...
    {
        new Location.LocationType Type { get; set; }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class LocationFallback_Registration : ILoquiRegistration
    {
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            {
                case LocationFallback_FieldIndex.Type:
                    return typeof(Location.LocationType);
                case LocationFallback_FieldIndex.Data:
                    return typeof(Int32);
                default:
    ...
    public partial class LocationFallbackSetterCommon : ALocationTargetSetterCommon
    {
        ...
        protected static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.Type = EnumBinaryTranslation<Location.LocationType>.Instance.Parse(frame: frame.SpawnWithLength(4));
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                EnumXmlTranslation<Location.LocationType>.Instance.Write(
                    node: node,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "Type":
                    ...
                    try
                    {
                        item.Type = EnumXmlTranslation<Location.LocationType>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
        ...
        public static void WriteEmbedded(
            ...
            MutagenWriter writer)
        {
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<Location.LocationType>.Instance.Write(
                writer,
                item.Type,
                length: 4);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ILocationFallbackGetter
    {
        ...
        public Location.LocationType Type => (Location.LocationType)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(0x0, 0x4));
