...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class SeasonalIngredientProductionXmlWriteTranslation : IXmlWriteTranslator
    {
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.SeasonalIngredientProduction");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.SeasonalIngredientProduction");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
