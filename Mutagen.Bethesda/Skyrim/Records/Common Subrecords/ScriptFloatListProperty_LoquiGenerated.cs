...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => ScriptFloatListPropertyXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ScriptFloatListPropertyXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new ScriptFloatListProperty CreateFromXml(
            XElement node,
            ScriptFloatListProperty.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static ScriptFloatListProperty CreateFromXml(
            XElement node,
        ...
        public new static ScriptFloatListProperty CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new ScriptFloatListProperty();
            ((ScriptFloatListPropertySetterCommon)((IScriptFloatListPropertyGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        [DebuggerStepThrough]
        public static new ScriptFloatListProperty CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((IScriptFloatListPropertyGetter)rhs, include);
    ...
    public partial interface IScriptFloatListPropertyGetter :
        ...
        IBinaryItem
    {
        static ILoquiRegistration Registration => ScriptFloatListProperty_Registration.Instance;
    ...
    public static partial class ScriptFloatListPropertyMixIn
    {
        ...
        public static bool HasBeenSet(
            this IScriptFloatListPropertyGetter item,
            ScriptFloatListProperty.Mask<bool?> checkMask)
        {
            return ((ScriptFloatListPropertyCommon)((IScriptFloatListPropertyGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static ScriptFloatListProperty.Mask<bool> GetHasBeenSetMask(this IScriptFloatListPropertyGetter item)
        {
            var ret = new ScriptFloatListProperty.Mask<bool>(false);
            ((ScriptFloatListPropertyCommon)((IScriptFloatListPropertyGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ScriptFloatListPropertySetterCommon)((IScriptFloatListPropertyGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ScriptFloatListPropertySetterCommon : ScriptPropertySetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ScriptFloatListPropertyXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class ScriptFloatListPropertyCommon : ScriptPropertyCommon
    {
        ...
        public void FillHasBeenSetMask(
            IScriptFloatListPropertyGetter item,
            ScriptFloatListProperty.Mask<bool> mask)
        {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IScriptFloatListPropertyGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ScriptFloatListPropertyXmlWriteTranslation :
        ScriptPropertyXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static ScriptFloatListPropertyXmlWriteTranslation Instance = new ScriptFloatListPropertyXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ScriptPropertyXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)ScriptFloatListProperty_FieldIndex.Data) ?? true))
            {
                ListXmlTranslation<Single>.Instance.Write(
                    node: node,
                    name: nameof(item.Data),
                    item: item.Data,
                    fieldIndex: (int)ScriptFloatListProperty_FieldIndex.Data,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)ScriptFloatListProperty_FieldIndex.Data),
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ScriptFloatListProperty");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ScriptFloatListProperty");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ScriptFloatListPropertyXmlCreateTranslation : ScriptPropertyXmlCreateTranslation
    {
        public new readonly static ScriptFloatListPropertyXmlCreateTranslation Instance = new ScriptFloatListPropertyXmlCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ScriptFloatListPropertyXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ScriptFloatListPropertyXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IScriptFloatListPropertyGetter
    {
        ...
        public IReadOnlyList<Single> Data => BinaryOverlaySetList<Single>.FactoryByStartIndex(_data.Slice(0), _package, 4, (s, p) => SpanExt.GetFloat(s));
        partial void CustomCtor(
