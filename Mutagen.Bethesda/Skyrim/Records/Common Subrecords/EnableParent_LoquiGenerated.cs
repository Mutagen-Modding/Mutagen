...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IEnumerable<FormKey> LinkFormKeys => EnableParentCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => EnableParentCommon.Instance.GetLinkFormKeys(this);
        ...
        void ILinkedFormKeyContainer.RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => EnableParentCommon.Instance.RemapLinks(this, mapping);
        #endregion
        ...
        [DebuggerStepThrough]
        public static EnableParent CreateFromBinary(MutagenFrame frame)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class EnableParent_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "VERSIONING":
                    return (ushort)EnableParent_FieldIndex.Versioning;
                case "REFERENCE":
                    return (ushort)EnableParent_FieldIndex.Reference;
                case "FLAGS":
                    return (ushort)EnableParent_FieldIndex.Flags;
                case "UNKNOWN":
                    return (ushort)EnableParent_FieldIndex.Unknown;
                default:
                    return null;
            }
        }
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            {
                case EnableParent_FieldIndex.Versioning:
                    return typeof(EnableParent.VersioningBreaks);
                case EnableParent_FieldIndex.Reference:
    ...
    public partial class EnableParentCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IEnableParentGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class EnableParentXmlWriteTranslation : IXmlWriteTranslator
    {
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)EnableParent_FieldIndex.Versioning) ?? true))
            {
                EnumXmlTranslation<EnableParent.VersioningBreaks>.Instance.Write(
                    node: node,
                    name: nameof(item.Versioning),
                    item: item.Versioning,
                    fieldIndex: (int)EnableParent_FieldIndex.Versioning,
                    errorMask: errorMask);
            }
            ...
            if ((translationMask?.GetShouldTranslate((int)EnableParent_FieldIndex.Unknown) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)EnableParent_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.EnableParent");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.EnableParent");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class EnableParentXmlCreateTranslation
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Versioning":
                    errorMask?.PushIndex((int)EnableParent_FieldIndex.Versioning);
                    try
                    {
                        item.Versioning = EnumXmlTranslation<EnableParent.VersioningBreaks>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "Flags":
                    ...
                    break;
                case "Unknown":
                    errorMask?.PushIndex((int)EnableParent_FieldIndex.Unknown);
                    try
                    {
