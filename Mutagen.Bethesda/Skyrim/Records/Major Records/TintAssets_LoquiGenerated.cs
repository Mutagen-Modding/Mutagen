            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case 0x53524954: // TIRS
                {
                    ...
                    item.Presets = 
                        Mutagen.Bethesda.Binary.ListBinaryTranslation<TintPreset>.Instance.ParseRepeatedItem(
                            frame: frame,
    ...
    public partial class TintAssetsBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            MasterReferenceReader masterReferences)
        {
            ...
            Mutagen.Bethesda.Binary.ListBinaryTranslation<ITintPresetGetter>.Instance.Write(
                ...
                items: item.Presets,
                masterReferences: masterReferences,
                transl: (MutagenWriter subWriter, ITintPresetGetter subItem, MasterReferenceReader m, RecordTypeConverter? conv) =>
                {
                    if (subItem.TryGet(out var Item))
                    {
