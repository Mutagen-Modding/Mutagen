...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IMagicEffectSoundGetter
    {
        ...
        public IFormLinkGetter<ISoundDescriptorGetter> Sound => new FormLink<ISoundDescriptorGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(4, 4))));
        partial void CustomCtor(
