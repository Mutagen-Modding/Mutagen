...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public IEnumerable<ILinkGetter> Links => CriticalDataCommon.Instance.GetLinks(this);
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class CriticalDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(ICriticalDataGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ICriticalDataGetter
    {
        ...
        public IFormLinkGetter<ISpellGetter> Effect => new FormLink<ISpellGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0xC, 0x4))));
        partial void CustomCtor(
