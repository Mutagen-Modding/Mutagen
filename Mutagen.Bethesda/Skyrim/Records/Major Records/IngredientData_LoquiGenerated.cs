            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case IngredientData_FieldIndex.Value:
                        return Value;
                    case IngredientData_FieldIndex.Weight:
                        return Weight;
                    default:
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class IngredientData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "3a95acbe-7e28-490e-a935-649249c361a2";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "WEIGHT":
                    return (ushort)IngredientData_FieldIndex.Weight;
                default:
                    return null;
            }
        }
    ...
    public partial class IngredientDataSetterCommon
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(IngredientData_Registration.DATA_HEADER)));
    ...
    public partial class IngredientDataSetterTranslationCommon
    {
            ...
            TranslationCrystal? copyMask)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)IngredientData_FieldIndex.Weight) ?? true))
            {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class IngredientDataXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)IngredientData_FieldIndex.Weight) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Weight),
                    item: item.Weight,
                    fieldIndex: (int)IngredientData_FieldIndex.Weight,
                    errorMask: errorMask);
            }
        }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "Value":
                    ...
                    break;
                case "Weight":
                    errorMask?.PushIndex((int)IngredientData_FieldIndex.Weight);
                    try
                    {
    ...
    public partial class IngredientDataBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.ExportHeader(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(IngredientData_Registration.DATA_HEADER),
