...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        TranslatedString? IMapMarkerGetter.Name => this.Name;
        #endregion
        #region Type
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = MapMarker_Registration.TriggeringRecordType;
        #endregion
    ...
    public partial class MapMarker_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "TYPE":
                    return (ushort)MapMarker_FieldIndex.Type;
                default:
                    return null;
            }
        }
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            switch (enu)
            {
                ...
                case MapMarker_FieldIndex.Type:
                    return typeof(MapMarker.MarkerType);
                default:
                    throw new ArgumentException($"Index is out of range: {index}");
            }
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class MapMarkerXmlWriteTranslation : IXmlWriteTranslator
    {
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)MapMarker_FieldIndex.Flags) ?? true))
            {
            ...
            if ((translationMask?.GetShouldTranslate((int)MapMarker_FieldIndex.Type) ?? true))
            {
                EnumXmlTranslation<MapMarker.MarkerType>.Instance.Write(
                    node: node,
                    name: nameof(item.Type),
                    item: item.Type,
                    fieldIndex: (int)MapMarker_FieldIndex.Type,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.MapMarker");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.MapMarker");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "Name":
                    ...
                    break;
                case "Type":
                    errorMask?.PushIndex((int)MapMarker_FieldIndex.Type);
                    try
                    {
                        item.Type = EnumXmlTranslation<MapMarker.MarkerType>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
    ...
    public partial class MapMarkerBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<MapMarker.MarkerType>.Instance.Write(
                ...
                item.Type,
                length: 2,
                header: recordTypeConverter.ConvertToCustom(MapMarker_Registration.TNAM_HEADER));
        }
