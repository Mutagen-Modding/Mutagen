...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class WorldspaceSubBlockXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)WorldspaceSubBlock_FieldIndex.Unknown) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)WorldspaceSubBlock_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.WorldspaceSubBlock");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.WorldspaceSubBlock");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "LastModified":
                    ...
                    break;
                case "Unknown":
                    errorMask?.PushIndex((int)WorldspaceSubBlock_FieldIndex.Unknown);
                    try
                    {
