...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        #region NavMesh
        public FormLink<NavigationMesh> NavMesh { get; set; } = new FormLink<NavigationMesh>();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => NavmeshNodeXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((NavmeshNodeXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static NavmeshNode CreateFromXml(
            XElement node,
            NavmeshNode.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((NavmeshNodeSetterCommon)((INavmeshNodeGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IEnumerable<FormKey> LinkFormKeys => NavmeshNodeCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => NavmeshNodeCommon.Instance.GetLinkFormKeys(this);
        protected void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => NavmeshNodeCommon.Instance.RemapLinks(this, mapping);
        void ILinkedFormKeyContainer.RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => NavmeshNodeCommon.Instance.RemapLinks(this, mapping);
        #endregion
        ...
        [DebuggerStepThrough]
        public static NavmeshNode CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((INavmeshNodeGetter)rhs, include);
    ...
    {
        new FormLink<NavigationMesh> NavMesh { get; set; }
    ...
    public static partial class NavmeshNodeMixIn
    {
        ...
        public static bool HasBeenSet(
            this INavmeshNodeGetter item,
            NavmeshNode.Mask<bool?> checkMask)
        {
            return ((NavmeshNodeCommon)((INavmeshNodeGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static NavmeshNode.Mask<bool> GetHasBeenSetMask(this INavmeshNodeGetter item)
        {
            var ret = new NavmeshNode.Mask<bool>(false);
            ((NavmeshNodeCommon)((INavmeshNodeGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((NavmeshNodeSetterCommon)((INavmeshNodeGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class NavmeshNode_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "NAVMESH":
                    return (ushort)NavmeshNode_FieldIndex.NavMesh;
                case "NODEINDEX":
                    return (ushort)NavmeshNode_FieldIndex.NodeIndex;
                default:
                    return null;
            }
        }
        ...
        public static readonly Type XmlWriteTranslation = typeof(NavmeshNodeXmlWriteTranslation);
    ...
    public partial class NavmeshNodeSetterCommon
    {
        ...
        {
            ClearPartial();
            item.NavMesh = new FormLink<NavigationMesh>(FormKey.Null);
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    NavmeshNodeXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class NavmeshNodeCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(INavmeshNodeGetter obj)
        {
            yield return obj.NavMesh.FormKey;
            yield break;
        }
        
        public void RemapLinks(INavmeshNodeGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class NavmeshNodeXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static NavmeshNodeXmlWriteTranslation Instance = new NavmeshNodeXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)NavmeshNode_FieldIndex.NavMesh) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.NavMesh),
                    item: item.NavMesh.FormKey,
                    fieldIndex: (int)NavmeshNode_FieldIndex.NavMesh,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NavmeshNode_FieldIndex.NodeIndex) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.NodeIndex),
                    item: item.NodeIndex,
                    fieldIndex: (int)NavmeshNode_FieldIndex.NodeIndex,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.NavmeshNode");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.NavmeshNode");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class NavmeshNodeXmlCreateTranslation
    {
        public readonly static NavmeshNodeXmlCreateTranslation Instance = new NavmeshNodeXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "NavMesh":
                    errorMask?.PushIndex((int)NavmeshNode_FieldIndex.NavMesh);
                    try
                    {
                    ...
                    break;
                case "NodeIndex":
                    errorMask?.PushIndex((int)NavmeshNode_FieldIndex.NodeIndex);
                    try
                    {
                        item.NodeIndex = UInt32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class NavmeshNodeXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((NavmeshNodeXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        INavmeshNodeGetter
    {
        ...
        public IFormLinkGetter<INavigationMeshGetter> NavMesh => new FormLink<INavigationMeshGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
