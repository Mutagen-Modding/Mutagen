...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerStepThrough]
        public static BodyDataPair CreateFromBinary(MutagenFrame frame)
        {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case 0x4D414E4D: // MNAM
                {
                    ...
                    item.Male = Mutagen.Bethesda.Skyrim.BodyData.CreateFromBinary(frame: frame);
                ...
                case 0x4D414E46: // FNAM
                {
                    ...
                    frame.Position += frame.MetaData.SubConstants.HeaderLength + contentLength; // Skip marker
                    item.Female = Mutagen.Bethesda.Skyrim.BodyData.CreateFromBinary(frame: frame);
