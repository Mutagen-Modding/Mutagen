...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullable<ISoundDescriptorGetter> IActivatorGetter.LoopingSound => this.LoopingSound;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullable<ISoundDescriptorGetter> IActivatorGetter.ActivationSound => this.ActivationSound;
        #endregion
        #region WaterType
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullable<IKeywordGetter> IActivatorGetter.InteractionKeyword => this.InteractionKeyword;
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ActivatorSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
            ...
            TranslationCrystal? copyMask)
        {
            ...
            {
                item.ActivationSound = rhs.ActivationSound.FormKey;
            }
            if ((copyMask?.GetShouldTranslate((int)Activator_FieldIndex.WaterType) ?? true))
            {
                item.WaterType = rhs.WaterType.FormKey;
            }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "ActivationSound":
                    ...
                    try
                    {
                        item.ActivationSound = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "WaterType":
                    ...
                    try
                    {
                        item.WaterType = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IActivatorGetter
    {
        ...
        public Activator.Flag? Flags => _FlagsLocation.HasValue ? (Activator.Flag)BinaryPrimitives.ReadUInt16LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)) : default(Activator.Flag?);
        #endregion
        #region InteractionKeyword
