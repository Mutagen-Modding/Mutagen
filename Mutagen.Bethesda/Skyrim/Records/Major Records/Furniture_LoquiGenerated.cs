...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IFurnitureGetter
    {
        ...
        public IWorkbenchDataGetter? WorkbenchData => _WorkbenchDataLocation.HasValue ? WorkbenchDataBinaryOverlay.WorkbenchDataFactory(new BinaryMemoryReadStream(_data.Slice(_WorkbenchDataLocation!.Value.Min)), _package, default(RecordTypeConverter)) : default;
