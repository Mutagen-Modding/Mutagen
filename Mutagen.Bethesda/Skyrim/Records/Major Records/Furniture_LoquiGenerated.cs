...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectBoundsGetter IFurnitureGetter.ObjectBounds => _ObjectBounds;
        #endregion
        #region Name
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IFormLinkNullable<Spell> _AssociatedSpell = new FormLinkNullable<Spell>();
        public IFormLinkNullable<Spell> AssociatedSpell => this._AssociatedSpell;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        ILoquiObjectSetter<IFurnitureInternal>
    {
        ...
        new IFormLinkNullable<Spell> AssociatedSpell { get; }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class Furniture_Registration : ILoquiRegistration
    {
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            switch (enu)
            {
                ...
                case Furniture_FieldIndex.AssociatedSpell:
                    return typeof(IFormLinkNullable<Spell>);
                case Furniture_FieldIndex.Markers:
    ...
    public partial class FurnitureSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void Clear(IFurnitureInternal item)
        {
            ...
            item.AssociatedSpell.FormKey = null;
            item.Markers = null;
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.SubConstants.HeaderLength;
                    item.AssociatedSpell.FormKey = Mutagen.Bethesda.Binary.FormLinkBinaryTranslation.Instance.Parse(
                        frame: frame.SpawnWithLength(contentLength),
                        defaultVal: FormKey.Null);
    ...
    public partial class FurnitureCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<ILinkGetter> GetLinks(IFurnitureGetter obj)
        {
            ...
            yield return obj.AssociatedSpell;
            if (obj.Markers != null)
            {
                foreach (var item in obj.Markers.SelectMany(f => f.Links))
                {
                    yield return item;
                }
            }
    ...
    public partial class FurnitureSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
            ...
            TranslationCrystal? copyMask)
        {
            ...
            {
                item.AssociatedSpell.FormKey = rhs.AssociatedSpell.FormKey;
            }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "AssociatedSpell":
                    ...
                    try
                    {
                        item.AssociatedSpell.FormKey = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IFurnitureGetter
    {
        ...
        private bool _WorkbenchData_IsSet => _WorkbenchDataLocation.HasValue;
        public IWorkbenchDataGetter? WorkbenchData => _WorkbenchData_IsSet ? WorkbenchDataBinaryOverlay.WorkbenchDataFactory(new BinaryMemoryReadStream(_data.Slice(_WorkbenchDataLocation!.Value.Min)), _package, default(RecordTypeConverter)) : default;
        ...
        public IFormLinkNullableGetter<ISpellGetter> AssociatedSpell => _AssociatedSpellLocation.HasValue ? new FormLinkNullable<ISpellGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _AssociatedSpellLocation.Value, _package.Meta)))) : FormLinkNullable<ISpellGetter>.Empty;
        #endregion
        ...
        public String? ModelFilename => _ModelFilenameLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _ModelFilenameLocation.Value, _package.Meta)) : default(string?);
        #endregion
        partial void CustomCtor(
