...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected object XmlWriteTranslator => PlacementXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PlacementXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static Placement CreateFromXml(
            XElement node,
            Placement.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((PlacementSetterCommon)((IPlacementGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        [DebuggerStepThrough]
        public static Placement CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((IPlacementGetter)rhs, include);
    ...
    public static partial class PlacementMixIn
    {
        ...
        public static bool HasBeenSet(
            this IPlacementGetter item,
            Placement.Mask<bool?> checkMask)
        {
            return ((PlacementCommon)((IPlacementGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static Placement.Mask<bool> GetHasBeenSetMask(this IPlacementGetter item)
        {
            var ret = new Placement.Mask<bool>(false);
            ((PlacementCommon)((IPlacementGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PlacementSetterCommon)((IPlacementGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public partial class PlacementSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    PlacementXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PlacementXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static PlacementXmlWriteTranslation Instance = new PlacementXmlWriteTranslation();
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.Placement");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.Placement");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PlacementXmlCreateTranslation
    {
        public readonly static PlacementXmlCreateTranslation Instance = new PlacementXmlCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PlacementXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PlacementXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
