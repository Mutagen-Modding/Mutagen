...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => LinkedDoorXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((LinkedDoorXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static LinkedDoor CreateFromXml(
            XElement node,
            LinkedDoor.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((LinkedDoorSetterCommon)((ILinkedDoorGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class LinkedDoorMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((LinkedDoorSetterCommon)((ILinkedDoorGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class LinkedDoor_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "UNKNOWN":
                    return (ushort)LinkedDoor_FieldIndex.Unknown;
                case "DOOR":
                    return (ushort)LinkedDoor_FieldIndex.Door;
                default:
                    return null;
            }
        }
        ...
        public static readonly Type XmlWriteTranslation = typeof(LinkedDoorXmlWriteTranslation);
    ...
    public partial class LinkedDoorSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    LinkedDoorXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class LinkedDoorXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static LinkedDoorXmlWriteTranslation Instance = new LinkedDoorXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)LinkedDoor_FieldIndex.Unknown) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)LinkedDoor_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)LinkedDoor_FieldIndex.Door) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Door),
                    item: item.Door.FormKey,
                    fieldIndex: (int)LinkedDoor_FieldIndex.Door,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.LinkedDoor");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.LinkedDoor");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class LinkedDoorXmlCreateTranslation
    {
        public readonly static LinkedDoorXmlCreateTranslation Instance = new LinkedDoorXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Unknown":
                    errorMask?.PushIndex((int)LinkedDoor_FieldIndex.Unknown);
                    try
                    {
                    ...
                    break;
                case "Door":
                    errorMask?.PushIndex((int)LinkedDoor_FieldIndex.Door);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class LinkedDoorXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((LinkedDoorXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ILinkedDoorGetter
    {
        ...
        public IFormLinkGetter<IPlacedObjectGetter> Door => new FormLink<IPlacedObjectGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x4, 0x4))));
        partial void CustomCtor(
