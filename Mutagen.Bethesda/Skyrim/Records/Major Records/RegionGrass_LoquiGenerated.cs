...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IRegionGrassGetter
    {
        ...
        public IFormLinkGetter<IGrassGetter> Grass => new FormLink<IGrassGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
