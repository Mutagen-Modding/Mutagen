...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        {
            #region Members
            public MaskItem<bool, RegionGrass.TranslationMask?> Grasses;
            #endregion
            ...
            public TranslationMask(bool defaultOn)
                : base(defaultOn)
            {
                this.Grasses = new MaskItem<bool, RegionGrass.TranslationMask?>(defaultOn, null);
            }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class RegionGrassesCommon : RegionDataCommon
    {
        ...
        public IEnumerable<FormKey> GetLinkFormKeys(IRegionGrassesGetter obj)
        {
            ...
            {
                foreach (var item in GrassesItem.SelectMany(f => f.LinkFormKeys))
                {
                    yield return item;
                }
            }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                ListXmlTranslation<IRegionGrassGetter>.Instance.Write(
                    node: node,
                    ...
                    transl: (XElement subNode, IRegionGrassGetter subItem, ErrorMaskBuilder? listSubMask, TranslationCrystal? listTranslMask) =>
                    {
                        var Item = subItem;
                        ((RegionGrassXmlWriteTranslation)((IXmlItem)Item).XmlWriteTranslator).Write(
                            item: Item,
                            node: subNode,
                            name: null,
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionGrasses");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionGrasses");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "Grasses":
                    ...
                    try
                    {
                        if (ListXmlTranslation<RegionGrass>.Instance.Parse(
                            node: node,
                            enumer: out var GrassesItem,
                            transl: LoquiXmlTranslation<RegionGrass>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Binary.ListBinaryTranslation<IRegionGrassGetter>.Instance.Write(
                ...
                transl: (MutagenWriter subWriter, IRegionGrassGetter subItem, RecordTypeConverter? conv) =>
                {
                    var Item = subItem;
