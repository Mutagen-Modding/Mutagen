...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IRegionSoundGetter
    {
        ...
        public IFormLinkGetter<ISoundDescriptorGetter> Sound => new FormLink<ISoundDescriptorGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
