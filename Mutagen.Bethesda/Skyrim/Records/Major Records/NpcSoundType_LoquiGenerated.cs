...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        #region Mutagen
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public IEnumerable<ILinkGetter> Links => NpcSoundTypeCommon.Instance.GetLinks(this);
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class NpcSoundTypeCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(INpcSoundTypeGetter obj)
        {
    ...
    public partial class NpcSoundTypeBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<NpcSoundType.SoundType>.Instance.WriteNullable(
                ...
                item.Type,
                length: 4,
                header: recordTypeConverter.ConvertToCustom(NpcSoundType_Registration.CSDT_HEADER));
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        INpcSoundTypeGetter
    {
        ...
        public NpcSoundType.SoundType? Type => Type_IsSet ? (NpcSoundType.SoundType)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _TypeLocation!.Value, _package.Meta)) : default(NpcSoundType.SoundType?);
        #endregion
