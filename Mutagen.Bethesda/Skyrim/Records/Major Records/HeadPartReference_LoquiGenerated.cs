...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
            ...
            where TItem : notnull
        {
            ...
            {
                int ret = 0;
                ret = ret.CombineHashCode(this.Number?.GetHashCode());
                ret = ret.CombineHashCode(this.Head?.GetHashCode());
                return ret;
            }
        ...
        #region Mutagen
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public IEnumerable<ILinkGetter> Links => HeadPartReferenceCommon.Instance.GetLinks(this);
        #endregion
    ...
    #region Common MixIn
    public static class HeadPartReferenceMixIn
    {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class HeadPartReferenceCommon
    {
        ...
        public virtual int GetHashCode(IHeadPartReferenceGetter item)
        {
            ...
            {
                ret = HashHelper.GetHashCode(Numberitem).CombineHashCode(ret);
            }
            if (item.Head.TryGet(out var Headitem))
            {
                ret = HashHelper.GetHashCode(Headitem).CombineHashCode(ret);
            }
            return ret;
        }
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IHeadPartReferenceGetter obj)
        {
