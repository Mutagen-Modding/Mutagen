...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => RegionObjectXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((RegionObjectXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static RegionObject CreateFromXml(
            XElement node,
            RegionObject.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((RegionObjectSetterCommon)((IRegionObjectGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class RegionObjectMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((RegionObjectSetterCommon)((IRegionObjectGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class RegionObject_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.RegionObject";
        ...
        public static readonly Type XmlWriteTranslation = typeof(RegionObjectXmlWriteTranslation);
    ...
    public partial class RegionObjectSetterCommon
    {
        ...
        {
            ClearPartial();
            item.Object = new FormLink<IRegionTarget>(FormKey.Null);
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    RegionObjectXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class RegionObjectXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static RegionObjectXmlWriteTranslation Instance = new RegionObjectXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Object) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Object),
                    item: item.Object.FormKey,
                    fieldIndex: (int)RegionObject_FieldIndex.Object,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.ParentIndex) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ParentIndex),
                    item: item.ParentIndex,
                    fieldIndex: (int)RegionObject_FieldIndex.ParentIndex,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Unknown) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)RegionObject_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Density) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Density),
                    item: item.Density,
                    fieldIndex: (int)RegionObject_FieldIndex.Density,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Clustering) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Clustering),
                    item: item.Clustering,
                    fieldIndex: (int)RegionObject_FieldIndex.Clustering,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.MinSlope) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.MinSlope),
                    item: item.MinSlope,
                    fieldIndex: (int)RegionObject_FieldIndex.MinSlope,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.MaxSlope) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.MaxSlope),
                    item: item.MaxSlope,
                    fieldIndex: (int)RegionObject_FieldIndex.MaxSlope,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Flags) ?? true))
            {
                EnumXmlTranslation<RegionObject.Flag>.Instance.Write(
                    node: node,
                    name: nameof(item.Flags),
                    item: item.Flags,
                    fieldIndex: (int)RegionObject_FieldIndex.Flags,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.RadiusWrtPercent) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RadiusWrtPercent),
                    item: item.RadiusWrtPercent,
                    fieldIndex: (int)RegionObject_FieldIndex.RadiusWrtPercent,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Radius) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Radius),
                    item: item.Radius,
                    fieldIndex: (int)RegionObject_FieldIndex.Radius,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.MinHeight) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.MinHeight),
                    item: item.MinHeight,
                    fieldIndex: (int)RegionObject_FieldIndex.MinHeight,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.MaxHeight) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.MaxHeight),
                    item: item.MaxHeight,
                    fieldIndex: (int)RegionObject_FieldIndex.MaxHeight,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Sink) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Sink),
                    item: item.Sink,
                    fieldIndex: (int)RegionObject_FieldIndex.Sink,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.SinkVariance) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SinkVariance),
                    item: item.SinkVariance,
                    fieldIndex: (int)RegionObject_FieldIndex.SinkVariance,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.SizeVariance) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SizeVariance),
                    item: item.SizeVariance,
                    fieldIndex: (int)RegionObject_FieldIndex.SizeVariance,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.AngleVariance) ?? true))
            {
                P3UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.AngleVariance),
                    item: item.AngleVariance,
                    fieldIndex: (int)RegionObject_FieldIndex.AngleVariance,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)RegionObject_FieldIndex.Unknown2) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown2),
                    item: item.Unknown2,
                    fieldIndex: (int)RegionObject_FieldIndex.Unknown2,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionObject");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionObject");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class RegionObjectXmlCreateTranslation
    {
        public readonly static RegionObjectXmlCreateTranslation Instance = new RegionObjectXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Object":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Object);
                    try
                    {
                    ...
                    break;
                case "ParentIndex":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.ParentIndex);
                    try
                    {
                    ...
                    break;
                case "Unknown":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Unknown);
                    try
                    {
                    ...
                    break;
                case "Density":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Density);
                    try
                    {
                    ...
                    break;
                case "Clustering":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Clustering);
                    try
                    {
                    ...
                    break;
                case "MinSlope":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.MinSlope);
                    try
                    {
                    ...
                    break;
                case "MaxSlope":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.MaxSlope);
                    try
                    {
                    ...
                    break;
                case "Flags":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Flags);
                    try
                    {
                        item.Flags = EnumXmlTranslation<RegionObject.Flag>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "RadiusWrtPercent":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.RadiusWrtPercent);
                    try
                    {
                    ...
                    break;
                case "Radius":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Radius);
                    try
                    {
                    ...
                    break;
                case "MinHeight":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.MinHeight);
                    try
                    {
                    ...
                    break;
                case "MaxHeight":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.MaxHeight);
                    try
                    {
                    ...
                    break;
                case "Sink":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Sink);
                    try
                    {
                    ...
                    break;
                case "SinkVariance":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.SinkVariance);
                    try
                    {
                    ...
                    break;
                case "SizeVariance":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.SizeVariance);
                    try
                    {
                    ...
                    break;
                case "AngleVariance":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.AngleVariance);
                    try
                    {
                    ...
                    break;
                case "Unknown2":
                    errorMask?.PushIndex((int)RegionObject_FieldIndex.Unknown2);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class RegionObjectXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((RegionObjectXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IRegionObjectGetter
    {
        ...
        public IFormLinkGetter<IRegionTargetGetter> Object => new FormLink<IRegionTargetGetter>(FormKey.Factory(_package.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
