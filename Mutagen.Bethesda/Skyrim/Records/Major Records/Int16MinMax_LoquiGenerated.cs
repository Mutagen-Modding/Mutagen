...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected object XmlWriteTranslator => Int16MinMaxXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((Int16MinMaxXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static Int16MinMax CreateFromXml(
            XElement node,
            Int16MinMax.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((Int16MinMaxSetterCommon)((IInt16MinMaxGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class Int16MinMaxMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((Int16MinMaxSetterCommon)((IInt16MinMaxGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class Int16MinMax_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(Int16MinMaxXmlWriteTranslation);
    ...
    public partial class Int16MinMaxSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    Int16MinMaxXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class Int16MinMaxXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static Int16MinMaxXmlWriteTranslation Instance = new Int16MinMaxXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)Int16MinMax_FieldIndex.Min) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Min),
                    item: item.Min,
                    fieldIndex: (int)Int16MinMax_FieldIndex.Min,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)Int16MinMax_FieldIndex.Max) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Max),
                    item: item.Max,
                    fieldIndex: (int)Int16MinMax_FieldIndex.Max,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.Int16MinMax");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.Int16MinMax");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class Int16MinMaxXmlCreateTranslation
    {
        public readonly static Int16MinMaxXmlCreateTranslation Instance = new Int16MinMaxXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Min":
                    errorMask?.PushIndex((int)Int16MinMax_FieldIndex.Min);
                    try
                    {
                        item.Min = Int16XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "Max":
                    errorMask?.PushIndex((int)Int16MinMax_FieldIndex.Max);
                    try
                    {
                        item.Max = Int16XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class Int16MinMaxXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((Int16MinMaxXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
