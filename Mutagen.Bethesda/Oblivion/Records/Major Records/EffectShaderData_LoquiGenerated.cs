...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class EffectShaderData_Registration : ILoquiRegistration
    {
        ...
        public const int NumStructFields = 56;
    ...
    public partial class EffectShaderDataSetterCommon
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(EffectShaderData_Registration.DATA_HEADER)));
    ...
    public partial class EffectShaderDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IEffectShaderDataGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IEffectShaderDataGetter
    {
        ...
        public EffectShader.Flag Flags => (EffectShader.Flag)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(0, 4));
        public EffectShader.SourceBlendMode MembraneShaderSourceBlendMode => (EffectShader.SourceBlendMode)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(4, 4));
        public EffectShader.BlendOperation MembraneShaderBlendOperation => (EffectShader.BlendOperation)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(8, 4));
        public EffectShader.ZTestFunction MembraneShaderZTestFunction => (EffectShader.ZTestFunction)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(12, 4));
        public Color FillTextureEffectColor => _data.Slice(16, 4).ReadColor();
        public Single FillTextureEffectAlphaFadeInTime => SpanExt.GetFloat(_data.Slice(20, 4));
        public Single FillTextureEffectFullAlphaTime => SpanExt.GetFloat(_data.Slice(24, 4));
        public Single FillTextureEffectAlphaFadeOutTime => SpanExt.GetFloat(_data.Slice(28, 4));
        public Single FillTextureEffectPersistentAlphaRatio => SpanExt.GetFloat(_data.Slice(32, 4));
        public Single FillTextureEffectAlphaPulseAmplitude => SpanExt.GetFloat(_data.Slice(36, 4));
        public Single FillTextureEffectAlphaPulseFrequency => SpanExt.GetFloat(_data.Slice(40, 4));
        public Single FillTextureEffectTextureAnimationSpeedU => SpanExt.GetFloat(_data.Slice(44, 4));
        public Single FillTextureEffectTextureAnimationSpeedV => SpanExt.GetFloat(_data.Slice(48, 4));
        public Single EdgeEffectFallOff => SpanExt.GetFloat(_data.Slice(52, 4));
        public Color EdgeEffectColor => _data.Slice(56, 4).ReadColor();
        public Single EdgeEffectAlphaFadeInTime => SpanExt.GetFloat(_data.Slice(60, 4));
        public Single EdgeEffectFullAlphaTime => SpanExt.GetFloat(_data.Slice(64, 4));
        public Single EdgeEffectAlphaFadeOutTime => SpanExt.GetFloat(_data.Slice(68, 4));
        public Single EdgeEffectPersistentAlphaRatio => SpanExt.GetFloat(_data.Slice(72, 4));
        public Single EdgeEffectAlphaPulseAmplitude => SpanExt.GetFloat(_data.Slice(76, 4));
        public Single EdgeEffectAlphaPulseFrequency => SpanExt.GetFloat(_data.Slice(80, 4));
        public Single FillTextureEffectFullAlphaRatio => SpanExt.GetFloat(_data.Slice(84, 4));
        public Single EdgeEffectFullAlphaRatio => SpanExt.GetFloat(_data.Slice(88, 4));
        public EffectShader.SourceBlendMode MembraneShaderDestBlendMode => (EffectShader.SourceBlendMode)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(92, 4));
        public EffectShader.SourceBlendMode ParticleShaderSourceBlendMode => (EffectShader.SourceBlendMode)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(96, 4));
        public EffectShader.BlendOperation ParticleShaderBlendOperation => (EffectShader.BlendOperation)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(100, 4));
        public EffectShader.ZTestFunction ParticleShaderZTestFunction => (EffectShader.ZTestFunction)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(104, 4));
        public EffectShader.SourceBlendMode ParticleShaderDestBlendMode => (EffectShader.SourceBlendMode)BinaryPrimitives.ReadInt32LittleEndian(_data.Span.Slice(108, 4));
        public Single ParticleShaderParticleBirthRampUpTime => SpanExt.GetFloat(_data.Slice(112, 4));
        public Single ParticleShaderFullParticleBirthTime => SpanExt.GetFloat(_data.Slice(116, 4));
        public Single ParticleShaderParticleBirthRampDownTime => SpanExt.GetFloat(_data.Slice(120, 4));
        public Single ParticleShaderFullParticleBirthRatio => SpanExt.GetFloat(_data.Slice(124, 4));
        public Single ParticleShaderPersistentParticleBirthRatio => SpanExt.GetFloat(_data.Slice(128, 4));
        public Single ParticleShaderParticleLifetime => SpanExt.GetFloat(_data.Slice(132, 4));
        public Single ParticleShaderParticleLifetimePlusMinus => SpanExt.GetFloat(_data.Slice(136, 4));
        public Single ParticleShaderInitialSpeedAlongNormal => SpanExt.GetFloat(_data.Slice(140, 4));
        public Single ParticleShaderAccelerationAlongNormal => SpanExt.GetFloat(_data.Slice(144, 4));
        public Single ParticleShaderInitialVelocity1 => SpanExt.GetFloat(_data.Slice(148, 4));
        public Single ParticleShaderInitialVelocity2 => SpanExt.GetFloat(_data.Slice(152, 4));
        public Single ParticleShaderInitialVelocity3 => SpanExt.GetFloat(_data.Slice(156, 4));
        public Single ParticleShaderAcceleration1 => SpanExt.GetFloat(_data.Slice(160, 4));
        public Single ParticleShaderAcceleration2 => SpanExt.GetFloat(_data.Slice(164, 4));
        public Single ParticleShaderAcceleration3 => SpanExt.GetFloat(_data.Slice(168, 4));
        public Single ParticleShaderScaleKey1 => SpanExt.GetFloat(_data.Slice(172, 4));
        public Single ParticleShaderScaleKey2 => SpanExt.GetFloat(_data.Slice(176, 4));
        public Single ParticleShaderScaleKey1Time => SpanExt.GetFloat(_data.Slice(180, 4));
        public Single ParticleShaderScaleKey2Time => SpanExt.GetFloat(_data.Slice(184, 4));
        public Color ColorKey1Color => _data.Slice(188, 4).ReadColor();
        public Color ColorKey2Color => _data.Slice(192, 4).ReadColor();
        public Color ColorKey3Color => _data.Slice(196, 4).ReadColor();
        public Single ColorKey1ColorAlpha => SpanExt.GetFloat(_data.Slice(200, 4));
        public Single ColorKey2ColorAlpha => SpanExt.GetFloat(_data.Slice(204, 4));
        public Single ColorKey3ColorAlpha => SpanExt.GetFloat(_data.Slice(208, 4));
        public Single ColorKey1ColorKeyTime => SpanExt.GetFloat(_data.Slice(212, 4));
        public Single ColorKey2ColorKeyTime => SpanExt.GetFloat(_data.Slice(216, 4));
        public Single ColorKey3ColorKeyTime => SpanExt.GetFloat(_data.Slice(220, 4));
        partial void CustomCtor(
