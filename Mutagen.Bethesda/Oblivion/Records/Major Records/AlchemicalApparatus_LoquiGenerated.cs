...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IAlchemicalApparatusGetter
    {
        ...
        public IAlchemicalApparatusDataGetter? Data => _DataLocation.HasValue ? AlchemicalApparatusDataBinaryOverlay.AlchemicalApparatusDataFactory(new BinaryMemoryReadStream(_data.Slice(_DataLocation!.Value.Min)), _package, default(RecordTypeConverter)) : default;
