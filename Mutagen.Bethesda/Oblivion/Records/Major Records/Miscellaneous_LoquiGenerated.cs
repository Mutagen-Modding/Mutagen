...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IMiscellaneousGetter
    {
        ...
        public IMiscellaneousDataGetter? Data => _DataLocation.HasValue ? MiscellaneousDataBinaryOverlay.MiscellaneousDataFactory(new BinaryMemoryReadStream(_data.Slice(_DataLocation!.Value.Min)), _package, default(RecordTypeConverter)) : default;
