...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class CombatStyleDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(ICombatStyleDataGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        ICombatStyleDataGetter
    {
        ...
        public Byte DodgePercentChance => _data.Span[0];
        public Byte LeftRightPercentChance => _data.Span[1];
        public Single DodgeLeftRightTimerMin => SpanExt.GetFloat(_data.Slice(4, 4));
        public Single DodgeLeftRightTimerMax => SpanExt.GetFloat(_data.Slice(8, 4));
        public Single DodgeForwardTimerMin => SpanExt.GetFloat(_data.Slice(12, 4));
        public Single DodgeForwardTimerMax => SpanExt.GetFloat(_data.Slice(16, 4));
        public Single DodgeBackTimerMin => SpanExt.GetFloat(_data.Slice(20, 4));
        public Single DodgeBackTimerMax => SpanExt.GetFloat(_data.Slice(24, 4));
        public Single IdleTimerMin => SpanExt.GetFloat(_data.Slice(28, 4));
        public Single IdleTimerMax => SpanExt.GetFloat(_data.Slice(32, 4));
        public Byte BlockPercentChance => _data.Span[36];
        public Byte AttackPercentChance => _data.Span[37];
        public Single RecoilStaggerBonusToAttack => SpanExt.GetFloat(_data.Slice(40, 4));
        public Single UnconsciousBonusToAttack => SpanExt.GetFloat(_data.Slice(44, 4));
        public Single HandToHandBonusToAttack => SpanExt.GetFloat(_data.Slice(48, 4));
        public Byte PowerAttackPercentChance => _data.Span[52];
        public Single RecoilStaggerBonusToPowerAttack => SpanExt.GetFloat(_data.Slice(56, 4));
        public Single UnconsciousBonusToPowerAttack => SpanExt.GetFloat(_data.Slice(60, 4));
        public Byte PowerAttackNormal => _data.Span[64];
        public Byte PowerAttackForward => _data.Span[65];
        public Byte PowerAttackBack => _data.Span[66];
        public Byte PowerAttackLeft => _data.Span[67];
        public Byte PowerAttackRight => _data.Span[68];
        public Single HoldTimerMin => SpanExt.GetFloat(_data.Slice(72, 4));
        public Single HoldTimerMax => SpanExt.GetFloat(_data.Slice(76, 4));
        public CombatStyle.Flag Flags => GetFlagsCustom(location: 80);
        public Byte AcrobaticDodgePercentChance => _data.Span[81];
        public Single RangeMultOptimal => SpanExt.GetFloat(_data.Slice(84, 4));
        public Single RangeMultMax => SpanExt.GetFloat(_data.Slice(88, 4));
        public Single SwitchDistanceMelee => SpanExt.GetFloat(_data.Slice(92, 4));
        public Single SwitchDistanceRanged => SpanExt.GetFloat(_data.Slice(96, 4));
        public Single BuffStandoffDistance => SpanExt.GetFloat(_data.Slice(100, 4));
        public Single RangedStandoffDistance => SpanExt.GetFloat(_data.Slice(104, 4));
        public Single GroupStandoffDistance => SpanExt.GetFloat(_data.Slice(108, 4));
        public Byte RushingAttackPercentChance => _data.Span[112];
        public Single RushingAttackDistanceMult => SpanExt.GetFloat(_data.Slice(116, 4));
