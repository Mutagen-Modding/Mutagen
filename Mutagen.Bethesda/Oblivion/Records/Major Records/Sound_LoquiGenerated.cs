...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        public static new Sound CreateFromXml(
            XElement node,
            Sound.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static new Sound CreateFromBinary(MutagenFrame frame)
        {
    ...
    public static class SoundMixIn
    {
        ...
        public static Sound.Mask<bool> GetHasBeenSetMask(this ISoundGetter item)
        {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class SoundCommon : OblivionMajorRecordCommon
    {
        ...
        public bool HasBeenSet(
            ...
            Sound.Mask<bool?> checkMask)
        {
            if (checkMask.File.HasValue && checkMask.File.Value != (item.File != null)) return false;
        ...
        public void FillHasBeenSetMask(
            ISoundGetter item,
            Sound.Mask<bool> mask)
        {
            mask.File = (item.File != null);
            var itemData = item.Data;
            mask.Data = new MaskItem<bool, SoundData.Mask<bool>?>(itemData != null, itemData?.GetHasBeenSetMask());
        ...
        public virtual int GetHashCode(ISoundGetter item)
        {
            ...
            {
                ret = HashHelper.GetHashCode(Fileitem).CombineHashCode(ret);
            }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        ISoundGetter
    {
        ...
        public String? File => _FileLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _FileLocation.Value, _package.Meta)) : default(string?);
        #endregion
        #region Data
