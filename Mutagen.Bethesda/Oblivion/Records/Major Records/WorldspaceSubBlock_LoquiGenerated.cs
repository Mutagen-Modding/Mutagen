...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        #region Items
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<Cell>? _Items;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public IEnumerable<ILinkGetter> Links => WorldspaceSubBlockCommon.Instance.GetLinks(this);
        [DebuggerStepThrough]
        ...
        {
            var ret = new WorldspaceSubBlock();
            await ((WorldspaceSubBlockSetterCommon)((IWorldspaceSubBlockGetter)ret).CommonSetterInstance()!).CopyInFromBinary(
                item: ret,
                masterReferences: masterReferences,
                frame: frame,
        ...
        ILoquiObjectSetter<IWorldspaceSubBlock>
    {
        ...
        new ExtendedList<Cell>? Items { get; set; }
    }
    ...
    public static class WorldspaceSubBlockMixIn
    {
        ...
        public static async Task CopyInFromBinary(
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            await ((WorldspaceSubBlockSetterCommon)((IWorldspaceSubBlockGetter)item).CommonSetterInstance()!).CopyInFromBinary(
                item: item,
                masterReferences: masterReferences,
                frame: frame,
                recordTypeConverter: recordTypeConverter);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class WorldspaceSubBlockCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IWorldspaceSubBlockGetter obj)
        {
            if (obj.Items != null)
            {
    ...
    public partial class WorldspaceSubBlockBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            MasterReferenceReader masterReferences)
        {
            Mutagen.Bethesda.Binary.ListBinaryTranslation<ICellGetter>.Instance.Write(
                ...
                items: item.Items,
                masterReferences: masterReferences,
                transl: (MutagenWriter subWriter, ICellGetter subItem, MasterReferenceReader m, RecordTypeConverter? conv) =>
                {
                    if (subItem.TryGet(out var Item))
                    {
