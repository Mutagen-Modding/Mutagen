...
{
    #region Class
    public partial class Group<T> : IGroup<T>, ILoquiObject<Group<T>>, ILoquiObjectSetter, IEquatable<Group<T>>
        where T : IFormID, ILoquiObject<T>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "LastModified":
                    ...
                    break;
                case "Items":
                    KeyedDictXmlTranslation<FormID, T>.Instance.ParseInto(
                        root: root,
                        item: item._Items,
        ...
        protected static TryGet<Group_FieldIndex?> Fill_Binary_RecordTypes(
            Group<T> item,
            MutagenFrame frame,
            ErrorMaskBuilder errorMask,
