    ...
    public static class Group
    {
            ...
            where T : notnull
        {
            ...
            public Mask(T initialValue)
            {
                ...
                this.RecordCache = new MaskItem<T, IEnumerable<MaskItemIndexed<FormKey, T, SkyrimMajorRecord.Mask<T>?>>?>(initialValue, null);
            }
                ...
                T RecordCache)
            {
                ...
                this.RecordCache = new MaskItem<T, IEnumerable<MaskItemIndexed<FormKey, T, SkyrimMajorRecord.Mask<T>?>>?>(RecordCache, null);
            }
            ...
            public T Unknown;
            public MaskItem<T, IEnumerable<MaskItemIndexed<FormKey, T, SkyrimMajorRecord.Mask<T>?>>?>? RecordCache;
            #endregion
            ...
            {
                fg.AppendLine($"{nameof(Group.Mask<T>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    if (printMask?.GroupType ?? true)
