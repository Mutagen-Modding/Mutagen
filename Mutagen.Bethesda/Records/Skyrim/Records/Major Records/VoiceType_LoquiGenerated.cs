...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
            ...
            where T : notnull
        {
            ...
            {
                fg.AppendLine($"{nameof(VoiceType.Mask<T>)} =>");
                fg.AppendLine("[");
        ...
        #region Mutagen
        public new static readonly RecordType GRUP_RECORD_TYPE = VoiceType_Registration.TRIGGERING_RECORD_TYPE;
        ...
        [DebuggerStepThrough]
        public static new VoiceType CreateFromBinary(
            MutagenFrame frame,
            MasterReferences masterReferences)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class VoiceType_Registration : ILoquiRegistration
    {
        ...
        public static readonly RecordType TRIGGERING_RECORD_TYPE = VTYP_HEADER;
    ...
    public partial class VoiceTypeCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<ILinkGetter> GetLinks(IVoiceTypeGetter obj)
        {
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            using (HeaderExport.ExportHeader(
                writer: writer,
                record: VoiceType_Registration.VTYP_HEADER,
