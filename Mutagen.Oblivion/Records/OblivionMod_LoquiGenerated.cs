...
namespace Mutagen.Oblivion
{
    ...
    public partial class OblivionMod : IOblivionMod, ILoquiObjectSetter, IEquatable<OblivionMod>
    {
        ...
        #endregion
        #region Enchantments
        private readonly INotifyingItem<Group<Enchantment>> _Enchantments = new NotifyingItem<Group<Enchantment>>();
        public INotifyingItem<Group<Enchantment>> Enchantments_Property => this._Enchantments;
        ...
        INotifyingItem<Group<Enchantment>> IOblivionMod.Enchantments_Property => this.Enchantments_Property;
        INotifyingItemGetter<Group<Enchantment>> IOblivionModGetter.Enchantments_Property => this.Enchantments_Property;
        #endregion
    ...
    public interface IOblivionMod : IOblivionModGetter, ILoquiClass<IOblivionMod, IOblivionModGetter>, ILoquiClass<OblivionMod, IOblivionModGetter>
    {
        ...
        new INotifyingItem<Group<Enchantment>> Enchantments_Property { get; }
    ...
    public interface IOblivionModGetter : ILoquiObject
    {
        ...
        INotifyingItemGetter<Group<Enchantment>> Enchantments_Property { get; }
...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class OblivionMod_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.OblivionMod";
    ...
    public static partial class OblivionModCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.OblivionMod"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.OblivionMod");
                    }
                    ...
                    {
                        MaskItem<Exception, Group_ErrorMask<Enchantment_ErrorMask>> subMask;
                        LoquiXmlTranslation<IGroupGetter<Enchantment>, Group_ErrorMask<Enchantment_ErrorMask>>.Instance.Write(
                            writer: writer,
                            item: item.Enchantments,
                            name: nameof(item.Enchantments),
                            doMasks: errorMask != null,
                            mask: out Group_ErrorMask<Enchantment_ErrorMask> loquiMask);
                        subMask = loquiMask == null ? null : new MaskItem<Exception, Group_ErrorMask<Enchantment_ErrorMask>>(null, loquiMask);
                        ErrorMask.HandleErrorMask(
                            errorMask,
                            (int)OblivionMod_FieldIndex.Enchantments,
                            subMask);
