...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class MasterReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.MasterReference";
    ...
    public static partial class MasterReferenceCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.MasterReference"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.MasterReference");
                    }
