...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class TES4_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.TES4";
    ...
    public static partial class TES4Common
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.TES4"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.TES4");
                    }
