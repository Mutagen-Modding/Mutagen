...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Header_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Header";
    ...
    public static partial class HeaderCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Header"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Header");
                    }
