...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GenderedBodyData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GenderedBodyData";
    ...
    public static partial class GenderedBodyDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GenderedBodyData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GenderedBodyData");
                    }
