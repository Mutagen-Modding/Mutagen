...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class ClassTraining_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.ClassTraining";
    ...
    public static partial class ClassTrainingCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.ClassTraining"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.ClassTraining");
                    }
