...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GameSettingInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GameSettingInt";
    ...
    public static partial class GameSettingIntCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GameSettingInt"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GameSettingInt");
                    }
