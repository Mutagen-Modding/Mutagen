...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class EnchantmentEffect_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.EnchantmentEffect";
    ...
    public static partial class EnchantmentEffectCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.EnchantmentEffect"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.EnchantmentEffect");
                    }
