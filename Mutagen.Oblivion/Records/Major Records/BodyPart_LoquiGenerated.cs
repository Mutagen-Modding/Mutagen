...
namespace Mutagen.Oblivion
{
    ...
    public partial class BodyPart : IBodyPart, ILoquiObjectSetter, IEquatable<BodyPart>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (BodyPart_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<BodyPart, BodyPart_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
            ...
            IBodyPartGetter def = null)
        {
            ...
            {
                ret = (BodyPart)Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class BodyPart_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.BodyPart";
    ...
    public static partial class BodyPartCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.BodyPart"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.BodyPart");
                    }
