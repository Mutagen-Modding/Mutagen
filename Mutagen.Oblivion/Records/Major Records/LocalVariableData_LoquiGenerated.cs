...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class LocalVariableData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.LocalVariableData";
    ...
    public static partial class LocalVariableDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.LocalVariableData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.LocalVariableData");
                    }
