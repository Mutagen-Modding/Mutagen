...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Hair_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Hair";
    ...
    public static partial class HairCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Hair"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Hair");
                    }
