...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class SoundDataExtended_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.SoundDataExtended";
    ...
    public static partial class SoundDataExtendedCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.SoundDataExtended"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.SoundDataExtended");
                    }
