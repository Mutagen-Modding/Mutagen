...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Enchantment_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "0da326e3-960f-4c8d-880d-64593d78494b";
        ...
        public const string FullName = "Mutagen.Oblivion.Enchantment";
    ...
    public static partial class EnchantmentCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Enchantment"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Enchantment");
                    }
