...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class RaceVoices_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.RaceVoices";
    ...
    public static partial class RaceVoicesCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.RaceVoices"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.RaceVoices");
                    }
