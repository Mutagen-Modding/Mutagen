...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class FacePart_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.FacePart";
    ...
    public static partial class FacePartCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.FacePart"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.FacePart");
                    }
