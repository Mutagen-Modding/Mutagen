...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class ScriptReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.ScriptReference";
    ...
    public static partial class ScriptReferenceCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.ScriptReference"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.ScriptReference");
                    }
