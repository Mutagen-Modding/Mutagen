...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class MagicEffect_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.MagicEffect";
    ...
    public static partial class MagicEffectCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.MagicEffect"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.MagicEffect");
                    }
