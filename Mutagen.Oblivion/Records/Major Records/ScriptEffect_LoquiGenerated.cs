...
namespace Mutagen.Oblivion
{
    ...
    public partial class ScriptEffect : IScriptEffect, ILoquiObjectSetter, IEquatable<ScriptEffect>
    {
        ...
        #region Script
        protected readonly INotifyingItem<FormID> _Script = NotifyingItem.Factory<FormID>(markAsSet: false);
        ...
        #endregion
        #region VisualEffect
        protected readonly INotifyingItem<FormID> _VisualEffect = NotifyingItem.Factory<FormID>(markAsSet: false);
        ...
        #endregion
        #region Flags
        protected readonly INotifyingItem<ScriptEffect.Flag> _Flags = NotifyingItem.Factory<ScriptEffect.Flag>(markAsSet: false);
...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class ScriptEffect_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.ScriptEffect";
    ...
    public static partial class ScriptEffectCommon
    {
            ...
            if (copyMask?.VisualEffect ?? true)
            {
                try
                {
                    item.VisualEffect_Property.SetToWithDefault(
                        rhs.VisualEffect_Property,
                        def?.VisualEffect_Property,
                        cmds);
                }
                catch (Exception ex)
                when (doMasks)
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.ScriptEffect"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.ScriptEffect");
                    }
