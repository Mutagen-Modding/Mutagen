...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class HavokData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "4d0528e4-6b76-4756-aae2-6822b10f7601";
        ...
        public const string FullName = "Mutagen.Oblivion.HavokData";
    ...
    public static partial class HavokDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.HavokData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.HavokData");
                    }
