...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Spell_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Spell";
    ...
    public static partial class SpellCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Spell"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Spell");
                    }
                }
            }
            catch (Exception ex)
