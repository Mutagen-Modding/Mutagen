...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class SkillBoost_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.SkillBoost";
    ...
    public static partial class SkillBoostCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.SkillBoost"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.SkillBoost");
                    }
