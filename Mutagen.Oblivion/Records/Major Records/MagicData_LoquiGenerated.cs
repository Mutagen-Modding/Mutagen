...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class MagicData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.MagicData";
    ...
    public static partial class MagicDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.MagicData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.MagicData");
                    }
