...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GlobalInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GlobalInt";
    ...
    public static partial class GlobalIntCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GlobalInt"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GlobalInt");
                    }
                }
            }
            catch (Exception ex)
