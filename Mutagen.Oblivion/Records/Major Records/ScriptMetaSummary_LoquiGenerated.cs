...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class ScriptMetaSummary_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.ScriptMetaSummary";
    ...
    public static partial class ScriptMetaSummaryCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.ScriptMetaSummary"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.ScriptMetaSummary");
                    }
