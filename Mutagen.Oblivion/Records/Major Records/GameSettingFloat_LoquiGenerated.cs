...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GameSettingFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GameSettingFloat";
    ...
    public static partial class GameSettingFloatCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GameSettingFloat"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GameSettingFloat");
                    }
