...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Global_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Global";
    ...
    public static partial class GlobalCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Global"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Global");
                    }
