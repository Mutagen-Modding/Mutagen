...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class RaceStatsGendered_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.RaceStatsGendered";
    ...
    public static partial class RaceStatsGenderedCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.RaceStatsGendered"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.RaceStatsGendered");
                    }
