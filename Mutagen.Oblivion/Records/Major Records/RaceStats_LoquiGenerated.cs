...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class RaceStats_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.RaceStats";
    ...
    public static partial class RaceStatsCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.RaceStats"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.RaceStats");
                    }
