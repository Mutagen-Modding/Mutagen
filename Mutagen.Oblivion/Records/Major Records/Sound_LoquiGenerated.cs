...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Sound_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Sound";
    ...
    public static partial class SoundCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Sound"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Sound");
                    }
