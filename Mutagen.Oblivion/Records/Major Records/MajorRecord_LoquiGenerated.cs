...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class MajorRecord_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.MajorRecord";
    ...
    public static partial class MajorRecordCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.MajorRecord"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.MajorRecord");
                    }
