...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GameSetting_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GameSetting";
    ...
    public static partial class GameSettingCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GameSetting"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GameSetting");
                    }
                }
            }
            catch (Exception ex)
