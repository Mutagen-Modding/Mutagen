...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Eye_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Eye";
    ...
    public static partial class EyeCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Eye"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Eye");
                    }
