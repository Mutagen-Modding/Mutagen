...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class FaceGenData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.FaceGenData";
    ...
    public static partial class FaceGenDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.FaceGenData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.FaceGenData");
                    }
