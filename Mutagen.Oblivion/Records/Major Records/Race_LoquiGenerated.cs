            ...
            Func<Race_ErrorMask> errorMask)
        {
            ...
            switch (nextRecordType.Type)
            {
                case "DESC":
                    ...
                    break;
                case "SPLO":
                    var SpellstryGet = Mutagen.Bethesda.Binary.ListBinaryTranslation<FormID, Exception>.Instance.ParseRepeatedItem(
                        frame: frame,
                ...
                case "HNAM":
                    frame.Position += Constants.SUBRECORD_LENGTH;
                    var HairstryGet = Mutagen.Bethesda.Binary.ListBinaryTranslation<FormID, Exception>.Instance.ParseRepeatedItem(
                        frame: frame.Spawn(contentLength),
                ...
                case "ENAM":
                    frame.Position += Constants.SUBRECORD_LENGTH;
                    var EyestryGet = Mutagen.Bethesda.Binary.ListBinaryTranslation<FormID, Exception>.Instance.ParseRepeatedItem(
                        frame: frame.Spawn(contentLength),
...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Race_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Race";
    ...
    public static partial class RaceCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Race"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Race");
                    }
