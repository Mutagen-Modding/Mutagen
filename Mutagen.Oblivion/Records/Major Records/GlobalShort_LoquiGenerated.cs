...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GlobalShort_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GlobalShort";
    ...
    public static partial class GlobalShortCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GlobalShort"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GlobalShort");
                    }
                }
            }
            catch (Exception ex)
