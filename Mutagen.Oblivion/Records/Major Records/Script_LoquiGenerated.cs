            ...
            Func<Script_ErrorMask> errorMask)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "SLSD":
                    ...
                    break;
                case "SCRO":
                    var ReferencestryGet = Mutagen.Bethesda.Binary.ListBinaryTranslation<FormID, Exception>.Instance.ParseRepeatedItem(
                        frame: frame,
...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Script_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Script";
    ...
    public static partial class ScriptCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Script"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Script");
                    }
