...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GameSettingString_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GameSettingString";
    ...
    public static partial class GameSettingStringCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GameSettingString"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GameSettingString");
                    }
