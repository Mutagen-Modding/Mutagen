...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Faction_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Faction";
    ...
    public static partial class FactionCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Faction"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Faction");
                    }
                    if (item.Relations.HasBeenSet)
                    {
                        MaskItem<Exception, IEnumerable<MaskItem<Exception, Relation_ErrorMask>>> subMask;
