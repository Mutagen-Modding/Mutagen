...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class GlobalFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.GlobalFloat";
    ...
    public static partial class GlobalFloatCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.GlobalFloat"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.GlobalFloat");
                    }
                }
            }
            catch (Exception ex)
