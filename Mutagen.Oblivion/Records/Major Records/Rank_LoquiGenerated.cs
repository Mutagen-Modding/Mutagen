...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Rank_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Rank";
    ...
    public static partial class RankCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Rank"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Rank");
                    }
