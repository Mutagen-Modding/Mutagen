...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class LocalVariable_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.LocalVariable";
    ...
    public static partial class LocalVariableCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.LocalVariable"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.LocalVariable");
                    }
