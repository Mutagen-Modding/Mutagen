...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class BodyData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.BodyData";
    ...
    public static partial class BodyDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.BodyData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.BodyData");
                    }
