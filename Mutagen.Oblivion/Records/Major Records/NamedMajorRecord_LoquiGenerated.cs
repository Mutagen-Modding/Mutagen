...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class NamedMajorRecord_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.NamedMajorRecord";
    ...
    public static partial class NamedMajorRecordCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.NamedMajorRecord"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.NamedMajorRecord");
                    }
