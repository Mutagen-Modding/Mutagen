...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Group_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Group";
    ...
    public static partial class GroupCommon
    {
            ...
            where T_ErrMask : MajorRecord_ErrorMask, IErrorMask<T_ErrMask>, new()
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Group"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Group");
                    }
