...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Relation_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Relation";
    ...
    public static partial class RelationCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Relation"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Relation");
                    }
