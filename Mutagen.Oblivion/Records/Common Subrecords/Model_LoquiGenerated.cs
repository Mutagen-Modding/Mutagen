...
namespace Mutagen.Oblivion.Internals
{
    ...
    public class Model_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Oblivion.Model";
    ...
    public static partial class ModelCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Oblivion.Model"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Oblivion.Model");
                    }
