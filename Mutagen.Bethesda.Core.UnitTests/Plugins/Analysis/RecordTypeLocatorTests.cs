...
public class RecordTypeLocatorTests
{
    ...
    public void TypicalSkyrim()
    {
        ...
        locs.GrupLocations.Values.Should().Equal(
            new GroupLocationMarker(new RangeInt64(80, 364), new("AMMO")),
            new GroupLocationMarker(new RangeInt64(365, 794), new("CELL")),
            new GroupLocationMarker(new RangeInt64(389, 794), new(0)),
            new GroupLocationMarker(new RangeInt64(413, 794), new(0)),
            new GroupLocationMarker(new RangeInt64(585, 794), new(0x39850)),
            new GroupLocationMarker(new RangeInt64(609, 706), new(0x39850)),
            new GroupLocationMarker(new RangeInt64(707, 794), new(0x39850)),
            new GroupLocationMarker(new RangeInt64(795, 1314), new("WRLD")),
            new GroupLocationMarker(new RangeInt64(1062, 1314), new(0x204C7)),
            new GroupLocationMarker(new RangeInt64(1086, 1314), new(0x1FFFF)),
            new GroupLocationMarker(new RangeInt64(1110, 1314), new(0x5FFFC)),
            new GroupLocationMarker(new RangeInt64(1221, 1314), new(0x204F2)),
            new GroupLocationMarker(new RangeInt64(1245, 1314), new(0x204F2)),
            new GroupLocationMarker(new RangeInt64(1315, 1567), new("DIAL")),
            new GroupLocationMarker(new RangeInt64(1413, 1567), new(0xE42)));
