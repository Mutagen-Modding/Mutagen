...
internal static class ModContextExt
{
    ...
    public static IEnumerable<IModContext<IFallout76Mod, IFallout76ModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
        this IFallout76ListGroupGetter<ICellBlockGetter> cellBlocks,
        ...
        bool throwIfUnknown)
    {
        foreach (var readOnlyBlock in cellBlocks.Records)
        {
            ...
            foreach (var readOnlySubBlock in readOnlyBlock.SubBlocks)
            {
                ...
                {
                    Func<IFallout76Mod, ICellGetter, bool, string?, FormKey?, ICell> cellGetter = (mod, copyCell, dup, edid, newForm) =>
                    {
                    ...
                    {
                        yield return new ModContext<IFallout76Mod, IFallout76ModGetter, IMajorRecord, IMajorRecordGetter>(
                            modKey: modKey,
                            record: readOnlyCell,
