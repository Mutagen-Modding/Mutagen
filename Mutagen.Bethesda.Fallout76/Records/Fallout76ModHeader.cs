...
public partial class Fallout76ModHeader
{
    ...
    public void SetOverriddenForms(IEnumerable<FormKey>? formKeys)
    {
        ...
        else
        {
            ...
            this.OverriddenForms.SetTo(formKeys.Select(f => f.ToLink<IFallout76MajorRecordGetter>()));
        }
    }
}

public partial interface IFallout76ModHeader : IModHeaderCommon
{
}

partial class Fallout76ModHeaderBinaryCreateTranslation
{
    public static partial void FillBinaryMasterReferencesCustom(MutagenFrame frame, IFallout76ModHeader item, PreviousParse lastParsed)
    {
...
partial class Fallout76ModHeaderBinaryWriteTranslation
{
    public static partial void WriteBinaryMasterReferencesCustom(MutagenWriter writer, IFallout76ModHeaderGetter item)
    {
