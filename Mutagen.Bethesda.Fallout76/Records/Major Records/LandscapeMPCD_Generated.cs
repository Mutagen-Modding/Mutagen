...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<LandscapeMPCD>
    {
        ...
        protected MemorySlice<Byte>? _MPCD;
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class LandscapeMPCD_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.LandscapeMPCD";
    ...
    internal partial class LandscapeMPCDSetterCommon
    {
            ...
            TypedParseParams translationParams)
        {
            ...
            PluginUtilityTranslation.SubrecordParse(
                ...
                frame: frame,
                translationParams: translationParams,
                fillTyped: LandscapeMPCDBinaryCreateTranslation.FillBinaryRecordTypes);
        }
    ...
    internal partial class LandscapeMPCDCommon
    {
        ...
        public void FillEqualsMask(
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ret.MPCD = MemorySliceExt.SequenceEqual(item.MPCD, rhs.MPCD);
        }
        ...
        {
            if ((printMask?.MPCD ?? true)
                && item.MPCD is {} MPCDItem)
            {
                sb.AppendLine($"MPCD => {SpanExt.ToHexString(MPCDItem)}");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!MemorySliceExt.SequenceEqual(lhs.MPCD, rhs.MPCD)) return false;
            }
            return true;
        }
    ...
    internal partial class LandscapeMPCDSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                if(rhs.MPCD is {} MPCDrhs)
                {
                    item.MPCD = MPCDrhs.ToArray();
                }
                else
                {
                    item.MPCD = default;
    ...
    internal partial class LandscapeMPCDBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.MPCD = ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
                    return (int)LandscapeMPCD_FieldIndex.MPCD;
                }
                default:
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILandscapeMPCDGetter
    {
        ...
        public ReadOnlyMemorySlice<Byte>? MPCD => _MPCDLocation.HasValue ? HeaderTranslation.ExtractSubrecordMemory(_recordData, _MPCDLocation.Value, _package.MetaData.Constants) : default(ReadOnlyMemorySlice<byte>?);
        #endregion
