...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IPackageScriptFragments
    {
        ...
        IScriptEntryGetter IPackageScriptFragmentsGetter.Script => Script;
        #endregion
        #region OnBegin
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case PackageScriptFragments_FieldIndex.Script:
                        return Script;
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => PackageScriptFragmentsCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => PackageScriptFragmentsSetterCommon.Instance.RemapLinks(this, mapping);
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class PackageScriptFragments_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.PackageScriptFragments";
    ...
    internal partial class PackageScriptFragmentsCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PackageScriptFragments_FieldIndex.Script) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Script, rhs.Script, out var lhsScript, out var rhsScript, out var isScriptEqual))
                {
                    if (!((ScriptEntryCommon)((IScriptEntryGetter)lhsScript).CommonInstance()!).Equals(lhsScript, rhsScript, equalsMask?.GetSubCrystal((int)PackageScriptFragments_FieldIndex.Script))) return false;
                }
    ...
    internal partial class PackageScriptFragmentsSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)PackageScriptFragments_FieldIndex.Script) ?? true))
            {
                errorMask?.PushIndex((int)PackageScriptFragments_FieldIndex.Script);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)PackageScriptFragments_FieldIndex.Script) ?? true))
                    {
                        item.Script = rhs.Script.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)PackageScriptFragments_FieldIndex.Script),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
