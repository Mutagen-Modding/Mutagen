            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case RegionArea_FieldIndex.Unknown:
                        return Unknown;
                    default:
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class RegionArea_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.RegionArea";
    ...
    internal partial class RegionAreaCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)RegionArea_FieldIndex.Unknown) ?? true))
            {
