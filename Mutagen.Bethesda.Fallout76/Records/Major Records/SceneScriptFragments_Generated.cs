...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ISceneScriptFragments
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => SceneScriptFragmentsCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class SceneScriptFragments_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.SceneScriptFragments";
    ...
    internal partial class SceneScriptFragmentsSetterCommon : ScriptFragmentsSetterCommon
    {
        ...
        public void RemapLinks(ISceneScriptFragments obj, IReadOnlyDictionary<FormKey, FormKey> mapping)
        {
            ...
            obj.PhaseFragments.RemapLinks(mapping);
        }
    ...
    internal partial class SceneScriptFragmentsCommon : ScriptFragmentsCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISceneScriptFragmentsGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.PhaseFragments.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
