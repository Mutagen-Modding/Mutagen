...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<BaseLayer>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((BaseLayerCommon)((IBaseLayerGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IBaseLayerGetter? obj)
        {
            return ((BaseLayerCommon)((IBaseLayerGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => BaseLayerCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class BaseLayer_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.BaseLayer";
    ...
    internal partial class BaseLayerCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)BaseLayer_FieldIndex.Header) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Header, rhs.Header, out var lhsHeader, out var rhsHeader, out var isHeaderEqual))
                {
                    if (!((LayerHeaderCommon)((ILayerHeaderGetter)lhsHeader).CommonInstance()!).Equals(lhsHeader, rhsHeader, equalsMask?.GetSubCrystal((int)BaseLayer_FieldIndex.Header))) return false;
                }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IBaseLayerGetter obj, bool iterateNestedRecords = true)
        {
            if (obj.Header is {} HeaderItems)
            {
                foreach (var item in HeaderItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.BTXT:
                {
                    ...
                    item.Header = Mutagen.Bethesda.Fallout76.LayerHeader.CreateFromBinary(
                        frame: frame,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IBaseLayerGetter
    {
        ...
        public virtual IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => BaseLayerCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual object BinaryWriteTranslator => BaseLayerBinaryWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        object IBinaryItem.BinaryWriteTranslator => this.BinaryWriteTranslator;
