...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IReverbParametersInternal
    {
        ...
        String? IReverbParametersGetter.EDID => this.EDID;
        #endregion
        ...
        #endregion
        #region ReverbClass
        public ReverbClass? ReverbClass { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReverbClass? IReverbParametersGetter.ReverbClass => this.ReverbClass;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case ReverbParameters_FieldIndex.EDID:
                        return EDID;
        ...
        public ReverbParameters(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public ReverbParameters(IFallout76Mod mod, string editorID)
            : this(
        ...
        IReverbParametersGetter
    {
        ...
        #region Mutagen
        new ReverbParameters.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.REVB)]
        ...
        IMapsToGetter<IReverbParametersGetter>
    {
        ...
        #region Mutagen
        ReverbParameters.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ReverbParameters_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ReverbParameters";
    ...
    #region Common
    internal partial class ReverbParametersSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class ReverbParametersCommon : Fallout76MajorRecordCommon
    {
        ...
        public static ReverbParameters_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ReverbParameters_FieldIndex.EDID) ?? true))
            {
    ...
    internal partial class ReverbParametersSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)ReverbParameters_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<ReverbClass, MutagenFrame, MutagenWriter>.Instance.WriteNullable(
                writer,
                item.ReverbClass,
                length: 4,
    ...
    internal partial class ReverbParametersBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
                ...
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)ReverbParameters_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IReverbParametersGetter
    {
        ...
        public ReverbParameters.MajorFlag MajorFlags => (ReverbParameters.MajorFlag)this.MajorRecordFlagsRaw;
        ...
        public ReverbClass? ReverbClass => EnumBinaryTranslation<ReverbClass, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(_ReverbClassLocation, _recordData, _package, 4);
        #endregion
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)ReverbParameters_FieldIndex.EDID, type);
                    }
                    else
                    {
