...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<DefaultObjectManager>
    {
        ...
        String? IDefaultObjectManagerGetter.EDID => this.EDID;
        #endregion
        #region DNAM
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IDefaultObjectManagerGetter.DNAM => this.DNAM;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case DefaultObjectManager_FieldIndex.EDID:
                        return EDID;
                    case DefaultObjectManager_FieldIndex.DNAM:
                        return DNAM;
                    default:
        ...
        public DefaultObjectManager(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public DefaultObjectManager(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IDefaultObjectManagerInternal>
    {
        ...
        #region Mutagen
        new DefaultObjectManager.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.DOBJ)]
        ...
        IMapsToGetter<IDefaultObjectManagerGetter>
    {
        ...
        #region Mutagen
        DefaultObjectManager.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DefaultObjectManager_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.DefaultObjectManager";
    ...
    #region Common
    internal partial class DefaultObjectManagerSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class DefaultObjectManagerCommon : Fallout76MajorRecordCommon
    {
        ...
        public static DefaultObjectManager_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)DefaultObjectManager_FieldIndex.EDID) ?? true))
            {
                if (!string.Equals(lhs.EDID, rhs.EDID)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)DefaultObjectManager_FieldIndex.DNAM) ?? true))
            {
    ...
    internal partial class DefaultObjectManagerSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)DefaultObjectManager_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            if ((copyMask?.GetShouldTranslate((int)DefaultObjectManager_FieldIndex.DNAM) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DefaultObjectManagerBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)DefaultObjectManager_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                case RecordTypeInts.DNAM:
                {
                    ...
                    return (int)DefaultObjectManager_FieldIndex.DNAM;
                }
                default:
                    return Fallout76MajorRecordBinaryCreateTranslation.FillBinaryRecordTypes(
                        item: item,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IDefaultObjectManagerGetter
    {
        ...
        public DefaultObjectManager.MajorFlag MajorFlags => (DefaultObjectManager.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)DefaultObjectManager_FieldIndex.EDID, type);
                    }
                    else
                    {
