...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IPerkScriptFragments
    {
        ...
        IScriptEntryGetter IPerkScriptFragmentsGetter.Script => Script;
        #endregion
        #region Fragments
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<PerkScriptFragment> _Fragments = new ExtendedList<PerkScriptFragment>();
        public ExtendedList<PerkScriptFragment> Fragments
        {
            get => this._Fragments;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IPerkScriptFragmentGetter> IPerkScriptFragmentsGetter.Fragments => _Fragments;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public Mask(TItem initialValue)
            {
                ...
                this.Fragments = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>?>(initialValue, []);
            }
                ...
                TItem Fragments)
            {
                ...
                this.Fragments = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>?>(Fragments, []);
            }
            ...
            public MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>?>? Fragments;
            #endregion
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Fragments != null)
                {
                    obj.Fragments = new MaskItem<R, IEnumerable<MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>>?>(eval(this.Fragments.Overall), []);
                    if (Fragments.Specific != null)
                    {
                        var l = new List<MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>>();
                        obj.Fragments.Specific = l;
                        foreach (var item in Fragments.Specific)
                        {
                            MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>? mask = item == null ? null : new MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>(item.Index, eval(item.Overall), item.Specific?.Translate(eval));
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public MaskItem<Exception?, IEnumerable<MaskItem<Exception?, PerkScriptFragment.ErrorMask?>>?>? Fragments;
            #endregion
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case PerkScriptFragments_FieldIndex.Script:
                        return Script;
            ...
            public void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    ...
                    case PerkScriptFragments_FieldIndex.Script:
                        ...
                        break;
                    case PerkScriptFragments_FieldIndex.Fragments:
                        this.Fragments = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, PerkScriptFragment.ErrorMask?>>?>(ex, null);
                        break;
                    default:
                        throw new ArgumentException($"Index is out of range: {index}");
                }
            ...
            public void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case PerkScriptFragments_FieldIndex.Script:
                        ...
                        break;
                    case PerkScriptFragments_FieldIndex.Fragments:
                        this.Fragments = (MaskItem<Exception?, IEnumerable<MaskItem<Exception?, PerkScriptFragment.ErrorMask?>>?>)obj;
                        break;
                    default:
                        throw new ArgumentException($"Index is out of range: {index}");
                }
        ...
        public class TranslationMask : ITranslationMask
        {
            ...
            public PerkScriptFragment.TranslationMask? Fragments;
            #endregion
        ...
        IPerkScriptFragmentsGetter
    {
        ...
        new ExtendedList<PerkScriptFragment> Fragments { get; }
    }
        ...
        ILoquiObject<IPerkScriptFragmentsGetter>
    {
        ...
        IReadOnlyList<IPerkScriptFragmentGetter> Fragments { get; }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class PerkScriptFragments_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.PerkScriptFragments";
    ...
    internal partial class PerkScriptFragmentsCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Script) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Script, rhs.Script, out var lhsScript, out var rhsScript, out var isScriptEqual))
                {
                    if (!((ScriptEntryCommon)((IScriptEntryGetter)lhsScript).CommonInstance()!).Equals(lhsScript, rhsScript, equalsMask?.GetSubCrystal((int)PerkScriptFragments_FieldIndex.Script))) return false;
                }
                else if (!isScriptEqual) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Fragments) ?? true))
            {
                if (!lhs.Fragments.SequenceEqual(rhs.Fragments, (l, r) => ((PerkScriptFragmentCommon)((IPerkScriptFragmentGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)PerkScriptFragments_FieldIndex.Fragments)))) return false;
            }
            return true;
        }
    ...
    internal partial class PerkScriptFragmentsSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Script) ?? true))
            {
                errorMask?.PushIndex((int)PerkScriptFragments_FieldIndex.Script);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)PerkScriptFragments_FieldIndex.Script) ?? true))
                    {
                        item.Script = rhs.Script.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)PerkScriptFragments_FieldIndex.Script),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
