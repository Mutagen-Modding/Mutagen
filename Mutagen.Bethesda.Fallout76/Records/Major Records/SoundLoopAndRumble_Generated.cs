        ...
        ISoundLoopAndRumble
    {
            ...
            IMask<TItem>
        {
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.Sidechain, rhs.Sidechain)) return false;
            ...
            public bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.Sidechain)) return false;
            ...
            public bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.Sidechain)) return true;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.Sidechain = eval(this.Sidechain);
            ...
            public void Print(StructuredStringBuilder sb, SoundLoopAndRumble.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.Sidechain ?? true)
                    {
                        sb.AppendItem(Sidechain, "Sidechain");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case SoundLoopAndRumble_FieldIndex.Loop:
                        return Loop;
                    case SoundLoopAndRumble_FieldIndex.Sidechain:
                        return Sidechain;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Sidechain = this.Sidechain.Combine(rhs.Sidechain);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class SoundLoopAndRumble_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.SoundLoopAndRumble";
    ...
    internal partial class SoundLoopAndRumbleCommon
    {
            ...
            SoundLoopAndRumble.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.Sidechain ?? true)
            {
                sb.AppendItem(item.Sidechain, "Sidechain");
            }
            if (printMask?.RumbleValues ?? true)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISoundLoopAndRumbleGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
    ...
    internal partial class SoundLoopAndRumbleSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)SoundLoopAndRumble_FieldIndex.Sidechain) ?? true))
            {
                item.Sidechain = rhs.Sidechain;
            }
    ...
    internal partial class SoundLoopAndRumbleBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            item.Loop = EnumBinaryTranslation<SoundDescriptor.LoopType, MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                length: 1);
            item.Sidechain = frame.ReadUInt8();
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ISoundLoopAndRumbleGetter
    {
        ...
        public Byte Sidechain => _structData.Span[0x2];
