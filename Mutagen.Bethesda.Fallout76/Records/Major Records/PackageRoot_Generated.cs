...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IPackageRoot
    {
        ...
        #region BranchCount
        public UInt32 BranchCount { get; set; } = default(UInt32);
        #endregion
        #region Flags
    ...
    public partial interface IPackageRoot :
        ...
        IPackageRootGetter
    {
        new UInt32 BranchCount { get; set; }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class PackageRoot_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.PackageRoot";
        ...
        public static readonly RecordType TriggeringRecordType = RecordTypes.PRCB;
        public static RecordTriggerSpecs TriggerSpecs => _recordSpecs.Value;
        private static readonly Lazy<RecordTriggerSpecs> _recordSpecs = new Lazy<RecordTriggerSpecs>(() =>
        {
            var all = RecordCollection.Factory(RecordTypes.PRCB);
    ...
    internal partial class PackageRootSetterCommon
    {
        ...
        {
            ClearPartial();
            item.BranchCount = default(UInt32);
            ...
            TypedParseParams translationParams)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                translationParams.ConvertToCustom(RecordTypes.PRCB),
...
namespace Mutagen.Bethesda.Fallout76
{
    public partial class PackageRootBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            using (HeaderExport.Subrecord(
                writer: writer,
                record: translationParams.ConvertToCustom(RecordTypes.PRCB),
    ...
    internal partial class PackageRootBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.BranchCount = frame.ReadUInt32();
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IPackageRootGetter
    {
        ...
        public UInt32 BranchCount => BinaryPrimitives.ReadUInt32LittleEndian(_structData.Slice(0x0, 0x4));
