...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<Landscape>
    {
        ...
        Int32? ILandscapeGetter.DATA => this.DATA;
        #endregion
        ...
        public Landscape(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public Landscape(IFallout76Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.LAND)]
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class Landscape_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.Landscape";
    ...
    #region Common
    internal partial class LandscapeSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class LandscapeCommon : Fallout76MajorRecordCommon
    {
        ...
        public static Landscape_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class LandscapeSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class LandscapeBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.VertexHeightMap = Mutagen.Bethesda.Fallout76.LandscapeVertexHeightMap.CreateFromBinary(frame: frame);
