...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<EncounterZone>
    {
        ...
        String? IEncounterZoneGetter.EDID => this.EDID;
        #endregion
        #region Owner
        private readonly IFormLink<IFallout76MajorRecordGetter> _Owner = new FormLink<IFallout76MajorRecordGetter>();
        public IFormLink<IFallout76MajorRecordGetter> Owner
        {
            get => _Owner;
            set => _Owner.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkGetter<IFallout76MajorRecordGetter> IEncounterZoneGetter.Owner => this.Owner;
        #endregion
        #region Location
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case EncounterZone_FieldIndex.EDID:
                        return EDID;
        ...
        public EncounterZone(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public EncounterZone(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IEncounterZoneInternal>
    {
        ...
        new IFormLink<IFallout76MajorRecordGetter> Owner { get; set; }
        ...
        #region Mutagen
        new EncounterZone.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.ECZN)]
        ...
        IMapsToGetter<IEncounterZoneGetter>
    {
        ...
        String? EDID { get; }
        IFormLinkGetter<IFallout76MajorRecordGetter> Owner { get; }
        ...
        #region Mutagen
        EncounterZone.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class EncounterZone_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.EncounterZone";
    ...
    #region Common
    internal partial class EncounterZoneSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class EncounterZoneCommon : Fallout76MajorRecordCommon
    {
        ...
        public static EncounterZone_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)EncounterZone_FieldIndex.EDID) ?? true))
            {
    ...
    internal partial class EncounterZoneSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)EncounterZone_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class EncounterZoneBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
                ...
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)EncounterZone_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IEncounterZoneGetter
    {
        ...
        public EncounterZone.MajorFlag MajorFlags => (EncounterZone.MajorFlag)this.MajorRecordFlagsRaw;
        ...
        public IFormLinkGetter<IFallout76MajorRecordGetter> Owner => _Owner_IsSet ? FormLinkBinaryTranslation.Instance.OverlayFactory<IFallout76MajorRecordGetter>(_package, _recordData.Span.Slice(_OwnerLocation, 0x4), isSet: _Owner_IsSet) : FormLink<IFallout76MajorRecordGetter>.Null;
        #endregion
        #region Location
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)EncounterZone_FieldIndex.EDID, type);
                    }
                    else
                    {
