...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<LeveledSpell>
    {
        ...
        String? ILeveledSpellGetter.EDID => this.EDID;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case LeveledSpell_FieldIndex.EDID:
                        return EDID;
                    default:
        ...
        public LeveledSpell(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public LeveledSpell(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<ILeveledSpellInternal>
    {
        ...
        #region Mutagen
        new LeveledSpell.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.LVSP)]
        ...
        IMapsToGetter<ILeveledSpellGetter>
    {
        ...
        #region Mutagen
        LeveledSpell.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class LeveledSpell_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.LeveledSpell";
    ...
    #region Common
    internal partial class LeveledSpellSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class LeveledSpellCommon : Fallout76MajorRecordCommon
    {
        ...
        public static LeveledSpell_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LeveledSpell_FieldIndex.EDID) ?? true))
            {
    ...
    internal partial class LeveledSpellSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)LeveledSpell_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            DeepCopyInCustom(
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class LeveledSpellBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
                ...
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)LeveledSpell_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILeveledSpellGetter
    {
        ...
        public LeveledSpell.MajorFlag MajorFlags => (LeveledSpell.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)LeveledSpell_FieldIndex.EDID, type);
                    }
                    else
                    {
