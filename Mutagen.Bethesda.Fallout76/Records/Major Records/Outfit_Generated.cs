...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IOutfitInternal
    {
        ...
        String? IOutfitGetter.EDID => this.EDID;
        #endregion
        #region INAM
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IOutfitGetter.INAM => this.INAM;
        #endregion
        #region Keyword
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IKeywordGetter> IOutfitGetter.Keyword => this.Keyword;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case Outfit_FieldIndex.EDID:
                        return EDID;
                    case Outfit_FieldIndex.INAM:
                        return INAM;
                    case Outfit_FieldIndex.Keyword:
                        return Keyword;
                    default:
        ...
        public Outfit(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public Outfit(IFallout76Mod mod, string editorID)
            : this(
        ...
        IOutfitGetter
    {
        ...
        #region Mutagen
        new Outfit.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.OTFT)]
        ...
        IMapsToGetter<IOutfitGetter>
    {
        ...
        #region Mutagen
        Outfit.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class Outfit_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.Outfit";
    ...
    #region Common
    internal partial class OutfitSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class OutfitCommon : Fallout76MajorRecordCommon
    {
        ...
        public static Outfit_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Outfit_FieldIndex.EDID) ?? true))
            {
                if (!string.Equals(lhs.EDID, rhs.EDID)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Outfit_FieldIndex.INAM) ?? true))
            {
                if (!MemorySliceExt.SequenceEqual(lhs.INAM, rhs.INAM)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Outfit_FieldIndex.Keyword) ?? true))
            {
    ...
    internal partial class OutfitSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)Outfit_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            if ((copyMask?.GetShouldTranslate((int)Outfit_FieldIndex.INAM) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)Outfit_FieldIndex.Keyword) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class OutfitBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
                ...
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)Outfit_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IOutfitGetter
    {
        ...
        public Outfit.MajorFlag MajorFlags => (Outfit.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)Outfit_FieldIndex.EDID, type);
                    }
                    else
                    {
