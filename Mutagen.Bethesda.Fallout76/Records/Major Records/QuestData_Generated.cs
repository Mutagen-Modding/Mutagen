...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class QuestData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.QuestData";
    ...
    internal partial class QuestDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)QuestData_FieldIndex.DelayTime) ?? true))
            {
                if (!lhs.DelayTime.EqualsWithin(rhs.DelayTime)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)QuestData_FieldIndex.Type) ?? true))
            {
