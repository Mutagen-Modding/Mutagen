...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<AnimationSoundTagSet>
    {
        ...
        String? IAnimationSoundTagSetGetter.EDID => this.EDID;
        #endregion
        #region XALG
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IAnimationSoundTagSetGetter.XALG => this.XALG;
        #endregion
        #region TNAM
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IFallout76MajorRecordGetter> IAnimationSoundTagSetGetter.TNAM => this.TNAM;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case AnimationSoundTagSet_FieldIndex.EDID:
                        return EDID;
                    case AnimationSoundTagSet_FieldIndex.XALG:
                        return XALG;
                    case AnimationSoundTagSet_FieldIndex.TNAM:
                        return TNAM;
                    default:
        ...
        public AnimationSoundTagSet(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public AnimationSoundTagSet(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IAnimationSoundTagSetInternal>
    {
        ...
        #region Mutagen
        new AnimationSoundTagSet.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.STAG)]
        ...
        IMapsToGetter<IAnimationSoundTagSetGetter>
    {
        ...
        #region Mutagen
        AnimationSoundTagSet.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class AnimationSoundTagSet_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.AnimationSoundTagSet";
    ...
    #region Common
    internal partial class AnimationSoundTagSetSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class AnimationSoundTagSetCommon : Fallout76MajorRecordCommon
    {
        ...
        public static AnimationSoundTagSet_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.EDID) ?? true))
            {
                if (!string.Equals(lhs.EDID, rhs.EDID)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.XALG) ?? true))
            {
                if (!MemorySliceExt.SequenceEqual(lhs.XALG, rhs.XALG)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.TNAM) ?? true))
            {
    ...
    internal partial class AnimationSoundTagSetSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            if ((copyMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.XALG) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)AnimationSoundTagSet_FieldIndex.TNAM) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class AnimationSoundTagSetBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)AnimationSoundTagSet_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                case RecordTypeInts.XALG:
                {
                    ...
                    return (int)AnimationSoundTagSet_FieldIndex.XALG;
                }
                case RecordTypeInts.TNAM:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.TNAM.SetTo(FormLinkBinaryTranslation.Instance.Parse(reader: frame));
                    return (int)AnimationSoundTagSet_FieldIndex.TNAM;
                }
                default:
                    return Fallout76MajorRecordBinaryCreateTranslation.FillBinaryRecordTypes(
                        item: item,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IAnimationSoundTagSetGetter
    {
        ...
        public AnimationSoundTagSet.MajorFlag MajorFlags => (AnimationSoundTagSet.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)AnimationSoundTagSet_FieldIndex.EDID, type);
                    }
                    else
                    {
