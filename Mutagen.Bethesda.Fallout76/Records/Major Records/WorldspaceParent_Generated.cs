...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IWorldspaceParent
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((WorldspaceParentCommon)((IWorldspaceParentGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IWorldspaceParentGetter? obj)
        {
            return ((WorldspaceParentCommon)((IWorldspaceParentGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(WorldspaceParent.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, WorldspaceParent.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(WorldspaceParent.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => WorldspaceParentCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => WorldspaceParentSetterCommon.Instance.RemapLinks(this, mapping);
        #endregion
    ...
    public static partial class WorldspaceParentMixIn
    {
        ...
        {
            return ((WorldspaceParentCommon)((IWorldspaceParentGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            WorldspaceParent.Mask<bool>? printMask = null)
        {
            ((WorldspaceParentCommon)((IWorldspaceParentGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class WorldspaceParent_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.WorldspaceParent";
        ...
        {
            var triggers = RecordCollection.Factory(RecordTypes.WNAM);
    ...
    internal partial class WorldspaceParentCommon
    {
            ...
            WorldspaceParent.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"WorldspaceParent =>");
            }
            else
            {
                sb.AppendLine($"{name} (WorldspaceParent) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)WorldspaceParent_FieldIndex.Worldspace) ?? true))
            {
                if (!lhs.Worldspace.Equals(rhs.Worldspace)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WorldspaceParent_FieldIndex.Flags) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IWorldspaceParentGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout76
{
    public partial class WorldspaceParentBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<WorldspaceParent.Flag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Flags,
                length: 2,
    ...
    internal partial class WorldspaceParentBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<WorldspaceParent.Flag, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
