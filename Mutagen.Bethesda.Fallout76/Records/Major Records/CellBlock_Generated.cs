...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class CellBlock_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.CellBlock";
    ...
    internal partial class CellBlockSetterCommon
    {
        ...
        {
            obj.SubBlocks.ForEach(x => x.RemapAssetLinks(mapping, queryCategories, linkCache));
        }
    ...
    internal partial class CellBlockCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ICellBlockGetter obj, bool iterateNestedRecords = true)
        {
            foreach (var item in obj.SubBlocks.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
