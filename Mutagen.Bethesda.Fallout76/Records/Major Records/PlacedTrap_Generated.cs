...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IPlacedTrapInternal
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => PlacedTrapCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public PlacedTrap(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public PlacedTrap(IFallout76Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.PGRE)]
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class PlacedTrap_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.PlacedTrap";
    ...
    internal partial class PlacedTrapCommon : APlacedTrapCommon
    {
        ...
        public static PlacedTrap_FieldIndex ConvertFieldIndex(APlacedTrap_FieldIndex index)
        {
            switch (index)
            {
                ...
                case APlacedTrap_FieldIndex.Version2:
                    return (PlacedTrap_FieldIndex)((int)index);
                case APlacedTrap_FieldIndex.Fallout76MajorRecordFlags:
                    return (PlacedTrap_FieldIndex)((int)index);
        ...
        public static new PlacedTrap_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPlacedTrapGetter obj, bool iterateNestedRecords = true)
        {
