...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<DialogBranch>
    {
        ...
        String? IDialogBranchGetter.EDID => this.EDID;
        #endregion
        #region Quest
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IQuestGetter> IDialogBranchGetter.Quest => this.Quest;
        #endregion
        #region TNAM
        public UInt32? TNAM { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt32? IDialogBranchGetter.TNAM => this.TNAM;
        #endregion
        #region DNAM
        public UInt32? DNAM { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt32? IDialogBranchGetter.DNAM => this.DNAM;
        #endregion
        ...
        public DialogBranch(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public DialogBranch(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IDialogBranchInternal>
    {
        ...
        #region Mutagen
        new DialogBranch.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.DLBR)]
        ...
        IMapsToGetter<IDialogBranchGetter>
    {
        ...
        #region Mutagen
        DialogBranch.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DialogBranch_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.DialogBranch";
    ...
    #region Common
    internal partial class DialogBranchSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class DialogBranchCommon : Fallout76MajorRecordCommon
    {
        ...
        public static DialogBranch_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)DialogBranch_FieldIndex.EDID) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)DialogBranch_FieldIndex.TNAM) ?? true))
            {
                if (lhs.TNAM != rhs.TNAM) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)DialogBranch_FieldIndex.DNAM) ?? true))
            {
    ...
    internal partial class DialogBranchSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)DialogBranch_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            ...
            if ((copyMask?.GetShouldTranslate((int)DialogBranch_FieldIndex.DNAM) ?? true))
            {
                item.DNAM = rhs.DNAM;
            }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DialogBranchBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)DialogBranch_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                case RecordTypeInts.DNAM:
                {
                    ...
                    return (int)DialogBranch_FieldIndex.DNAM;
                }
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IDialogBranchGetter
    {
        ...
        public DialogBranch.MajorFlag MajorFlags => (DialogBranch.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)DialogBranch_FieldIndex.EDID, type);
                    }
                    else
                    {
