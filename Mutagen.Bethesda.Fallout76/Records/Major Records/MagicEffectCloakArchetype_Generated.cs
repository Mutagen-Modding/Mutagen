...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    {
        #region Association
        private readonly IFormLink<ISpellGetter> _Association = new FormLink<ISpellGetter>();
        public IFormLink<ISpellGetter> Association
        {
            get => _Association;
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case MagicEffectCloakArchetype_FieldIndex.Association:
                        return Association;
                    default:
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => MagicEffectCloakArchetypeCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public override void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => MagicEffectCloakArchetypeSetterCommon.Instance.RemapLinks(this, mapping);
        #endregion
    ...
    public partial interface IMagicEffectCloakArchetype :
        ...
        IFormLinkContainer,
        ILoquiObjectSetter<IMagicEffectCloakArchetype>,
        IMagicEffectCloakArchetypeGetter
    {
        new IFormLink<ISpellGetter> Association { get; set; }
    }
    ...
    {
        public static void Clear(this IMagicEffectCloakArchetype item)
        {
        ...
        public static void DeepCopyIn(
            this IMagicEffectCloakArchetype lhs,
            IMagicEffectCloakArchetypeGetter rhs,
        ...
        public static void CopyInFromBinary(
            this IMagicEffectCloakArchetype item,
            MutagenFrame frame,
            TypedParseParams translationParams = default)
        {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class MagicEffectCloakArchetype_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.MagicEffectCloakArchetype";
    ...
    #region Common
    internal partial class MagicEffectCloakArchetypeSetterCommon : AMagicEffectArchetypeSetterCommon
    {
        public new static readonly MagicEffectCloakArchetypeSetterCommon Instance = new MagicEffectCloakArchetypeSetterCommon();

        partial void ClearPartial();
        
        public void Clear(IMagicEffectCloakArchetype item)
        {
            ClearPartial();
        ...
        {
            Clear(item: (IMagicEffectCloakArchetype)item);
        }
    ...
    internal partial class MagicEffectCloakArchetypeCommon : AMagicEffectArchetypeCommon
    {
        ...
        public static MagicEffectCloakArchetype_FieldIndex ConvertFieldIndex(AMagicEffectArchetype_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MagicEffectCloakArchetype_FieldIndex.Association) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMagicEffectCloakArchetypeGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class MagicEffectCloakArchetypeSetterTranslationCommon : AMagicEffectArchetypeSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)MagicEffectCloakArchetype_FieldIndex.Association) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class MagicEffectCloakArchetypeBinaryCreateTranslation : AMagicEffectArchetypeBinaryCreateTranslation
    {
