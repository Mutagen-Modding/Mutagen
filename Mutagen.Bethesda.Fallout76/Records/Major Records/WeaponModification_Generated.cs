...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IWeaponModificationInternal
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => WeaponModificationCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public WeaponModification(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public WeaponModification(IFallout76Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.OMOD)]
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class WeaponModification_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.WeaponModification";
    ...
    internal partial class WeaponModificationCommon : AObjectModificationCommon
    {
        ...
        public static WeaponModification_FieldIndex ConvertFieldIndex(AObjectModification_FieldIndex index)
        {
            switch (index)
            {
                ...
                case AObjectModification_FieldIndex.Version2:
                    return (WeaponModification_FieldIndex)((int)index);
                case AObjectModification_FieldIndex.Fallout76MajorRecordFlags:
                    return (WeaponModification_FieldIndex)((int)index);
        ...
        public static new WeaponModification_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IWeaponModificationGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IWeaponModificationGetter
    {
        ...
        protected override Type LinkType => typeof(IWeaponModificationGetter);
