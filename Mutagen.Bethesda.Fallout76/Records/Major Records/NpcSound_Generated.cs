...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        INpcSound
    {
        ...
        IFormLinkNullableGetter<IKeywordGetter> INpcSoundGetter.Keyword => this.Keyword;
        #endregion
        #region Sound
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case NpcSound_FieldIndex.Keyword:
                        return Keyword;
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => NpcSoundCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class NpcSound_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.NpcSound";
    ...
    internal partial class NpcSoundCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INpcSoundGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class NpcSoundSetterTranslationCommon
    {
        ...
        public void DeepCopyIn(
            ...
            bool deepCopy)
        {
            if ((copyMask?.GetShouldTranslate((int)NpcSound_FieldIndex.Keyword) ?? true))
            {
    ...
    public partial class NpcSoundBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            FormLinkBinaryTranslation.Instance.WriteNullable(
                writer: writer,
                item: item.Keyword,
                header: translationParams.ConvertToCustom(RecordTypes.CS2K));
            FormLinkBinaryTranslation.Instance.WriteNullable(
                writer: writer,
                item: item.Sound,
                header: translationParams.ConvertToCustom(RecordTypes.CS2D));
        }
