...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ITeleportDestination
    {
        ...
        public IFormLink<ICellGetter> TransitionInterior
        {
            get => _TransitionInterior;
            set => _TransitionInterior.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkGetter<ICellGetter> ITeleportDestinationGetter.TransitionInterior => this.TransitionInterior;
        #endregion
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case TeleportDestination_FieldIndex.Flags:
                        return Flags;
                    case TeleportDestination_FieldIndex.TransitionInterior:
        ...
        ITeleportDestinationGetter
    {
        ...
        new IFormLink<ICellGetter> TransitionInterior { get; set; }
    }
        ...
        IPositionRotationGetter
    {
        ...
        IFormLinkGetter<ICellGetter> TransitionInterior { get; }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class TeleportDestination_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.TeleportDestination";
    ...
    internal partial class TeleportDestinationSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)TeleportDestination_FieldIndex.TransitionInterior) ?? true))
            {
