...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ImpactDataSet>
    {
        ...
        String? IImpactDataSetGetter.EDID => this.EDID;
        #endregion
        #region Impacts
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<ImpactDataSetEntry> _Impacts = new ExtendedList<ImpactDataSetEntry>();
        public ExtendedList<ImpactDataSetEntry> Impacts
        {
            get => this._Impacts;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IImpactDataSetEntryGetter> IImpactDataSetGetter.Impacts => _Impacts;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.Impacts = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ImpactDataSetEntry.Mask<TItem>?>>?>(initialValue, []);
            }
            ...
            {
                this.EDID = EDID;
                this.Impacts = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ImpactDataSetEntry.Mask<TItem>?>>?>(Impacts, []);
            }
            ...
            #region Members
            public TItem EDID;
            public MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ImpactDataSetEntry.Mask<TItem>?>>?>? Impacts;
            #endregion
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Impacts != null)
                {
                    obj.Impacts = new MaskItem<R, IEnumerable<MaskItemIndexed<R, ImpactDataSetEntry.Mask<R>?>>?>(eval(this.Impacts.Overall), []);
                    if (Impacts.Specific != null)
                    {
                        var l = new List<MaskItemIndexed<R, ImpactDataSetEntry.Mask<R>?>>();
                        obj.Impacts.Specific = l;
                        foreach (var item in Impacts.Specific)
                        {
                            MaskItemIndexed<R, ImpactDataSetEntry.Mask<R>?>? mask = item == null ? null : new MaskItemIndexed<R, ImpactDataSetEntry.Mask<R>?>(item.Index, eval(item.Overall), item.Specific?.Translate(eval));
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public MaskItem<Exception?, IEnumerable<MaskItem<Exception?, ImpactDataSetEntry.ErrorMask?>>?>? Impacts;
            #endregion
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case ImpactDataSet_FieldIndex.EDID:
                        return EDID;
            ...
            public override void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    case ImpactDataSet_FieldIndex.EDID:
                        ...
                        break;
                    case ImpactDataSet_FieldIndex.Impacts:
                        this.Impacts = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, ImpactDataSetEntry.ErrorMask?>>?>(ex, null);
                        break;
                    default:
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    case ImpactDataSet_FieldIndex.EDID:
                        ...
                        break;
                    case ImpactDataSet_FieldIndex.Impacts:
                        this.Impacts = (MaskItem<Exception?, IEnumerable<MaskItem<Exception?, ImpactDataSetEntry.ErrorMask?>>?>)obj;
                        break;
                    default:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Impacts = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, ImpactDataSetEntry.ErrorMask?>>?>(Noggog.ExceptionExt.Combine(this.Impacts?.Overall, rhs.Impacts?.Overall), Noggog.ExceptionExt.Combine(this.Impacts?.Specific, rhs.Impacts?.Specific));
                return ret;
            }
            ...
            ITranslationMask
        {
            #region Members
            public bool EDID;
            public ImpactDataSetEntry.TranslationMask? Impacts;
            #endregion
        ...
        public ImpactDataSet(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public ImpactDataSet(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IImpactDataSetInternal>
    {
        ...
        new ExtendedList<ImpactDataSetEntry> Impacts { get; }
        #region Mutagen
        new ImpactDataSet.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.IPDS)]
        ...
        IMapsToGetter<IImpactDataSetGetter>
    {
        ...
        String? EDID { get; }
        IReadOnlyList<IImpactDataSetEntryGetter> Impacts { get; }

        #region Mutagen
        ImpactDataSet.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ImpactDataSet_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ImpactDataSet";
    ...
    #region Common
    internal partial class ImpactDataSetSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class ImpactDataSetCommon : Fallout76MajorRecordCommon
    {
        ...
        public static ImpactDataSet_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ImpactDataSet_FieldIndex.EDID) ?? true))
            {
            ...
            {
                if (!lhs.Impacts.SequenceEqual(rhs.Impacts, (l, r) => ((ImpactDataSetEntryCommon)((IImpactDataSetEntryGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)ImpactDataSet_FieldIndex.Impacts)))) return false;
            }
            return true;
        }
    ...
    internal partial class ImpactDataSetSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)ImpactDataSet_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<IImpactDataSetEntryGetter>.Instance.Write(
                writer: writer,
                items: item.Impacts,
                transl: (MutagenWriter subWriter, IImpactDataSetEntryGetter subItem, TypedWriteParams conv) =>
                {
                    var Item = subItem;
                    ((ImpactDataSetEntryBinaryWriteTranslation)((IBinaryItem)Item).BinaryWriteTranslator).Write(
                        item: Item,
                        writer: subWriter,
    ...
    internal partial class ImpactDataSetBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)ImpactDataSet_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                {
                    item.Impacts.SetTo(
                        Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<ImpactDataSetEntry>.Instance.Parse(
                            reader: frame,
                            triggeringRecord: ImpactDataSetEntry_Registration.TriggerSpecs,
                            translationParams: translationParams,
                            transl: ImpactDataSetEntry.TryCreateFromBinary));
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IImpactDataSetGetter
    {
        ...
        public ImpactDataSet.MajorFlag MajorFlags => (ImpactDataSet.MajorFlag)this.MajorRecordFlagsRaw;
        ...
        #endregion
        public IReadOnlyList<IImpactDataSetEntryGetter> Impacts { get; private set; } = [];
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)ImpactDataSet_FieldIndex.EDID, type);
                    }
                    else
                    {
                ...
                case RecordTypeInts.PNAM:
                {
                    this.Impacts = BinaryOverlayList.FactoryByArray<IImpactDataSetEntryGetter>(
                        mem: stream.RemainingMemory,
                        package: _package,
                        translationParams: translationParams,
                        getter: (s, p, recConv) => ImpactDataSetEntryBinaryOverlay.ImpactDataSetEntryFactory(new OverlayStream(s, p), p, recConv),
                        locs: ParseRecordLocations(
                            stream: stream,
                            trigger: ImpactDataSetEntry_Registration.TriggerSpecs,
