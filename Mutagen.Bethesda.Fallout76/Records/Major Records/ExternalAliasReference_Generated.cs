...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ExternalAliasReference>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ExternalAliasReferenceCommon)((IExternalAliasReferenceGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IExternalAliasReferenceGetter? obj)
        {
            return ((ExternalAliasReferenceCommon)((IExternalAliasReferenceGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ExternalAliasReferenceCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ExternalAliasReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ExternalAliasReference";
    ...
    internal partial class ExternalAliasReferenceCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ExternalAliasReference_FieldIndex.Quest) ?? true))
            {
                if (!lhs.Quest.Equals(rhs.Quest)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ExternalAliasReference_FieldIndex.AliasID) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IExternalAliasReferenceGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    {
        public static readonly ExternalAliasReferenceBinaryWriteTranslation Instance = new();
