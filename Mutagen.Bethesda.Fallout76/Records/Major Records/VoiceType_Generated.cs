...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IVoiceTypeInternal
    {
        ...
        String? IVoiceTypeGetter.EDID => this.EDID;
        #endregion
        #region FULL
        public TranslatedString? FULL { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ITranslatedStringGetter? IVoiceTypeGetter.FULL => this.FULL;
        #endregion
        #region DNAM
        public Byte? DNAM { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Byte? IVoiceTypeGetter.DNAM => this.DNAM;
        #endregion
        #region ENAM
        public String? ENAM { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IVoiceTypeGetter.ENAM => this.ENAM;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case VoiceType_FieldIndex.EDID:
                        return EDID;
                    case VoiceType_FieldIndex.FULL:
                        return FULL;
                    case VoiceType_FieldIndex.DNAM:
                        return DNAM;
                    case VoiceType_FieldIndex.ENAM:
                        return ENAM;
                    default:
        ...
        public VoiceType(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public VoiceType(IFallout76Mod mod, string editorID)
            : this(
        ...
        IVoiceTypeGetter
    {
        ...
        #region Mutagen
        new VoiceType.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.VTYP)]
        ...
        IMapsToGetter<IVoiceTypeGetter>
    {
        ...
        #region Mutagen
        VoiceType.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class VoiceType_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.VoiceType";
    ...
    #region Common
    internal partial class VoiceTypeSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class VoiceTypeCommon : Fallout76MajorRecordCommon
    {
        ...
        public static VoiceType_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)VoiceType_FieldIndex.EDID) ?? true))
            {
                if (!string.Equals(lhs.EDID, rhs.EDID)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)VoiceType_FieldIndex.FULL) ?? true))
            {
                if (!object.Equals(lhs.FULL, rhs.FULL)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)VoiceType_FieldIndex.DNAM) ?? true))
            {
                if (lhs.DNAM != rhs.DNAM) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)VoiceType_FieldIndex.ENAM) ?? true))
            {
    ...
    internal partial class VoiceTypeSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)VoiceType_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            if ((copyMask?.GetShouldTranslate((int)VoiceType_FieldIndex.FULL) ?? true))
            {
                item.FULL = rhs.FULL?.DeepCopy();
            }
            if ((copyMask?.GetShouldTranslate((int)VoiceType_FieldIndex.DNAM) ?? true))
            {
                item.DNAM = rhs.DNAM;
            }
            if ((copyMask?.GetShouldTranslate((int)VoiceType_FieldIndex.ENAM) ?? true))
            {
                item.ENAM = rhs.ENAM;
            }
            DeepCopyInCustom(
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class VoiceTypeBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)VoiceType_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                case RecordTypeInts.FULL:
                {
                    ...
                    item.FULL = StringBinaryTranslation.Instance.Parse(
                        ...
                        stringBinaryType: StringBinaryType.NullTerminate,
                        parseWhole: true);
                    return (int)VoiceType_FieldIndex.FULL;
                }
                case RecordTypeInts.DNAM:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.DNAM = frame.ReadUInt8();
                    return (int)VoiceType_FieldIndex.DNAM;
                }
                case RecordTypeInts.ENAM:
                {
                    ...
                    item.ENAM = StringBinaryTranslation.Instance.Parse(
                        ...
                        stringBinaryType: StringBinaryType.NullTerminate,
                        parseWhole: true);
                    return (int)VoiceType_FieldIndex.ENAM;
                }
                default:
                    return Fallout76MajorRecordBinaryCreateTranslation.FillBinaryRecordTypes(
                        item: item,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IVoiceTypeGetter
    {
        ...
        public VoiceType.MajorFlag MajorFlags => (VoiceType.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)VoiceType_FieldIndex.EDID, type);
                    }
                    else
                    {
