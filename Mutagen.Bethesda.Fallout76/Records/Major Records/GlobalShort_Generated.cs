...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<GlobalShort>
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(GlobalShort.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, GlobalShort.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(GlobalShort.Mask<TItem>)} =>");
                using (sb.Brace())
                {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case GlobalShort_FieldIndex.Data:
                        return Data;
                    case GlobalShort_FieldIndex.NTWK:
                        return NTWK;
                    default:
        ...
        public GlobalShort(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GlobalShort(IFallout76Mod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.GLOB)]
    ...
    public static partial class GlobalShortMixIn
    {
        ...
        {
            return ((GlobalShortCommon)((IGlobalShortGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            GlobalShort.Mask<bool>? printMask = null)
        {
            ((GlobalShortCommon)((IGlobalShortGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class GlobalShort_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.GlobalShort";
    ...
    internal partial class GlobalShortCommon : GlobalCommon
    {
            ...
            GlobalShort.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"GlobalShort =>");
            }
            else
            {
                sb.AppendLine($"{name} (GlobalShort) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
        ...
        public static GlobalShort_FieldIndex ConvertFieldIndex(Global_FieldIndex index)
        {
            switch (index)
            {
                ...
                case Global_FieldIndex.Version2:
                    return (GlobalShort_FieldIndex)((int)index);
                case Global_FieldIndex.Fallout76MajorRecordFlags:
                    return (GlobalShort_FieldIndex)((int)index);
        ...
        public static new GlobalShort_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)GlobalShort_FieldIndex.NTWK) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IGlobalShortGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class GlobalShortSetterTranslationCommon : GlobalSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)GlobalShort_FieldIndex.NTWK) ?? true))
            {
                item.NTWK = rhs.NTWK;
            }
            DeepCopyInCustom(
    ...
    internal partial class GlobalShortBinaryCreateTranslation : GlobalBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.NTWK = true;
                    return (int)GlobalShort_FieldIndex.NTWK;
                }
                default:
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IGlobalShortGetter
    {
        ...
        protected override Type LinkType => typeof(IGlobalShortGetter);
