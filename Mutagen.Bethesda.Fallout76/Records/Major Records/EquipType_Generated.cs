...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<EquipType>
    {
        ...
        String? IEquipTypeGetter.EDID => this.EDID;
        #endregion
        #region PNAM
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IEquipTypeGetter.PNAM => this.PNAM;
        #endregion
        #region DATA
        public UInt32? DATA { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt32? IEquipTypeGetter.DATA => this.DATA;
        #endregion
        #region ANAM
        public UInt32? ANAM { get; set; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt32? IEquipTypeGetter.ANAM => this.ANAM;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case EquipType_FieldIndex.EDID:
                        return EDID;
                    case EquipType_FieldIndex.PNAM:
                        return PNAM;
                    case EquipType_FieldIndex.DATA:
                        return DATA;
                    case EquipType_FieldIndex.ANAM:
                        return ANAM;
                    default:
        ...
        public EquipType(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public EquipType(IFallout76Mod mod, string editorID)
            : this(
        ...
        ILoquiObjectSetter<IEquipTypeInternal>
    {
        ...
        #region Mutagen
        new EquipType.MajorFlag MajorFlags { get; set; }
        #endregion
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Fallout76.Internals.RecordTypeInts.EQUP)]
        ...
        IMapsToGetter<IEquipTypeGetter>
    {
        ...
        #region Mutagen
        EquipType.MajorFlag MajorFlags { get; }
        #endregion
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class EquipType_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.EquipType";
    ...
    #region Common
    internal partial class EquipTypeSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class EquipTypeCommon : Fallout76MajorRecordCommon
    {
        ...
        public static EquipType_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)EquipType_FieldIndex.EDID) ?? true))
            {
                if (!string.Equals(lhs.EDID, rhs.EDID)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EquipType_FieldIndex.PNAM) ?? true))
            {
                if (!MemorySliceExt.SequenceEqual(lhs.PNAM, rhs.PNAM)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EquipType_FieldIndex.DATA) ?? true))
            {
                if (lhs.DATA != rhs.DATA) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)EquipType_FieldIndex.ANAM) ?? true))
            {
    ...
    internal partial class EquipTypeSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)EquipType_FieldIndex.EDID) ?? true))
            {
                item.EDID = rhs.EDID;
            }
            if ((copyMask?.GetShouldTranslate((int)EquipType_FieldIndex.PNAM) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)EquipType_FieldIndex.DATA) ?? true))
            {
                item.DATA = rhs.DATA;
            }
            if ((copyMask?.GetShouldTranslate((int)EquipType_FieldIndex.ANAM) ?? true))
            {
                item.ANAM = rhs.ANAM;
            }
            DeepCopyInCustom(
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class EquipTypeBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        item.EDID = StringBinaryTranslation.Instance.Parse(
                            ...
                            parseWhole: true);
                        return new ParseResult((int)EquipType_FieldIndex.EDID, nextRecordType);
                    }
                    else
                    {
                ...
                case RecordTypeInts.PNAM:
                {
                    ...
                    return (int)EquipType_FieldIndex.PNAM;
                }
                case RecordTypeInts.DATA:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.DATA = frame.ReadUInt32();
                    return (int)EquipType_FieldIndex.DATA;
                }
                case RecordTypeInts.ANAM:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.ANAM = frame.ReadUInt32();
                    return (int)EquipType_FieldIndex.ANAM;
                }
                default:
                    return Fallout76MajorRecordBinaryCreateTranslation.FillBinaryRecordTypes(
                        item: item,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IEquipTypeGetter
    {
        ...
        public EquipType.MajorFlag MajorFlags => (EquipType.MajorFlag)this.MajorRecordFlagsRaw;
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.EDID:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)MajorRecord_FieldIndex.EditorID)
                    {
                        ...
                        return new ParseResult((int)EquipType_FieldIndex.EDID, type);
                    }
                    else
                    {
