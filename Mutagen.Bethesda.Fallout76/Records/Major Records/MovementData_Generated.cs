...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class MovementData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.MovementData";
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class MovementDataBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.Left = Mutagen.Bethesda.Fallout76.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Right = Mutagen.Bethesda.Fallout76.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Forward = Mutagen.Bethesda.Fallout76.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Back = Mutagen.Bethesda.Fallout76.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Pitch = Mutagen.Bethesda.Fallout76.MovementRotationData.CreateFromBinary(frame: frame);
            item.Roll = Mutagen.Bethesda.Fallout76.MovementRotationData.CreateFromBinary(frame: frame);
            item.Yaw = Mutagen.Bethesda.Fallout76.MovementRotationData.CreateFromBinary(frame: frame);
            if (frame.Complete)
            {
