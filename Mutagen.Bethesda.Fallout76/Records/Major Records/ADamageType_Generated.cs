...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ADamageType>
    {
        ...
        ITranslatedStringGetter? IADamageTypeGetter.FULL => this.FULL;
        #endregion
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ADamageTypeCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public ADamageType(IFallout76Mod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public ADamageType(IFallout76Mod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ADamageType_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ADamageType";
    ...
    #region Common
    internal partial class ADamageTypeSetterCommon : Fallout76MajorRecordSetterCommon
    {
    ...
    internal partial class ADamageTypeCommon : Fallout76MajorRecordCommon
    {
        ...
        public static ADamageType_FieldIndex ConvertFieldIndex(Fallout76MajorRecord_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ADamageType_FieldIndex.FULL) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IADamageTypeGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class ADamageTypeSetterTranslationCommon : Fallout76MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)ADamageType_FieldIndex.FULL) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ADamageTypeBinaryCreateTranslation : Fallout76MajorRecordBinaryCreateTranslation
    {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.FULL:
                {
                    ...
                    item.FULL = StringBinaryTranslation.Instance.Parse(
                        ...
                        parseWhole: true);
                    return (int)ADamageType_FieldIndex.FULL;
                }
                default:
