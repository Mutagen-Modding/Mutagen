...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ANpcLevel_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ANpcLevel";
    ...
    internal partial class ANpcLevelCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IANpcLevelGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
