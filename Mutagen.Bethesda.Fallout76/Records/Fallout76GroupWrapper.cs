...
namespace Mutagen.Bethesda.Fallout76.Records;

internal class Fallout76GroupWrapper<TMajor> : IFallout76GroupGetter<TMajor>
    where TMajor : class, IFallout76MajorRecordGetter, IBinaryItem
{
    private readonly GroupMergeGetter<IFallout76GroupGetter<TMajor>, TMajor> _groupMerge;

    public Fallout76GroupWrapper(GroupMergeGetter<IFallout76GroupGetter<TMajor>, TMajor> groupMerge)
    {
    ...
    ILoquiRegistration ILoquiObject.Registration => Fallout76Group_Registration.Instance;

    public static Fallout76Group_Registration StaticRegistration => Fallout76Group_Registration.Instance;

    [DebuggerStepThrough]
    protected object CommonInstance(Type type0) =>
        GenericCommonInstanceGetter.Get(Fallout76GroupCommon<TMajor>.Instance, typeof(TMajor), type0);

    [DebuggerStepThrough]
    protected object CommonSetterTranslationInstance() => Fallout76GroupSetterTranslationCommon.Instance;

    [DebuggerStepThrough]
    object IFallout76GroupGetter<TMajor>.CommonInstance(Type type0) => this.CommonInstance(type0);

    [DebuggerStepThrough]
    object? IFallout76GroupGetter<TMajor>.CommonSetterInstance(Type type0) => null;

    [DebuggerStepThrough]
    object IFallout76GroupGetter<TMajor>.CommonSetterTranslationInstance() => this.CommonSetterTranslationInstance();
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    protected object BinaryWriteTranslator => Fallout76GroupBinaryWriteTranslation.Instance;
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    {
        ((Fallout76GroupBinaryWriteTranslation)this.BinaryWriteTranslator).Write(
            item: this,
            writer: writer,
