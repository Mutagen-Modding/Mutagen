            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case DoorTriangle_FieldIndex.Unknown3:
                        return Unknown3;
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DoorTriangle_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.DoorTriangle";
    ...
    internal partial class DoorTriangleCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)DoorTriangle_FieldIndex.Unknown3) ?? true))
            {
    ...
    internal partial class DoorTriangleSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)DoorTriangle_FieldIndex.Unknown3) ?? true))
            {
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IDoorTriangleGetter
    {
        ...
        public Int32 Unknown3 => BinaryPrimitives.ReadInt32LittleEndian(_structData.Slice(0x2, 0x4));
