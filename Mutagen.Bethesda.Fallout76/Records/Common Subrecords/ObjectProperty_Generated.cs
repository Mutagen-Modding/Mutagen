...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IObjectProperty
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ObjectPropertyCommon)((IObjectPropertyGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IObjectPropertyGetter? obj)
        {
            return ((ObjectPropertyCommon)((IObjectPropertyGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ObjectPropertyCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ObjectProperty_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ObjectProperty";
    ...
    internal partial class ObjectPropertyCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ObjectProperty_FieldIndex.ActorValue) ?? true))
            {
                if (!lhs.ActorValue.Equals(rhs.ActorValue)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ObjectProperty_FieldIndex.Value) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IObjectPropertyGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    {
        public static readonly ObjectPropertyBinaryWriteTranslation Instance = new();
    ...
    {
        public static readonly ObjectPropertyBinaryCreateTranslation Instance = new ObjectPropertyBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IObjectPropertyGetter
    {
        ...
        public static IObjectPropertyGetter ObjectPropertyFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
