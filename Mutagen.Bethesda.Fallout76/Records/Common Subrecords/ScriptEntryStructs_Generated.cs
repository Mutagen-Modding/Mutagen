...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IScriptEntryStructs
    {
            ...
            IMask<TItem>
        {
            ...
            {
                this.Members = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ScriptProperty.Mask<TItem>?>>?>(Members, []);
            }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                if (Members != null)
                {
                    obj.Members = new MaskItem<R, IEnumerable<MaskItemIndexed<R, ScriptProperty.Mask<R>?>>?>(eval(this.Members.Overall), []);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ScriptEntryStructs_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ScriptEntryStructs";
    ...
    internal partial class ScriptEntryStructsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IScriptEntryStructsGetter obj, bool iterateNestedRecords = true)
        {
