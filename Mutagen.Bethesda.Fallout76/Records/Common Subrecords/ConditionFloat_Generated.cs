...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ConditionFloat>
    {
        ...
        #region ComparisonValue2
        public Single ComparisonValue2 { get; set; } = default(Single);
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                this.ComparisonValue2 = initialValue;
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.ComparisonValue2, rhs.ComparisonValue2)) return false;
            ...
            public override int GetHashCode()
            {
                ...
                hash.Add(this.ComparisonValue2);
                hash.Add(this.Data);
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.ComparisonValue2)) return false;
                if (Data != null)
                {
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.ComparisonValue2)) return true;
                if (Data != null)
                {
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.ComparisonValue2 = eval(this.ComparisonValue2);
            ...
            public void Print(StructuredStringBuilder sb, ConditionFloat.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    if (printMask?.ComparisonValue2 ?? true)
                    {
                        sb.AppendItem(ComparisonValue2, "ComparisonValue2");
                    }
        ...
        {
            #region Members
            public Exception? ComparisonValue2;
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case ConditionFloat_FieldIndex.ComparisonValue2:
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                {
                    case ConditionFloat_FieldIndex.ComparisonValue2:
                        this.ComparisonValue2 = (Exception?)obj;
                        break;
                    case ConditionFloat_FieldIndex.Data:
            ...
            public override bool IsInError()
            {
                ...
                if (ComparisonValue2 != null) return true;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.ComparisonValue2 = this.ComparisonValue2.Combine(rhs.ComparisonValue2);
            ...
            ITranslationMask
        {
            ...
            {
                this.ComparisonValue2 = defaultOn;
            }
    ...
    {
        new Single ComparisonValue2 { get; set; }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ConditionFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ConditionFloat";
    ...
    internal partial class ConditionFloatSetterCommon : ConditionSetterCommon
    {
        ...
        {
            ClearPartial();
            item.ComparisonValue2 = default(Single);
            item.Data.Clear();
            base.Clear(item);
        }
    ...
    internal partial class ConditionFloatCommon : ConditionCommon
    {
        ...
        public void FillEqualsMask(
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ret.ComparisonValue2 = item.ComparisonValue2.EqualsWithin(rhs.ComparisonValue2);
            ...
            ConditionFloat.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.ComparisonValue2 ?? true)
            {
                sb.AppendItem(item.ComparisonValue2, "ComparisonValue2");
            }
            if (printMask?.Data?.Overall ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ConditionFloat_FieldIndex.ComparisonValue2) ?? true))
            {
                if (!lhs.ComparisonValue2.EqualsWithin(rhs.ComparisonValue2)) return false;
            }
        ...
        {
            var hash = new HashCode();
            hash.Add(item.ComparisonValue2);
            hash.Add(item.Data);
            hash.Add(base.GetHashCode());
            return hash.ToHashCode();
        }
    ...
    internal partial class ConditionFloatSetterTranslationCommon : ConditionSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)ConditionFloat_FieldIndex.ComparisonValue2) ?? true))
            {
                item.ComparisonValue2 = rhs.ComparisonValue2;
            }
    ...
    internal partial class ConditionFloatBinaryCreateTranslation : ConditionBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ConditionBinaryCreateTranslation.FillBinaryStructs(
                item: item,
                frame: frame);
            item.ComparisonValue2 = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IConditionFloatGetter
    {
        ...
        public Single ComparisonValue2 => _structData.Slice(0x4, 0x4).Float();
        #region Data
