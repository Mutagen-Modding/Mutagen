...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ATopicReference>
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(ATopicReference.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ATopicReference.Mask<bool>? printMask = null)
            {
        ...
        #region Mutagen
        public virtual IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ATopicReferenceCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class ATopicReferenceMixIn
    {
        ...
        {
            return ((ATopicReferenceCommon)((IATopicReferenceGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ATopicReference.Mask<bool>? printMask = null)
        {
            ((ATopicReferenceCommon)((IATopicReferenceGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ATopicReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ATopicReference";
    ...
    internal partial class ATopicReferenceCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IATopicReferenceGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
