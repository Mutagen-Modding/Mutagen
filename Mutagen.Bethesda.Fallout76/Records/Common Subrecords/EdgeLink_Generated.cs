...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<EdgeLink>
    {
        ...
        #endregion
        #region Unknown22
        public SByte Unknown22 { get; set; } = default(SByte);
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.Unknown22, rhs.Unknown22)) return false;
                return true;
            }
            ...
            public bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.Unknown22)) return false;
                return true;
            }
            #endregion
            ...
            public bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.Unknown22)) return true;
                return false;
            }
            #endregion
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.Unknown22 = eval(this.Unknown22);
            }
            #endregion
            ...
            public void Print(StructuredStringBuilder sb, EdgeLink.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.Unknown22 ?? true)
                    {
                        sb.AppendItem(Unknown22, "Unknown22");
                    }
                }
            }
            #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case EdgeLink_FieldIndex.Unknown22:
                        return Unknown22;
                    default:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Unknown22 = this.Unknown22.Combine(rhs.Unknown22);
                return ret;
            }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class EdgeLink_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.EdgeLink";
    ...
    internal partial class EdgeLinkCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.Unknown22 = item.Unknown22 == rhs.Unknown22;
        }
            ...
            EdgeLink.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.Unknown22 ?? true)
            {
                sb.AppendItem(item.Unknown22, "Unknown22");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)EdgeLink_FieldIndex.Unknown22) ?? true))
            {
                if (lhs.Unknown22 != rhs.Unknown22) return false;
            }
            return true;
        }
    ...
    internal partial class EdgeLinkSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)EdgeLink_FieldIndex.Unknown22) ?? true))
            {
                item.Unknown22 = rhs.Unknown22;
            }
            DeepCopyInCustom(
                item: item,
                rhs: rhs,
...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        IEdgeLinkGetter
    {
        ...
        public Int32 Unknown2 => BinaryPrimitives.ReadInt32LittleEndian(_structData.Slice(0x0, 0x4));
        ...
        public SByte Unknown22 => (sbyte)_structData.Slice(0xA, 0x1)[0];
