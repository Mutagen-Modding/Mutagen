...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class Bone_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.Bone";
    ...
    internal partial class BoneCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IBoneGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    {
        public static readonly BoneBinaryWriteTranslation Instance = new();
