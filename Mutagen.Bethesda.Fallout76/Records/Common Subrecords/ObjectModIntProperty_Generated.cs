...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ObjectModIntProperty_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ObjectModIntProperty";
        ...
        where T : struct, Enum
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IObjectModIntPropertyGetter<T> obj, bool iterateNestedRecords = true)
        {
