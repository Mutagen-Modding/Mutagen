...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ContainerEntry_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ContainerEntry";
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.CNTO:
                {
                    ...
                    item.Item = Mutagen.Bethesda.Fallout76.ContainerItem.CreateFromBinary(frame: frame);
                    return (int)ContainerEntry_FieldIndex.Item;
                }
                case RecordTypeInts.COED:
                {
                    item.Data = Mutagen.Bethesda.Fallout76.ExtraData.CreateFromBinary(frame: frame);
