...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ActivateParents>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ActivateParentsCommon)((IActivateParentsGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IActivateParentsGetter? obj)
        {
            return ((ActivateParentsCommon)((IActivateParentsGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(ActivateParents.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ActivateParents.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                        ...
                        && Parents is {} ParentsItem)
                    {
                        ...
                        using (sb.Brace())
                        {
                            sb.AppendItem(ParentsItem.Overall);
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ActivateParentsCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class ActivateParentsMixIn
    {
        ...
        {
            return ((ActivateParentsCommon)((IActivateParentsGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ActivateParents.Mask<bool>? printMask = null)
        {
            ((ActivateParentsCommon)((IActivateParentsGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ActivateParents_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ActivateParents";
    ...
    internal partial class ActivateParentsCommon
    {
            ...
            ActivateParents.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"ActivateParents =>");
            }
            else
            {
                sb.AppendLine($"{name} (ActivateParents) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!lhs.Parents.SequenceEqual(rhs.Parents, (l, r) => ((ActivateParentCommon)((IActivateParentGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)ActivateParents_FieldIndex.Parents)))) return false;
            }
            return true;
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IActivateParentsGetter obj, bool iterateNestedRecords = true)
        {
            foreach (var item in obj.Parents.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
                ...
                case RecordTypeInts.XAPR:
                {
                    this.Parents = BinaryOverlayList.FactoryByArray<IActivateParentGetter>(
                        ...
                        locs: ParseRecordLocations(
                            stream: stream,
                            trigger: ActivateParent_Registration.TriggerSpecs,
