...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class DestructionStage_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.DestructionStage";
    ...
    internal partial class DestructionStageCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IDestructionStageGetter obj, bool iterateNestedRecords = true)
        {
