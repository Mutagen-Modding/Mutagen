...
using static Mutagen.Bethesda.Fallout76.Condition;
...
partial class ConditionDataBinaryOverlay
{
    ...
    public IFormLinkGetter<IFallout76MajorRecordGetter> Reference => FormLinkBinaryTranslation.Instance.OverlayFactory<IFallout76MajorRecordGetter>(_package, _structData.Span.Slice(0x10, 0x4));
...
partial class FunctionConditionDataBinaryOverlay
{
    ...
    public IFormLinkGetter<IFallout76MajorRecordGetter> ParameterOneRecord => FormLinkBinaryTranslation.Instance.OverlayFactory<IFallout76MajorRecordGetter>(_package, _data2);

    public int ParameterOneNumber => BinaryPrimitives.ReadInt32LittleEndian(_data2);

    public IFormLinkGetter<IFallout76MajorRecordGetter> ParameterTwoRecord => FormLinkBinaryTranslation.Instance.OverlayFactory<IFallout76MajorRecordGetter>(_package, _data2.Slice(4));
