...
namespace Mutagen.Bethesda.Fallout76
{
        ...
        ILoquiObjectSetter<ALocationTarget>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ALocationTargetCommon)((IALocationTargetGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IALocationTargetGetter? obj)
        {
            return ((ALocationTargetCommon)((IALocationTargetGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(ALocationTarget.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ALocationTarget.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(ALocationTarget.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                }
            }
        ...
        #region Mutagen
        public virtual IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ALocationTargetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class ALocationTargetMixIn
    {
        ...
        {
            return ((ALocationTargetCommon)((IALocationTargetGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ALocationTarget.Mask<bool>? printMask = null)
        {
            ((ALocationTargetCommon)((IALocationTargetGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    internal partial class ALocationTarget_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Fallout76.ALocationTarget";
    ...
    internal partial class ALocationTargetCommon
    {
            ...
            ALocationTarget.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"ALocationTarget =>");
            }
            else
            {
                sb.AppendLine($"{name} (ALocationTarget) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IALocationTargetGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout76
{
    ...
    {
        public static readonly ALocationTargetBinaryWriteTranslation Instance = new();
