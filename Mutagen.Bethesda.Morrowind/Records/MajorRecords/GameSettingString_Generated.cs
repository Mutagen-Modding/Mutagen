...
namespace Mutagen.Bethesda.Morrowind
{
        ...
        ILoquiObjectSetter<GameSettingString>
    {
            ...
            IMask<TItem>
        {
            ...
            : base(
                ...
                Version2: Version2,
                MorrowindMajorRecordFlags: MorrowindMajorRecordFlags)
            {
                this.Data = Data;
            }
        ...
        public GameSettingString(IMorrowindMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public GameSettingString(IMorrowindMod mod, string editorID)
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Morrowind.Internals.RecordTypeInts.GMST)]
...
namespace Mutagen.Bethesda.Morrowind
{
    ...
    internal partial class GameSettingString_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Morrowind.GameSettingString";
    ...
    internal partial class GameSettingStringSetterCommon : GameSettingSetterCommon
    {
        ...
        public override void Clear(IMorrowindMajorRecordInternal item)
        {
            Clear(item: (IGameSettingStringInternal)item);
        }
    ...
    internal partial class GameSettingStringCommon : GameSettingCommon
    {
        ...
        public static GameSettingString_FieldIndex ConvertFieldIndex(GameSetting_FieldIndex index)
        {
            switch (index)
            {
                ...
                case GameSetting_FieldIndex.Version2:
                    return (GameSettingString_FieldIndex)((int)index);
                case GameSetting_FieldIndex.MorrowindMajorRecordFlags:
                    return (GameSettingString_FieldIndex)((int)index);
                default:
        ...
        public static new GameSettingString_FieldIndex ConvertFieldIndex(MorrowindMajorRecord_FieldIndex index)
        {
            switch (index)
            {
                case MorrowindMajorRecord_FieldIndex.MajorRecordFlagsRaw:
                    return (GameSettingString_FieldIndex)((int)index);
                case MorrowindMajorRecord_FieldIndex.FormKey:
                    return (GameSettingString_FieldIndex)((int)index);
                case MorrowindMajorRecord_FieldIndex.VersionControl:
                    return (GameSettingString_FieldIndex)((int)index);
                case MorrowindMajorRecord_FieldIndex.EditorID:
                    return (GameSettingString_FieldIndex)((int)index);
        ...
        public override int GetHashCode(IMorrowindMajorRecordGetter item)
        {
            return GetHashCode(item: (IGameSettingStringGetter)item);
        }
        ...
        public override MorrowindMajorRecord Duplicate(
...
namespace Mutagen.Bethesda.Morrowind
{
    ...
    {
        public new static readonly GameSettingStringBinaryWriteTranslation Instance = new();
            ...
            TypedWriteParams translationParams)
        {
            PluginUtilityTranslation.WriteMajorRecord(
                ...
                writeEmbedded: MorrowindMajorRecordBinaryWriteTranslation.WriteEmbedded,
