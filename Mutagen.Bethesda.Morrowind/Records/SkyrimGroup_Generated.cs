...
namespace Mutagen.Bethesda.Morrowind
{
    ...
    public partial class SkyrimGroup<T> :
        ...
        ISkyrimGroup<T>
        where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObjectSetter<T>, TGetter
    {
        #region Ctor
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks() => SkyrimGroupCommon<T>.Instance.EnumerateFormLinks(this);
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType) => SkyrimGroupCommon<T>.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => SkyrimGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => SkyrimGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
        #endregion
    ...
    public partial interface ISkyrimGroupGetter<out T> :
        ...
        where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<T>
    {
    ...
    public static partial class SkyrimGroupMixIn
    {
        ...
        public static bool Equals<T, T_TranslMask>(
            ...
            where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<T>
            where T_TranslMask : class, ITranslationMask
        {
            return ((SkyrimGroupCommon<T>)((ISkyrimGroupGetter<T>)item).CommonInstance(typeof(T))!).Equals(
                lhs: item,
                rhs: rhs,
        ...
        public static void DeepCopyIn<T, TGetter>(
            ...
            where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObjectSetter<T>, TGetter
            where TGetter : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<TGetter>
        {
        ...
        public static void DeepCopyIn<T, TGetter, T_ErrMask, T_TranslMask>(
            ...
            where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObjectSetter<T>, TGetter
            where TGetter : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<TGetter>
            where T_ErrMask : class, IErrorMask<T_ErrMask>
            where T_TranslMask : class, ITranslationMask
        {
...
namespace Mutagen.Bethesda.Morrowind
{
    ...
    internal partial class SkyrimGroup_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Morrowind.SkyrimGroup";
        ...
        where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<T>
    {
            ...
            SkyrimGroup.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"SkyrimGroup<{typeof(T).Name}> =>");
            }
            else
            {
        ...
        public object GetNew<T_Setter>()
            where T_Setter : class, SkyrimMajorRecord, IBinaryItem, ILoquiObjectSetter<T>, TGetter
        {
            return SkyrimGroup<T_Setter>.GetNew();
        }
        
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISkyrimGroupGetter<T> obj)
        {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(ISkyrimGroupGetter<T> obj, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType)
        {
...
namespace Mutagen.Bethesda.Morrowind
{
            ...
            where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObject<T>
        {
            Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<T>.Instance.Write(
                ...
                transl: (MutagenWriter r, T dictSubItem) =>
                {
                    ...
                    {
                        ((IBinaryWriteTranslator)((IBinaryItem)Item).BinaryWriteTranslator).Write(
                            item: Item,
                            writer: r);
                    }
                });
    ...
    internal partial class SkyrimGroupBinaryCreateTranslation<T>
        where T : class, SkyrimMajorRecord, IBinaryItem, ILoquiObjectSetter<T>, TGetter
    {
        public static readonly SkyrimGroupBinaryCreateTranslation<T> Instance = new SkyrimGroupBinaryCreateTranslation<T>();
    ...
    public static class SkyrimGroup
    {
            ...
            IMask<TItem>
        {
            ...
            public Mask(TItem initialValue)
            {
                ...
                this.RecordCache = new MaskItem<TItem, IEnumerable<MaskItemIndexed<FormKey, TItem, IMask<TItem>?>>?>(initialValue, null);
            }
                ...
                TItem RecordCache)
            {
                ...
                this.RecordCache = new MaskItem<TItem, IEnumerable<MaskItemIndexed<FormKey, TItem, IMask<TItem>?>>?>(RecordCache, null);
            }
            ...
            public MaskItem<TItem, IEnumerable<MaskItemIndexed<FormKey, TItem, IMask<TItem>?>>?>? RecordCache;
            #endregion
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (RecordCache != null)
                {
                    obj.RecordCache = new MaskItem<R, IEnumerable<MaskItemIndexed<FormKey, R, IMask<R>?>>?>(eval(this.RecordCache.Overall), default);
