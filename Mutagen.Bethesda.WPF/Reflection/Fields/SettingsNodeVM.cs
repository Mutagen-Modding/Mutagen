...
namespace Mutagen.Bethesda.WPF.Reflection.Fields
{
    ...
    public abstract class SettingsNodeVM : ViewModel
    {
        ...
        public static string GetDiskName(MemberInfo? member)
        {
            ...
            return member.GetCustomAttributeValueByName(nameof(JsonDiskName), nameof(JsonDiskName.Name), member.Name);
        }
        ...
        public static string GetDisplayName(MemberInfo? member)
        {
            ...
            return member.GetCustomAttributeValueByName(nameof(SettingName), nameof(SettingName.Name), member.Name.Humanize(LetterCasing.Title));
        }
