...
public class TestDataPathing
{
    ...
    public static string CountDisagreesSingleRecordContentEmptyTests = "Files/Core/CountDisagreesSingleRecordContentEmptyTests.esp";
    ...
    public static string FluffedNullString = "Files/Core/Strings/FluffedNullString";
