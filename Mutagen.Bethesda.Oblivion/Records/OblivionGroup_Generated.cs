...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        where T : class, IOblivionMajorRecordInternal, IBinaryItem
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => OblivionGroupCommon<T>.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => OblivionGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => OblivionGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
        #endregion
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        where T : class, IOblivionMajorRecordInternal, IBinaryItem
    {
        ...
        public IEnumerable<IMajorRecord> EnumerateMajorRecordsLoopLogic(IOblivionGroup<T> obj)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumeratePotentiallyTypedMajorRecords(
            ...
            bool throwIfUnknown)
        {
            if (type == null) return OblivionGroupCommon<T>.Instance.EnumerateMajorRecords(obj);
            return OblivionGroupCommon<T>.Instance.EnumerateMajorRecords(obj, type, throwIfUnknown);
        }
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(
            ...
            bool throwIfUnknown)
        {
            foreach (var item in OblivionGroupCommon<T>.Instance.EnumerateMajorRecordsLoopLogic(obj, type, throwIfUnknown))
            {
                yield return item;
            }
        }
        ...
        where T : class, IOblivionMajorRecordGetter, IBinaryItem
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IOblivionGroupGetter<T> obj, bool iterateNestedRecords = true)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(IOblivionGroupGetter<T> obj)
        {
