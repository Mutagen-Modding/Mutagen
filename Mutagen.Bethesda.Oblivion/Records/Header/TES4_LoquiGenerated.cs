...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class TES4 : ITES4, ILoquiObject<TES4>, ILoquiObjectSetter, IEquatable<TES4>
    {
                ...
                case "Header":
                    try
                    {
                        ...
                        if (LoquiXmlTranslation<Header>.Instance.Parse(
                            root: root,
                            item: out var HeaderParse,
                            errorMask: errorMask))
                        {
                            item._Header.Item = HeaderParse;
                        }
                        else
                        {
                            item._Header.Unset();
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            {
                case "HEDR":
                    LoquiBinaryTranslation<Header>.Instance.ParseInto(
                        frame: frame,
