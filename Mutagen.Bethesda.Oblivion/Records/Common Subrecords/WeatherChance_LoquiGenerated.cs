...
{
    #region Class
    public partial class WeatherChance : IWeatherChance, ILoquiObjectSetter, IEquatable<WeatherChance>
    {
        ...
        #region Chance
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingItem<Int32> _Chance = NotifyingItem.Factory<Int32>();
        public INotifyingItem<Int32> Chance_Property => _Chance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public Int32 Chance
        {
        ...
        {
            return WeatherChanceCommon.ToString(this, printMask: null);
        }
        ...
        public bool Equals(WeatherChance rhs)
        {
            ...
            if (Weather != rhs.Weather) return false;
        ...
        #region XML Create
        [DebuggerStepThrough]
        public static WeatherChance Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                doMasks: false,
        ...
        public static WeatherChance Create_XML(Stream stream)
        {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (WeatherChance_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        [DebuggerStepThrough]
        public static WeatherChance Create_Binary(MutagenFrame frame)
        {
        ...
        public static WeatherChance Create_Binary(Stream stream)
        {
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<WeatherChance, WeatherChance_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out WeatherChance_ErrorMask errorMask)
        {
            errorMask = (WeatherChance_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            WeatherChance_CopyMask copyMask = null,
            IWeatherChanceGetter def = null)
            where CopyType : class, IWeatherChance
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(WeatherChance)))
            {
                ret = new WeatherChance() as CopyType;
            }
            else
            {
    ...
    #region Interface
    public interface IWeatherChance : IWeatherChanceGetter, ILoquiClass<IWeatherChance, IWeatherChanceGetter>, ILoquiClass<WeatherChance, IWeatherChanceGetter>
    {
    ...
    public interface IWeatherChanceGetter : ILoquiObject
    {
        #region Weather
        Weather Weather { get; }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class WeatherChanceCommon
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            Func<WeatherChance_ErrorMask> maskGetter = () =>
            {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.WeatherChance"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.WeatherChance");
                    }
