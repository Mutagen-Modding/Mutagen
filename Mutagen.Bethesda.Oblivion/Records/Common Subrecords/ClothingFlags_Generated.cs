...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<ClothingFlags>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((ClothingFlagsCommon)((IClothingFlagsGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IClothingFlagsGetter? obj)
        {
            return ((ClothingFlagsCommon)((IClothingFlagsGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(ClothingFlags.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ClothingFlags.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(ClothingFlags.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class ClothingFlagsMixIn
    {
        ...
        {
            return ((ClothingFlagsCommon)((IClothingFlagsGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ClothingFlags.Mask<bool>? printMask = null)
        {
            ((ClothingFlagsCommon)((IClothingFlagsGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class ClothingFlagsCommon
    {
            ...
            ClothingFlags.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"ClothingFlags =>");
            }
            else
            {
                sb.AppendLine($"{name} (ClothingFlags) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ClothingFlags_FieldIndex.BipedFlags) ?? true))
            {
                if (lhs.BipedFlags != rhs.BipedFlags) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)ClothingFlags_FieldIndex.GeneralFlags) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IClothingFlagsGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IClothingFlagsGetter
    {
        ...
        public BipedFlag BipedFlags => (BipedFlag)BinaryPrimitives.ReadUInt16LittleEndian(_structData.Span.Slice(0x0, 0x2));
        public EquipmentFlag GeneralFlags => (EquipmentFlag)BinaryPrimitives.ReadUInt16LittleEndian(_structData.Span.Slice(0x2, 0x2));
