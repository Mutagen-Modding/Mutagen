...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class EnableParent : IEnableParent, ILoquiObject<EnableParent>, ILoquiObjectSetter, IEquatable<EnableParent>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        INotifyingItemGetter<EnableParent.Flag> IEnableParentGetter.Flags_Property => this.Flags_Property;
        #endregion
        ...
        #region XML Create
        [DebuggerStepThrough]
        public static EnableParent Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                doMasks: false,
        ...
        [DebuggerStepThrough]
        public static (EnableParent Object, EnableParent_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
            EnableParent_ErrorMask errMaskRet = null;
            var ret = Create_XML_Internal(
                root: root,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new EnableParent_ErrorMask()) : default(Func<EnableParent_ErrorMask>));
            return (ret, errMaskRet);
        }

        public static EnableParent Create_XML(string path)
        {
        ...
        public static EnableParent Create_XML(Stream stream)
        {
        ...
        {
            LoquiXmlTranslation<EnableParent, EnableParent_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (EnableParent_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        private static EnableParent Create_XML_Internal(
            XElement root,
        ...
        [DebuggerStepThrough]
        public static (EnableParent Object, EnableParent_ErrorMask ErrorMask) Create_Binary(
            MutagenFrame frame,
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<EnableParent, EnableParent_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out EnableParent_ErrorMask errorMask)
        {
            errorMask = (EnableParent_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
        ...
        private static EnableParent Create_Binary_Internal(
            MutagenFrame frame,
            Func<EnableParent_ErrorMask> errorMask,
            RecordTypeConverter recordTypeConverter)
        {
    ...
    public partial interface IEnableParentGetter : ILoquiObject
    {
        ...
        INotifyingItemGetter<EnableParent.Flag> Flags_Property { get; }
    ...
    public static partial class EnableParentCommon
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            if (copyMask?.Reference ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)EnableParent_FieldIndex.Reference, ex);
                }
            }
            if (copyMask?.Flags ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)EnableParent_FieldIndex.Flags, ex);
                }
            }
        }
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.EnableParent"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.EnableParent");
                    }
