...
{
    #region Class
    public partial class GameSettingString : GameSetting, IGameSettingString, ILoquiObject<GameSettingString>, ILoquiObjectSetter, IEquatable<GameSettingString>
    {
        ...
        #region Data
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingSetItem<String> _Data = NotifyingSetItem.Factory<String>(markAsSet: false);
            ...
            switch (nextRecordType.Type)
            {
                ...
                default:
                    return GameSetting.Fill_Binary_RecordTypes(
                        ...
                        frame: frame,
                        recordTypeConverter: recordTypeConverter,
                        errorMask: errorMask).Bubble((i) => GameSettingStringCommon.ConvertFieldIndex(i));
            }
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class GameSettingStringCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.GameSettingString"))
                {
                    if (name != null)
                    {
