...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        protected object XmlWriteTranslator => NpcDataXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((NpcDataXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static NpcData CreateFromXml(
            XElement node,
            NpcData.TranslationMask? translationMask = null)
        {
        ...
        {
            var ret = new NpcData();
            ((NpcDataSetterCommon)((INpcDataGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class NpcDataMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((NpcDataSetterCommon)((INpcDataGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class NpcData_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(NpcDataXmlWriteTranslation);
    ...
    public partial class NpcDataSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    NpcDataXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public partial class NpcDataXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static NpcDataXmlWriteTranslation Instance = new NpcDataXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Armorer) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Armorer),
                    item: item.Armorer,
                    fieldIndex: (int)NpcData_FieldIndex.Armorer,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Athletics) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Athletics),
                    item: item.Athletics,
                    fieldIndex: (int)NpcData_FieldIndex.Athletics,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Blade) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Blade),
                    item: item.Blade,
                    fieldIndex: (int)NpcData_FieldIndex.Blade,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Block) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Block),
                    item: item.Block,
                    fieldIndex: (int)NpcData_FieldIndex.Block,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Blunt) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Blunt),
                    item: item.Blunt,
                    fieldIndex: (int)NpcData_FieldIndex.Blunt,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.HandToHand) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.HandToHand),
                    item: item.HandToHand,
                    fieldIndex: (int)NpcData_FieldIndex.HandToHand,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.HeavyArmor) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.HeavyArmor),
                    item: item.HeavyArmor,
                    fieldIndex: (int)NpcData_FieldIndex.HeavyArmor,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Alchemy) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Alchemy),
                    item: item.Alchemy,
                    fieldIndex: (int)NpcData_FieldIndex.Alchemy,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Alteration) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Alteration),
                    item: item.Alteration,
                    fieldIndex: (int)NpcData_FieldIndex.Alteration,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Conjuration) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Conjuration),
                    item: item.Conjuration,
                    fieldIndex: (int)NpcData_FieldIndex.Conjuration,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Destruction) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Destruction),
                    item: item.Destruction,
                    fieldIndex: (int)NpcData_FieldIndex.Destruction,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Illusion) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Illusion),
                    item: item.Illusion,
                    fieldIndex: (int)NpcData_FieldIndex.Illusion,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Mysticism) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Mysticism),
                    item: item.Mysticism,
                    fieldIndex: (int)NpcData_FieldIndex.Mysticism,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Restoration) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Restoration),
                    item: item.Restoration,
                    fieldIndex: (int)NpcData_FieldIndex.Restoration,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Acrobatics) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Acrobatics),
                    item: item.Acrobatics,
                    fieldIndex: (int)NpcData_FieldIndex.Acrobatics,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.LightArmor) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LightArmor),
                    item: item.LightArmor,
                    fieldIndex: (int)NpcData_FieldIndex.LightArmor,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Marksman) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Marksman),
                    item: item.Marksman,
                    fieldIndex: (int)NpcData_FieldIndex.Marksman,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Mercantile) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Mercantile),
                    item: item.Mercantile,
                    fieldIndex: (int)NpcData_FieldIndex.Mercantile,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Security) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Security),
                    item: item.Security,
                    fieldIndex: (int)NpcData_FieldIndex.Security,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Sneak) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Sneak),
                    item: item.Sneak,
                    fieldIndex: (int)NpcData_FieldIndex.Sneak,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Speechcraft) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Speechcraft),
                    item: item.Speechcraft,
                    fieldIndex: (int)NpcData_FieldIndex.Speechcraft,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Health) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Health),
                    item: item.Health,
                    fieldIndex: (int)NpcData_FieldIndex.Health,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Strength) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Strength),
                    item: item.Strength,
                    fieldIndex: (int)NpcData_FieldIndex.Strength,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Intelligence) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Intelligence),
                    item: item.Intelligence,
                    fieldIndex: (int)NpcData_FieldIndex.Intelligence,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Willpower) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Willpower),
                    item: item.Willpower,
                    fieldIndex: (int)NpcData_FieldIndex.Willpower,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Agility) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Agility),
                    item: item.Agility,
                    fieldIndex: (int)NpcData_FieldIndex.Agility,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Speed) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Speed),
                    item: item.Speed,
                    fieldIndex: (int)NpcData_FieldIndex.Speed,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Endurance) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Endurance),
                    item: item.Endurance,
                    fieldIndex: (int)NpcData_FieldIndex.Endurance,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Personality) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Personality),
                    item: item.Personality,
                    fieldIndex: (int)NpcData_FieldIndex.Personality,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)NpcData_FieldIndex.Luck) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Luck),
                    item: item.Luck,
                    fieldIndex: (int)NpcData_FieldIndex.Luck,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Oblivion.NpcData");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Oblivion.NpcData");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class NpcDataXmlCreateTranslation
    {
        public readonly static NpcDataXmlCreateTranslation Instance = new NpcDataXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Armorer":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Armorer);
                    try
                    {
                    ...
                    break;
                case "Athletics":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Athletics);
                    try
                    {
                    ...
                    break;
                case "Blade":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Blade);
                    try
                    {
                    ...
                    break;
                case "Block":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Block);
                    try
                    {
                    ...
                    break;
                case "Blunt":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Blunt);
                    try
                    {
                    ...
                    break;
                case "HandToHand":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.HandToHand);
                    try
                    {
                    ...
                    break;
                case "HeavyArmor":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.HeavyArmor);
                    try
                    {
                    ...
                    break;
                case "Alchemy":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Alchemy);
                    try
                    {
                    ...
                    break;
                case "Alteration":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Alteration);
                    try
                    {
                    ...
                    break;
                case "Conjuration":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Conjuration);
                    try
                    {
                    ...
                    break;
                case "Destruction":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Destruction);
                    try
                    {
                    ...
                    break;
                case "Illusion":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Illusion);
                    try
                    {
                    ...
                    break;
                case "Mysticism":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Mysticism);
                    try
                    {
                    ...
                    break;
                case "Restoration":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Restoration);
                    try
                    {
                    ...
                    break;
                case "Acrobatics":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Acrobatics);
                    try
                    {
                    ...
                    break;
                case "LightArmor":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.LightArmor);
                    try
                    {
                    ...
                    break;
                case "Marksman":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Marksman);
                    try
                    {
                    ...
                    break;
                case "Mercantile":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Mercantile);
                    try
                    {
                    ...
                    break;
                case "Security":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Security);
                    try
                    {
                    ...
                    break;
                case "Sneak":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Sneak);
                    try
                    {
                    ...
                    break;
                case "Speechcraft":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Speechcraft);
                    try
                    {
                    ...
                    break;
                case "Health":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Health);
                    try
                    {
                    ...
                    break;
                case "Strength":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Strength);
                    try
                    {
                    ...
                    break;
                case "Intelligence":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Intelligence);
                    try
                    {
                    ...
                    break;
                case "Willpower":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Willpower);
                    try
                    {
                    ...
                    break;
                case "Agility":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Agility);
                    try
                    {
                    ...
                    break;
                case "Speed":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Speed);
                    try
                    {
                    ...
                    break;
                case "Endurance":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Endurance);
                    try
                    {
                    ...
                    break;
                case "Personality":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Personality);
                    try
                    {
                    ...
                    break;
                case "Luck":
                    errorMask?.PushIndex((int)NpcData_FieldIndex.Luck);
                    try
                    {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class NpcDataXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((NpcDataXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
