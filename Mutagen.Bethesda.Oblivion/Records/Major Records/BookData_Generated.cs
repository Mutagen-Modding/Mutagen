...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class BookDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IBookDataGetter obj)
        {
            yield break;
        }
        
        public void RemapLinks(IBookDataGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public partial class BookDataXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)BookData_FieldIndex.Teaches) ?? true))
            {
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Oblivion.BookData");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Oblivion.BookData");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
