...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<LeveledSpell>
    {
        ...
        #region XML Create
        [DebuggerStepThrough]
        public new static LeveledSpell Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                errorMask: null);
        ...
        public static LeveledSpell Create_XML(string path)
        {
        ...
        public static LeveledSpell Create_XML(Stream stream)
        {
            ...
            NotifyingFireParameters cmds = null)
        {
            this.CopyIn_XML(
                root: root,
                errorMask: out LeveledSpell_ErrorMask errMask,
                cmds: cmds);
            errorMask = errMask;
        }
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "Flags":
                    ...
                    break;
                case "Entries":
                    ListXmlTranslation<LeveledEntry<Spell>>.Instance.ParseInto(
                        root: root,
                        item: item.Entries,
            ...
            string name = null)
        {
            ...
            if (item.Entries.HasBeenSet)
            {
                ListXmlTranslation<LeveledEntry<Spell>>.Instance.Write(
                    ...
                    fieldIndex: (int)LeveledSpell_FieldIndex.Entries,
                    errorMask: errorMask,
                    transl: (XElement subNode, LeveledEntry<Spell> subItem, ErrorMaskBuilder listSubMask) =>
                    {
