...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)LeveledSpell_FieldIndex.Entries) ?? true))
            {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        ILeveledSpellGetter
    {
        ...
        public LeveledFlag? Flags => _FlagsLocation.HasValue ? (LeveledFlag)HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)[0] : default(LeveledFlag?);
        #endregion
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.LVLO:
                {
                    this.Entries = BinaryOverlayList<LeveledEntryBinaryOverlay<IASpellGetter>>.FactoryByArray(
                        ...
                        package: _package,
                        recordTypeConverter: recordTypeConverter,
                        getter: (s, p, recConv) => LeveledEntryBinaryOverlay<IASpellGetter>.LeveledEntryFactory(new OverlayStream(s, p), p, recConv),
