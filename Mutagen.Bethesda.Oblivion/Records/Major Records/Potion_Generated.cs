...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class PotionCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            {
                if (!lhs.Effects.SequenceEqual(rhs.Effects, (l, r) => ((EffectCommon)((IEffectGetter)l).CommonInstance()!).Equals(l, r, crystal?.GetSubCrystal((int)Potion_FieldIndex.Effects)))) return false;
            }
            return true;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public new static readonly PotionBinaryWriteTranslation Instance = new PotionBinaryWriteTranslation();
