...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public abstract partial class NPCSpawn : MajorRecord, INPCSpawn, ILoquiObjectSetter, IEquatable<NPCSpawn>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (NPCSpawn_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<NPCSpawn, NPCSpawn_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out NPCSpawn_ErrorMask errorMask)
        {
            errorMask = (NPCSpawn_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class NPCSpawnCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.NPCSpawn"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.NPCSpawn");
                    }
                }
            }
            catch (Exception ex)
