...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISigilStoneInternal
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(SigilStone.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, SigilStone.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(SigilStone.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks() => SigilStoneCommon.Instance.EnumerateFormLinks(this);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.SGST)]
    ...
    public static partial class SigilStoneMixIn
    {
        ...
        {
            return ((SigilStoneCommon)((ISigilStoneGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            SigilStone.Mask<bool>? printMask = null)
        {
            ((SigilStoneCommon)((ISigilStoneGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class SigilStoneCommon : OblivionMajorRecordCommon
    {
            ...
            SigilStone.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"SigilStone =>");
            }
            else
            {
                sb.AppendLine($"{name} (SigilStone) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)SigilStone_FieldIndex.Model) ?? true))
            {
                ...
                {
                    if (!((ModelCommon)((IModelGetter)lhsModel).CommonInstance()!).Equals(lhsModel, rhsModel, crystal?.GetSubCrystal((int)SigilStone_FieldIndex.Model))) return false;
                }
            ...
            if ((crystal?.GetShouldTranslate((int)SigilStone_FieldIndex.Data) ?? true))
            {
                ...
                {
                    if (!((SigilStoneDataCommon)((ISigilStoneDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, crystal?.GetSubCrystal((int)SigilStone_FieldIndex.Data))) return false;
                }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISigilStoneGetter obj)
        {
