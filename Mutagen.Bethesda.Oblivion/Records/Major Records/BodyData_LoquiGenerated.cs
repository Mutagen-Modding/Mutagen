...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<BodyData>
    {
        ...
        protected PropertyForwarder<BodyData, Model> _ModelForwarder;
        public INotifyingSetItem<Model> Model_Property => _ModelForwarder ?? (_ModelForwarder = new PropertyForwarder<BodyData, Model>(this, (int)BodyData_FieldIndex.Model));
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public Model Model
        {
            get => this._Model;
        ...
        {
            var oldHasBeenSet = _hasBeenSetTracker[(int)BodyData_FieldIndex.Model];
            ...
            if (_Model_subscriptions != null)
            {
                ...
                _Model_subscriptions.FireSubscriptions(
                    index: (int)BodyData_FieldIndex.Model,
        ...
        {
            _hasBeenSetTracker[(int)BodyData_FieldIndex.Model] = false;
            Model = default(Model);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public void CopyIn_XML(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiXmlTranslation<BodyData>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                errorMask: null,
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                case "Model":
                    ...
                    break;
                case "BodyParts":
                    ListXmlTranslation<BodyPart>.Instance.ParseInto(
                        root: root,
                        item: item.BodyParts,
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case 0x4E4F4349: // ICON
                    ...
                    Mutagen.Bethesda.Binary.ListBinaryTranslation<BodyPart>.Instance.ParseRepeatedItem(
                        ...
                        errorMask: errorMask,
                        transl: LoquiBinaryTranslation<BodyPart>.Instance.Parse);
    ...
    public static partial class BodyDataCommon
    {
            ...
            string name = null)
        {
            ...
            if (item.BodyParts.HasBeenSet)
            {
                ListXmlTranslation<BodyPart>.Instance.Write(
                    ...
                    fieldIndex: (int)BodyData_FieldIndex.BodyParts,
                    errorMask: errorMask,
                    transl: (XElement subNode, BodyPart subItem, ErrorMaskBuilder listSubMask) =>
                    {
            ...
            ErrorMaskBuilder errorMask)
        {
            ...
            Mutagen.Bethesda.Binary.ListBinaryTranslation<BodyPart>.Instance.Write(
                ...
                fieldIndex: (int)BodyData_FieldIndex.BodyParts,
                errorMask: errorMask,
                transl: LoquiBinaryTranslation<BodyPart>.Instance.Write);
        }
