...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Book : NamedMajorRecord, IBook, ILoquiObject<Book>, ILoquiObjectSetter, IEquatable<Book>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "Description":
                    ...
                    break;
                case "Flags":
                    EnumXmlTranslation<Book.BookFlag>.Instance.ParseInto(
                        root,
        ...
        public static Book Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Book, Book_FieldIndex>(
                record: new Book(),
                frame: frame,
                errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "DATA":
                    ...
                    {
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Book.BookFlag>.Instance.ParseInto(
