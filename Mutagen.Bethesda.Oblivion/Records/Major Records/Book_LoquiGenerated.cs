...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Book : NamedMajorRecord, IBook, ILoquiObjectSetter, IEquatable<Book>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Book_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<Book, Book_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out Book_ErrorMask errorMask)
        {
            errorMask = (Book_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
