...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class LocalVariableData : ILocalVariableData, ILoquiObject<LocalVariableData>, ILoquiObjectSetter, IEquatable<LocalVariableData>
    {
            ...
            bool doMasks = true)
        {
            ...
            errorMask = LocalVariableData_ErrorMask.Factory(errorMaskBuilder);
            return ret;
        }
        ...
        {
            LoquiXmlTranslation<LocalVariableData>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                errorMask: null,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class LocalVariableDataCommon
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            {
                errorMask.PushIndex((int)LocalVariableData_FieldIndex.Data);
                try
                {
    ...
    public class LocalVariableData_ErrorMask : IErrorMask, IErrorMask<LocalVariableData_ErrorMask>
    {
        ...
        #region Factory
        public static LocalVariableData_ErrorMask Factory(ErrorMaskBuilder errorMask)
        {
            if (errorMask?.Empty ?? true) return null;
            return new LocalVariableData_ErrorMask();
        }
        #endregion
