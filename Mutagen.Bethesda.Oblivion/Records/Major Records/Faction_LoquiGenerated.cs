...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Faction : NamedMajorRecord, IFaction, ILoquiObject<Faction>, ILoquiObjectSetter, IEquatable<Faction>
    {
        ...
        #region Flags
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingSetItem<Faction.FactionFlag> _Flags = NotifyingSetItem.Factory<Faction.FactionFlag>(markAsSet: false);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingSetItem<Single> _CrimeGoldMultiplier = NotifyingSetItem.Factory<Single>(markAsSet: false);
            ...
            switch (name)
            {
                ...
                case "CrimeGoldMultiplier":
                    FloatXmlTranslation.Instance.ParseInto(
                        ...
                        item: item._CrimeGoldMultiplier,
                        errorMask: errorMask);
                    break;
                case "Ranks":
        ...
        public static Faction Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Faction, Faction_FieldIndex>(
                record: new Faction(),
                frame: frame,
                errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "DATA":
                    ...
                    Mutagen.Bethesda.Binary.EnumBinaryTranslation<Faction.FactionFlag>.Instance.ParseInto(
            ...
            string name = null)
        {
            ...
            if (item.Ranks.HasBeenSet)
            {
                ListXmlTranslation<Rank>.Instance.Write(
                    ...
                    fieldIndex: (int)Faction_FieldIndex.Ranks,
                    errorMask: errorMask,
                    transl: (XElement subNode, Rank subItem, ErrorMaskBuilder listSubMask) =>
                    {
