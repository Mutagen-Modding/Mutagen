...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Door : NamedMajorRecord, IDoor, ILoquiObjectSetter, IEquatable<Door>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Door_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<Door, Door_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out Door_ErrorMask errorMask)
        {
            errorMask = (Door_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
