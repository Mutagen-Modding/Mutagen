...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Door : NamedMajorRecord, IDoor, ILoquiObject<Door>, ILoquiObjectSetter, IEquatable<Door>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "LoopSound":
                    ...
                    break;
                case "Flags":
                    EnumXmlTranslation<Door.DoorFlag>.Instance.ParseInto(
                        root,
                ...
                case "RandomTeleportDestinations":
                    ListXmlTranslation<FormIDSetLink<Worldspace>>.Instance.ParseInto(
                        root: root,
                        item: item._RandomTeleportDestinations,
        ...
        public static Door Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Door, Door_FieldIndex>(
                record: new Door(),
                frame: frame,
                errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "FNAM":
                    frame.Position += Constants.SUBRECORD_LENGTH;
                    Mutagen.Bethesda.Binary.EnumBinaryTranslation<Door.DoorFlag>.Instance.ParseInto(
    ...
    public static partial class DoorCommon
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            ...
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<Door.DoorFlag>.Instance.Write(
                ...
                nullable: false);
            Mutagen.Bethesda.Binary.ListBinaryTranslation<FormIDSetLink<Worldspace>>.Instance.Write(
                writer: writer,
