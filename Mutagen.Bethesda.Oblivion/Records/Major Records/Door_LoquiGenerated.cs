...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IModelInternalGetter IDoorGetter.Model => this.Model;
        #endregion
        #region Script
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlySetList<IFormIDLinkGetter<IPlaceInternalGetter>> IDoorGetter.RandomTeleportDestinations => _RandomTeleportDestinations;
        #endregion
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((DoorCommon)((IDoorInternalGetter)this).CommonInstance()).Equals(this, rhs);
        }

        public bool Equals(Door obj)
        {
            return ((DoorCommon)((IDoorInternalGetter)this).CommonInstance()).Equals(this, obj);
        }

        public override int GetHashCode() => ((DoorCommon)((IDoorInternalGetter)this).CommonInstance()).GetHashCode(this);
        ...
        IBinaryItem
    {
        ...
        #endregion
        #region RandomTeleportDestinations
        IReadOnlySetList<IFormIDLinkGetter<IPlaceInternalGetter>> RandomTeleportDestinations { get; }
        #endregion
    ...
    public static class DoorMixIn
    {
        ...
        {
            ((DoorSetterCommon)((IDoorInternalGetter)item).CommonSetterInstance()).Clear(item: item);
        }
        ...
        {
            return ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).GetEqualsMask(
                item: item,
                rhs: rhs,
                include: include);
        }
        ...
        {
            return ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            Door_Mask<bool> printMask = null)
        {
            ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
        ...
        {
            return ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }
        ...
        public static Door_Mask<bool> GetHasBeenSetMask(this IDoorInternalGetter item)
        {
            ...
            ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class DoorCommon : OblivionMajorRecordCommon
    {
        ...
        {
            var ret = new Door_Mask<bool>();
            ((DoorCommon)((IDoorInternalGetter)item).CommonInstance()).FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
                include: include);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal translationMask)
        {
            ...
            {
                ListXmlTranslation<IFormIDLinkGetter<IPlaceInternalGetter>>.Instance.Write(
                    node: node,
                    ...
                    transl: (XElement subNode, IFormIDLinkGetter<IPlaceInternalGetter> subItem, ErrorMaskBuilder listSubMask, TranslationCrystal listTranslMask) =>
                    {
                        FormKeyXmlTranslation.Instance.Write(
                            node: subNode,
                            name: null,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            MasterReferences masterReferences)
        {
            ...
            if (item.RandomTeleportDestinations.HasBeenSet)
            {
                Mutagen.Bethesda.Binary.ListBinaryTranslation<IFormIDLinkGetter<IPlaceInternalGetter>>.Instance.Write(
                    writer: writer,
                    items: item.RandomTeleportDestinations,
                    transl: (MutagenWriter subWriter, IFormIDLinkGetter<IPlaceInternalGetter> subItem) =>
                    {
                        Mutagen.Bethesda.Binary.FormLinkBinaryTranslation.Instance.Write(
                            writer: subWriter,
                            item: subItem,
