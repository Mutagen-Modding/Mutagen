...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        protected object XmlWriteTranslator => ClimateDataXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ClimateDataXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static ClimateData CreateFromXml(
            XElement node,
            ClimateData.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((ClimateDataSetterCommon)((IClimateDataGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = ClimateData_Registration.TriggeringRecordType;
        #endregion
    ...
    public static partial class ClimateDataMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ClimateDataSetterCommon)((IClimateDataGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class ClimateDataSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ClimateDataXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class ClimateDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IClimateDataGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public partial class ClimateDataXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static ClimateDataXmlWriteTranslation Instance = new ClimateDataXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.SunriseBegin) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SunriseBegin),
                    item: item.SunriseBegin,
                    fieldIndex: (int)ClimateData_FieldIndex.SunriseBegin,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.SunriseEnd) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SunriseEnd),
                    item: item.SunriseEnd,
                    fieldIndex: (int)ClimateData_FieldIndex.SunriseEnd,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.SunsetBegin) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SunsetBegin),
                    item: item.SunsetBegin,
                    fieldIndex: (int)ClimateData_FieldIndex.SunsetBegin,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.SunsetEnd) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SunsetEnd),
                    item: item.SunsetEnd,
                    fieldIndex: (int)ClimateData_FieldIndex.SunsetEnd,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.Volatility) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Volatility),
                    item: item.Volatility,
                    fieldIndex: (int)ClimateData_FieldIndex.Volatility,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.Phase) ?? true))
            {
                EnumXmlTranslation<Climate.MoonPhase>.Instance.Write(
                    node: node,
                    name: nameof(item.Phase),
                    item: item.Phase,
                    fieldIndex: (int)ClimateData_FieldIndex.Phase,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ClimateData_FieldIndex.PhaseLength) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PhaseLength),
                    item: item.PhaseLength,
                    fieldIndex: (int)ClimateData_FieldIndex.PhaseLength,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Oblivion.ClimateData");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Oblivion.ClimateData");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ClimateDataXmlCreateTranslation
    {
        public readonly static ClimateDataXmlCreateTranslation Instance = new ClimateDataXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "SunriseBegin":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.SunriseBegin);
                    try
                    {
                    ...
                    break;
                case "SunriseEnd":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.SunriseEnd);
                    try
                    {
                    ...
                    break;
                case "SunsetBegin":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.SunsetBegin);
                    try
                    {
                    ...
                    break;
                case "SunsetEnd":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.SunsetEnd);
                    try
                    {
                    ...
                    break;
                case "Volatility":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.Volatility);
                    try
                    {
                    ...
                    break;
                case "Phase":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.Phase);
                    try
                    {
                    ...
                    break;
                case "PhaseLength":
                    errorMask?.PushIndex((int)ClimateData_FieldIndex.PhaseLength);
                    try
                    {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public static class ClimateDataXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ClimateDataXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
