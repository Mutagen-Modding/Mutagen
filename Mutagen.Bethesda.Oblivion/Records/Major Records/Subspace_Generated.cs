...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISubspaceInternal
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(Subspace.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, Subspace.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(Subspace.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((SubspaceCommon)((ISubspaceGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ISubspaceGetter? obj)
        {
            return ((SubspaceCommon)((ISubspaceGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
    ...
    public static partial class SubspaceMixIn
    {
        ...
        {
            return ((SubspaceCommon)((ISubspaceGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            Subspace.Mask<bool>? printMask = null)
        {
            ((SubspaceCommon)((ISubspaceGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
{
    #region Field Index
    internal enum Subspace_FieldIndex
    {
    ...
    #region Registration
    internal partial class Subspace_Registration : ILoquiRegistration
    {
        ...
        {
            var triggers = RecordCollection.Factory(RecordTypes.SBSP);
    ...
    #region Common
    internal partial class SubspaceSetterCommon : OblivionMajorRecordSetterCommon
    {
    ...
    internal partial class SubspaceCommon : OblivionMajorRecordCommon
    {
            ...
            Subspace.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"Subspace =>");
            }
            else
            {
                sb.AppendLine($"{name} (Subspace) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Subspace_FieldIndex.Point) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISubspaceGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public Subspace Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Subspace(formKey, default(OblivionRelease));
    ...
    internal partial class SubspaceSetterTranslationCommon : OblivionMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class Subspace
    {
        ...
        public new static ILoquiRegistration StaticRegistration => Subspace_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class SubspaceBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
        public new static readonly SubspaceBinaryCreateTranslation Instance = new SubspaceBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Oblivion
{
    internal partial class SubspaceBinaryOverlay :
