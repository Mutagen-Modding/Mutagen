...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        public void Name_Set(
            ...
            bool markSet = true)
        {
            this.RaiseAndSetIfReferenceChanged(ref _Name, value, _hasBeenSetTracker, markSet, (int)MapMarker_FieldIndex.Name, nameof(Name), nameof(Name_IsSet));
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IMapMarkerGetter
    {
        ...
        public MapMarker.Flag Flags => (MapMarker.Flag)HeaderTranslation.ExtractSubrecordSpan(_data.Slice(0), _FlagsLocation.Value, _package.Meta)[0];
        #endregion
        #region Name
