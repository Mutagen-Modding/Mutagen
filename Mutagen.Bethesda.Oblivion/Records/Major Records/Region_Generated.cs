...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.REGN)]
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    #region Common
    internal partial class RegionSetterCommon : OblivionMajorRecordSetterCommon
    {
    ...
    internal partial class RegionCommon : OblivionMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRegionGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in ObjectsItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in WeatherItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in GrassesItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
        ...
        public Region Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Region(formKey, default(OblivionRelease));
    ...
    internal partial class RegionSetterTranslationCommon : OblivionMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class RegionBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
