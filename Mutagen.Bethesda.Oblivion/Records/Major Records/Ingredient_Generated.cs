...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.INGR)]
    ...
    internal partial class IngredientCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Ingredient_FieldIndex.Data) ?? true))
            {
                ...
                {
                    if (!((IngredientDataCommon)((IIngredientDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, equalsMask?.GetSubCrystal((int)Ingredient_FieldIndex.Data))) return false;
                }
        ...
        public Ingredient Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Ingredient(formKey, default(OblivionRelease));
