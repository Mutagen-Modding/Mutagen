...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IQuestTargetData
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((QuestTargetDataCommon)((IQuestTargetDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IQuestTargetDataGetter? obj)
        {
            return ((QuestTargetDataCommon)((IQuestTargetDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class QuestTargetDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)QuestTargetData_FieldIndex.Target) ?? true))
            {
                if (!lhs.Target.Equals(rhs.Target)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)QuestTargetData_FieldIndex.Flags) ?? true))
            {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public static readonly QuestTargetDataBinaryWriteTranslation Instance = new();
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IQuestTargetDataGetter
    {
        ...
        public IFormLinkGetter<IPlacedGetter> Target => new FormLink<IPlacedGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x0, 0x4))));
        public QuestTarget.Flag Flags => (QuestTarget.Flag)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0x4, 0x4));
