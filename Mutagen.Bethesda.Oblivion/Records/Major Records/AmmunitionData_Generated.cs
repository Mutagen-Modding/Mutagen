...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public partial class AmmunitionDataBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            MutagenWriter writer)
        {
            FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Write(
                writer: writer,
                item: item.Speed);
            EnumBinaryTranslation<AmmunitionData.Flag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Flags,
                length: 4);
    ...
    public partial class AmmunitionDataBinaryCreateTranslation
    {
            ...
            MutagenFrame frame)
        {
            ...
            item.Flags = EnumBinaryTranslation<AmmunitionData.Flag, MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                length: 4);
