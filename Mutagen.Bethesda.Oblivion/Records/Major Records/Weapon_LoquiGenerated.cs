...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IModelInternalGetter IWeaponGetter.Model => this.Model;
        #endregion
        #region Icon
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((WeaponCommon)((IWeaponInternalGetter)this).CommonInstance()).Equals(this, rhs);
        }

        public bool Equals(Weapon obj)
        {
            return ((WeaponCommon)((IWeaponInternalGetter)this).CommonInstance()).Equals(this, obj);
        }

        public override int GetHashCode() => ((WeaponCommon)((IWeaponInternalGetter)this).CommonInstance()).GetHashCode(this);
    ...
    public static class WeaponMixIn
    {
        ...
        {
            ((WeaponSetterCommon)((IWeaponInternalGetter)item).CommonSetterInstance()).Clear(item: item);
        }
        ...
        {
            return ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).GetEqualsMask(
                item: item,
                rhs: rhs,
                include: include);
        }
        ...
        {
            return ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            Weapon_Mask<bool> printMask = null)
        {
            ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
        ...
        {
            return ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }
        ...
        public static Weapon_Mask<bool> GetHasBeenSetMask(this IWeaponInternalGetter item)
        {
            ...
            ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class WeaponCommon : ItemAbstractCommon
    {
        ...
        {
            var ret = new Weapon_Mask<bool>();
            ((WeaponCommon)((IWeaponInternalGetter)item).CommonInstance()).FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
                include: include);
