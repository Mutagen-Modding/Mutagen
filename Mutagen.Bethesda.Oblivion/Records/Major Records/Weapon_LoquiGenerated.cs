...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Weapon : NamedMajorRecord, IWeapon, ILoquiObject<Weapon>, ILoquiObjectSetter, IEquatable<Weapon>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "EnchantmentPoints":
                    ...
                    break;
                case "Type":
                    EnumXmlTranslation<Weapon.WeaponType>.Instance.ParseInto(
                        root,
                ...
                case "Reach":
                    ...
                    break;
                case "Flags":
                    EnumXmlTranslation<Weapon.WeaponFlag>.Instance.ParseInto(
                        root,
        ...
        public static Weapon Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Weapon, Weapon_FieldIndex>(
                record: new Weapon(),
                frame: frame,
                errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "DATA":
                    ...
                    {
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Weapon.WeaponType>.Instance.ParseInto(
                        ...
                        Mutagen.Bethesda.Binary.FloatBinaryTranslation.Instance.ParseInto(
                            ...
                            fieldIndex: (int)Weapon_FieldIndex.Reach,
                            errorMask: errorMask);
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Weapon.WeaponFlag>.Instance.ParseInto(
                            frame: dataFrame.SpawnWithLength(4),
                            item: item._Flags,
                            fieldIndex: (int)Weapon_FieldIndex.Flags,
                            errorMask: errorMask);
