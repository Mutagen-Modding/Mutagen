...
{
    #region Class
    public partial class RegionDataGrasses : RegionData, IRegionDataGrasses, ILoquiObjectSetter, IEquatable<RegionDataGrasses>
    {
        ...
        public bool Equals(RegionDataGrasses rhs)
        {
            ...
            {
                if (!Grasses.SequenceEqual(rhs.Grasses)) return false;
            }
            return true;
        }
        ...
        [DebuggerStepThrough]
        public static (RegionDataGrasses Object, RegionDataGrasses_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
            RegionDataGrasses_ErrorMask errMaskRet = null;
            var ret = Create_XML_Internal(
                root: root,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new RegionDataGrasses_ErrorMask()) : default(Func<RegionDataGrasses_ErrorMask>));
        ...
        {
            LoquiXmlTranslation<RegionDataGrasses, RegionDataGrasses_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (RegionDataGrasses_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        private static RegionDataGrasses Create_XML_Internal(
            XElement root,
        ...
        [DebuggerStepThrough]
        public static (RegionDataGrasses Object, RegionDataGrasses_ErrorMask ErrorMask) Create_Binary(
            MutagenFrame frame,
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<RegionDataGrasses, RegionDataGrasses_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out RegionDataGrasses_ErrorMask errorMask)
        {
            errorMask = (RegionDataGrasses_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
        ...
        private static RegionDataGrasses Create_Binary_Internal(
            MutagenFrame frame,
            Func<RegionDataGrasses_ErrorMask> errorMask,
            RecordTypeConverter recordTypeConverter)
        {
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            RegionDataGrasses_CopyMask copyMask = null,
            IRegionDataGrassesGetter def = null)
            where CopyType : class, IRegionDataGrasses
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(RegionDataGrasses)))
            {
                ret = new RegionDataGrasses() as CopyType;
            }
            else
            {
    ...
    #region Interface
    public interface IRegionDataGrasses : IRegionDataGrassesGetter, IRegionData, ILoquiClass<IRegionDataGrasses, IRegionDataGrassesGetter>, ILoquiClass<RegionDataGrasses, IRegionDataGrassesGetter>
    {
        new INotifyingList<FormIDLink<Grass>> Grasses { get; }
    }

    public interface IRegionDataGrassesGetter : IRegionDataGetter
    {
        #region Grasses
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class RegionDataGrassesCommon
    {
        ...
        public static void CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            RegionDataGrasses_ErrorMask retErrorMask = null;
            Func<RegionDataGrasses_ErrorMask> maskGetter = () =>
            {
                if (retErrorMask == null)
                {
                    retErrorMask = new RegionDataGrasses_ErrorMask();
                }
                return retErrorMask;
            };
            CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            if (copyMask?.Grasses != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionDataGrasses_FieldIndex.Grasses, ex);
                }
            }
        }
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.RegionDataGrasses"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.RegionDataGrasses");
                    }
                    if (item.Grasses.HasBeenSet)
                    {
