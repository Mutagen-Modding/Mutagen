...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.FACT)]
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class FactionCommon : OblivionMajorRecordCommon
    {
        ...
        public Faction Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Faction(formKey, default(OblivionRelease));
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<Faction.FactionFlag, MutagenFrame, MutagenWriter>.Instance.WriteNullable(
                writer,
                item.Flags,
                length: 1,
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IFactionGetter
    {
        ...
        public Faction.FactionFlag? Flags => EnumBinaryTranslation<Faction.FactionFlag, MutagenFrame, MutagenWriter>.Instance.ParseRecordNullable(_FlagsLocation, _recordData, _package, 1);
        #endregion
        #region CrimeGoldMultiplier
