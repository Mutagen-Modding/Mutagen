...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<Quest>
    {
        ...
        [DebuggerStepThrough]
        public static (Quest Object, Quest_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
            Quest_ErrorMask errMaskRet = null;
            var ret = Create_XML_Internal(
                root: root,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new Quest_ErrorMask()) : default(Func<Quest_ErrorMask>));
        ...
        {
            LoquiXmlTranslation<Quest, Quest_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
            ...
            string name = null)
        {
            errorMask = this.Write_XML_Internal(
                node: node,
                name: name,
                doMasks: doMasks) as Quest_ErrorMask;
        }
        ...
        private static Quest Create_XML_Internal(
            XElement root,
            Func<Quest_ErrorMask> errorMask)
        {
            var ret = new Quest();
            try
            {
        ...
        [DebuggerStepThrough]
        public static (Quest Object, Quest_ErrorMask ErrorMask) Create_Binary(
            MutagenFrame frame,
        ...
        private static Quest Create_Binary_Internal(
            MutagenFrame frame,
            Func<Quest_ErrorMask> errorMask,
            RecordTypeConverter recordTypeConverter)
        {
            return UtilityTranslation.MajorRecordParse<Quest, Quest_ErrorMask>(
                record: new Quest(),
                frame: frame,
                errorMask: errorMask,
        ...
        public void CopyFieldsFrom(
            ...
            bool doMasks = true)
        {
            Quest_ErrorMask retErrorMask = null;
            Func<IErrorMask> maskGetter = !doMasks ? default(Func<IErrorMask>) : () =>
            {
                if (retErrorMask == null)
                {
                    retErrorMask = new Quest_ErrorMask();
                }
                return retErrorMask;
            };
