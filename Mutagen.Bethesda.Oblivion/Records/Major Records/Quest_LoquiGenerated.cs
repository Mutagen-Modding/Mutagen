...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        protected override IXmlWriteTranslator XmlWriteTranslator => QuestXmlWriteTranslation.Instance;
        #region Xml Create
        [DebuggerStepThrough]
            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    QuestXmlCreateTranslation.FillPublicElement_Xml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
        ...
        protected override IBinaryWriteTranslator BinaryWriteTranslator => QuestBinaryWriteTranslation.Instance;
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class Quest_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlTranslation = typeof(QuestXmlWriteTranslation);
        ...
        public static readonly Type BinaryTranslation = typeof(QuestBinaryWriteTranslation);
        #region Interface
            ...
            TranslationCrystal translationMask)
        {
                ...
                && (translationMask?.GetShouldTranslate((int)Quest_FieldIndex.Stages) ?? true))
            {
                ListXmlTranslation<IQuestStageGetter>.Instance.Write(
                    ...
                    {
                        ((QuestStageXmlWriteTranslation)((IXmlItem)subItem).XmlWriteTranslator).Write(
                            item: subItem,
                            node: subNode,
                            name: null,
                            errorMask: listSubMask,
                ...
                && (translationMask?.GetShouldTranslate((int)Quest_FieldIndex.Targets) ?? true))
            {
                ListXmlTranslation<IQuestTargetInternalGetter>.Instance.Write(
                    ...
                    {
                        ((QuestTargetXmlWriteTranslation)((IXmlItem)subItem).XmlWriteTranslator).Write(
                            item: subItem,
                            node: subNode,
                            name: null,
                            errorMask: listSubMask,
            ...
            MasterReferences masterReferences)
        {
            ...
            if (item.Stages.HasBeenSet)
            {
                Mutagen.Bethesda.Binary.ListBinaryTranslation<IQuestStageGetter>.Instance.Write(
                    ...
                    {
                        ((QuestStageBinaryWriteTranslation)((IBinaryItem)subItem).BinaryWriteTranslator).Write(
                            item: subItem,
                            writer: subWriter,
                            errorMask: listErrorMask,
                            masterReferences: masterReferences,
            ...
            if (item.Targets.HasBeenSet)
            {
                Mutagen.Bethesda.Binary.ListBinaryTranslation<IQuestTargetInternalGetter>.Instance.Write(
                    ...
                    {
                        ((QuestTargetBinaryWriteTranslation)((IBinaryItem)subItem).BinaryWriteTranslator).Write(
                            item: subItem,
                            writer: subWriter,
                            errorMask: listErrorMask,
                            masterReferences: masterReferences,
