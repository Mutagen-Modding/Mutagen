...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullable<IWorldspaceGetter> IWorldspaceGetter.Parent => this.Parent;
        #endregion
        #region Climate
        ...
        IBinaryItem
    {
        ...
        String? Name { get; }
        IFormLinkNullable<IWorldspaceGetter> Parent { get; }
            ...
            Type type)
        {
            switch (type.Name)
            {
                ...
                case "IRoadInternal":
                    ...
                    {
                        yield return Roaditem;
                        foreach (var item in Roaditem.EnumerateMajorRecords(type))
                        {
                            yield return item;
                        }
                    }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IWorldspaceGetter
    {
        ...
        public MusicType? Music => _MusicLocation.HasValue ? (MusicType)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _MusicLocation!.Value, _package.MetaData.Constants)) : default(MusicType?);
        #endregion
        #region OffsetData
