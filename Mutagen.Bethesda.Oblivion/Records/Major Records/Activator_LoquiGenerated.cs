...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Activator : NamedMajorRecord, IActivator, ILoquiObjectSetter, IEquatable<Activator>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Activator_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<Activator, Activator_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out Activator_ErrorMask errorMask)
        {
            errorMask = (Activator_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                doMasks: true);
        }
            ...
            Func<Activator_ErrorMask> errorMask)
        {
            ...
            try
            {
                frame = frame.Spawn(HeaderTranslation.ParseRecord(
                    frame,
                    Activator_Registration.ACTI_HEADER));
                using (frame)
                {
                    Fill_Binary_Structs(
                        item: ret,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class ActivatorCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.Activator"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.Activator");
                    }
            ...
            Func<Activator_ErrorMask> errorMask)
        {
            ...
            Mutagen.Bethesda.Binary.RawFormIDBinaryTranslation.Instance.Write(
                ...
                fieldIndex: (int)Activator_FieldIndex.Script,
                errorMask: errorMask,
                header: Activator_Registration.SCRI_HEADER,
                nullable: false);
            Mutagen.Bethesda.Binary.RawFormIDBinaryTranslation.Instance.Write(
                writer: writer,
                ...
                fieldIndex: (int)Activator_FieldIndex.Sound,
                errorMask: errorMask,
                header: Activator_Registration.SNAM_HEADER,
                nullable: false);
        }
