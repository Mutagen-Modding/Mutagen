...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Weather : MajorRecord, IWeather, ILoquiObjectSetter, IEquatable<Weather>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Weather_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<Weather, Weather_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out Weather_ErrorMask errorMask)
        {
            errorMask = (Weather_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
