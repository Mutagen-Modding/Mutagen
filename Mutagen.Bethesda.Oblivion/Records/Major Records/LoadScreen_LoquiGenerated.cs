...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<LoadScreen>
    {
        ...
        #region XML Create
        [DebuggerStepThrough]
        public new static LoadScreen Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                errorMask: null);
        ...
        public static LoadScreen Create_XML(string path)
        {
        ...
        public static LoadScreen Create_XML(Stream stream)
        {
            ...
            NotifyingFireParameters cmds = null)
        {
            this.CopyIn_XML(
                root: root,
                errorMask: out LoadScreen_ErrorMask errMask,
                cmds: cmds);
            errorMask = errMask;
        }
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "Description":
                    ...
                    break;
                case "Locations":
                    ListXmlTranslation<LoadScreenLocation>.Instance.ParseInto(
                        root: root,
                        item: item.Locations,
            ...
            string name = null)
        {
            ...
            if (item.Locations.HasBeenSet)
            {
                ListXmlTranslation<LoadScreenLocation>.Instance.Write(
                    ...
                    fieldIndex: (int)LoadScreen_FieldIndex.Locations,
                    errorMask: errorMask,
                    transl: (XElement subNode, LoadScreenLocation subItem, ErrorMaskBuilder listSubMask) =>
                    {
