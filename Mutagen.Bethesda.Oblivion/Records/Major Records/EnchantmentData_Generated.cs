...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class EnchantmentDataSetterCommon
    {
        ...
        #region Mutagen
        public void RemapLinks(IEnchantmentData obj, IReadOnlyDictionary<FormKey, FormKey> mapping)
        {
        }
    ...
    internal partial class EnchantmentDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IEnchantmentDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public static readonly EnchantmentDataBinaryWriteTranslation Instance = new();
