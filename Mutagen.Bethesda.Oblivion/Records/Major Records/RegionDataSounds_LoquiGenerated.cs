...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class RegionDataSounds_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlTranslation = typeof(RegionDataSoundsXmlWriteTranslation);
        ...
        public static readonly Type BinaryTranslation = typeof(RegionDataSoundsBinaryWriteTranslation);
        #region Interface
            ...
            TranslationCrystal translationMask)
        {
                ...
                && (translationMask?.GetShouldTranslate((int)RegionDataSounds_FieldIndex.Sounds) ?? true))
            {
                ListXmlTranslation<IRegionSoundGetter>.Instance.Write(
                    ...
                    {
                        ((RegionSoundXmlWriteTranslation)((IXmlItem)subItem).XmlWriteTranslator).Write(
                            item: subItem,
                            node: subNode,
                            name: null,
            ...
            MasterReferences masterReferences)
        {
            ...
            if (item.Sounds.HasBeenSet)
            {
                Mutagen.Bethesda.Binary.ListBinaryTranslation<IRegionSoundGetter>.Instance.Write(
                    ...
                    {
                        ((RegionSoundBinaryWriteTranslation)((IBinaryItem)subItem).BinaryWriteTranslator).Write(
                            item: subItem,
                            writer: subWriter,
