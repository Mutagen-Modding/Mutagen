...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class RegionDataSounds : RegionData, IRegionDataSounds, ILoquiObjectSetter, IEquatable<RegionDataSounds>
    {
        ...
        #region MusicType
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingSetItem<RegionDataSound.MusicType> _MusicType = NotifyingSetItem.Factory<RegionDataSound.MusicType>(markAsSet: false);
        public INotifyingSetItem<RegionDataSound.MusicType> MusicType_Property => _MusicType;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public RegionDataSound.MusicType MusicType
        {
            get => this._MusicType.Item;
            set => this._MusicType.Set(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        INotifyingSetItem<RegionDataSound.MusicType> IRegionDataSounds.MusicType_Property => this.MusicType_Property;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        INotifyingSetItemGetter<RegionDataSound.MusicType> IRegionDataSoundsGetter.MusicType_Property => this.MusicType_Property;
        #endregion
        #region Sounds
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            Func<RegionDataSounds_ErrorMask> errorMask)
        {
            ...
            {
                case "MusicType":
                    item._MusicType.SetIfSucceeded(EnumXmlTranslation<RegionDataSound.MusicType>.Instance.Parse(
                        root,
                        nullable: false,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                case "RDMD":
                    ...
                    item._MusicType.SetIfSucceeded(Mutagen.Bethesda.Binary.EnumBinaryTranslation<RegionDataSound.MusicType>.Instance.Parse(
        ...
        protected new static void CopyInInternal_RegionDataSounds(RegionDataSounds obj, KeyValuePair<ushort, object> pair)
        {
            ...
            switch (enu)
            {
                case RegionDataSounds_FieldIndex.MusicType:
                    obj._MusicType.Set(
                        (RegionDataSound.MusicType)pair.Value,
                        null);
                    break;
                case RegionDataSounds_FieldIndex.Sounds:
    ...
    {
        new RegionDataSound.MusicType MusicType { get; set; }
        new INotifyingSetItem<RegionDataSound.MusicType> MusicType_Property { get; }
    ...
    {
        #region MusicType
        RegionDataSound.MusicType MusicType { get; }
        INotifyingSetItemGetter<RegionDataSound.MusicType> MusicType_Property { get; }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class RegionDataSounds_Registration : ILoquiRegistration
    {
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            {
                case RegionDataSounds_FieldIndex.MusicType:
                    return typeof(RegionDataSound.MusicType);
                case RegionDataSounds_FieldIndex.Sounds:
    ...
    public static partial class RegionDataSoundsCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.RegionDataSounds"))
                {
                    ...
                    {
                        EnumXmlTranslation<RegionDataSound.MusicType>.Instance.Write(
                            writer: writer,
            ...
            Func<RegionDataSounds_ErrorMask> errorMask)
        {
            RegionDataCommon.Write_Binary_RecordTypes(
                ...
                recordTypeConverter: recordTypeConverter,
                errorMask: errorMask);
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<RegionDataSound.MusicType>.Instance.Write(
                writer,
