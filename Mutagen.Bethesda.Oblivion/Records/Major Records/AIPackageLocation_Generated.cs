...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<AIPackageLocation>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((AIPackageLocationCommon)((IAIPackageLocationGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IAIPackageLocationGetter? obj)
        {
            return ((AIPackageLocationCommon)((IAIPackageLocationGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => AIPackageLocationCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class AIPackageLocationCommon
    {
            ...
            AIPackageLocation.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"AIPackageLocation =>");
            }
            else
            {
            ...
            AIPackageLocation.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.LocationReference ?? true)
            {
                sb.AppendItem(item.LocationReference.FormKey, "LocationReference");
            }
            if (printMask?.Radius ?? true)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)AIPackageLocation_FieldIndex.Type) ?? true))
            {
                if (lhs.Type != rhs.Type) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AIPackageLocation_FieldIndex.LocationReference) ?? true))
            {
                if (!lhs.LocationReference.Equals(rhs.LocationReference)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AIPackageLocation_FieldIndex.Radius) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAIPackageLocationGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class AIPackageLocationBinaryWriteTranslation : IBinaryWriteTranslator
    {
        ...
        public static void WriteEmbedded(
            ...
            MutagenWriter writer)
        {
            EnumBinaryTranslation<AIPackageLocation.LocationType, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Type,
                length: 4);
    ...
    {
        public static readonly AIPackageLocationBinaryCreateTranslation Instance = new AIPackageLocationBinaryCreateTranslation();

        public static void FillBinaryStructs(
            IAIPackageLocation item,
            MutagenFrame frame)
        {
            item.Type = EnumBinaryTranslation<AIPackageLocation.LocationType, MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                length: 4);
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IAIPackageLocationGetter
    {
        ...
        public static IAIPackageLocationGetter AIPackageLocationFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
