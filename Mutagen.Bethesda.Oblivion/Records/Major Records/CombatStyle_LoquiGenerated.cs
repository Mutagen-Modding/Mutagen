            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                ...
                foreach (var elem in node.Elements())
                {
                    ...
                    CombatStyleXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case 0x44545343: // CSTD
                {
                    ...
                    CombatStyleBinaryTranslation.FillBinarySecondaryFlagsCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                        ...
                        if (!item.CSTDDataTypeState.HasFlag(CombatStyle.CSTDDataType.Break1))
                        {
                            ...
                            if (!item.CSTDDataTypeState.HasFlag(CombatStyle.CSTDDataType.Break2))
                            {
                                ...
                                if (!item.CSTDDataTypeState.HasFlag(CombatStyle.CSTDDataType.Break3))
                                {
                                    ...
                                    {
                                        CombatStyleBinaryTranslation.WriteBinarySecondaryFlags(
                                            writer: writer,
                                            item: item,
                                            masterReferences: masterReferences,
                                            errorMask: errorMask);
