...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Birthsign : NamedMajorRecord, IBirthsign, ILoquiObjectSetter, IEquatable<Birthsign>
    {
        ...
        [DebuggerStepThrough]
        public static (Birthsign Object, Birthsign_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
        ...
        {
            LoquiXmlTranslation<Birthsign, Birthsign_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Birthsign_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        private static Birthsign Create_XML_Internal(
            XElement root,
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<Birthsign, Birthsign_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
            ...
            Func<Birthsign_ErrorMask> errorMask)
        {
            ...
            try
            {
                frame = frame.Spawn(HeaderTranslation.ParseRecord(
                    frame,
                    Birthsign_Registration.BSGN_HEADER));
                using (frame)
                {
                    Fill_Binary_Structs(
                        item: ret,
            ...
            IBirthsignGetter def = null)
        {
            ...
            {
                ret = (Birthsign)Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
    ...
    public static partial class BirthsignCommon
    {
            ...
            NotifyingFireParameters? cmds)
        {
            ...
            if (copyMask?.Icon ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)Birthsign_FieldIndex.Icon, ex);
                }
            }
            if (copyMask?.Description ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)Birthsign_FieldIndex.Description, ex);
                }
            }
            if (copyMask?.Spells != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)Birthsign_FieldIndex.Spells, ex);
                }
            }
        }
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.Birthsign"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.Birthsign");
                    }
