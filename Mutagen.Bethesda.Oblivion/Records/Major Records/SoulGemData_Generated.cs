...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISoulGemData
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((SoulGemDataCommon)((ISoulGemDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ISoulGemDataGetter? obj)
        {
            return ((SoulGemDataCommon)((ISoulGemDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(SoulGemData.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, SoulGemData.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(SoulGemData.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class SoulGemDataMixIn
    {
        ...
        {
            return ((SoulGemDataCommon)((ISoulGemDataGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            SoulGemData.Mask<bool>? printMask = null)
        {
            ((SoulGemDataCommon)((ISoulGemDataGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
{
    #region Field Index
    internal enum SoulGemData_FieldIndex
    {
        Value = 0,
        Weight = 1,
    }
    ...
    #region Registration
    internal partial class SoulGemData_Registration : ILoquiRegistration
    {
    ...
    #region Common
    internal partial class SoulGemDataSetterCommon
    {
    ...
    internal partial class SoulGemDataCommon
    {
            ...
            SoulGemData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"SoulGemData =>");
            }
            else
            {
                sb.AppendLine($"{name} (SoulGemData) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)SoulGemData_FieldIndex.Value) ?? true))
            {
                if (lhs.Value != rhs.Value) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoulGemData_FieldIndex.Weight) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISoulGemDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    public partial class SoulGemData
    {
        ...
        public static ILoquiRegistration StaticRegistration => SoulGemData_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class SoulGemDataBinaryCreateTranslation
    {
        public static readonly SoulGemDataBinaryCreateTranslation Instance = new SoulGemDataBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Oblivion
{
    internal partial class SoulGemDataBinaryOverlay :
        PluginBinaryOverlay,
        ISoulGemDataGetter
    {
        #region Common Routing
        ...
        public static ISoulGemDataGetter SoulGemDataFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
