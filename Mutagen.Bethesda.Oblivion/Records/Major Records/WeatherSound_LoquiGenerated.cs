...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class WeatherSound : IWeatherSound, ILoquiObject<WeatherSound>, ILoquiObjectSetter, IEquatable<WeatherSound>
    {
        ...
        #region Type
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingItem<WeatherSound.SoundType> _Type = NotifyingItem.Factory<WeatherSound.SoundType>();
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (WeatherSound_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<WeatherSound, WeatherSound_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out WeatherSound_ErrorMask errorMask)
        {
            errorMask = (WeatherSound_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
