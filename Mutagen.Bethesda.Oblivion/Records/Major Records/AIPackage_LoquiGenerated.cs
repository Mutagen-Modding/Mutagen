...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class AIPackage : MajorRecord, IAIPackage, ILoquiObjectSetter, IEquatable<AIPackage>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (AIPackage_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<AIPackage, AIPackage_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out AIPackage_ErrorMask errorMask)
        {
            errorMask = (AIPackage_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class AIPackageCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.AIPackage"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.AIPackage");
                    }
                }
            }
            catch (Exception ex)
