            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    AIPackageXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case 0x54444B50: // PKDT
                {
                    ...
                    AIPackageBinaryTranslation.FillBinaryFlagsCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                    AIPackageBinaryTranslation.FillBinaryGeneralTypeCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
    ...
    public static partial class AIPackageCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.Location = EqualsMaskHelper.EqualsHelper(
                ...
                item.Location,
                rhs.Location,
                (loqLhs, loqRhs) => AIPackageLocationCommon.GetEqualsMask(loqLhs, loqRhs),
                include);
            ret.Schedule = EqualsMaskHelper.EqualsHelper(
                ...
                item.Schedule,
                rhs.Schedule,
                (loqLhs, loqRhs) => AIPackageScheduleCommon.GetEqualsMask(loqLhs, loqRhs),
                include);
            ret.Target = EqualsMaskHelper.EqualsHelper(
                ...
                item.Target,
                rhs.Target,
                (loqLhs, loqRhs) => AIPackageTargetCommon.GetEqualsMask(loqLhs, loqRhs),
                include);
        ...
        IBinaryTranslator
    {
            ...
            MasterReferences masterReferences)
        {
            ...
            if (item.PKDTDataTypeState.HasFlag(AIPackage.PKDTDataType.Has))
            {
                ...
                {
                    AIPackageBinaryTranslation.WriteBinaryFlags(
                        writer: writer,
                        item: item,
                        errorMask: errorMask,
                        masterReferences: masterReferences);
                    AIPackageBinaryTranslation.WriteBinaryGeneralType(
                        writer: writer,
                        item: item,
                        errorMask: errorMask,
                        masterReferences: masterReferences);
