...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IPotionData
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((PotionDataCommon)((IPotionDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IPotionDataGetter? obj)
        {
            return ((PotionDataCommon)((IPotionDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(PotionData.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, PotionData.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(PotionData.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class PotionDataMixIn
    {
        ...
        {
            return ((PotionDataCommon)((IPotionDataGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            PotionData.Mask<bool>? printMask = null)
        {
            ((PotionDataCommon)((IPotionDataGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class PotionDataCommon
    {
            ...
            PotionData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"PotionData =>");
            }
            else
            {
                sb.AppendLine($"{name} (PotionData) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PotionData_FieldIndex.Value) ?? true))
            {
                if (lhs.Value != rhs.Value) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PotionData_FieldIndex.Flags) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPotionDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public static readonly PotionDataBinaryWriteTranslation Instance = new();
    ...
    {
        public static readonly PotionDataBinaryCreateTranslation Instance = new PotionDataBinaryCreateTranslation();
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IPotionDataGetter
    {
        ...
        public static IPotionDataGetter PotionDataFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
