...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class CreatureConfigurationCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.BaseSpellPoints) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CreatureConfiguration_FieldIndex.LevelOffset) ?? true))
            {
