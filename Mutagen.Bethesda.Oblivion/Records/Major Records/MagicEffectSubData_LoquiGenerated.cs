            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "EnchantEffect":
                    ...
                    try
                    {
                        item.EnchantEffect = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "CastingSound":
                    ...
                    try
                    {
                        item.CastingSound = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "BoltSound":
                    ...
                    try
                    {
                        item.BoltSound = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "HitSound":
                    ...
                    try
                    {
                        item.HitSound = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "AreaSound":
                    ...
                    try
                    {
                        item.AreaSound = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
