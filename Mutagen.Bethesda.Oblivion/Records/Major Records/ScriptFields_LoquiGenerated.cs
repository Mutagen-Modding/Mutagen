        ...
        IEquatable<ScriptFields>
    {
            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    ScriptFieldsXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    ScriptFieldsBinaryTranslation.FillBinaryMetadataSummaryOldCustomPublic(
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class ScriptFieldsCommon
    {
        ...
        public static void Clear(IScriptFields item)
        {
            item.CompiledScript_Unset();
            item.SourceCode_Unset();
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.MetadataSummary = EqualsMaskHelper.EqualsHelper(
                ...
                rhs.MetadataSummary,
                (loqLhs, loqRhs) => ScriptMetaSummaryCommon.GetEqualsMask(loqLhs, loqRhs),
                include);
    ...
    public partial class ScriptFieldsBinaryTranslation : IBinaryTranslator
    {
            ...
            MasterReferences masterReferences)
        {
            ...
            ScriptFieldsBinaryTranslation.WriteBinaryMetadataSummaryOld(
                writer: writer,
                item: item,
                masterReferences: masterReferences,
                errorMask: errorMask);
