...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<ScriptFields>
    {
        ...
        #region XML Create
        [DebuggerStepThrough]
        public static ScriptFields Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                errorMask: null);
        ...
        public static ScriptFields Create_XML(string path)
        {
        ...
        public static ScriptFields Create_XML(Stream stream)
        {
