...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class SigilStone : NamedMajorRecord, ISigilStone, ILoquiObjectSetter, IEquatable<SigilStone>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (SigilStone_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<SigilStone, SigilStone_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out SigilStone_ErrorMask errorMask)
        {
            errorMask = (SigilStone_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class SigilStoneCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.SigilStone"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.SigilStone");
                    }
