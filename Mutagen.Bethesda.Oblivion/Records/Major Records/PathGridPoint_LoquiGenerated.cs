...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<PathGridPoint>
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = doMasks ? new ErrorMaskBuilder() : null;
            PathGridPointXmlTranslation.Instance.Write_Xml(
                item: this,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = doMasks ? new ErrorMaskBuilder() : null;
            PathGridPointBinaryTranslation.Instance.Write_Binary(
                item: this,
                masterReferences: masterReferences,
                writer: writer,
                recordTypeConverter: null,
        ...
        public void Clear()
        {
            ...
            PathGridPointCommon.Clear(this);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class PathGridPointCommon
    {
        ...
        public static void Clear(IPathGridPoint item)
        {
            item.Point = default(P3Float);
            item.NumConnectionsFluffBytes = default(Byte[]);
    ...
    #region Modules
    #region Xml Translation
    public partial class PathGridPointXmlTranslation
    {
    ...
    #region Binary Translation
    public partial class PathGridPointBinaryTranslation
    {
