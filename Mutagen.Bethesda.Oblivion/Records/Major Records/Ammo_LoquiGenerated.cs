...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Ammo : ItemAbstract, IAmmo, ILoquiObject<Ammo>, ILoquiObjectSetter, IEquatable<Ammo>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "Speed":
                    ...
                    break;
                case "Flags":
                    EnumXmlTranslation<Ammo.AmmoFlag>.Instance.ParseInto(
                        root,
        ...
        public static Ammo Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Ammo, Ammo_FieldIndex>(
                record: new Ammo(),
                frame: frame,
                errorMask: errorMask,
                ...
                case "DATA":
                    ...
                    using (var dataFrame = frame.SpawnWithLength(contentLength))
                    {
                        Mutagen.Bethesda.Binary.FloatBinaryTranslation.Instance.ParseInto(
                            ...
                            fieldIndex: (int)Ammo_FieldIndex.Speed,
                            errorMask: errorMask);
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Ammo.AmmoFlag>.Instance.ParseInto(
