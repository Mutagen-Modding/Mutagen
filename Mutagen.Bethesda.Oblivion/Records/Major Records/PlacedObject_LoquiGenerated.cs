...
{
    #region Class
    public partial class PlacedObject : MajorRecord, IPlacedObject, ILoquiObjectSetter, IEquatable<PlacedObject>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        FormIDSetLink<MajorRecord> IPlacedObjectGetter.Object_Property => this.Object_Property;
        #endregion
        ...
        #region ActionFlags
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingItem<PlacedObject.ActionFlag> _ActionFlags = NotifyingItem.Factory<PlacedObject.ActionFlag>();
        public INotifyingItem<PlacedObject.ActionFlag> ActionFlags_Property => _ActionFlags;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        INotifyingItem<PlacedObject.ActionFlag> IPlacedObject.ActionFlags_Property => this.ActionFlags_Property;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        INotifyingItemGetter<PlacedObject.ActionFlag> IPlacedObjectGetter.ActionFlags_Property => this.ActionFlags_Property;
        #endregion
        #region Count
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public FormIDLink<SoulGem> ContainedSoul_Property { get; } = new FormIDLink<SoulGem>();
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public SoulGem ContainedSoul { get => ContainedSoul_Property.Item; set => ContainedSoul_Property.Item = value; }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        FormIDLink<SoulGem> IPlacedObjectGetter.ContainedSoul_Property => this.ContainedSoul_Property;
        #endregion
        #region Position
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            switch (name)
            {
                case "Object":
                    item.Object_Property.SetIfSucceeded(FormIDXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)PlacedObject_FieldIndex.Object,
                        errorMask: errorMask));
                    break;
            ...
            switch (nextRecordType.Type)
            {
                case "NAME":
                    ...
                    item.Object_Property.SetIfSucceeded(Mutagen.Bethesda.Binary.FormIDBinaryTranslation.Instance.Parse(
                        ...
                        fieldIndex: (int)PlacedObject_FieldIndex.Object,
                        errorMask: errorMask));
                    return TryGet<PlacedObject_FieldIndex?>.Succeed(PlacedObject_FieldIndex.Object);
                case "XTEL":
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            PlacedObject_CopyMask copyMask = null,
            IPlacedObjectGetter def = null)
            where CopyType : class, IPlacedObject
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(PlacedObject)))
            {
                ret = new PlacedObject() as CopyType;
            }
            else
            {
        ...
        protected override void SetNthObject(ushort index, object obj, NotifyingFireParameters cmds = null)
        {
            ...
            switch (enu)
            {
                case PlacedObject_FieldIndex.Object:
    ...
    #region Interface
    public interface IPlacedObject : IPlacedObjectGetter, IMajorRecord, ILoquiClass<IPlacedObject, IPlacedObjectGetter>, ILoquiClass<PlacedObject, IPlacedObjectGetter>
    {
        ...
        new INotifyingItem<PlacedObject.ActionFlag> ActionFlags_Property { get; }
    ...
    public interface IPlacedObjectGetter : IMajorRecordGetter
    {
        #region Object
        ...
        INotifyingItemGetter<PlacedObject.ActionFlag> ActionFlags_Property { get; }
        ...
        FormIDLink<SoulGem> ContainedSoul_Property { get; }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public class PlacedObject_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "OBJECT":
                    return (ushort)PlacedObject_FieldIndex.Object;
                case "TELEPORTDESTINATION":
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            switch (enu)
            {
                ...
                case PlacedObject_FieldIndex.Scale:
                    return typeof(Single);
                case PlacedObject_FieldIndex.ContainedSoul:
                    return typeof(FormIDLink<SoulGem>);
                case PlacedObject_FieldIndex.Position:
    ...
    public static partial class PlacedObjectCommon
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            Func<PlacedObject_ErrorMask> maskGetter = () =>
            {
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            if (copyMask?.Object ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)PlacedObject_FieldIndex.Object, ex);
                }
            }
                                ...
                                case CopyOption.CopyIn:
                                    TeleportDestinationCommon.CopyFieldsFrom(
                                        ...
                                        errorMask: (doMasks ? new Func<TeleportDestination_ErrorMask>(() =>
                                        {
                                            ...
                                            if (baseMask.TeleportDestination.Specific == null)
                                            {
                                                baseMask.TeleportDestination = new MaskItem<Exception, TeleportDestination_ErrorMask>(null, new TeleportDestination_ErrorMask());
                                            }
                                            return baseMask.TeleportDestination.Specific;
                                        }
                                        ) : null),
                            ...
                            switch (copyMask?.Lock.Overall ?? CopyOption.Reference)
                            {
                                ...
                                case CopyOption.CopyIn:
                                    LockInformationCommon.CopyFieldsFrom(
                                        ...
                                        {
                                            var baseMask = errorMask();
                                            if (baseMask.Lock.Specific == null)
                                            {
                                                baseMask.Lock = new MaskItem<Exception, LockInformation_ErrorMask>(null, new LockInformation_ErrorMask());
                                            }
                                            return baseMask.Lock.Specific;
                                        }
                                        ) : null),
                            ...
                            switch (copyMask?.DistantLODData.Overall ?? CopyOption.Reference)
                            {
                                ...
                                case CopyOption.CopyIn:
                                    DistantLODDataCommon.CopyFieldsFrom(
                                        ...
                                        {
                                            var baseMask = errorMask();
                                            if (baseMask.DistantLODData.Specific == null)
                                            {
                                                baseMask.DistantLODData = new MaskItem<Exception, DistantLODData_ErrorMask>(null, new DistantLODData_ErrorMask());
                                            }
                                            return baseMask.DistantLODData.Specific;
                                        }
                                        ) : null),
            ...
            if (copyMask?.ActionFlags ?? true)
            {
                try
                {
                    item.ActionFlags_Property.Set(
                        value: rhs.ActionFlags,
                        cmds: cmds);
                }
                catch (Exception ex)
                when (doMasks)
                            ...
                            switch (copyMask?.MapMarker.Overall ?? CopyOption.Reference)
                            {
                                ...
                                case CopyOption.CopyIn:
                                    MapMarkerCommon.CopyFieldsFrom(
                                        ...
                                        {
                                            var baseMask = errorMask();
                                            if (baseMask.MapMarker.Specific == null)
                                            {
                                                baseMask.MapMarker = new MaskItem<Exception, MapMarker_ErrorMask>(null, new MapMarker_ErrorMask());
                                            }
                                            return baseMask.MapMarker.Specific;
                                        }
                                        ) : null),
            ...
            if (copyMask?.ContainedSoul ?? true)
            {
                try
                {
                    item.ContainedSoul_Property.Set(
                        value: rhs.ContainedSoul,
                        cmds: cmds);
                }
                catch (Exception ex)
                when (doMasks)
            ...
            NotifyingUnsetParameters cmds = null)
        {
            ...
            switch (enu)
            {
                ...
                case PlacedObject_FieldIndex.Unknown:
                    ...
                    break;
                case PlacedObject_FieldIndex.ActionFlags:
                    obj.ActionFlags = default(PlacedObject.ActionFlag);
                    break;
                case PlacedObject_FieldIndex.Count:
                ...
                case PlacedObject_FieldIndex.Scale:
                    ...
                    break;
                case PlacedObject_FieldIndex.ContainedSoul:
                    obj.ContainedSoul = default(FormIDLink<SoulGem>);
                    break;
                case PlacedObject_FieldIndex.Position:
            ...
            NotifyingUnsetParameters cmds = null)
        {
            ...
            item.ContainedSoul = default(FormIDLink<SoulGem>);
            ...
            PlacedObject_Mask<bool> ret)
        {
            ...
            ret.TeleportDestination = item.TeleportDestination_Property.LoquiEqualsHelper(rhs.TeleportDestination_Property, (loqLhs, loqRhs) => TeleportDestinationCommon.GetEqualsMask(loqLhs, loqRhs));
            ret.Lock = item.Lock_Property.LoquiEqualsHelper(rhs.Lock_Property, (loqLhs, loqRhs) => LockInformationCommon.GetEqualsMask(loqLhs, loqRhs));
            ...
            ret.DistantLODData = item.DistantLODData_Property.LoquiEqualsHelper(rhs.DistantLODData_Property, (loqLhs, loqRhs) => DistantLODDataCommon.GetEqualsMask(loqLhs, loqRhs));
            ...
            ret.MapMarker = item.MapMarker_Property.LoquiEqualsHelper(rhs.MapMarker_Property, (loqLhs, loqRhs) => MapMarkerCommon.GetEqualsMask(loqLhs, loqRhs));
    ...
    #region Mask
    public class PlacedObject_Mask<T> : MajorRecord_Mask<T>, IMask<T>, IEquatable<PlacedObject_Mask<T>>
    {
        #region Ctors
    ...
    public class PlacedObject_ErrorMask : MajorRecord_ErrorMask, IErrorMask<PlacedObject_ErrorMask>
    {
        #region Members
