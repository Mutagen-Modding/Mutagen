            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                ...
                foreach (var elem in node.Elements())
                {
                    ...
                    WaterXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case 0x41544144: // DATA
                {
                    ...
                    WaterBinaryTranslation.FillBinaryNothingCustomLogicCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                    ...
                    WaterBinaryTranslation.FillBinaryBloodCustomLogicCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                    ...
                    WaterBinaryTranslation.FillBinaryOilCustomLogicCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                    ...
                    WaterBinaryTranslation.FillBinaryOddExtraBytesCustomPublic(
                        frame: dataFrame,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
        ...
        IBinaryTranslator
    {
            ...
            MasterReferences masterReferences)
        {
            ...
            if (item.DATADataTypeState.HasFlag(Water.DATADataType.Has))
            {
                ...
                {
                    WaterBinaryTranslation.WriteBinaryNothingCustomLogic(
                        writer: writer,
                        item: item,
                        masterReferences: masterReferences,
                        errorMask: errorMask);
                    if (!item.DATADataTypeState.HasFlag(Water.DATADataType.Break0))
                    {
                        ...
                        Mutagen.Bethesda.Binary.FloatBinaryTranslation.Instance.Write(
                            writer: writer,
                            item: item.FogDistanceNearPlane);
                        WaterBinaryTranslation.WriteBinaryBloodCustomLogic(
                            writer: writer,
                            item: item,
                            masterReferences: masterReferences,
                            errorMask: errorMask);
                        if (!item.DATADataTypeState.HasFlag(Water.DATADataType.Break1))
                        {
                            ...
                            writer.WriteZeros(3);
                            WaterBinaryTranslation.WriteBinaryOilCustomLogic(
                                writer: writer,
                                item: item,
                                masterReferences: masterReferences,
                                errorMask: errorMask);
                            if (!item.DATADataTypeState.HasFlag(Water.DATADataType.Break2))
                            {
                                ...
                                Mutagen.Bethesda.Binary.FloatBinaryTranslation.Instance.Write(
                                    writer: writer,
                                    item: item.DisplacementSimulatorForce);
                                WaterBinaryTranslation.WriteBinaryOddExtraBytes(
                                    writer: writer,
                                    item: item,
                                    masterReferences: masterReferences,
                                    errorMask: errorMask);
