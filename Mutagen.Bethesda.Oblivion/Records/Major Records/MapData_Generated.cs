...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IMapData
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((MapDataCommon)((IMapDataGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IMapDataGetter? obj)
        {
            return ((MapDataCommon)((IMapDataGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class MapDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MapData_FieldIndex.UsableDimensions) ?? true))
            {
                if (!lhs.UsableDimensions.Equals(rhs.UsableDimensions)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MapData_FieldIndex.CellCoordinatesNWCell) ?? true))
            {
                if (!lhs.CellCoordinatesNWCell.Equals(rhs.CellCoordinatesNWCell)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)MapData_FieldIndex.CellCoordinatesSECell) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMapDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IMapDataGetter
    {
        ...
        public P2Int16 CellCoordinatesNWCell => P2Int16BinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0x8, 0x4));
        public P2Int16 CellCoordinatesSECell => P2Int16BinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0xC, 0x4));
