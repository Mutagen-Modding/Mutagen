...
{
    #region Class
    public partial class ContainerItem : IContainerItem, ILoquiObject<ContainerItem>, ILoquiObjectSetter, IEquatable<ContainerItem>
    {
            ...
            string name = null)
        {
            errorMask = this.Write_XML_Internal(
                node: node,
                name: name,
                doMasks: doMasks) as ContainerItem_ErrorMask;
        }
