...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class LeveledCreatureCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(ILeveledCreatureGetter obj)
        {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<ILeveledCreatureEntryGetter>.Instance.Write(
                writer: writer,
                items: item.Entries,
                transl: (MutagenWriter subWriter, ILeveledCreatureEntryGetter subItem, RecordTypeConverter? conv) =>
                {
                    var Item = subItem;
    ...
    public partial class LeveledCreatureBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Entries.SetTo(
                        Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<LeveledCreatureEntry>.Instance.Parse(
                            reader: frame,
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Template.SetTo(Mutagen.Bethesda.Records.Binary.Translations.FormLinkBinaryTranslation.Instance.Parse(reader: frame));
