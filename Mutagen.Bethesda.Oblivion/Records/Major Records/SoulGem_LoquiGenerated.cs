...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class SoulGem : NamedMajorRecord, ISoulGem, ILoquiObjectSetter, IEquatable<SoulGem>
    {
        ...
        public bool Equals(SoulGem rhs)
        {
            ...
            {
                if (MaximumCapacity != rhs.MaximumCapacity) return false;
            }
            return true;
        }
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (SoulGem_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<SoulGem, SoulGem_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out SoulGem_ErrorMask errorMask)
        {
            errorMask = (SoulGem_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            SoulGem_CopyMask copyMask = null,
            ISoulGemGetter def = null)
            where CopyType : class, ISoulGem
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(SoulGem)))
            {
                ret = new SoulGem() as CopyType;
            }
            else
            {
    ...
    #region Interface
    public interface ISoulGem : ISoulGemGetter, INamedMajorRecord, ILoquiClass<ISoulGem, ISoulGemGetter>, ILoquiClass<SoulGem, ISoulGemGetter>
    {
    ...
    public interface ISoulGemGetter : INamedMajorRecordGetter
    {
        #region Model
        Model Model { get; }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class SoulGemCommon
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            Func<SoulGem_ErrorMask> maskGetter = () =>
            {
