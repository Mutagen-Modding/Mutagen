...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => LogEntryCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class LogEntryCommon
    {
        ...
        {
            if (obj.ResultScript is ILinkedFormKeyContainer ResultScriptlinkCont)
            {
                foreach (var item in ResultScriptlinkCont.LinkFormKeys)
                {
                    yield return item;
                }
            }
        ...
        public void RemapLinks(ILogEntryGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    public partial class LogEntryXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)LogEntry_FieldIndex.Conditions) ?? true))
            {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        ILogEntryGetter
    {
        ...
        public LogEntry.Flag? Flags => _FlagsLocation.HasValue ? (LogEntry.Flag)HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)[0] : default(LogEntry.Flag?);
        #endregion
