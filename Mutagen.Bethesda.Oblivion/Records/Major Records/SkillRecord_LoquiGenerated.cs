...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class SkillRecord : MajorRecord, ISkillRecord, ILoquiObject<SkillRecord>, ILoquiObjectSetter, IEquatable<SkillRecord>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "Attribute":
                    ...
                    break;
                case "Specialization":
                    EnumXmlTranslation<Specialization>.Instance.ParseInto(
                        root,
                        fieldIndex: (int)SkillRecord_FieldIndex.Specialization,
                        item: item._Specialization,
                        errorMask: errorMask);
                    break;
                case "UseValueFirst":
        ...
        public static SkillRecord Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<SkillRecord, SkillRecord_FieldIndex>(
                ...
                case "DATA":
                    ...
                    using (var dataFrame = frame.SpawnWithLength(contentLength))
                    {
                        ...
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<ActorValue>.Instance.ParseInto(
                            ...
                            fieldIndex: (int)SkillRecord_FieldIndex.Attribute,
                            errorMask: errorMask);
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Specialization>.Instance.ParseInto(
                            frame: dataFrame.SpawnWithLength(4),
                            item: item._Specialization,
                            fieldIndex: (int)SkillRecord_FieldIndex.Specialization,
                            errorMask: errorMask);
