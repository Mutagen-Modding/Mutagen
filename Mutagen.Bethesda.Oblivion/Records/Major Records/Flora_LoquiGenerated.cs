...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Flora : NamedMajorRecord, IFlora, ILoquiObjectSetter, IEquatable<Flora>
    {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (Flora_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<Flora, Flora_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out Flora_ErrorMask errorMask)
        {
            errorMask = (Flora_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
            ...
            RecordTypeConverter recordTypeConverter)
        {
            ...
            try
            {
                frame = frame.Spawn(HeaderTranslation.ParseRecord(
                    frame,
                    Flora_Registration.FLOR_HEADER));
                using (frame)
                {
                    Fill_Binary_Structs(
                        item: ret,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class FloraCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.Flora"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.Flora");
                    }
