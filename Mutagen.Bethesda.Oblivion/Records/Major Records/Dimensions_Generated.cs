...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class DimensionsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IDimensionsGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class DimensionsBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.Width = Mutagen.Bethesda.Records.Binary.Translations.FloatBinaryTranslation.Instance.Parse(frame: frame);
            item.Height = Mutagen.Bethesda.Records.Binary.Translations.FloatBinaryTranslation.Instance.Parse(frame: frame);
        }
