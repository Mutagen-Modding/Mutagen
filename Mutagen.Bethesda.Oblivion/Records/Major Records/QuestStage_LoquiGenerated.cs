...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<QuestStage>
    {
        ...
        #region XML Create
        [DebuggerStepThrough]
        public static QuestStage Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                errorMask: null);
        ...
        public static QuestStage Create_XML(string path)
        {
        ...
        public static QuestStage Create_XML(Stream stream)
        {
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                case "Stage":
                    ...
                    break;
                case "LogEntries":
                    ListXmlTranslation<LogEntry>.Instance.ParseInto(
                        root: root,
            ...
            string name = null)
        {
            ...
            if (item.LogEntries.HasBeenSet)
            {
                ListXmlTranslation<LogEntry>.Instance.Write(
                    ...
                    fieldIndex: (int)QuestStage_FieldIndex.LogEntries,
                    errorMask: errorMask,
                    transl: (XElement subNode, LogEntry subItem, ErrorMaskBuilder listSubMask) =>
                    {
