...
{
    #region Class
    public partial class Sound : MajorRecord, ISound, ILoquiObject<Sound>, ILoquiObjectSetter, IEquatable<Sound>
    {
            ...
            string name = null)
        {
            errorMask = this.Write_XML_Internal(
                node: node,
                name: name,
                doMasks: doMasks) as Sound_ErrorMask;
        }
        ...
        public static Sound Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Sound, Sound_FieldIndex>(
                record: new Sound(),
                frame: frame,
                errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                ...
                case "SNDD":
                    LoquiBinaryTranslation<SoundData>.Instance.ParseInto(
                        frame: frame,
                ...
                case "SNDX":
                    LoquiBinaryTranslation<SoundDataExtended>.Instance.ParseInto(
                        frame: frame,
                        fieldIndex: (int)Sound_FieldIndex.Data,
                        errorMask: errorMask,
                        item: item._Data);
