...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ISoundItem
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((SoundItemCommon)((ISoundItemGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ISoundItemGetter? obj)
        {
            return ((SoundItemCommon)((ISoundItemGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => SoundItemCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class SoundItemCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)SoundItem_FieldIndex.Sound) ?? true))
            {
                if (!lhs.Sound.Equals(rhs.Sound)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)SoundItem_FieldIndex.Chance) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISoundItemGetter obj, bool iterateNestedRecords = true)
        {
