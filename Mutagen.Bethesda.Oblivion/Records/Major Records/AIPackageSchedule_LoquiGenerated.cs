...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerStepThrough]
        public static AIPackageSchedule CreateFromBinary(MutagenFrame frame)
        {
    ...
    public partial class AIPackageScheduleSetterCommon
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(RecordTypes.PSDT)));
    ...
    public partial class AIPackageScheduleBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(RecordTypes.PSDT),
