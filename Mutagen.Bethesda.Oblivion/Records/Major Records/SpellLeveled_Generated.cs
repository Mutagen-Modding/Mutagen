...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class SpellLeveledCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISpellLeveledGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public SpellLeveled Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new SpellLeveled(formKey, default(OblivionRelease));
