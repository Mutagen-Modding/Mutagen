        ...
        IEquatable<Region>
    {
            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    RegionXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    RegionBinaryTranslation.FillBinaryRegionAreaLogicCustomPublic(
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IBinaryTranslator
    {
            ...
            MasterReferences masterReferences)
        {
            ...
            RegionBinaryTranslation.WriteBinaryRegionAreaLogic(
                writer: writer,
                item: item,
                masterReferences: masterReferences,
                errorMask: errorMask);
