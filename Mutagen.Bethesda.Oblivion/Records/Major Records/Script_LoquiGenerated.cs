    ...
    public static partial class ScriptCommon
    {
            ...
            string name = null)
        {
            ...
            if (item.MetadataSummary_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)Script_FieldIndex.MetadataSummary) ?? true))
            {
            ...
            if (item.CompiledScript_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)Script_FieldIndex.CompiledScript) ?? true))
            {
            ...
            if (item.SourceCode_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)Script_FieldIndex.SourceCode) ?? true))
            {
            ...
            if (item.LocalVariables.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)Script_FieldIndex.LocalVariables) ?? true))
            {
                ListXmlTranslation<LocalVariable>.Instance.Write(
                    ...
                    fieldIndex: (int)Script_FieldIndex.LocalVariables,
                    errorMask: errorMask,
                    translationMask: translationMask.GetSubCrystal((int)Script_FieldIndex.LocalVariables),
            ...
            if (item.References.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)Script_FieldIndex.References) ?? true))
            {
                ListXmlTranslation<ScriptReference>.Instance.Write(
                    ...
                    fieldIndex: (int)Script_FieldIndex.References,
                    errorMask: errorMask,
                    translationMask: translationMask.GetSubCrystal((int)Script_FieldIndex.References),
