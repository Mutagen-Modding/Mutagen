...
{
    #region Class
    public partial class RegionArea : IRegionArea, ILoquiObjectSetter, IEquatable<RegionArea>
    {
        ...
        #region EdgeFallOff
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected INotifyingSetItem<UInt32> _EdgeFallOff = NotifyingSetItem.Factory<UInt32>(markAsSet: false);
        public INotifyingSetItem<UInt32> EdgeFallOff_Property => _EdgeFallOff;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public UInt32 EdgeFallOff
        {
            get => this._EdgeFallOff.Item;
            set => this._EdgeFallOff.Set(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerStepThrough]
        public static (RegionArea Object, RegionArea_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
        ...
        private static RegionArea Create_XML_Internal(
            XElement root,
            ...
            switch (name)
            {
                ...
                case "RegionPoints":
                    item._RegionPoints.SetIfSucceeded(ListXmlTranslation<P2Float, Exception>.Instance.Parse(
                        ...
                        {
                            return P2FloatXmlTranslation.Instance.Parse(
                                r,
                                nullable: false,
                                doMasks: listDoMasks,
        ...
        [DebuggerStepThrough]
        public static (RegionArea Object, RegionArea_ErrorMask ErrorMask) Create_Binary(
            MutagenFrame frame,
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<RegionArea, RegionArea_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        private static RegionArea Create_Binary_Internal(
            MutagenFrame frame,
            Func<RegionArea_ErrorMask> errorMask,
            RecordTypeConverter recordTypeConverter)
        {
            ...
            try
            {
                using (frame)
                {
                    Fill_Binary_Structs(
                        ...
                        frame: frame,
                        errorMask: errorMask);
                    RegionArea_FieldIndex? lastParsed = null;
        ...
        protected static TryGet<RegionArea_FieldIndex?> Fill_Binary_RecordTypes(
            RegionArea item,
            MutagenFrame frame,
            RegionArea_FieldIndex? lastParsed,
            Func<RegionArea_ErrorMask> errorMask,
            ...
            switch (nextRecordType.Type)
            {
                case "RPLI":
                    ...
                    item._EdgeFallOff.SetIfSucceeded(Mutagen.Bethesda.Binary.UInt32BinaryTranslation.Instance.Parse(
                        ...
                        fieldIndex: (int)RegionArea_FieldIndex.EdgeFallOff,
                        errorMask: errorMask));
                    return TryGet<RegionArea_FieldIndex?>.Succeed(RegionArea_FieldIndex.EdgeFallOff);
                case "RPLD":
                    ...
                    var RegionPointstryGet = Mutagen.Bethesda.Binary.ListBinaryTranslation<P2Float, Exception>.Instance.ParseRepeatedItem(
                        ...
                        {
                            return Mutagen.Bethesda.Binary.P2FloatBinaryTranslation.Instance.Parse(
                                r,
                                doMasks: listDoMasks,
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            RegionArea_CopyMask copyMask = null,
            IRegionAreaGetter def = null)
            where CopyType : class, IRegionArea
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(RegionArea)))
            {
                ret = new RegionArea() as CopyType;
            }
            else
            {
    ...
    #region Interface
    public interface IRegionArea : IRegionAreaGetter, ILoquiClass<IRegionArea, IRegionAreaGetter>, ILoquiClass<RegionArea, IRegionAreaGetter>
    {
    ...
    public interface IRegionAreaGetter : ILoquiObject
    {
        #region EdgeFallOff
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class RegionAreaCommon
    {
        ...
        public static void CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            RegionArea_ErrorMask retErrorMask = null;
            Func<RegionArea_ErrorMask> maskGetter = () =>
            {
                if (retErrorMask == null)
                {
                    retErrorMask = new RegionArea_ErrorMask();
                }
                return retErrorMask;
            };
            CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            if (copyMask?.EdgeFallOff ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionArea_FieldIndex.EdgeFallOff, ex);
                }
            }
            if (copyMask?.RegionPoints != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionArea_FieldIndex.RegionPoints, ex);
                }
            }
        }
            ...
            Func<RegionArea_ErrorMask> errorMask)
        {
            Mutagen.Bethesda.Binary.UInt32BinaryTranslation.Instance.Write(
                ...
                nullable: false);
            Mutagen.Bethesda.Binary.ListBinaryTranslation<P2Float, Exception>.Instance.Write(
                writer: writer,
                item: item.RegionPoints,
                fieldIndex: (int)RegionArea_FieldIndex.RegionPoints,
