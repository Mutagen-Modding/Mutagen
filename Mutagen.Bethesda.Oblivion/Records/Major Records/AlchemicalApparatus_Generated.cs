...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<AlchemicalApparatus>
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => AlchemicalApparatusCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.APPA)]
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    #region Common
    internal partial class AlchemicalApparatusSetterCommon : OblivionMajorRecordSetterCommon
    {
    ...
    internal partial class AlchemicalApparatusCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Icon) ?? true))
            {
                if (!string.Equals(lhs.Icon, rhs.Icon)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Script) ?? true))
            {
                if (!lhs.Script.Equals(rhs.Script)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Data) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Data, rhs.Data, out var lhsData, out var rhsData, out var isDataEqual))
                {
                    if (!((AlchemicalApparatusDataCommon)((IAlchemicalApparatusDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, equalsMask?.GetSubCrystal((int)AlchemicalApparatus_FieldIndex.Data))) return false;
                }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAlchemicalApparatusGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public AlchemicalApparatus Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new AlchemicalApparatus(formKey, default(OblivionRelease));
    ...
    internal partial class AlchemicalApparatusSetterTranslationCommon : OblivionMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class AlchemicalApparatusBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IAlchemicalApparatusGetter
    {
        ...
        public IAlchemicalApparatusDataGetter? Data => _DataLocation.HasValue ? AlchemicalApparatusDataBinaryOverlay.AlchemicalApparatusDataFactory(_recordData.Slice(_DataLocation!.Value.Min), _package) : default;
        #endregion
