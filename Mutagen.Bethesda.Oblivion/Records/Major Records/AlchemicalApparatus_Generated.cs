...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<AlchemicalApparatus>
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(StructuredStringBuilder sb, AlchemicalApparatus.Mask<bool>? printMask = null)
            {
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class AlchemicalApparatusCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Icon) ?? true))
            {
                if (!string.Equals(lhs.Icon, rhs.Icon)) return false;
            }
            if ((crystal?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Script) ?? true))
            {
                if (!lhs.Script.Equals(rhs.Script)) return false;
            }
            if ((crystal?.GetShouldTranslate((int)AlchemicalApparatus_FieldIndex.Data) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.Data, rhs.Data, out var lhsData, out var rhsData, out var isDataEqual))
                {
                    if (!((AlchemicalApparatusDataCommon)((IAlchemicalApparatusDataGetter)lhsData).CommonInstance()!).Equals(lhsData, rhsData, crystal?.GetSubCrystal((int)AlchemicalApparatus_FieldIndex.Data))) return false;
                }
        ...
        public AlchemicalApparatus Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new AlchemicalApparatus(formKey);
