...
{
    #region Class
    public partial class RegionSound : IRegionSound, ILoquiObjectSetter, IEquatable<RegionSound>
    {
        ...
        [DebuggerStepThrough]
        public static (RegionSound Object, RegionSound_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
            RegionSound_ErrorMask errMaskRet = null;
            var ret = Create_XML_Internal(
                root: root,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new RegionSound_ErrorMask()) : default(Func<RegionSound_ErrorMask>));
        ...
        {
            LoquiXmlTranslation<RegionSound, RegionSound_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (RegionSound_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        private static RegionSound Create_XML_Internal(
            XElement root,
            ...
            Func<RegionSound_ErrorMask> errorMask)
        {
            switch (name)
            {
                case "Sound":
                    ...
                    break;
                case "Flags":
                    item._Flags.SetIfSucceeded(EnumXmlTranslation<RegionSound.Flag>.Instance.Parse(
                        root,
                        nullable: false,
                    ...
                    break;
                case "Chance":
                    item._Chance.SetIfSucceeded(FloatXmlTranslation.Instance.ParseNonNull(
                        root,
        ...
        [DebuggerStepThrough]
        public static (RegionSound Object, RegionSound_ErrorMask ErrorMask) Create_Binary(
            MutagenFrame frame,
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<RegionSound, RegionSound_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out RegionSound_ErrorMask errorMask)
        {
            errorMask = (RegionSound_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
        ...
        private static RegionSound Create_Binary_Internal(
            MutagenFrame frame,
            Func<RegionSound_ErrorMask> errorMask,
            RecordTypeConverter recordTypeConverter)
        {
        ...
        public static CopyType CopyGeneric<CopyType>(
            ...
            RegionSound_CopyMask copyMask = null,
            IRegionSoundGetter def = null)
            where CopyType : class, IRegionSound
        {
            CopyType ret;
            if (item.GetType().Equals(typeof(RegionSound)))
            {
                ret = new RegionSound() as CopyType;
            }
            else
            {
    ...
    #region Interface
    public interface IRegionSound : IRegionSoundGetter, ILoquiClass<IRegionSound, IRegionSoundGetter>, ILoquiClass<RegionSound, IRegionSoundGetter>
    {
    ...
    public interface IRegionSoundGetter : ILoquiObject
    {
        #region Sound
        Sound Sound { get; }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class RegionSoundCommon
    {
        ...
        public static void CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            RegionSound_ErrorMask retErrorMask = null;
            Func<RegionSound_ErrorMask> maskGetter = () =>
            {
                if (retErrorMask == null)
                {
                    retErrorMask = new RegionSound_ErrorMask();
                }
                return retErrorMask;
            };
            CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            if (copyMask?.Sound ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionSound_FieldIndex.Sound, ex);
                }
            }
            if (copyMask?.Flags ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionSound_FieldIndex.Flags, ex);
                }
            }
            if (copyMask?.Chance ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)RegionSound_FieldIndex.Chance, ex);
                }
            }
        }
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.RegionSound"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.RegionSound");
                    }
