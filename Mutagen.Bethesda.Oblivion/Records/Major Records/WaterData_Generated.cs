...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class WaterDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.WindVelocity) ?? true))
            {
                if (!lhs.WindVelocity.EqualsWithin(rhs.WindVelocity)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.WindDirection) ?? true))
            {
                if (!lhs.WindDirection.EqualsWithin(rhs.WindDirection)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.WaveAmplitude) ?? true))
            {
                if (!lhs.WaveAmplitude.EqualsWithin(rhs.WaveAmplitude)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.WaveFrequency) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.ScrollXSpeed) ?? true))
            {
                if (!lhs.ScrollXSpeed.EqualsWithin(rhs.ScrollXSpeed)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.ScrollYSpeed) ?? true))
            {
                if (!lhs.ScrollYSpeed.EqualsWithin(rhs.ScrollYSpeed)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.FogDistanceNearPlane) ?? true))
            {
                if (!lhs.FogDistanceNearPlane.EqualsWithin(rhs.FogDistanceNearPlane)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.FogDistanceFarPlane) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)WaterData_FieldIndex.TextureBlend) ?? true))
            {
