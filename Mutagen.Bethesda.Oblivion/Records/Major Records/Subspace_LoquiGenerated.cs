...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Subspace : MajorRecord, ISubspace, ILoquiObjectSetter, IEquatable<Subspace>
    {
            ...
            NotifyingFireParameters cmds = null)
        {
            this.CopyIn_XML(
                root: root,
                errorMask: out Subspace_ErrorMask errMask,
                cmds: cmds);
            errorMask = errMask;
        }
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<Subspace, Subspace_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        private static Subspace Create_Binary_Internal(
            ...
            RecordTypeConverter recordTypeConverter)
        {
            return MajorRecord.TypicalParsing<Subspace, Subspace_ErrorMask, Subspace_FieldIndex>(
                record: new Subspace(),
                frame: frame,
                errorMask: errorMask,
