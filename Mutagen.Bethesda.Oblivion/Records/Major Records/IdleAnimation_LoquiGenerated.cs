...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<IdleAnimation>
    {
        ...
        #region XML Create
        [DebuggerStepThrough]
        public new static IdleAnimation Create_XML(XElement root)
        {
            return Create_XML(
                root: root,
                errorMask: null);
        ...
        public static IdleAnimation Create_XML(string path)
        {
        ...
        public static IdleAnimation Create_XML(Stream stream)
        {
            ...
            NotifyingFireParameters cmds = null)
        {
            this.CopyIn_XML(
                root: root,
                errorMask: out IdleAnimation_ErrorMask errMask,
                cmds: cmds);
            errorMask = errMask;
        }
            ...
            ErrorMaskBuilder errorMask)
        {
            switch (name)
            {
                ...
                case "RelatedIdleAnimations":
                    ListXmlTranslation<FormIDLink<IdleAnimation>>.Instance.ParseInto(
                        root: root,
            ...
            string name = null)
        {
            ...
            if (item.RelatedIdleAnimations.HasBeenSet)
            {
                ListXmlTranslation<FormIDLink<IdleAnimation>>.Instance.Write(
                    ...
                    fieldIndex: (int)IdleAnimation_FieldIndex.RelatedIdleAnimations,
                    errorMask: errorMask,
                    transl: (XElement subNode, FormIDLink<IdleAnimation> subItem, ErrorMaskBuilder listSubMask) =>
                    {
