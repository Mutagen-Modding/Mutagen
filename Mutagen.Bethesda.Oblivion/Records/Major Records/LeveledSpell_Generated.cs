...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class LeveledSpellCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!lhs.Entries.SequenceEqual(rhs.Entries, (l, r) => ((LeveledSpellEntryCommon)((ILeveledSpellEntryGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)LeveledSpell_FieldIndex.Entries)))) return false;
            }
            return true;
        }
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILeveledSpellGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.Entries.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
        ...
        public LeveledSpell Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new LeveledSpell(formKey, default(OblivionRelease));
