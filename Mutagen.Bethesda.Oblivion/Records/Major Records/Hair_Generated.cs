...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class HairCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IHairGetter obj)
        {
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.StringBinaryTranslation.Instance.WriteNullable(
                ...
                binaryType: StringBinaryType.NullTerminate);
            Mutagen.Bethesda.Records.Binary.Translations.EnumBinaryTranslation<Hair.HairFlag>.Instance.WriteNullable(
                writer,
                item.Flags,
                length: 1,
    ...
    public partial class HairBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<Hair.HairFlag>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
