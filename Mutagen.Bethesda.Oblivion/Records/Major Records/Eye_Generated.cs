...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<Eye>
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(Eye.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, Eye.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(Eye.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.EYES)]
    ...
    public static partial class EyeMixIn
    {
        ...
        {
            return ((EyeCommon)((IEyeGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            Eye.Mask<bool>? printMask = null)
        {
            ((EyeCommon)((IEyeGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class EyeCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IEyeGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public Eye Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Eye(formKey, default(OblivionRelease));
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public new static readonly EyeBinaryWriteTranslation Instance = new();
            ...
            TypedWriteParams translationParams)
        {
            ...
            StringBinaryTranslation.Instance.WriteNullable(
                ...
                binaryType: StringBinaryType.NullTerminate);
            EnumBinaryTranslation<Eye.Flag, MutagenFrame, MutagenWriter>.Instance.WriteNullable(
                writer,
                item.Flags,
                length: 1,
    ...
    internal partial class EyeBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<Eye.Flag, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
