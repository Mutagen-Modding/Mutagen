...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class LoadScreenLocationBinaryWrapper : ILoadScreenLocationGetter
    {
        ...
        public IPlaceInternalGetter Direct => default;
        #endregion
        #region Indirect
        public IFormIDLinkGetter<IWorldspaceInternalGetter> Indirect_Property => new FormIDLink<IWorldspaceInternalGetter>(FormKey.Factory(_package.MasterReferences, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(4, 4))));
        public IWorldspaceInternalGetter Indirect => default;
        #endregion
