...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class Enchantment : NamedMajorRecord, IEnchantment, ILoquiObject<Enchantment>, ILoquiObjectSetter, IEquatable<Enchantment>
    {
            ...
            ErrorMaskBuilder errorMask)
        {
            ...
            {
                case "Type":
                    EnumXmlTranslation<Enchantment.EnchantmentType>.Instance.ParseInto(
                        root,
                ...
                case "EnchantCost":
                    UInt32XmlTranslation.Instance.ParseInto(
                        ...
                        item: item._EnchantCost,
                        errorMask: errorMask);
                    break;
                case "Flags":
                    EnumXmlTranslation<Enchantment.Flag>.Instance.ParseInto(
                        root,
        ...
        public static Enchantment Create_Binary(
            ...
            ErrorMaskBuilder errorMask)
        {
            return UtilityTranslation.MajorRecordParse<Enchantment, Enchantment_FieldIndex>(
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.Type)
            {
                case "ENIT":
                    ...
                    {
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Enchantment.EnchantmentType>.Instance.ParseInto(
                        ...
                        Mutagen.Bethesda.Binary.UInt32BinaryTranslation.Instance.ParseInto(
                            ...
                            fieldIndex: (int)Enchantment_FieldIndex.EnchantCost,
                            errorMask: errorMask);
                        Mutagen.Bethesda.Binary.EnumBinaryTranslation<Enchantment.Flag>.Instance.ParseInto(
                            frame: dataFrame.SpawnWithLength(4),
                            item: item._Flags,
                            fieldIndex: (int)Enchantment_FieldIndex.Flags,
                            errorMask: errorMask);
