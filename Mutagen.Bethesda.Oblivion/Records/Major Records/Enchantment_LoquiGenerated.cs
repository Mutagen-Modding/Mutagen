...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override IEnumerable<FormKey> LinkFormKeys => EnchantmentCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => EnchantmentCommon.Instance.GetLinkFormKeys(this);
        ...
        void ILinkedFormKeyContainer.RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => EnchantmentCommon.Instance.RemapLinks(this, mapping);
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class EnchantmentCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IEnchantmentGetter obj)
        {
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IEnchantmentGetter
    {
        ...
        public IEnchantmentDataGetter? Data => _DataLocation.HasValue ? EnchantmentDataBinaryOverlay.EnchantmentDataFactory(new BinaryMemoryReadStream(_data.Slice(_DataLocation!.Value.Min)), _package) : default;
