...
namespace Mutagen.Bethesda.Oblivion.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<ILeveledItemEntryGetter>.Instance.Write(
                writer: writer,
                items: item.Entries,
    ...
    public partial class LeveledItemBinaryCreateTranslation : OblivionMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Entries.SetTo(
                        Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<LeveledItemEntry>.Instance.Parse(
                            reader: frame,
