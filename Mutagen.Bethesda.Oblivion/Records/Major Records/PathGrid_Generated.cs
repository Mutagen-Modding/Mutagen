...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IPathGridInternal
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => PathGridCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class PathGridCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPathGridGetter obj, bool iterateNestedRecords = true)
        {
            foreach (var item in base.EnumerateFormLinks(obj, iterateNestedRecords))
            {
                yield return item;
            }
            foreach (var item in obj.PointToReferenceMappings.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
        ...
        public PathGrid Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new PathGrid(formKey, default(OblivionRelease));
