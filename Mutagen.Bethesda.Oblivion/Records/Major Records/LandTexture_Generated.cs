...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<LandTexture>
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => LandTextureCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class LandTextureCommon : OblivionMajorRecordCommon
    {
            ...
            LandTexture.Mask<bool>? printMask = null)
        {
            ...
            {
                sb.AppendItem(TextureSpecularExponentItem, "TextureSpecularExponent");
            }
            if (printMask?.PotentialGrass?.Overall ?? true)
            {
                sb.AppendLine("PotentialGrass =>");
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILandTextureGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public LandTexture Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new LandTexture(formKey, default(OblivionRelease));
