...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class GlobalInt : Global, IGlobalInt, ILoquiObjectSetter, IEquatable<GlobalInt>
    {
        ...
        public INotifyingSetItemGetter<Int32> Data_Property => _Data;
        public Int32 Data
        {
            get => this._Data.Item;
            protected set => this._Data.Set(value);
        }
        INotifyingSetItemGetter<Int32> IGlobalIntGetter.Data_Property => this.Data_Property;
        #endregion
        ...
        private static GlobalInt Create_Binary_Internal(
            ...
            RecordTypeConverter recordTypeConverter)
        {
            return MajorRecord.TypicalParsing<GlobalInt, GlobalInt_ErrorMask, GlobalInt_FieldIndex>(
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class GlobalIntCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.GlobalInt"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.GlobalInt");
                    }
                }
            }
            catch (Exception ex)
