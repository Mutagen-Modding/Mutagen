...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        IEquatable<WorldspaceBlock>
    {
        ...
        {
            _hasBeenSetTracker[(int)WorldspaceBlock_FieldIndex.BlockNumber] = false;
        ...
        {
            _hasBeenSetTracker[(int)WorldspaceBlock_FieldIndex.LastModified] = false;
        ...
        public void CopyIn_XML(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiXmlTranslation<WorldspaceBlock, WorldspaceBlock_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
            ...
            string name = null)
        {
            errorMask = this.Write_XML_Internal(
                node: node,
                name: name,
                doMasks: doMasks) as WorldspaceBlock_ErrorMask;
        }
            ...
            Func<WorldspaceBlock_ErrorMask> errorMask)
        {
            switch (name)
            {
                ...
                case "LastModified":
                    ...
                    break;
                case "Items":
                    item._Items.SetIfSucceededOrDefault(ListXmlTranslation<WorldspaceSubBlock, MaskItem<Exception, WorldspaceSubBlock_ErrorMask>>.Instance.Parse(
                        root: root,
            ...
            RecordTypeConverter recordTypeConverter = null)
        {
            ...
            {
                case "GRUP":
                    item.Items.SetIfSucceededOrDefault(Mutagen.Bethesda.Binary.ListBinaryTranslation<WorldspaceSubBlock, MaskItem<Exception, WorldspaceSubBlock_ErrorMask>>.Instance.ParseRepeatedItem(
                        frame: frame,
    ...
    public static partial class WorldspaceBlockCommon
    {
            ...
            try
            {
                ...
                if (item.Items.HasBeenSet)
                {
                    ListXmlTranslation<WorldspaceSubBlock, MaskItem<Exception, WorldspaceSubBlock_ErrorMask>>.Instance.Write(
                        ...
                        fieldIndex: (int)WorldspaceBlock_FieldIndex.Items,
                        errorMask: errorMask,
                        transl: (XElement subNode, WorldspaceSubBlock subItem, bool listDoMasks, out MaskItem<Exception, WorldspaceSubBlock_ErrorMask> listSubMask) =>
                        {
            ...
            Func<WorldspaceBlock_ErrorMask> errorMask)
        {
            Mutagen.Bethesda.Binary.ListBinaryTranslation<WorldspaceSubBlock, MaskItem<Exception, WorldspaceSubBlock_ErrorMask>>.Instance.Write(
                ...
                fieldIndex: (int)WorldspaceBlock_FieldIndex.Items,
                errorMask: errorMask,
                transl: (MutagenWriter subWriter, WorldspaceSubBlock subItem, bool listDoMasks, out MaskItem<Exception, WorldspaceSubBlock_ErrorMask> listSubMask) =>
                {
