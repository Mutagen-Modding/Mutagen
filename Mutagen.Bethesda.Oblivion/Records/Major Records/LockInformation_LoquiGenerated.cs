...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    public partial class LockInformation : ILockInformation, ILoquiObject<LockInformation>, ILoquiObjectSetter, IEquatable<LockInformation>
    {
        ...
        public bool Equals(LockInformation rhs)
        {
            ...
            if (LockLevel != rhs.LockLevel) return false;
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (LockInformation_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiBinaryTranslation<LockInformation, LockInformation_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out LockInformation_ErrorMask errorMask)
        {
            errorMask = (LockInformation_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                recordTypeConverter: null,
                doMasks: true);
        }
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class LockInformationCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.Bethesda.Oblivion.LockInformation"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.Bethesda.Oblivion.LockInformation");
                    }
