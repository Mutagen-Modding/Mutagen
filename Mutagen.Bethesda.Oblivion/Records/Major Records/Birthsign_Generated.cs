...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<Birthsign>
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => BirthsignCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class BirthsignCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IBirthsignGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public Birthsign Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Birthsign(formKey, default(OblivionRelease));
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    {
        public new static readonly BirthsignBinaryWriteTranslation Instance = new();
