            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    NPCXmlTranslation.FillPublicElementXml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public static partial class NPCCommon
    {
        ...
        public static void Clear(INPC item)
        {
            item.Name_Unset();
            item.Model_Unset();
            item.Flags = default(NPC.NPCFlag);
        ...
        public static NPC_Mask<bool> GetHasBeenSetMask(INPCGetter item)
        {
            ...
            ret.ACBSDataTypeState = true;
            ret.AIDTDataTypeState = true;
        ...
        IXmlTranslator
    {
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal translationMask)
        {
            NPCAbstractXmlTranslation.WriteToNodeXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
            ...
            TranslationCrystal translationMask)
        {
            switch (name)
            {
                ...
                case "DATADataTypeState":
                    ...
                    break;
                default:
                    NPCAbstractXmlTranslation.FillPublicElementXml(
                        item: item,
                        node: node,
                        name: name,
                        errorMask: errorMask,
