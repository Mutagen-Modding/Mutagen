...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class RoadCommon : OblivionMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IRoadGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public Road Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Road(formKey, default(OblivionRelease));
