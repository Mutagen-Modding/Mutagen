...
namespace Mutagen.Bethesda.Oblivion
{
        ...
        ILoquiObjectSetter<AIPackage>
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(AIPackage.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, AIPackage.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(AIPackage.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => AIPackageCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class AIPackageMixIn
    {
        ...
        {
            return ((AIPackageCommon)((IAIPackageGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            AIPackage.Mask<bool>? printMask = null)
        {
            ((AIPackageCommon)((IAIPackageGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    internal partial class AIPackageCommon : OblivionMajorRecordCommon
    {
            ...
            AIPackage.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"AIPackage =>");
            }
            else
            {
                sb.AppendLine($"{name} (AIPackage) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            AIPackage.Mask<bool>? printMask = null)
        {
            ...
            {
                ScheduleItem?.Print(sb, "Schedule");
            }
            if ((printMask?.Target?.Overall ?? true)
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAIPackageGetter obj, bool iterateNestedRecords = true)
        {
        ...
        public AIPackage Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new AIPackage(formKey, default(OblivionRelease));
