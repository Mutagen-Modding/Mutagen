...
namespace Mutagen.Bethesda.Skyrim.Pex
{
        ...
        ILoquiObjectSetter<DebugInfo>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object PexWriteTranslator => DebugInfoPexWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        object IPexItem.PexWriteTranslator => this.PexWriteTranslator;
        void IPexItem.WriteToBinary(PexWriter writer)
        {
            ((DebugInfoPexWriteTranslation)this.PexWriteTranslator).Write(
                item: this,
                writer: writer);
        }
        #region Pex Create
        public static DebugInfo CreateFromBinary(PexReader reader)
        {
            var ret = new DebugInfo();
            ((DebugInfoSetterCommon)((IDebugInfoGetter)ret).CommonSetterInstance()!).CopyInFromBinary(
                item: ret,
                reader: reader);
            return ret;
        }
    ...
    public static partial class DebugInfoMixIn
    {
        ...
        public static void CopyInFromBinary(
            this IDebugInfo item,
            PexReader reader)
        {
            ((DebugInfoSetterCommon)((IDebugInfoGetter)item).CommonSetterInstance()!).CopyInFromBinary(
                item: item,
                reader: reader);
        }
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    ...
    public partial class DebugInfo_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.Pex.DebugInfo";
        ...
        public static readonly Type PexWriteTranslation = typeof(DebugInfoPexWriteTranslation);
        #region Interface
    ...
    public partial class DebugInfoSetterCommon
    {
        ...
        public virtual void CopyInFromBinary(
            ...
            PexReader reader)
        {
            item.ModificationTime = reader.ReadDateTime();
            item.Functions.SetTo(
                Mutagen.Bethesda.Translations.Binary.ListBinaryTranslation<PexWriter, PexReader, DebugFunction>.Instance.Parse(
                    reader: reader,
                    amount: reader.ReadUInt16(),
                    transl: DebugFunction.TryCreateFromBinary));
        }
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    public partial class DebugInfoPexWriteTranslation : IPexWriteTranslator
    {
        public readonly static DebugInfoPexWriteTranslation Instance = new DebugInfoPexWriteTranslation();

        public void Write(
            PexWriter writer,
            IDebugInfoGetter item)
        {
            writer.Write(item.ModificationTime);
            Mutagen.Bethesda.Translations.Binary.ListBinaryTranslation<PexWriter, PexReader, IDebugFunctionGetter>.Instance.Write(
                writer: writer,
                items: item.Functions,
                countLengthLength: 2,
                transl: (PexWriter subWriter, IDebugFunctionGetter subItem) =>
                {
                    var Item = subItem;
                    ((DebugFunctionPexWriteTranslation)((IPexItem)Item).PexWriteTranslator).Write(
                        item: Item,
                        writer: subWriter);
                });
        }
        ...
        {
            Write(
                item: (IDebugInfoGetter)item,
                writer: writer);
        }

    }

    public partial class DebugInfoPexCreateTranslation
    {
        public readonly static DebugInfoPexCreateTranslation Instance = new DebugInfoPexCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim.Pex
{
    ...
    public static class DebugInfoPexTranslationMixIn
    {
        public static void WriteToBinary(
            this IDebugInfoGetter item,
            PexWriter writer)
        {
            ((DebugInfoPexWriteTranslation)item.PexWriteTranslator).Write(
                item: item,
                writer: writer);
        }
