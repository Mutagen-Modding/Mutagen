...
namespace Mutagen.Bethesda.Skyrim.Pex
{
        ...
        IPexFile
    {
        ...
        #region Objects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private ExtendedList<Object> _Objects = new ExtendedList<Object>();
        public ExtendedList<Object> Objects
        {
            get => this._Objects;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IObjectGetter> IPexFileGetter.Objects => _Objects;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public Mask(TItem initialValue)
            {
                ...
                this.Objects = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, Object.Mask<TItem>?>>?>(initialValue, Enumerable.Empty<MaskItemIndexed<TItem, Object.Mask<TItem>?>>());
                ...
                TItem UserFlags)
            {
                ...
                this.Objects = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, Object.Mask<TItem>?>>?>(Objects, Enumerable.Empty<MaskItemIndexed<TItem, Object.Mask<TItem>?>>());
            ...
            public MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, Object.Mask<TItem>?>>?>? Objects;
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Objects != null)
                {
                    obj.Objects = new MaskItem<R, IEnumerable<MaskItemIndexed<R, Object.Mask<R>?>>?>(eval(this.Objects.Overall), Enumerable.Empty<MaskItemIndexed<R, Object.Mask<R>?>>());
                    if (Objects.Specific != null)
                    {
                        var l = new List<MaskItemIndexed<R, Object.Mask<R>?>>();
                        obj.Objects.Specific = l;
                        foreach (var item in Objects.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, Object.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, Object.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public MaskItem<Exception?, IEnumerable<MaskItem<Exception?, Object.ErrorMask?>>?>? Objects;
            ...
            public void SetNthException(int index, Exception ex)
            {
                ...
                switch (enu)
                {
                    ...
                    case PexFile_FieldIndex.DebugInfo:
                        ...
                        break;
                    case PexFile_FieldIndex.Objects:
                        this.Objects = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, Object.ErrorMask?>>?>(ex, null);
                        break;
                    case PexFile_FieldIndex.UserFlags:
            ...
            public void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case PexFile_FieldIndex.DebugInfo:
                        ...
                        break;
                    case PexFile_FieldIndex.Objects:
                        this.Objects = (MaskItem<Exception?, IEnumerable<MaskItem<Exception?, Object.ErrorMask?>>?>)obj;
                        break;
                    case PexFile_FieldIndex.UserFlags:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Objects = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, Object.ErrorMask?>>?>(ExceptionExt.Combine(this.Objects?.Overall, rhs.Objects?.Overall), ExceptionExt.Combine(this.Objects?.Specific, rhs.Objects?.Specific));
        ...
        public class TranslationMask : ITranslationMask
        {
            ...
            public Object.TranslationMask? Objects;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object PexWriteTranslator => PexFilePexWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        object IPexItem.PexWriteTranslator => this.PexWriteTranslator;
        void IPexItem.WriteToBinary(PexWriter writer)
        {
            ((PexFilePexWriteTranslation)this.PexWriteTranslator).Write(
                item: this,
                writer: writer);
        }
        #region Pex Create
        public static PexFile CreateFromBinary(string path)
        {
            using var stream = new FileStream(path, FileMode.Open, FileAccess.Read);
            var reader = new PexReader(new BinaryReadStream(stream, isLittleEndian: false), new());
            return CreateFromBinary(reader: reader);
        }

        public static PexFile CreateFromBinary(
            string path,
        ...
        public static PexFile CreateFromBinary(Stream stream)
        {
            var reader = new PexReader(new BinaryReadStream(stream, isLittleEndian: false), new());
            return CreateFromBinary(reader: reader);
        }
    ...
    public partial interface IPexFile :
        ...
        IPexFileGetter,
        Mutagen.Bethesda.Pex.Records.IPexFileCommon
    {
        ...
        new ExtendedList<Object> Objects { get; }
    ...
    public partial interface IPexFileGetter :
        ...
        IPexItem,
        Mutagen.Bethesda.Pex.Records.IPexFileCommonGetter
    {
        ...
        IReadOnlyList<IObjectGetter> Objects { get; }
    ...
    public static partial class PexFileMixIn
    {
        ...
        public static void CopyInFromBinary(
            ...
            PexReader reader)
        {
            ((PexFileSetterCommon)((IPexFileGetter)item).CommonSetterInstance()!).CopyInFromBinary(
                item: item,
                reader: reader);
        }
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    ...
    public partial class PexFile_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.Pex.PexFile";
        ...
        public static readonly Type PexWriteTranslation = typeof(PexFilePexWriteTranslation);
        #region Interface
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    public partial class PexFilePexWriteTranslation : IPexWriteTranslator
    {
        public readonly static PexFilePexWriteTranslation Instance = new PexFilePexWriteTranslation();
        ...
        {
            Write(
                item: (IPexFileGetter)item,
                writer: writer);
        }

    }

    public partial class PexFilePexCreateTranslation
    {
        public readonly static PexFilePexCreateTranslation Instance = new PexFilePexCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim.Pex
{
    ...
    public static class PexFilePexTranslationMixIn
    {
            ...
            string path)
        {
            ...
            using var writer = new PexWriter(new BinaryWriteStream(stream, isLittleEndian: false));
            ((PexFilePexWriteTranslation)item.PexWriteTranslator).Write(
                item: item,
                writer: writer);
        }
