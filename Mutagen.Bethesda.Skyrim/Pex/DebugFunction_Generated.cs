...
namespace Mutagen.Bethesda.Skyrim.Pex
{
        ...
        ILoquiObjectSetter<DebugFunction>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object PexWriteTranslator => DebugFunctionPexWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        object IPexItem.PexWriteTranslator => this.PexWriteTranslator;
        void IPexItem.WriteToBinary(PexWriter writer)
        {
            ((DebugFunctionPexWriteTranslation)this.PexWriteTranslator).Write(
                item: this,
                writer: writer);
        }
        #region Pex Create
        public static DebugFunction CreateFromBinary(PexReader reader)
        {
            var ret = new DebugFunction();
            ((DebugFunctionSetterCommon)((IDebugFunctionGetter)ret).CommonSetterInstance()!).CopyInFromBinary(
                item: ret,
                reader: reader);
            return ret;
        }
        ...
        IPexItem
    {
        ...
        static ILoquiRegistration Registration => DebugFunction_Registration.Instance;
    ...
    public static partial class DebugFunctionMixIn
    {
        ...
        public static void CopyInFromBinary(
            this IDebugFunction item,
            PexReader reader)
        {
            ((DebugFunctionSetterCommon)((IDebugFunctionGetter)item).CommonSetterInstance()!).CopyInFromBinary(
                item: item,
                reader: reader);
        }
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    ...
    public partial class DebugFunction_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.Pex.DebugFunction";
        ...
        public static readonly Type PexWriteTranslation = typeof(DebugFunctionPexWriteTranslation);
        #region Interface
    ...
    public partial class DebugFunctionSetterCommon
    {
        ...
        public virtual void CopyInFromBinary(
            ...
            PexReader reader)
        {
            item.ObjectName = reader.ReadString();
            item.StateName = reader.ReadString();
            item.FunctionName = reader.ReadString();
            item.FunctionType = EnumBinaryTranslation<DebugFunctionType, PexReader, PexWriter>.Instance.Parse(
                reader: reader,
                length: 1);
            item.Instructions.SetTo(
                Mutagen.Bethesda.Translations.Binary.ListBinaryTranslation<PexWriter, PexReader, UInt16>.Instance.Parse(
                    reader: reader,
                    amount: reader.ReadUInt16(),
                    transl: UInt16BinaryTranslation<PexReader, PexWriter>.Instance.Parse));
        }
...
namespace Mutagen.Bethesda.Skyrim.Pex.Internals
{
    public partial class DebugFunctionPexWriteTranslation : IPexWriteTranslator
    {
        public readonly static DebugFunctionPexWriteTranslation Instance = new DebugFunctionPexWriteTranslation();
            ...
            IDebugFunctionGetter item)
        {
            ...
            writer.Write(item.StateName);
            writer.Write(item.FunctionName);
            EnumBinaryTranslation<DebugFunctionType, PexReader, PexWriter>.Instance.Write(
                writer,
                item.FunctionType,
                length: 1);
            Mutagen.Bethesda.Translations.Binary.ListBinaryTranslation<PexWriter, PexReader, UInt16>.Instance.Write(
                writer: writer,
                items: item.Instructions,
                countLengthLength: 2,
                transl: UInt16BinaryTranslation<PexReader, PexWriter>.Instance.Write);
        }
        ...
        {
            Write(
                item: (IDebugFunctionGetter)item,
                writer: writer);
        }

    }

    public partial class DebugFunctionPexCreateTranslation
    {
        public readonly static DebugFunctionPexCreateTranslation Instance = new DebugFunctionPexCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim.Pex
{
    ...
    public static class DebugFunctionPexTranslationMixIn
    {
        public static void WriteToBinary(
            this IDebugFunctionGetter item,
            PexWriter writer)
        {
            ((DebugFunctionPexWriteTranslation)item.PexWriteTranslator).Write(
                item: item,
                writer: writer);
        }
