...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class BodyTemplateCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)BodyTemplate_FieldIndex.Flags) ?? true))
            {
                if (lhs.Flags != rhs.Flags) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)BodyTemplate_FieldIndex.ArmorType) ?? true))
            {
                if (lhs.ArmorType != rhs.ArmorType) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)BodyTemplate_FieldIndex.ActsLike44) ?? true))
            {
