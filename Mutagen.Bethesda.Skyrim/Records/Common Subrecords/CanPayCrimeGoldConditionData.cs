...
public partial class CanPayCrimeGoldConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.CanPayCrimeGold;
}
