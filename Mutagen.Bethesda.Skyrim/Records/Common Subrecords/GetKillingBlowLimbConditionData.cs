...
public partial class GetKillingBlowLimbConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetKillingBlowLimb;
}
