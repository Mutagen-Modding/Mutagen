...
public partial class GetEquippedItemTypeConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetEquippedItemType;
}
