...
public partial class GetVampireFeedConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVampireFeed;
}
