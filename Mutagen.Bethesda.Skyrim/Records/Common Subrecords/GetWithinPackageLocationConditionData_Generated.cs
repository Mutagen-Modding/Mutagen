...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class GetWithinPackageLocationConditionDataSetterCommon : ConditionDataSetterCommon
    {
    ...
    internal partial class GetWithinPackageLocationConditionDataCommon : ConditionDataCommon
    {
        ...
        public static GetWithinPackageLocationConditionData_FieldIndex ConvertFieldIndex(ConditionData_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class GetWithinPackageLocationConditionDataSetterTranslationCommon : ConditionDataSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class GetWithinPackageLocationConditionDataBinaryCreateTranslation : ConditionDataBinaryCreateTranslation
    {
