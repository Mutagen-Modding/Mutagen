...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<ILinkedReferencesGetter>
    {
        ...
        protected IEnumerable<FormLinkInformation> LinkFormKeys => LinkedReferencesCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => LinkedReferencesCommon.Instance.GetLinkFormKeys(this);
    ...
    public partial class LinkedReferencesSetterCommon
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(RecordTypes.XLKR)));
    ...
    public partial class LinkedReferencesBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(RecordTypes.XLKR),
