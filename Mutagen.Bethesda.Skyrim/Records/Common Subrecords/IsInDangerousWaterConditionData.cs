...
public partial class IsInDangerousWaterConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInDangerousWater;
}
