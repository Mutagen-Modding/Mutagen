...
public partial class GetStolenItemValueNoCrimeConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetStolenItemValueNoCrime;
}
