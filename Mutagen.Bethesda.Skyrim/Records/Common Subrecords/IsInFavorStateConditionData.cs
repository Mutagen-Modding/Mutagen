...
public partial class IsInFavorStateConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInFavorState;
}
