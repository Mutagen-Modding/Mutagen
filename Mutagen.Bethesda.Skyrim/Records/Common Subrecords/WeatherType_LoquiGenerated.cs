...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class WeatherTypeXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)WeatherType_FieldIndex.Global) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Global),
                    item: item.Global.FormKey,
                    fieldIndex: (int)WeatherType_FieldIndex.Global,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.WeatherType");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.WeatherType");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "Chance":
                    ...
                    break;
                case "Global":
                    errorMask?.PushIndex((int)WeatherType_FieldIndex.Global);
                    try
                    {
