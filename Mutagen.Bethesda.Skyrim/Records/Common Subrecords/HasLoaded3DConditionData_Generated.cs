...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<HasLoaded3DConditionData>
    {
        ...
        String? IHasLoaded3DConditionDataGetter.FirstUnusedStringParameter => this.FirstUnusedStringParameter;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? IHasLoaded3DConditionDataGetter.SecondUnusedStringParameter => this.SecondUnusedStringParameter;
        #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case HasLoaded3DConditionData_FieldIndex.FirstUnusedIntParameter:
                        return FirstUnusedIntParameter;
                    case HasLoaded3DConditionData_FieldIndex.FirstUnusedStringParameter:
                        return FirstUnusedStringParameter;
                    case HasLoaded3DConditionData_FieldIndex.SecondUnusedIntParameter:
                        return SecondUnusedIntParameter;
                    case HasLoaded3DConditionData_FieldIndex.SecondUnusedStringParameter:
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class HasLoaded3DConditionDataSetterCommon : ConditionDataSetterCommon
    {
    ...
    internal partial class HasLoaded3DConditionDataCommon : ConditionDataCommon
    {
        ...
        public static HasLoaded3DConditionData_FieldIndex ConvertFieldIndex(ConditionData_FieldIndex index)
        {
            switch (index)
            {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.FirstUnusedIntParameter) ?? true))
            {
                if (lhs.FirstUnusedIntParameter != rhs.FirstUnusedIntParameter) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.FirstUnusedStringParameter) ?? true))
            {
                if (!string.Equals(lhs.FirstUnusedStringParameter, rhs.FirstUnusedStringParameter)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.SecondUnusedIntParameter) ?? true))
            {
                if (lhs.SecondUnusedIntParameter != rhs.SecondUnusedIntParameter) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.SecondUnusedStringParameter) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IHasLoaded3DConditionDataGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class HasLoaded3DConditionDataSetterTranslationCommon : ConditionDataSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.FirstUnusedIntParameter) ?? true))
            {
                item.FirstUnusedIntParameter = rhs.FirstUnusedIntParameter;
            }
            if ((copyMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.FirstUnusedStringParameter) ?? true))
            {
                item.FirstUnusedStringParameter = rhs.FirstUnusedStringParameter;
            }
            if ((copyMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.SecondUnusedIntParameter) ?? true))
            {
                item.SecondUnusedIntParameter = rhs.SecondUnusedIntParameter;
            }
            if ((copyMask?.GetShouldTranslate((int)HasLoaded3DConditionData_FieldIndex.SecondUnusedStringParameter) ?? true))
            {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class HasLoaded3DConditionDataBinaryCreateTranslation : ConditionDataBinaryCreateTranslation
    {
