...
public partial class GetTrespassWarningLevelConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetTrespassWarningLevel;
}
