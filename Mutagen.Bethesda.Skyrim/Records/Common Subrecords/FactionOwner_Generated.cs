...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IFactionOwnerGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => FactionOwnerCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => FactionOwnerCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class FactionOwnerCommon : OwnerTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(IFactionOwnerGetter obj)
        {
