...
public partial class GetTotalPersuasionNumberConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetTotalPersuasionNumber;
}
