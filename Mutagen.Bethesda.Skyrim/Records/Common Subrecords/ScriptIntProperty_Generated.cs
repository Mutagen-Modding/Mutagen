...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected override object XmlWriteTranslator => ScriptIntPropertyXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ScriptIntPropertyXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new ScriptIntProperty CreateFromXml(
            XElement node,
            ScriptIntProperty.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static ScriptIntProperty CreateFromXml(
            XElement node,
        ...
        public new static ScriptIntProperty CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new ScriptIntProperty();
            ((ScriptIntPropertySetterCommon)((IScriptIntPropertyGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class ScriptIntPropertyMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ScriptIntPropertySetterCommon)((IScriptIntPropertyGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ScriptIntProperty_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(ScriptIntPropertyXmlWriteTranslation);
    ...
    public partial class ScriptIntPropertySetterCommon : ScriptPropertySetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ScriptIntPropertyXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ScriptIntPropertyXmlWriteTranslation :
        ScriptPropertyXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static ScriptIntPropertyXmlWriteTranslation Instance = new ScriptIntPropertyXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ScriptPropertyXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)ScriptIntProperty_FieldIndex.Data) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Data),
                    item: item.Data,
                    fieldIndex: (int)ScriptIntProperty_FieldIndex.Data,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ScriptIntProperty");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ScriptIntProperty");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ScriptIntPropertyXmlCreateTranslation : ScriptPropertyXmlCreateTranslation
    {
        public new readonly static ScriptIntPropertyXmlCreateTranslation Instance = new ScriptIntPropertyXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Data":
                    errorMask?.PushIndex((int)ScriptIntProperty_FieldIndex.Data);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ScriptIntPropertyXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ScriptIntPropertyXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
