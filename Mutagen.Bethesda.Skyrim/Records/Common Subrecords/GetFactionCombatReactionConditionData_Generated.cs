...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IGetFactionCombatReactionConditionDataGetter
    {
        ...
        public IFormLinkOrAliasGetter<IFactionGetter> SecondParameter => new FormLinkOrAlias<IFactionGetter>(this, FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x8, 0x4))));
