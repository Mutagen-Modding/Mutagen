...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
            ...
            where TItem : notnull
        {
            ...
            {
                fg.AppendLine($"{nameof(ObjectBounds.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        [DebuggerStepThrough]
        public static ObjectBounds CreateFromBinary(MutagenFrame frame)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ObjectBoundsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IObjectBoundsGetter obj)
        {
            yield break;
        }
        
        public void RemapLinks(IObjectBoundsGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
