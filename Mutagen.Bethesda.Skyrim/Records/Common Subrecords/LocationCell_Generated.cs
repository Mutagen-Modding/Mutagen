...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<ILocationCellGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => LocationCellCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => LocationCellCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class LocationCellCommon : ALocationTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(ILocationCellGetter obj)
        {
