...
public partial class IsInSameCurrentLocAsRefAliasConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInSameCurrentLocAsRefAlias;
}
