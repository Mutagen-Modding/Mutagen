...
public partial class GetIsEditorLocationConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetIsEditorLocation;
}
