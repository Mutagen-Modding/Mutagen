...
public partial class IsPlayersLastRiddenMountConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsPlayersLastRiddenMount;
}
