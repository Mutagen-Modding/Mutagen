...
public partial class IsTrespassingConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsTrespassing;
}
