...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IHasMagicEffectConditionDataGetter
    {
        ...
        public IFormLinkOrAliasGetter<IMagicEffectGetter> FirstParameter => new FormLinkOrAlias<IMagicEffectGetter>(this, FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x4, 0x4))));
