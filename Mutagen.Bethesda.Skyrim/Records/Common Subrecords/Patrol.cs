...
namespace Mutagen.Bethesda.Skyrim
{
    namespace Internals
    {
        ...
        {
            public static partial ParseResult FillBinaryPatrolScriptMarkerCustom(MutagenFrame frame, IPatrol item, int? lastParsed)
            {
        ...
        public partial class PatrolBinaryOverlay
        {
            ...
            public partial ParseResult PatrolScriptMarkerCustomParse(OverlayStream stream, int offset, int? lastParsed)
            {
