...
public partial class IsUnlockedDoorConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsUnlockedDoor;
}
