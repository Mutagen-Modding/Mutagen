...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IGetIsCurrentPackageConditionDataGetter
    {
        ...
        public IFormLinkOrAliasGetter<IPackageGetter> FirstParameter => new FormLinkOrAlias<IPackageGetter>(this, FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x4, 0x4))));
