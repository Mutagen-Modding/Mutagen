...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<GetIsCurrentPackageConditionData>
    {
        ...
        {
            _FirstParameter = new FormLinkOrAlias<IPackageGetter>(this);
            CustomCtor();
        }
        ...
        private readonly IFormLinkOrAlias<IPackageGetter> _FirstParameter = default!;
        public IFormLinkOrAlias<IPackageGetter> FirstParameter
        {
            get => _FirstParameter;
            set => _FirstParameter.SetTo(value);
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkOrAliasGetter<IPackageGetter> IGetIsCurrentPackageConditionDataGetter.FirstParameter => this.FirstParameter;
        #endregion
    ...
    {
        new IFormLinkOrAlias<IPackageGetter> FirstParameter { get; set; }
        ...
        ILoquiObject<IGetIsCurrentPackageConditionDataGetter>
    {
        ...
        IFormLinkOrAliasGetter<IPackageGetter> FirstParameter { get; }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class GetIsCurrentPackageConditionDataSetterCommon : FunctionConditionDataSetterCommon
    {
    ...
    internal partial class GetIsCurrentPackageConditionDataCommon : FunctionConditionDataCommon
    {
        ...
        public static GetIsCurrentPackageConditionData_FieldIndex ConvertFieldIndex(FunctionConditionData_FieldIndex index)
        {
            switch (index)
            {
        ...
        public static new GetIsCurrentPackageConditionData_FieldIndex ConvertFieldIndex(ConditionData_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class GetIsCurrentPackageConditionDataSetterTranslationCommon : FunctionConditionDataSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class GetIsCurrentPackageConditionDataBinaryCreateTranslation : FunctionConditionDataBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IGetIsCurrentPackageConditionDataGetter
    {
        ...
        public IFormLinkOrAliasGetter<IPackageGetter> FirstParameter => FormLinkOrAlias<IPackageGetter>.Factory(this, FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x4, 0x4))), BinaryPrimitives.ReadUInt32LittleEndian(_structData.Span.Slice(0x4, 0x4)));
        ...
        partial void CustomCtor();
        protected GetIsCurrentPackageConditionDataBinaryOverlay(
        ...
        public static IGetIsCurrentPackageConditionDataGetter GetIsCurrentPackageConditionDataFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
            TypedParseParams translationParams = default)
        {
            ...
            var ret = new GetIsCurrentPackageConditionDataBinaryOverlay(
                memoryPair: memoryPair,
                package: package);
            stream.Position += 0xC;
        ...
        public static IGetIsCurrentPackageConditionDataGetter GetIsCurrentPackageConditionDataFactory(
            ...
            TypedParseParams translationParams = default)
        {
            return GetIsCurrentPackageConditionDataFactory(
