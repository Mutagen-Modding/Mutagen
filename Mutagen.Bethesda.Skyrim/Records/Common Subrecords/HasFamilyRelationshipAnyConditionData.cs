...
public partial class HasFamilyRelationshipAnyConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.HasFamilyRelationshipAny;
}
