...
public partial class IsInFurnitureStateConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInFurnitureState;
}
