...
public partial class GetKnockedStateEnumConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetKnockedStateEnum;
}
