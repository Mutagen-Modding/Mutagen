...
public partial class GetLocAliasRefTypeAliveCountConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetLocAliasRefTypeAliveCount;
}
