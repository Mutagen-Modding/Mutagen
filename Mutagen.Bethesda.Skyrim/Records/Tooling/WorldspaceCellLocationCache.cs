...
using CellContext = Mutagen.Bethesda.Plugins.Cache.IModContext<Mutagen.Bethesda.Skyrim.ISkyrimMod, Mutagen.Bethesda.Skyrim.ISkyrimModGetter, Mutagen.Bethesda.Skyrim.ICell, Mutagen.Bethesda.Skyrim.ICellGetter>;
        ...
        public WorldspaceCellLocationCache(IEnumerable<CellContext> allCellContexts) {
            lazyGrid = new Lazy<Dictionary<IFormLink<IWorldspaceGetter>, Dictionary<P2Int, CellContext>>>(() => {
                ...
                foreach(var cellContext in allCellContexts) {
                    ...
                    if(cell.Grid == null || cell.MajorFlags.HasFlag(Cell.MajorFlag.Persistent)) {
                        continue;
                    }
