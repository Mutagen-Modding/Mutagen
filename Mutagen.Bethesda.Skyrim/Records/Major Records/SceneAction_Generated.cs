...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => SceneActionXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((SceneActionXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static SceneAction CreateFromXml(
            XElement node,
            SceneAction.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((SceneActionSetterCommon)((ISceneActionGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = SceneAction_Registration.TriggeringRecordType;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IEnumerable<FormKey> LinkFormKeys => SceneActionCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => SceneActionCommon.Instance.GetLinkFormKeys(this);
        ...
        [DebuggerStepThrough]
        public static SceneAction CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((ISceneActionGetter)rhs, include);
    ...
    public static partial class SceneActionMixIn
    {
        ...
        public static bool HasBeenSet(
            this ISceneActionGetter item,
            SceneAction.Mask<bool?> checkMask)
        {
            return ((SceneActionCommon)((ISceneActionGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static SceneAction.Mask<bool> GetHasBeenSetMask(this ISceneActionGetter item)
        {
            var ret = new SceneAction.Mask<bool>(false);
            ((SceneActionCommon)((ISceneActionGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((SceneActionSetterCommon)((ISceneActionGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class SceneAction_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(SceneActionXmlWriteTranslation);
    ...
    public partial class SceneActionSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    SceneActionXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class SceneActionCommon
    {
            ...
            SceneAction.Mask<bool?> checkMask)
        {
            ...
            if (checkMask.ActorID.HasValue && checkMask.ActorID.Value != (item.ActorID != null)) return false;
            ...
            if (checkMask.StartPhase.HasValue && checkMask.StartPhase.Value != (item.StartPhase != null)) return false;
            if (checkMask.EndPhase.HasValue && checkMask.EndPhase.Value != (item.EndPhase != null)) return false;
            if (checkMask.TimerSeconds.HasValue && checkMask.TimerSeconds.Value != (item.TimerSeconds != null)) return false;
            if (checkMask.Topic.HasValue && checkMask.Topic.Value != (item.Topic.FormKey != null)) return false;
            if (checkMask.HeadtrackActorID.HasValue && checkMask.HeadtrackActorID.Value != (item.HeadtrackActorID != null)) return false;
            if (checkMask.LoopingMax.HasValue && checkMask.LoopingMax.Value != (item.LoopingMax != null)) return false;
            if (checkMask.LoopingMin.HasValue && checkMask.LoopingMin.Value != (item.LoopingMin != null)) return false;
            if (checkMask.Emotion.HasValue && checkMask.Emotion.Value != (item.Emotion != null)) return false;
            if (checkMask.EmotionValue.HasValue && checkMask.EmotionValue.Value != (item.EmotionValue != null)) return false;
        ...
        public void FillHasBeenSetMask(
            ISceneActionGetter item,
            SceneAction.Mask<bool> mask)
        {
            mask.Type = true;
            mask.Name = (item.Name != null);
            mask.ActorID = (item.ActorID != null);
            mask.LNAM = (item.LNAM != null);
            mask.Index = (item.Index != null);
            mask.Flags = (item.Flags != null);
            mask.StartPhase = (item.StartPhase != null);
            mask.EndPhase = (item.EndPhase != null);
            mask.TimerSeconds = (item.TimerSeconds != null);
            mask.Packages = new MaskItem<bool, IEnumerable<(int Index, bool Value)>?>(true, default);
            mask.Topic = (item.Topic.FormKey != null);
            mask.HeadtrackActorID = (item.HeadtrackActorID != null);
            mask.LoopingMax = (item.LoopingMax != null);
            mask.LoopingMin = (item.LoopingMin != null);
            mask.Emotion = (item.Emotion != null);
            mask.EmotionValue = (item.EmotionValue != null);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class SceneActionXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static SceneActionXmlWriteTranslation Instance = new SceneActionXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Type) ?? true))
            {
                EnumXmlTranslation<SceneAction.TypeEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.Type),
                    item: item.Type,
                    fieldIndex: (int)SceneAction_FieldIndex.Type,
                    errorMask: errorMask);
            }
            if ((item.Name != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Name) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Name),
                    item: item.Name,
                    fieldIndex: (int)SceneAction_FieldIndex.Name,
                    errorMask: errorMask);
            }
            if ((item.ActorID != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.ActorID) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ActorID),
                    item: item.ActorID.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.ActorID,
                    errorMask: errorMask);
            }
            if ((item.LNAM != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.LNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LNAM),
                    item: item.LNAM.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.LNAM,
                    errorMask: errorMask);
            }
            if ((item.Index != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Index) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Index),
                    item: item.Index.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.Index,
                    errorMask: errorMask);
            }
            if ((item.Flags != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Flags) ?? true))
            {
                EnumXmlTranslation<SceneAction.Flag>.Instance.Write(
                    node: node,
                    name: nameof(item.Flags),
                    item: item.Flags,
                    fieldIndex: (int)SceneAction_FieldIndex.Flags,
                    errorMask: errorMask);
            }
            if ((item.StartPhase != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.StartPhase) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.StartPhase),
                    item: item.StartPhase.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.StartPhase,
                    errorMask: errorMask);
            }
            if ((item.EndPhase != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.EndPhase) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.EndPhase),
                    item: item.EndPhase.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.EndPhase,
                    errorMask: errorMask);
            }
            if ((item.TimerSeconds != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.TimerSeconds) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.TimerSeconds),
                    item: item.TimerSeconds.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.TimerSeconds,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Packages) ?? true))
            {
                ListXmlTranslation<IFormLink<IPackageGetter>>.Instance.Write(
                    node: node,
                    name: nameof(item.Packages),
                    item: item.Packages,
                    fieldIndex: (int)SceneAction_FieldIndex.Packages,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)SceneAction_FieldIndex.Packages),
            ...
            if ((item.Topic.FormKey != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Topic) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Topic),
                    item: item.Topic.FormKey,
                    fieldIndex: (int)SceneAction_FieldIndex.Topic,
                    errorMask: errorMask);
            }
            if ((item.HeadtrackActorID != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.HeadtrackActorID) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.HeadtrackActorID),
                    item: item.HeadtrackActorID.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.HeadtrackActorID,
                    errorMask: errorMask);
            }
            if ((item.LoopingMax != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.LoopingMax) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LoopingMax),
                    item: item.LoopingMax.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.LoopingMax,
                    errorMask: errorMask);
            }
            if ((item.LoopingMin != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.LoopingMin) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LoopingMin),
                    item: item.LoopingMin.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.LoopingMin,
                    errorMask: errorMask);
            }
            if ((item.Emotion != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Emotion) ?? true))
            {
                EnumXmlTranslation<Emotion>.Instance.Write(
                    node: node,
                    name: nameof(item.Emotion),
                    item: item.Emotion,
                    fieldIndex: (int)SceneAction_FieldIndex.Emotion,
                    errorMask: errorMask);
            }
            if ((item.EmotionValue != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.EmotionValue) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.EmotionValue),
                    item: item.EmotionValue.Value,
                    fieldIndex: (int)SceneAction_FieldIndex.EmotionValue,
                    errorMask: errorMask);
            }
            if ((item.Unused != null)
                && (translationMask?.GetShouldTranslate((int)SceneAction_FieldIndex.Unused) ?? true))
            {
                if (item.Unused.TryGet(out var UnusedItem))
                {
                    ((ScenePhaseUnusedDataXmlWriteTranslation)((IXmlItem)UnusedItem).XmlWriteTranslator).Write(
                        ...
                        fieldIndex: (int)SceneAction_FieldIndex.Unused,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)SceneAction_FieldIndex.Unused));
                }
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.SceneAction");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.SceneAction");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class SceneActionXmlCreateTranslation
    {
        public readonly static SceneActionXmlCreateTranslation Instance = new SceneActionXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "Type":
                    ...
                    try
                    {
                        item.Type = EnumXmlTranslation<SceneAction.TypeEnum>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "Name":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.Name);
                    try
                    {
                    ...
                    break;
                case "ActorID":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.ActorID);
                    try
                    {
                        item.ActorID = Int32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "LNAM":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.LNAM);
                    try
                    {
                    ...
                    break;
                case "Index":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.Index);
                    try
                    {
                    ...
                    break;
                case "Flags":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.Flags);
                    try
                    {
                        item.Flags = EnumXmlTranslation<SceneAction.Flag>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "StartPhase":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.StartPhase);
                    try
                    {
                        item.StartPhase = UInt32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "EndPhase":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.EndPhase);
                    try
                    {
                        item.EndPhase = UInt32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "TimerSeconds":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.TimerSeconds);
                    try
                    {
                        item.TimerSeconds = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "Packages":
                    ...
                    break;
                case "Topic":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.Topic);
                    try
                    {
                    ...
                    break;
                case "HeadtrackActorID":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.HeadtrackActorID);
                    try
                    {
                        item.HeadtrackActorID = Int32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "LoopingMax":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.LoopingMax);
                    try
                    {
                        item.LoopingMax = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "LoopingMin":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.LoopingMin);
                    try
                    {
                        item.LoopingMin = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "Emotion":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.Emotion);
                    try
                    {
                    ...
                    break;
                case "EmotionValue":
                    errorMask?.PushIndex((int)SceneAction_FieldIndex.EmotionValue);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class SceneActionXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((SceneActionXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ISceneActionGetter
    {
        ...
        public SceneAction.TypeEnum Type => _TypeLocation.HasValue ? (SceneAction.TypeEnum)BinaryPrimitives.ReadUInt16LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _TypeLocation!.Value, _package.MetaData.Constants)) : default(SceneAction.TypeEnum);
        #endregion
        #region Name
        ...
        public SceneAction.Flag? Flags => _FlagsLocation.HasValue ? (SceneAction.Flag)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)) : default(SceneAction.Flag?);
        #endregion
        #region StartPhase
        ...
        public Emotion? Emotion => _EmotionLocation.HasValue ? (Emotion)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _EmotionLocation!.Value, _package.MetaData.Constants)) : default(Emotion?);
        #endregion
        #region EmotionValue
