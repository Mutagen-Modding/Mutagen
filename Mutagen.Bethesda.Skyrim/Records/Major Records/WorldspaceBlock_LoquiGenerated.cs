...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IEnumerable<FormKey> LinkFormKeys => WorldspaceBlockCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => WorldspaceBlockCommon.Instance.GetLinkFormKeys(this);
        protected void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => WorldspaceBlockCommon.Instance.RemapLinks(this, mapping);
        void ILinkedFormKeyContainer.RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => WorldspaceBlockCommon.Instance.RemapLinks(this, mapping);
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class WorldspaceBlock_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.WorldspaceBlock";
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            switch (enu)
            {
                ...
                case WorldspaceBlock_FieldIndex.Unknown:
                    return typeof(Int32);
                case WorldspaceBlock_FieldIndex.Items:
                    return typeof(ExtendedList<WorldspaceSubBlock>);
                default:
                    throw new ArgumentException($"Index is out of range: {index}");
            }
        }
    ...
    public partial class WorldspaceBlockCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IWorldspaceBlockGetter obj)
        {
        ...
        public void RemapLinks(IWorldspaceBlockGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class WorldspaceBlockXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)WorldspaceBlock_FieldIndex.Unknown) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)WorldspaceBlock_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.WorldspaceBlock");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.WorldspaceBlock");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "LastModified":
                    ...
                    break;
                case "Unknown":
                    errorMask?.PushIndex((int)WorldspaceBlock_FieldIndex.Unknown);
                    try
                    {
