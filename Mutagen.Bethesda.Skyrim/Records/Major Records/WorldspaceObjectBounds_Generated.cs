...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IWorldspaceObjectBounds
    {
        ...
        public void Print(
            ...
            string? name = null)
        {
            WorldspaceObjectBoundsMixIn.Print(
                item: this,
                sb: sb,
                name: name);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(WorldspaceObjectBounds.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, WorldspaceObjectBounds.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(WorldspaceObjectBounds.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class WorldspaceObjectBoundsMixIn
    {
        ...
        {
            return ((WorldspaceObjectBoundsCommon)((IWorldspaceObjectBoundsGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            WorldspaceObjectBounds.Mask<bool>? printMask = null)
        {
            ((WorldspaceObjectBoundsCommon)((IWorldspaceObjectBoundsGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class WorldspaceObjectBoundsCommon
    {
            ...
            WorldspaceObjectBounds.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"WorldspaceObjectBounds =>");
            }
            else
            {
                sb.AppendLine($"{name} (WorldspaceObjectBounds) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IWorldspaceObjectBoundsGetter obj)
        {
            yield break;
        }
