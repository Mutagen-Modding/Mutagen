...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IAPerkEntryPointEffectGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => APerkEntryPointEffectCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => APerkEntryPointEffectCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class APerkEntryPointEffectCommon : APerkEffectCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(IAPerkEntryPointEffectGetter obj)
        {
