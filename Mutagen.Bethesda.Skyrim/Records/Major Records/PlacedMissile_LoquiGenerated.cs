...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => PlacedMissileXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PlacedMissileXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new PlacedMissile CreateFromXml(
            XElement node,
            PlacedMissile.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static PlacedMissile CreateFromXml(
            XElement node,
        ...
        public new static PlacedMissile CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new PlacedMissile();
            ((PlacedMissileSetterCommon)((IPlacedMissileGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => PlacedMissileCommon.Instance.GetLinkFormKeys(this);
        ...
        [DebuggerStepThrough]
        public static new PlacedMissile CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((IPlacedMissileGetter)rhs, include);
    ...
    public partial interface IPlacedMissileGetter :
        ...
        IBinaryItem
    {
        static ILoquiRegistration Registration => PlacedMissile_Registration.Instance;
    ...
    public static partial class PlacedMissileMixIn
    {
        ...
        public static bool HasBeenSet(
            this IPlacedMissileGetter item,
            PlacedMissile.Mask<bool?> checkMask)
        {
            return ((PlacedMissileCommon)((IPlacedMissileGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static PlacedMissile.Mask<bool> GetHasBeenSetMask(this IPlacedMissileGetter item)
        {
            var ret = new PlacedMissile.Mask<bool>(false);
            ((PlacedMissileCommon)((IPlacedMissileGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PlacedMissileSetterCommon)((IPlacedMissileGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    FillPrivateElementXml(
                        ...
                        errorMask: errorMask,
                        translationMask: translationMask);
                    PlacedMissileXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PlacedMissileXmlWriteTranslation :
        APlacedTrapXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static PlacedMissileXmlWriteTranslation Instance = new PlacedMissileXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            APlacedTrapXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)PlacedMissile_FieldIndex.Projectile) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Projectile),
                    item: item.Projectile.FormKey,
                    fieldIndex: (int)PlacedMissile_FieldIndex.Projectile,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.PlacedMissile");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.PlacedMissile");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PlacedMissileXmlCreateTranslation : APlacedTrapXmlCreateTranslation
    {
        public new readonly static PlacedMissileXmlCreateTranslation Instance = new PlacedMissileXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Projectile":
                    errorMask?.PushIndex((int)PlacedMissile_FieldIndex.Projectile);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PlacedMissileXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PlacedMissileXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(PlacedMissile_Registration.PMIS_HEADER),
    ...
    public partial class PlacedMissileBinaryCreateTranslation : APlacedTrapBinaryCreateTranslation
    {
        ...
        public override RecordType RecordType => PlacedMissile_Registration.PMIS_HEADER;
