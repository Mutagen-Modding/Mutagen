...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Book>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => BookCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class BookSetterCommon : SkyrimMajorRecordSetterCommon
    {
    ...
    internal partial class BookCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IBookGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
    ...
    internal partial class BookSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class BookBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IBookGetter
    {
        ...
        public Book.BookType Type => _Type_IsSet ? (Book.BookType)_recordData.Span.Slice(_TypeLocation, 0x1)[0] : default;
        #endregion
        #region Unused
