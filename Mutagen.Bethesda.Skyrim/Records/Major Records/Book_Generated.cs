...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Book>
    {
        ...
        #endregion
        #region InventoryArt
        private IFormLinkNullable<IStaticGetter> _InventoryArt = new FormLinkNullable<IStaticGetter>();
        public IFormLinkNullable<IStaticGetter> InventoryArt
        {
            get => _InventoryArt;
            set => _InventoryArt = value.AsNullable();
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    public partial class BookBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.BookText = Mutagen.Bethesda.Records.Binary.Translations.StringBinaryTranslation.Instance.Parse(
                        reader: frame.SpawnWithLength(contentLength),
                        source: StringsSource.DL,
                        stringBinaryType: StringBinaryType.NullTerminate);
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.InventoryArt.SetTo(Mutagen.Bethesda.Records.Binary.Translations.FormLinkBinaryTranslation.Instance.Parse(reader: frame));
