...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IBookGetter>
    {
        ...
        void IFormLinkContainer.RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => BookCommon.Instance.RemapLinks(this, mapping);
        public Book(
            FormKey formKey,
        ...
        IBinaryItem
    {
        ...
        UInt32 Value { get; }
        Single Weight { get; }
        FormLinkNullable<IStaticGetter> InventoryArt { get; }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class BookCommon : SkyrimMajorRecordCommon
    {
        ...
        public Book Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Book(formKey, default(SkyrimRelease));
    ...
    public partial class BookSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                item.InventoryArt = new FormLinkNullable<IStaticGetter>(rhs.InventoryArt.FormKeyNullable);
            }
