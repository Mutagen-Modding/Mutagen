    ...
    public partial class LeveledSpellEntryBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.HasValue && lastParsed.Value >= (int)LeveledSpellEntry_FieldIndex.Data) return TryGet<int?>.Failure;
                    item.Data = Mutagen.Bethesda.Skyrim.LeveledSpellEntryData.CreateFromBinary(frame: frame);
                    return TryGet<int?>.Succeed((int)LeveledSpellEntry_FieldIndex.Data);
                }
                case RecordTypeInts.COED:
                {
                    if (lastParsed.HasValue && lastParsed.Value >= (int)LeveledSpellEntry_FieldIndex.ExtraData) return TryGet<int?>.Failure;
                    item.ExtraData = Mutagen.Bethesda.Skyrim.ExtraData.CreateFromBinary(frame: frame);
                    return TryGet<int?>.Succeed((int)LeveledSpellEntry_FieldIndex.ExtraData);
                }
                default:
