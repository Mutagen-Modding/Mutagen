...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Door>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => DoorCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => DoorSetterCommon.Instance.RemapListedAssetLinks(this, mapping);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class DoorSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IDoor obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
    ...
    internal partial class DoorCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IDoorGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
