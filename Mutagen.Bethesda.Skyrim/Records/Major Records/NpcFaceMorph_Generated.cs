...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class NpcFaceMorphCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.NoseLongVsShort) ?? true))
            {
                if (!lhs.NoseLongVsShort.EqualsWithin(rhs.NoseLongVsShort)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.NoseUpVsDown) ?? true))
            {
                if (!lhs.NoseUpVsDown.EqualsWithin(rhs.NoseUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.JawUpVsDown) ?? true))
            {
                if (!lhs.JawUpVsDown.EqualsWithin(rhs.JawUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.JawNarrowVsWide) ?? true))
            {
                if (!lhs.JawNarrowVsWide.EqualsWithin(rhs.JawNarrowVsWide)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.JawForwardVsBack) ?? true))
            {
                if (!lhs.JawForwardVsBack.EqualsWithin(rhs.JawForwardVsBack)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.CheeksUpVsDown) ?? true))
            {
                if (!lhs.CheeksUpVsDown.EqualsWithin(rhs.CheeksUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.CheeksForwardVsBack) ?? true))
            {
                if (!lhs.CheeksForwardVsBack.EqualsWithin(rhs.CheeksForwardVsBack)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.EyesUpVsDown) ?? true))
            {
                if (!lhs.EyesUpVsDown.EqualsWithin(rhs.EyesUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.EyesInVsOut) ?? true))
            {
                if (!lhs.EyesInVsOut.EqualsWithin(rhs.EyesInVsOut)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.BrowsUpVsDown) ?? true))
            {
                if (!lhs.BrowsUpVsDown.EqualsWithin(rhs.BrowsUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.BrowsInVsOut) ?? true))
            {
                if (!lhs.BrowsInVsOut.EqualsWithin(rhs.BrowsInVsOut)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.BrowsForwardVsBack) ?? true))
            {
                if (!lhs.BrowsForwardVsBack.EqualsWithin(rhs.BrowsForwardVsBack)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.LipsUpVsDown) ?? true))
            {
                if (!lhs.LipsUpVsDown.EqualsWithin(rhs.LipsUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.LipsInVsOut) ?? true))
            {
                if (!lhs.LipsInVsOut.EqualsWithin(rhs.LipsInVsOut)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.ChinNarrowVsWide) ?? true))
            {
                if (!lhs.ChinNarrowVsWide.EqualsWithin(rhs.ChinNarrowVsWide)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.ChinUpVsDown) ?? true))
            {
                if (!lhs.ChinUpVsDown.EqualsWithin(rhs.ChinUpVsDown)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.ChinUnderbiteVsOverbite) ?? true))
            {
                if (!lhs.ChinUnderbiteVsOverbite.EqualsWithin(rhs.ChinUnderbiteVsOverbite)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.EyesForwardVsBack) ?? true))
            {
                if (!lhs.EyesForwardVsBack.EqualsWithin(rhs.EyesForwardVsBack)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)NpcFaceMorph_FieldIndex.Unknown) ?? true))
            {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class NpcFaceMorphBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.NoseLongVsShort = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.NoseUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.JawUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.JawNarrowVsWide = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.JawForwardVsBack = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.CheeksUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.CheeksForwardVsBack = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EyesUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EyesInVsOut = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.BrowsUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.BrowsInVsOut = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.BrowsForwardVsBack = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.LipsUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.LipsInVsOut = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ChinNarrowVsWide = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ChinUpVsDown = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.ChinUnderbiteVsOverbite = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
            item.EyesForwardVsBack = FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame);
