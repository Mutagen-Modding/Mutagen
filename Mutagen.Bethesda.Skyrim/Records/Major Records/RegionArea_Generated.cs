...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class RegionArea_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.RegionArea";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "REGIONPOINTLISTDATA":
                    return (ushort)RegionArea_FieldIndex.RegionPointListData;
                default:
                    return null;
            }
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class RegionAreaXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((item.RegionPointListData != null)
                && (translationMask?.GetShouldTranslate((int)RegionArea_FieldIndex.RegionPointListData) ?? true))
            {
                ListXmlTranslation<P2Float>.Instance.Write(
                    node: node,
                    name: nameof(item.RegionPointListData),
                    item: item.RegionPointListData,
                    fieldIndex: (int)RegionArea_FieldIndex.RegionPointListData,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)RegionArea_FieldIndex.RegionPointListData),
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionArea");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionArea");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
                ...
                case "RegionPointListData":
                    ...
                    try
                    {
                        if (ListXmlTranslation<P2Float>.Instance.Parse(
                            node: node,
                            enumer: out var RegionPointListDataItem,
                            transl: P2FloatXmlTranslation.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.RegionPointListData = RegionPointListDataItem.ToExtendedList();
                        }
                        else
                        {
                            item.RegionPointListData = null;
