...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Hazard>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => HazardCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class HazardSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IHazard obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
    ...
    internal partial class HazardCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IHazardGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IHazardGetter
    {
        ...
        public IFormLinkGetter<IEffectRecordGetter> Spell => _Spell_IsSet ? new FormLink<IEffectRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_recordData.Span.Slice(_SpellLocation, 0x4)))) : FormLink<IEffectRecordGetter>.Null;
        #endregion
        #region Light
