...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LensFlare>
    {
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query) => LensFlareSetterCommon.Instance.RemapAssetLinks(this, mapping, query);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LensFlareSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapAssetLinks(ILensFlare obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query)
        {
            base.RemapAssetLinks(obj, mapping, query);
            obj.Sprites?.ForEach(x => x.RemapAssetLinks(mapping, query));
        }
