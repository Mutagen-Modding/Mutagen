...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected override object XmlWriteTranslator => PerkAddRangeToValueXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PerkAddRangeToValueXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new PerkAddRangeToValue CreateFromXml(
            XElement node,
            PerkAddRangeToValue.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static PerkAddRangeToValue CreateFromXml(
            XElement node,
        ...
        public new static PerkAddRangeToValue CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new PerkAddRangeToValue();
            ((PerkAddRangeToValueSetterCommon)((IPerkAddRangeToValueGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class PerkAddRangeToValueMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PerkAddRangeToValueSetterCommon)((IPerkAddRangeToValueGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class PerkAddRangeToValue_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(PerkAddRangeToValueXmlWriteTranslation);
    ...
    public partial class PerkAddRangeToValueSetterCommon : APerkEntryPointEffectSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    PerkAddRangeToValueXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PerkAddRangeToValueXmlWriteTranslation :
        APerkEntryPointEffectXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static PerkAddRangeToValueXmlWriteTranslation Instance = new PerkAddRangeToValueXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            APerkEntryPointEffectXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)PerkAddRangeToValue_FieldIndex.From) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.From),
                    item: item.From,
                    fieldIndex: (int)PerkAddRangeToValue_FieldIndex.From,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)PerkAddRangeToValue_FieldIndex.To) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.To),
                    item: item.To,
                    fieldIndex: (int)PerkAddRangeToValue_FieldIndex.To,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.PerkAddRangeToValue");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.PerkAddRangeToValue");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PerkAddRangeToValueXmlCreateTranslation : APerkEntryPointEffectXmlCreateTranslation
    {
        public new readonly static PerkAddRangeToValueXmlCreateTranslation Instance = new PerkAddRangeToValueXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "From":
                    errorMask?.PushIndex((int)PerkAddRangeToValue_FieldIndex.From);
                    try
                    {
                        item.From = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "To":
                    errorMask?.PushIndex((int)PerkAddRangeToValue_FieldIndex.To);
                    try
                    {
                        item.To = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PerkAddRangeToValueXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PerkAddRangeToValueXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
