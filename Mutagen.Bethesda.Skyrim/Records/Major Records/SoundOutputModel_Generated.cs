...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class SoundOutputModelCommon : SkyrimMajorRecordCommon
    {
            ...
            SoundOutputModel.Mask<bool?> checkMask)
        {
            ...
            if (checkMask.OutputChannels?.Overall.HasValue ?? false && checkMask.OutputChannels.Overall.Value != (item.OutputChannels != null)) return false;
            if (checkMask.OutputChannels?.Specific != null && (item.OutputChannels == null || !item.OutputChannels.HasBeenSet(checkMask.OutputChannels.Specific))) return false;
            if (checkMask.Attenuation?.Overall.HasValue ?? false && checkMask.Attenuation.Overall.Value != (item.Attenuation != null)) return false;
            if (checkMask.Attenuation?.Specific != null && (item.Attenuation == null || !item.Attenuation.HasBeenSet(checkMask.Attenuation.Specific))) return false;
            ...
            SoundOutputModel.Mask<bool> mask)
        {
            ...
            mask.Data = new MaskItem<bool, SoundOutputData.Mask<bool>?>(itemData != null, itemData?.GetHasBeenSetMask());
            mask.FNAM = (item.FNAM != null);
            mask.Type = (item.Type != null);
            mask.CNAM = (item.CNAM != null);
            mask.SNAM = (item.SNAM != null);
            var itemOutputChannels = item.OutputChannels;
            mask.OutputChannels = new MaskItem<bool, SoundOutputChannels.Mask<bool>?>(itemOutputChannels != null, itemOutputChannels?.GetHasBeenSetMask());
            var itemAttenuation = item.Attenuation;
            mask.Attenuation = new MaskItem<bool, SoundOutputAttenuation.Mask<bool>?>(itemAttenuation != null, itemAttenuation?.GetHasBeenSetMask());
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            SkyrimMajorRecordXmlWriteTranslation.WriteToNodeXml(
                ...
                translationMask: translationMask);
            if ((item.Data != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.Data) ?? true))
            {
                if (item.Data.TryGet(out var DataItem))
                {
                    ((SoundOutputDataXmlWriteTranslation)((IXmlItem)DataItem).XmlWriteTranslator).Write(
                        item: DataItem,
                        node: node,
                        name: nameof(item.Data),
                        fieldIndex: (int)SoundOutputModel_FieldIndex.Data,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.Data));
                }
            }
            if ((item.FNAM != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.FNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FNAM),
                    item: item.FNAM.Value,
                    fieldIndex: (int)SoundOutputModel_FieldIndex.FNAM,
                    errorMask: errorMask);
            }
            if ((item.Type != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.Type) ?? true))
            {
                EnumXmlTranslation<SoundOutputModel.TypeEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.Type),
                    item: item.Type,
                    fieldIndex: (int)SoundOutputModel_FieldIndex.Type,
                    errorMask: errorMask);
            }
            if ((item.CNAM != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.CNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.CNAM),
                    item: item.CNAM.Value,
                    fieldIndex: (int)SoundOutputModel_FieldIndex.CNAM,
                    errorMask: errorMask);
            }
            if ((item.SNAM != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.SNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SNAM),
                    item: item.SNAM.Value,
                    fieldIndex: (int)SoundOutputModel_FieldIndex.SNAM,
                    errorMask: errorMask);
            }
            if ((item.OutputChannels != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.OutputChannels) ?? true))
            {
                if (item.OutputChannels.TryGet(out var OutputChannelsItem))
                {
                    ((SoundOutputChannelsXmlWriteTranslation)((IXmlItem)OutputChannelsItem).XmlWriteTranslator).Write(
                        item: OutputChannelsItem,
                        node: node,
                        name: nameof(item.OutputChannels),
                        fieldIndex: (int)SoundOutputModel_FieldIndex.OutputChannels,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.OutputChannels));
                }
            }
            if ((item.Attenuation != null)
                && (translationMask?.GetShouldTranslate((int)SoundOutputModel_FieldIndex.Attenuation) ?? true))
            {
                if (item.Attenuation.TryGet(out var AttenuationItem))
                {
                    ((SoundOutputAttenuationXmlWriteTranslation)((IXmlItem)AttenuationItem).XmlWriteTranslator).Write(
                        item: AttenuationItem,
                        node: node,
                        name: nameof(item.Attenuation),
                        fieldIndex: (int)SoundOutputModel_FieldIndex.Attenuation,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.Attenuation));
                }
            }
        }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "Data":
                    ...
                    try
                    {
                        item.Data = LoquiXmlTranslation<SoundOutputData>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.Data));
                    }
                    ...
                    break;
                case "FNAM":
                    errorMask?.PushIndex((int)SoundOutputModel_FieldIndex.FNAM);
                    try
                    {
                    ...
                    break;
                case "Type":
                    errorMask?.PushIndex((int)SoundOutputModel_FieldIndex.Type);
                    try
                    {
                        item.Type = EnumXmlTranslation<SoundOutputModel.TypeEnum>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "CNAM":
                    errorMask?.PushIndex((int)SoundOutputModel_FieldIndex.CNAM);
                    try
                    {
                    ...
                    break;
                case "SNAM":
                    errorMask?.PushIndex((int)SoundOutputModel_FieldIndex.SNAM);
                    try
                    {
                        item.SNAM = ByteArrayXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "OutputChannels":
                    ...
                    try
                    {
                        item.OutputChannels = LoquiXmlTranslation<SoundOutputChannels>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.OutputChannels));
                    }
                ...
                case "Attenuation":
                    ...
                    try
                    {
                        item.Attenuation = LoquiXmlTranslation<SoundOutputAttenuation>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)SoundOutputModel_FieldIndex.Attenuation));
                    }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ISoundOutputModelGetter
    {
        ...
        public SoundOutputModel.TypeEnum? Type => _TypeLocation.HasValue ? (SoundOutputModel.TypeEnum)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _TypeLocation!.Value, _package.MetaData.Constants)) : default(SoundOutputModel.TypeEnum?);
        #endregion
        #region CNAM
