...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => BookSkillXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((BookSkillXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new BookSkill CreateFromXml(
            XElement node,
            BookSkill.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static BookSkill CreateFromXml(
            XElement node,
        ...
        public new static BookSkill CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new BookSkill();
            ((BookSkillSetterCommon)((IBookSkillGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        [DebuggerStepThrough]
        public static new BookSkill CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((IBookSkillGetter)rhs, include);
    ...
    public static partial class BookSkillMixIn
    {
        ...
        {
            return ((BookSkillCommon)((IBookSkillGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static BookSkill.Mask<bool> GetHasBeenSetMask(this IBookSkillGetter item)
        {
            var ret = new BookSkill.Mask<bool>(false);
            ((BookSkillCommon)((IBookSkillGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((BookSkillSetterCommon)((IBookSkillGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class BookSkill_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "SKILL":
                    return (ushort)BookSkill_FieldIndex.Skill;
                default:
                    return null;
            }
        }
        ...
        public static readonly Type XmlWriteTranslation = typeof(BookSkillXmlWriteTranslation);
    ...
    public partial class BookSkillSetterCommon : BookTeachTargetSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    BookSkillXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class BookSkillCommon : BookTeachTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IBookSkillGetter obj)
        {
        ...
        public void RemapLinks(IBookSkillGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class BookSkillXmlWriteTranslation :
        BookTeachTargetXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static BookSkillXmlWriteTranslation Instance = new BookSkillXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
                ...
                && (translationMask?.GetShouldTranslate((int)BookSkill_FieldIndex.Skill) ?? true))
            {
                EnumXmlTranslation<Skill>.Instance.Write(
                    ...
                    item: item.Skill,
                    fieldIndex: (int)BookSkill_FieldIndex.Skill,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.BookSkill");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.BookSkill");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class BookSkillXmlCreateTranslation : BookTeachTargetXmlCreateTranslation
    {
        public new readonly static BookSkillXmlCreateTranslation Instance = new BookSkillXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Skill":
                    errorMask?.PushIndex((int)BookSkill_FieldIndex.Skill);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class BookSkillXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((BookSkillXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
