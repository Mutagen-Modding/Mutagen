...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Explosion>
    {
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query) => ExplosionSetterCommon.Instance.RemapAssetLinks(this, mapping, query);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ExplosionSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapAssetLinks(IExplosion obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query)
        {
    ...
    internal partial class ExplosionCommon : SkyrimMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Explosion_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.VirtualMachineAdapter, rhs.VirtualMachineAdapter, out var lhsVirtualMachineAdapter, out var rhsVirtualMachineAdapter, out var isVirtualMachineAdapterEqual))
                {
                    if (!((VirtualMachineAdapterCommon)((IVirtualMachineAdapterGetter)lhsVirtualMachineAdapter).CommonInstance()!).Equals(lhsVirtualMachineAdapter, rhsVirtualMachineAdapter, equalsMask?.GetSubCrystal((int)Explosion_FieldIndex.VirtualMachineAdapter))) return false;
                }
