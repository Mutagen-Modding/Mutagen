...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IExplosionGetter>
    {
        ...
        public override IEnumerable<FormLinkInformation> LinkFormKeys => ExplosionCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ExplosionCommon : SkyrimMajorRecordCommon
    {
        ...
        {
            var ret = new Explosion(getNextFormKey(), ((IExplosionGetter)item).FormVersion);
