...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<ICellNavigationMeshDataGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => CellNavigationMeshDataCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => CellNavigationMeshDataCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class CellNavigationMeshDataCommon : ANavigationMeshDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(ICellNavigationMeshDataGetter obj)
        {
