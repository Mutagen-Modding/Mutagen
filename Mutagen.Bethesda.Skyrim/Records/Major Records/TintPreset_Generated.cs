...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ITintPreset
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((TintPresetCommon)((ITintPresetGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(ITintPresetGetter? obj)
        {
            return ((TintPresetCommon)((ITintPresetGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(TintPreset.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, TintPreset.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(TintPreset.Mask<TItem>)} =>");
                using (sb.Brace())
                {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => TintPresetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
    ...
    public static partial class TintPresetMixIn
    {
        ...
        {
            return ((TintPresetCommon)((ITintPresetGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            TintPreset.Mask<bool>? printMask = null)
        {
            ((TintPresetCommon)((ITintPresetGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
{
    #region Field Index
    internal enum TintPreset_FieldIndex
    {
        Color = 0,
        DefaultValue = 1,
        Index = 2,
    ...
    #region Registration
    internal partial class TintPreset_Registration : ILoquiRegistration
    {
    ...
    #region Common
    internal partial class TintPresetSetterCommon
    {
    ...
    internal partial class TintPresetCommon
    {
            ...
            TintPreset.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"TintPreset =>");
            }
            else
            {
                sb.AppendLine($"{name} (TintPreset) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)TintPreset_FieldIndex.Color) ?? true))
            {
                if (!lhs.Color.Equals(rhs.Color)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)TintPreset_FieldIndex.DefaultValue) ?? true))
            {
                if (!lhs.DefaultValue.EqualsWithin(rhs.DefaultValue)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)TintPreset_FieldIndex.Index) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ITintPresetGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class TintPresetSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    public partial class TintPreset
    {
        ...
        public static ILoquiRegistration StaticRegistration => TintPreset_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Skyrim
{
    internal partial class TintPresetBinaryOverlay :
        PluginBinaryOverlay,
        ITintPresetGetter
    {
        #region Common Routing
