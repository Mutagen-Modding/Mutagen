...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class RegionData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Skyrim.RegionData";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "ICONS":
                    return (ushort)RegionData_FieldIndex.Icons;
                default:
                    return null;
            }
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class RegionDataXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((item.Icons != null)
                && (translationMask?.GetShouldTranslate((int)RegionData_FieldIndex.Icons) ?? true))
            {
                if (item.Icons.TryGet(out var IconsItem))
                {
                    ((IconsXmlWriteTranslation)((IXmlItem)IconsItem).XmlWriteTranslator).Write(
                        ...
                        fieldIndex: (int)RegionData_FieldIndex.Icons,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)RegionData_FieldIndex.Icons));
                }
            }
        }
        ...
        public virtual void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionData");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionData");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
