...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LoadScreen>
    {
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query) => LoadScreenSetterCommon.Instance.RemapAssetLinks(this, mapping, query);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class LoadScreenSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapAssetLinks(ILoadScreen obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query)
        {
            ...
            obj.Icons?.RemapAssetLinks(mapping, query);
        }
