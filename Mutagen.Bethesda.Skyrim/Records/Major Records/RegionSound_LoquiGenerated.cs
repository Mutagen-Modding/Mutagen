...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        IFormLink<ISoundDescriptorGetter> IRegionSoundGetter.Sound => this.Sound;
        #endregion
        #region Flags
        ...
        #region Mutagen
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IEnumerable<FormKey> LinkFormKeys => RegionSoundCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => RegionSoundCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class RegionSoundCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IRegionSoundGetter obj)
        {
            yield return obj.Sound.FormKey;
            yield break;
        }
        
        public void RemapLinks(IRegionSoundGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class RegionSoundXmlWriteTranslation : IXmlWriteTranslator
    {
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionSound");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionSound");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IRegionSoundGetter
    {
        ...
        public IFormLink<ISoundDescriptorGetter> Sound => new FormLink<ISoundDescriptorGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(0x0, 0x4))));
