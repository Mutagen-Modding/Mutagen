...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Alpha>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((AlphaCommon)((IAlphaGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IAlphaGetter? obj)
        {
            return ((AlphaCommon)((IAlphaGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class AlphaCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Alpha_FieldIndex.Cutoff) ?? true))
            {
                if (lhs.Cutoff != rhs.Cutoff) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Alpha_FieldIndex.Base) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAlphaGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
