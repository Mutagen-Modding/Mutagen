...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<CellBlock>
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => CellBlockCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class CellBlockCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)CellBlock_FieldIndex.Unknown) ?? true))
            {
                if (lhs.Unknown != rhs.Unknown) return false;
            }
            if ((crystal?.GetShouldTranslate((int)CellBlock_FieldIndex.SubBlocks) ?? true))
            {
                if (!lhs.SubBlocks.SequenceEqual(rhs.SubBlocks, (l, r) => ((CellSubBlockCommon)((ICellSubBlockGetter)l).CommonInstance()!).Equals(l, r, crystal?.GetSubCrystal((int)CellBlock_FieldIndex.SubBlocks)))) return false;
            }
            return true;
        }
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(ICellBlockGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
