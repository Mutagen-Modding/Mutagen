...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<ArmorAddon>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => ArmorAddonCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Skyrim.Internals.RecordTypeInts.ARMA)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ArmorAddonSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IArmorAddon obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
            base.RemapListedAssetLinks(obj, mapping);
            obj.WorldModel?.ForEach(x => x?.RemapListedAssetLinks(mapping));
            obj.FirstPersonModel?.ForEach(x => x?.RemapListedAssetLinks(mapping));
        }
    ...
    internal partial class ArmorAddonCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IArmorAddonGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
