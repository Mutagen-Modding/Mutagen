...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        public bool Equals(ImageSpaceHdr obj)
        {
        ...
        protected object XmlWriteTranslator => ImageSpaceHdrXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ImageSpaceHdrXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static ImageSpaceHdr CreateFromXml(
            XElement node,
            ImageSpaceHdr.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((ImageSpaceHdrSetterCommon)((IImageSpaceHdrGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = ImageSpaceHdr_Registration.TriggeringRecordType;
        #endregion
    ...
    public static partial class ImageSpaceHdrMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ImageSpaceHdrSetterCommon)((IImageSpaceHdrGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ImageSpaceHdr_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(ImageSpaceHdrXmlWriteTranslation);
    ...
    public partial class ImageSpaceHdrSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ImageSpaceHdrXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            frame = frame.SpawnWithFinalPosition(HeaderTranslation.ParseSubrecord(
                frame.Reader,
                recordTypeConverter.ConvertToCustom(ImageSpaceHdr_Registration.HNAM_HEADER)));
    ...
    public partial class ImageSpaceHdrCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IImageSpaceHdrGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ImageSpaceHdrXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static ImageSpaceHdrXmlWriteTranslation Instance = new ImageSpaceHdrXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.EyeAdaptSpeed) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.EyeAdaptSpeed),
                    item: item.EyeAdaptSpeed,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.EyeAdaptSpeed,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.BloomBlurRadius) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BloomBlurRadius),
                    item: item.BloomBlurRadius,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.BloomBlurRadius,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.BloomThreshold) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BloomThreshold),
                    item: item.BloomThreshold,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.BloomThreshold,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.BloomScale) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BloomScale),
                    item: item.BloomScale,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.BloomScale,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.ReceiveBloomThreshold) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ReceiveBloomThreshold),
                    item: item.ReceiveBloomThreshold,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.ReceiveBloomThreshold,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.White) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.White),
                    item: item.White,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.White,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.SunlightScale) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SunlightScale),
                    item: item.SunlightScale,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.SunlightScale,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.SkyScale) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SkyScale),
                    item: item.SkyScale,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.SkyScale,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ImageSpaceHdr_FieldIndex.EyeAdaptStrength) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.EyeAdaptStrength),
                    item: item.EyeAdaptStrength,
                    fieldIndex: (int)ImageSpaceHdr_FieldIndex.EyeAdaptStrength,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ImageSpaceHdr");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ImageSpaceHdr");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ImageSpaceHdrXmlCreateTranslation
    {
        public readonly static ImageSpaceHdrXmlCreateTranslation Instance = new ImageSpaceHdrXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "EyeAdaptSpeed":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.EyeAdaptSpeed);
                    try
                    {
                    ...
                    break;
                case "BloomBlurRadius":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.BloomBlurRadius);
                    try
                    {
                        item.BloomBlurRadius = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BloomThreshold":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.BloomThreshold);
                    try
                    {
                        item.BloomThreshold = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BloomScale":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.BloomScale);
                    try
                    {
                        item.BloomScale = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "ReceiveBloomThreshold":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.ReceiveBloomThreshold);
                    try
                    {
                        item.ReceiveBloomThreshold = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "White":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.White);
                    try
                    {
                        item.White = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "SunlightScale":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.SunlightScale);
                    try
                    {
                        item.SunlightScale = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "SkyScale":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.SkyScale);
                    try
                    {
                        item.SkyScale = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "EyeAdaptStrength":
                    errorMask?.PushIndex((int)ImageSpaceHdr_FieldIndex.EyeAdaptStrength);
                    try
                    {
                        item.EyeAdaptStrength = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ImageSpaceHdrXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ImageSpaceHdrXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
    ...
    public partial class ImageSpaceHdrBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(ImageSpaceHdr_Registration.HNAM_HEADER),
