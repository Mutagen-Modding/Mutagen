...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class CombatStyle_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "OFFENSIVEMULT":
                    return (ushort)CombatStyle_FieldIndex.OffensiveMult;
                case "DEFENSIVEMULT":
                    return (ushort)CombatStyle_FieldIndex.DefensiveMult;
                case "GROUPOFFENSIVEMULT":
                    return (ushort)CombatStyle_FieldIndex.GroupOffensiveMult;
                case "EQUIPMENTSCOREMULTMELEE":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultMelee;
                case "EQUIPMENTSCOREMULTMAGIC":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultMagic;
                case "EQUIPMENTSCOREMULTRANGED":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultRanged;
                case "EQUIPMENTSCOREMULTSHOUT":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultShout;
                case "EQUIPMENTSCOREMULTUNARMED":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultUnarmed;
                case "EQUIPMENTSCOREMULTSTAFF":
                    return (ushort)CombatStyle_FieldIndex.EquipmentScoreMultStaff;
                case "AVOIDTHREATCHANCE":
                    return (ushort)CombatStyle_FieldIndex.AvoidThreatChance;
                case "CSMD":
                    return (ushort)CombatStyle_FieldIndex.CSMD;
                case "MELEE":
                    return (ushort)CombatStyle_FieldIndex.Melee;
                case "CLOSERANGE":
                    return (ushort)CombatStyle_FieldIndex.CloseRange;
                case "LONGRANGESTRAFEMULT":
                    return (ushort)CombatStyle_FieldIndex.LongRangeStrafeMult;
                case "FLIGHT":
                    return (ushort)CombatStyle_FieldIndex.Flight;
                case "FLAGS":
                    return (ushort)CombatStyle_FieldIndex.Flags;
                case "CSGDDATATYPESTATE":
                    return (ushort)CombatStyle_FieldIndex.CSGDDataTypeState;
                default:
                    return null;
            }
        }
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            switch (enu)
            {
                ...
                case CombatStyle_FieldIndex.Melee:
                    return typeof(CombatStyleMelee);
                case CombatStyle_FieldIndex.CloseRange:
                    return typeof(CombatStyleCloseRange);
                case CombatStyle_FieldIndex.LongRangeStrafeMult:
                    return typeof(Single);
                case CombatStyle_FieldIndex.Flight:
                    return typeof(CombatStyleFlight);
                case CombatStyle_FieldIndex.Flags:
                    return typeof(CombatStyle.Flag);
                case CombatStyle_FieldIndex.CSGDDataTypeState:
                    return typeof(CombatStyle.CSGDDataType);
                default:
