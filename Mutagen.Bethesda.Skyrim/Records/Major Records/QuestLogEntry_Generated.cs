...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class QuestLogEntryCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IQuestLogEntryGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class QuestLogEntryBinaryWriteTranslation : IBinaryWriteTranslator
    {
        ...
        public static void WriteRecordTypes(
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            Mutagen.Bethesda.Records.Binary.Translations.EnumBinaryTranslation<QuestLogEntry.Flag>.Instance.WriteNullable(
                writer,
                item.Flags,
                length: 1,
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.QSDT:
                {
                    ...
                    item.Flags = EnumBinaryTranslation<QuestLogEntry.Flag>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
                ...
                case RecordTypeInts.CNAM:
                {
                    ...
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Entry = Mutagen.Bethesda.Records.Binary.Translations.StringBinaryTranslation.Instance.Parse(
