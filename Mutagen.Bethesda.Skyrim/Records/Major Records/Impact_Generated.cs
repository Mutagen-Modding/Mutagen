...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Impact>
    {
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query) => ImpactSetterCommon.Instance.RemapAssetLinks(this, mapping, query);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ImpactSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapAssetLinks(IImpact obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery query)
        {
