...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IPlacedTrapGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => PlacedTrapCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => PlacedTrapCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class PlacedTrapCommon : APlacedTrapCommon
    {
        ...
        public static new PlacedTrap_FieldIndex ConvertFieldIndex(APlaced_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(IPlacedTrapGetter obj)
        {
        ...
        {
            var ret = new PlacedTrap(getNextFormKey(), ((IPlacedTrapGetter)item).FormVersion);
