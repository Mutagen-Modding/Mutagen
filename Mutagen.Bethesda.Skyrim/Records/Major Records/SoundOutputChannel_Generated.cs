...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        public bool Equals(SoundOutputChannel? obj)
        {
        ...
        protected object XmlWriteTranslator => SoundOutputChannelXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((SoundOutputChannelXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static SoundOutputChannel CreateFromXml(
            XElement node,
            SoundOutputChannel.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((SoundOutputChannelSetterCommon)((ISoundOutputChannelGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class SoundOutputChannelMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((SoundOutputChannelSetterCommon)((ISoundOutputChannelGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class SoundOutputChannel_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "L":
                    return (ushort)SoundOutputChannel_FieldIndex.L;
                case "R":
                    return (ushort)SoundOutputChannel_FieldIndex.R;
                case "C":
                    return (ushort)SoundOutputChannel_FieldIndex.C;
                case "LFE":
                    return (ushort)SoundOutputChannel_FieldIndex.LFE;
                case "RL":
                    return (ushort)SoundOutputChannel_FieldIndex.RL;
                case "RR":
                    return (ushort)SoundOutputChannel_FieldIndex.RR;
                case "BL":
                    return (ushort)SoundOutputChannel_FieldIndex.BL;
                case "BR":
                    return (ushort)SoundOutputChannel_FieldIndex.BR;
                default:
                    return null;
            }
        }
        ...
        public static readonly Type XmlWriteTranslation = typeof(SoundOutputChannelXmlWriteTranslation);
    ...
    public partial class SoundOutputChannelSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    SoundOutputChannelXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class SoundOutputChannelXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static SoundOutputChannelXmlWriteTranslation Instance = new SoundOutputChannelXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.L) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.L),
                    item: item.L,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.L,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.R) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.R),
                    item: item.R,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.R,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.C) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.C),
                    item: item.C,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.C,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.LFE) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LFE),
                    item: item.LFE,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.LFE,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.RL) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RL),
                    item: item.RL,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.RL,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.RR) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RR),
                    item: item.RR,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.RR,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.BL) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BL),
                    item: item.BL,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.BL,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundOutputChannel_FieldIndex.BR) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BR),
                    item: item.BR,
                    fieldIndex: (int)SoundOutputChannel_FieldIndex.BR,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.SoundOutputChannel");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.SoundOutputChannel");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class SoundOutputChannelXmlCreateTranslation
    {
        public readonly static SoundOutputChannelXmlCreateTranslation Instance = new SoundOutputChannelXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "L":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.L);
                    try
                    {
                        item.L = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "R":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.R);
                    try
                    {
                        item.R = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "C":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.C);
                    try
                    {
                        item.C = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "LFE":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.LFE);
                    try
                    {
                        item.LFE = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "RL":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.RL);
                    try
                    {
                        item.RL = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "RR":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.RR);
                    try
                    {
                        item.RR = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BL":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.BL);
                    try
                    {
                        item.BL = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BR":
                    errorMask?.PushIndex((int)SoundOutputChannel_FieldIndex.BR);
                    try
                    {
                        item.BR = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class SoundOutputChannelXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((SoundOutputChannelXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
