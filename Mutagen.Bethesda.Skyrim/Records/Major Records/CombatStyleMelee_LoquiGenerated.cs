...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        public bool Equals(CombatStyleMelee obj)
        {
        ...
        protected object XmlWriteTranslator => CombatStyleMeleeXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((CombatStyleMeleeXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static CombatStyleMelee CreateFromXml(
            XElement node,
            CombatStyleMelee.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((CombatStyleMeleeSetterCommon)((ICombatStyleMeleeGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = CombatStyleMelee_Registration.TriggeringRecordType;
        [Flags]
        ...
        [DebuggerStepThrough]
        public static CombatStyleMelee CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((ICombatStyleMeleeGetter)rhs, include);
    ...
    public static partial class CombatStyleMeleeMixIn
    {
        ...
        public static bool HasBeenSet(
            this ICombatStyleMeleeGetter item,
            CombatStyleMelee.Mask<bool?> checkMask)
        {
            return ((CombatStyleMeleeCommon)((ICombatStyleMeleeGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static CombatStyleMelee.Mask<bool> GetHasBeenSetMask(this ICombatStyleMeleeGetter item)
        {
            var ret = new CombatStyleMelee.Mask<bool>(false);
            ((CombatStyleMeleeCommon)((ICombatStyleMeleeGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((CombatStyleMeleeSetterCommon)((ICombatStyleMeleeGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class CombatStyleMeleeSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    CombatStyleMeleeXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class CombatStyleMeleeCommon
    {
        ...
        public void FillHasBeenSetMask(
            ICombatStyleMeleeGetter item,
            CombatStyleMelee.Mask<bool> mask)
        {
            mask.Versioning = true;
            mask.AttackStaggeredMult = true;
            mask.PowerAttackStaggeredMult = true;
            mask.PowerAttackBlockingMult = true;
            mask.BashMult = true;
            mask.BashRecoilMult = true;
            mask.BashAttackMult = true;
            mask.BashPowerAttackMult = true;
            mask.SpecialAttackMult = true;
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class CombatStyleMeleeXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static CombatStyleMeleeXmlWriteTranslation Instance = new CombatStyleMeleeXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.Versioning) ?? true))
            {
                EnumXmlTranslation<CombatStyleMelee.VersioningBreaks>.Instance.Write(
                    node: node,
                    name: nameof(item.Versioning),
                    item: item.Versioning,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.Versioning,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.AttackStaggeredMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.AttackStaggeredMult),
                    item: item.AttackStaggeredMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.AttackStaggeredMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.PowerAttackStaggeredMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PowerAttackStaggeredMult),
                    item: item.PowerAttackStaggeredMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.PowerAttackStaggeredMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.PowerAttackBlockingMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PowerAttackBlockingMult),
                    item: item.PowerAttackBlockingMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.PowerAttackBlockingMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.BashMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BashMult),
                    item: item.BashMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.BashMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.BashRecoilMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BashRecoilMult),
                    item: item.BashRecoilMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.BashRecoilMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.BashAttackMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BashAttackMult),
                    item: item.BashAttackMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.BashAttackMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.BashPowerAttackMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BashPowerAttackMult),
                    item: item.BashPowerAttackMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.BashPowerAttackMult,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)CombatStyleMelee_FieldIndex.SpecialAttackMult) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SpecialAttackMult),
                    item: item.SpecialAttackMult,
                    fieldIndex: (int)CombatStyleMelee_FieldIndex.SpecialAttackMult,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.CombatStyleMelee");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.CombatStyleMelee");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class CombatStyleMeleeXmlCreateTranslation
    {
        public readonly static CombatStyleMeleeXmlCreateTranslation Instance = new CombatStyleMeleeXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Versioning":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.Versioning);
                    try
                    {
                        item.Versioning = EnumXmlTranslation<CombatStyleMelee.VersioningBreaks>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "AttackStaggeredMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.AttackStaggeredMult);
                    try
                    {
                        item.AttackStaggeredMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "PowerAttackStaggeredMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.PowerAttackStaggeredMult);
                    try
                    {
                        item.PowerAttackStaggeredMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "PowerAttackBlockingMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.PowerAttackBlockingMult);
                    try
                    {
                        item.PowerAttackBlockingMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BashMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.BashMult);
                    try
                    {
                        item.BashMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BashRecoilMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.BashRecoilMult);
                    try
                    {
                        item.BashRecoilMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BashAttackMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.BashAttackMult);
                    try
                    {
                        item.BashAttackMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "BashPowerAttackMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.BashPowerAttackMult);
                    try
                    {
                        item.BashPowerAttackMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "SpecialAttackMult":
                    errorMask?.PushIndex((int)CombatStyleMelee_FieldIndex.SpecialAttackMult);
                    try
                    {
                        item.SpecialAttackMult = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class CombatStyleMeleeXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((CombatStyleMeleeXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
