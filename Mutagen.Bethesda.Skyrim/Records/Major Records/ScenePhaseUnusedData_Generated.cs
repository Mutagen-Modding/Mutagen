...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IScenePhaseUnusedData
    {
        ...
        public void Print(
            ...
            string? name = null)
        {
            ScenePhaseUnusedDataMixIn.Print(
                item: this,
                sb: sb,
                name: name);
        }
            ...
            IMask<TItem>
        {
            ...
            public string Print(ScenePhaseUnusedData.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, ScenePhaseUnusedData.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(ScenePhaseUnusedData.Mask<TItem>)} =>");
                using (sb.Brace())
                {
    ...
    public static partial class ScenePhaseUnusedDataMixIn
    {
        ...
        {
            return ((ScenePhaseUnusedDataCommon)((IScenePhaseUnusedDataGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            ScenePhaseUnusedData.Mask<bool>? printMask = null)
        {
            ((ScenePhaseUnusedDataCommon)((IScenePhaseUnusedDataGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class ScenePhaseUnusedDataCommon
    {
            ...
            ScenePhaseUnusedData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"ScenePhaseUnusedData =>");
            }
            else
            {
                sb.AppendLine($"{name} (ScenePhaseUnusedData) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
    ...
    internal partial class ScenePhaseUnusedDataBinaryCreateTranslation
    {
            ...
            TypedParseParams? translationParams = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)ScenePhaseUnusedData_FieldIndex.SCHR, translationParams)) return ParseResult.Stop;
                ...
                {
                    if (lastParsed.ShortCircuit((int)ScenePhaseUnusedData_FieldIndex.SCDA, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                ...
                {
                    if (lastParsed.ShortCircuit((int)ScenePhaseUnusedData_FieldIndex.SCTX, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                ...
                {
                    if (lastParsed.ShortCircuit((int)ScenePhaseUnusedData_FieldIndex.QNAM, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                ...
                {
                    if (lastParsed.ShortCircuit((int)ScenePhaseUnusedData_FieldIndex.SCRO, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
