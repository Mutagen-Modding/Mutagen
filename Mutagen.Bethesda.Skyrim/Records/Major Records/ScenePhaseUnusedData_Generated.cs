...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => ScenePhaseUnusedDataXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ScenePhaseUnusedDataXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static ScenePhaseUnusedData CreateFromXml(
            XElement node,
            ScenePhaseUnusedData.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((ScenePhaseUnusedDataSetterCommon)((IScenePhaseUnusedDataGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class ScenePhaseUnusedDataMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ScenePhaseUnusedDataSetterCommon)((IScenePhaseUnusedDataGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ScenePhaseUnusedData_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(ScenePhaseUnusedDataXmlWriteTranslation);
    ...
    public partial class ScenePhaseUnusedDataSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ScenePhaseUnusedDataXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ScenePhaseUnusedDataXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static ScenePhaseUnusedDataXmlWriteTranslation Instance = new ScenePhaseUnusedDataXmlWriteTranslation();
        ...
        {
            if ((item.SCHR != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhaseUnusedData_FieldIndex.SCHR) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SCHR),
                    item: item.SCHR.Value,
                    fieldIndex: (int)ScenePhaseUnusedData_FieldIndex.SCHR,
                    errorMask: errorMask);
            }
            if ((item.SCDA != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhaseUnusedData_FieldIndex.SCDA) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SCDA),
                    item: item.SCDA.Value,
                    fieldIndex: (int)ScenePhaseUnusedData_FieldIndex.SCDA,
                    errorMask: errorMask);
            }
            if ((item.SCTX != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhaseUnusedData_FieldIndex.SCTX) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SCTX),
                    item: item.SCTX.Value,
                    fieldIndex: (int)ScenePhaseUnusedData_FieldIndex.SCTX,
                    errorMask: errorMask);
            }
            if ((item.QNAM != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhaseUnusedData_FieldIndex.QNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.QNAM),
                    item: item.QNAM.Value,
                    fieldIndex: (int)ScenePhaseUnusedData_FieldIndex.QNAM,
                    errorMask: errorMask);
            }
            if ((item.SCRO != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhaseUnusedData_FieldIndex.SCRO) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SCRO),
                    item: item.SCRO.Value,
                    fieldIndex: (int)ScenePhaseUnusedData_FieldIndex.SCRO,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ScenePhaseUnusedData");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ScenePhaseUnusedData");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ScenePhaseUnusedDataXmlCreateTranslation
    {
        public readonly static ScenePhaseUnusedDataXmlCreateTranslation Instance = new ScenePhaseUnusedDataXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "SCHR":
                    errorMask?.PushIndex((int)ScenePhaseUnusedData_FieldIndex.SCHR);
                    try
                    {
                    ...
                    break;
                case "SCDA":
                    errorMask?.PushIndex((int)ScenePhaseUnusedData_FieldIndex.SCDA);
                    try
                    {
                        item.SCDA = ByteArrayXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "SCTX":
                    errorMask?.PushIndex((int)ScenePhaseUnusedData_FieldIndex.SCTX);
                    try
                    {
                    ...
                    break;
                case "QNAM":
                    errorMask?.PushIndex((int)ScenePhaseUnusedData_FieldIndex.QNAM);
                    try
                    {
                    ...
                    break;
                case "SCRO":
                    errorMask?.PushIndex((int)ScenePhaseUnusedData_FieldIndex.SCRO);
                    try
                    {
                        item.SCRO = ByteArrayXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ScenePhaseUnusedDataXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ScenePhaseUnusedDataXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
