...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IWorldspaceNavigationMeshDataGetter>
    {
        ...
        protected override IEnumerable<FormLinkInformation> LinkFormKeys => WorldspaceNavigationMeshDataCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormLinkInformation> ILinkedFormKeyContainerGetter.LinkFormKeys => WorldspaceNavigationMeshDataCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class WorldspaceNavigationMeshDataCommon : ANavigationMeshDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(IWorldspaceNavigationMeshDataGetter obj)
        {
