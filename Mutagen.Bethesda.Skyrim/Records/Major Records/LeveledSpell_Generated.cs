...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class LeveledSpellCommon : SkyrimMajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)LeveledSpell_FieldIndex.ObjectBounds) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.ObjectBounds, rhs.ObjectBounds, out var lhsObjectBounds, out var rhsObjectBounds, out var isObjectBoundsEqual))
                {
                    if (!((ObjectBoundsCommon)((IObjectBoundsGetter)lhsObjectBounds).CommonInstance()!).Equals(lhsObjectBounds, rhsObjectBounds, crystal?.GetSubCrystal((int)LeveledSpell_FieldIndex.ObjectBounds))) return false;
                }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ILeveledSpellGetter
    {
        ...
        public LeveledSpell.Flag Flags => _FlagsLocation.HasValue ? (LeveledSpell.Flag)HeaderTranslation.ExtractSubrecordMemory(_data, _FlagsLocation!.Value, _package.MetaData.Constants)[0] : default(LeveledSpell.Flag);
        #endregion
            ...
            TypedParseParams? parseParams = null)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.LLCT:
                {
                    this.Entries = BinaryOverlayList.FactoryByCountPerItem<LeveledSpellEntryBinaryOverlay>(
                        stream: stream,
                        package: _package,
                        countLength: 1,
                        allRecordTypes: LeveledSpellEntry_Registration.AllRecordTypes,
