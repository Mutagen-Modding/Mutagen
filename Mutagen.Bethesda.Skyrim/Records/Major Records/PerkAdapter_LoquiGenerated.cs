...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => PerkAdapterXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PerkAdapterXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new PerkAdapter CreateFromXml(
            XElement node,
            PerkAdapter.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static PerkAdapter CreateFromXml(
            XElement node,
        ...
        public new static PerkAdapter CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new PerkAdapter();
            ((PerkAdapterSetterCommon)((IPerkAdapterGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
            ...
            where TItem : notnull
        {
            ...
            public string ToString(PerkAdapter.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, PerkAdapter.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(PerkAdapter.Mask<TItem>)} =>");
                fg.AppendLine("[");
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = PerkAdapter_Registration.TriggeringRecordType;
        #endregion
    ...
    public partial interface IPerkAdapterGetter :
        ...
        IBinaryItem
    {
        static ILoquiRegistration Registration => PerkAdapter_Registration.Instance;
    ...
    public static partial class PerkAdapterMixIn
    {
        ...
        {
            return ((PerkAdapterCommon)((IPerkAdapterGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            PerkAdapter.Mask<bool>? printMask = null)
        {
            ((PerkAdapterCommon)((IPerkAdapterGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PerkAdapterSetterCommon)((IPerkAdapterGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class PerkAdapter_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                case "SCRIPTFRAGMENTS":
                    return (ushort)PerkAdapter_FieldIndex.ScriptFragments;
                default:
                    return null;
            }
        }
        ...
        public static Type GetNthType(ushort index)
        {
            ...
            {
                case PerkAdapter_FieldIndex.ScriptFragments:
                    return typeof(PerkScriptFragments);
                default:
                    return AVirtualMachineAdapter_Registration.GetNthType(index);
            }
        }

        public static readonly Type XmlWriteTranslation = typeof(PerkAdapterXmlWriteTranslation);
    ...
    public partial class PerkAdapterSetterCommon : AVirtualMachineAdapterSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    PerkAdapterXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class PerkAdapterCommon : AVirtualMachineAdapterCommon
    {
            ...
            PerkAdapter.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"PerkAdapter =>");
            }
            else
            {
                fg.AppendLine($"{name} (PerkAdapter) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        public void RemapLinks(IPerkAdapterGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PerkAdapterXmlWriteTranslation :
        AVirtualMachineAdapterXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static PerkAdapterXmlWriteTranslation Instance = new PerkAdapterXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((item.ScriptFragments != null)
                && (translationMask?.GetShouldTranslate((int)PerkAdapter_FieldIndex.ScriptFragments) ?? true))
            {
                if (item.ScriptFragments.TryGet(out var ScriptFragmentsItem))
                {
                    ((PerkScriptFragmentsXmlWriteTranslation)((IXmlItem)ScriptFragmentsItem).XmlWriteTranslator).Write(
                        item: ScriptFragmentsItem,
                        node: node,
                        name: nameof(item.ScriptFragments),
                        fieldIndex: (int)PerkAdapter_FieldIndex.ScriptFragments,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)PerkAdapter_FieldIndex.ScriptFragments));
                }
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.PerkAdapter");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.PerkAdapter");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PerkAdapterXmlCreateTranslation : AVirtualMachineAdapterXmlCreateTranslation
    {
        public new readonly static PerkAdapterXmlCreateTranslation Instance = new PerkAdapterXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "ScriptFragments":
                    ...
                    try
                    {
                        item.ScriptFragments = LoquiXmlTranslation<PerkScriptFragments>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)PerkAdapter_FieldIndex.ScriptFragments));
                    }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PerkAdapterXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PerkAdapterXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
