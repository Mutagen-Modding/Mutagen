...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<DefaultObjectManager>
    {
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                this.Objects = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, DefaultObject.Mask<TItem>?>>?>(initialValue, []);
            }
            ...
            {
                this.Objects = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, DefaultObject.Mask<TItem>?>>?>(Objects, []);
            }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Objects != null)
                {
                    obj.Objects = new MaskItem<R, IEnumerable<MaskItemIndexed<R, DefaultObject.Mask<R>?>>?>(eval(this.Objects.Overall), []);
                    if (Objects.Specific != null)
                    {
                        ...
                        {
                            MaskItemIndexed<R, DefaultObject.Mask<R>?>? mask = item == null ? null : new MaskItemIndexed<R, DefaultObject.Mask<R>?>(item.Index, eval(item.Overall), item.Specific?.Translate(eval));
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.Objects = new MaskItem<Exception?, IEnumerable<MaskItem<Exception?, DefaultObject.ErrorMask?>>?>(Noggog.ExceptionExt.Combine(this.Objects?.Overall, rhs.Objects?.Overall), Noggog.ExceptionExt.Combine(this.Objects?.Specific, rhs.Objects?.Specific));
                return ret;
            }
        ...
        {
            #region Members
            public DefaultObject.TranslationMask? Objects;
            #endregion
        ...
        public DefaultObjectManager(ISkyrimMod mod)
            : this(
                mod.GetNextFormKey(),
                mod.SkyrimRelease)
        {
        ...
        public DefaultObjectManager(ISkyrimMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Skyrim.Internals.RecordTypeInts.DOBJ)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class DefaultObjectManagerCommon : SkyrimMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            {
                if (!lhs.Objects.SequenceEqualNullable(rhs.Objects, (l, r) => ((DefaultObjectCommon)((IDefaultObjectGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)DefaultObjectManager_FieldIndex.Objects)))) return false;
            }
            return true;
        }
        ...
        IDefaultObjectManagerGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                case RecordTypeInts.DNAM:
                {
                    this.Objects = BinaryOverlayList.FactoryByStartIndexWithTrigger<IDefaultObjectGetter>(
                        stream: stream,
                        package: _package,
                        finalPos: finalPos,
                        itemLength: 8,
