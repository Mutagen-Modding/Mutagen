...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected object XmlWriteTranslator => SoundLoopAndRumbleXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((SoundLoopAndRumbleXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static SoundLoopAndRumble CreateFromXml(
            XElement node,
            SoundLoopAndRumble.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((SoundLoopAndRumbleSetterCommon)((ISoundLoopAndRumbleGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = SoundLoopAndRumble_Registration.TriggeringRecordType;
        #endregion
    ...
    public static partial class SoundLoopAndRumbleMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((SoundLoopAndRumbleSetterCommon)((ISoundLoopAndRumbleGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class SoundLoopAndRumble_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(SoundLoopAndRumbleXmlWriteTranslation);
    ...
    public partial class SoundLoopAndRumbleSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    SoundLoopAndRumbleXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class SoundLoopAndRumbleXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static SoundLoopAndRumbleXmlWriteTranslation Instance = new SoundLoopAndRumbleXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)SoundLoopAndRumble_FieldIndex.Unknown) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown),
                    item: item.Unknown,
                    fieldIndex: (int)SoundLoopAndRumble_FieldIndex.Unknown,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundLoopAndRumble_FieldIndex.Loop) ?? true))
            {
                EnumXmlTranslation<SoundDescriptor.LoopType>.Instance.Write(
                    node: node,
                    name: nameof(item.Loop),
                    item: item.Loop,
                    fieldIndex: (int)SoundLoopAndRumble_FieldIndex.Loop,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundLoopAndRumble_FieldIndex.Unknown2) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unknown2),
                    item: item.Unknown2,
                    fieldIndex: (int)SoundLoopAndRumble_FieldIndex.Unknown2,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)SoundLoopAndRumble_FieldIndex.RumbleValues) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RumbleValues),
                    item: item.RumbleValues,
                    fieldIndex: (int)SoundLoopAndRumble_FieldIndex.RumbleValues,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.SoundLoopAndRumble");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.SoundLoopAndRumble");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class SoundLoopAndRumbleXmlCreateTranslation
    {
        public readonly static SoundLoopAndRumbleXmlCreateTranslation Instance = new SoundLoopAndRumbleXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Unknown":
                    errorMask?.PushIndex((int)SoundLoopAndRumble_FieldIndex.Unknown);
                    try
                    {
                    ...
                    break;
                case "Loop":
                    errorMask?.PushIndex((int)SoundLoopAndRumble_FieldIndex.Loop);
                    try
                    {
                        item.Loop = EnumXmlTranslation<SoundDescriptor.LoopType>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "Unknown2":
                    errorMask?.PushIndex((int)SoundLoopAndRumble_FieldIndex.Unknown2);
                    try
                    {
                    ...
                    break;
                case "RumbleValues":
                    errorMask?.PushIndex((int)SoundLoopAndRumble_FieldIndex.RumbleValues);
                    try
                    {
                        item.RumbleValues = ByteXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class SoundLoopAndRumbleXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((SoundLoopAndRumbleXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
