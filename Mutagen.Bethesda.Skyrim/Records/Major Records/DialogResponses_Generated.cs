...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<IDialogResponsesGetter>
    {
        ...
        public override IEnumerable<FormLinkInformation> LinkFormKeys => DialogResponsesCommon.Instance.GetLinkFormKeys(this);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class DialogResponsesCommon : SkyrimMajorRecordCommon
    {
        ...
        {
            var ret = new DialogResponses(getNextFormKey(), ((IDialogResponsesGetter)item).FormVersion);
