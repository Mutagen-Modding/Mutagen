    ...
    namespace Internals
    {
        ...
        public partial class GameSettingBoolBinaryWriteTranslation
        {
            static partial void WriteBinaryDataCustom(MutagenWriter writer, IGameSettingBoolGetter item)
            {
                ...
                using (HeaderExport.Subrecord(writer, GameSettingBool_Registration.DATA_HEADER))
                {
        ...
        public partial class GameSettingBoolBinaryOverlay
        {
            ...
            bool GetDataCustom() => _DataLocation.HasValue ? BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _DataLocation.Value, _package.MetaData.Constants)) != 0 : default;
