...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        IFormLink<IProjectileGetter> IPlacedBeamGetter.Projectile => this.Projectile;
        #endregion
        ...
        {
            if (!(obj is IPlacedBeamGetter rhs)) return false;
            return ((PlacedBeamCommon)((IPlacedBeamGetter)this).CommonInstance()!).Equals(this, rhs);
        }

        public bool Equals(PlacedBeam? obj)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => PlacedBeamXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PlacedBeamXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new PlacedBeam CreateFromXml(
            XElement node,
            PlacedBeam.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static PlacedBeam CreateFromXml(
            XElement node,
        ...
        public new static PlacedBeam CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new PlacedBeam();
            ((PlacedBeamSetterCommon)((IPlacedBeamGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        public PlacedBeam(IMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public PlacedBeam(IMod mod, string editorID)
    ...
    public partial interface IPlacedBeamGetter :
        ...
        IBinaryItem
    {
        static ILoquiRegistration Registration => PlacedBeam_Registration.Instance;
    ...
    public static partial class PlacedBeamMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PlacedBeamSetterCommon)((IPlacedBeamGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class PlacedBeam_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "PROJECTILE":
                    return (ushort)PlacedBeam_FieldIndex.Projectile;
                default:
                    return null;
            }
        }
    ...
    public partial class PlacedBeamSetterCommon : APlacedTrapSetterCommon
    {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    FillPrivateElementXml(
                        ...
                        errorMask: errorMask,
                        translationMask: translationMask);
                    PlacedBeamXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
        ...
        public virtual void CopyInFromBinary(
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            UtilityTranslation.MajorRecordParse<IPlacedBeamInternal>(
                record: item,
                frame: frame,
                recordTypeConverter: recordTypeConverter,
    ...
    public partial class PlacedBeamCommon : APlacedTrapCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IPlacedBeamGetter obj)
        {
        ...
        public void RemapLinks(IPlacedBeamGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        partial void PostDuplicate(PlacedBeam obj, PlacedBeam rhs, Func<FormKey> getNextFormKey, IList<(IMajorRecordCommon Record, FormKey OriginalFormKey)>? duplicatedRecords);
        
        public override IMajorRecordCommon Duplicate(IMajorRecordCommonGetter item, Func<FormKey> getNextFormKey, IList<(IMajorRecordCommon Record, FormKey OriginalFormKey)>? duplicatedRecords)
        {
            var ret = new PlacedBeam(getNextFormKey());
            ret.DeepCopyIn((PlacedBeam)item);
            duplicatedRecords?.Add((ret, item.FormKey));
            PostDuplicate(ret, (PlacedBeam)item, getNextFormKey, duplicatedRecords);
            return ret;
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    public partial class PlacedBeam
    {
        ...
        public new static PlacedBeam_Registration Registration => PlacedBeam_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PlacedBeamXmlWriteTranslation :
        APlacedTrapXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static PlacedBeamXmlWriteTranslation Instance = new PlacedBeamXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            APlacedTrapXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)PlacedBeam_FieldIndex.Projectile) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Projectile),
                    item: item.Projectile.FormKey,
                    fieldIndex: (int)PlacedBeam_FieldIndex.Projectile,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.PlacedBeam");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.PlacedBeam");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PlacedBeamXmlCreateTranslation : APlacedTrapXmlCreateTranslation
    {
        public new readonly static PlacedBeamXmlCreateTranslation Instance = new PlacedBeamXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Projectile":
                    errorMask?.PushIndex((int)PlacedBeam_FieldIndex.Projectile);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PlacedBeamXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PlacedBeamXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
