...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => QuestLogEntryXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((QuestLogEntryXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static QuestLogEntry CreateFromXml(
            XElement node,
            QuestLogEntry.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((QuestLogEntrySetterCommon)((IQuestLogEntryGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class QuestLogEntryMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((QuestLogEntrySetterCommon)((IQuestLogEntryGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public partial class QuestLogEntrySetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    QuestLogEntryXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class QuestLogEntryXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static QuestLogEntryXmlWriteTranslation Instance = new QuestLogEntryXmlWriteTranslation();
        ...
        {
            if ((item.Flags != null)
                && (translationMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.Flags) ?? true))
            {
                EnumXmlTranslation<QuestLogEntry.Flag>.Instance.Write(
                    node: node,
                    name: nameof(item.Flags),
                    item: item.Flags,
                    fieldIndex: (int)QuestLogEntry_FieldIndex.Flags,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.Conditions) ?? true))
            {
                ListXmlTranslation<IConditionGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.Conditions),
                    item: item.Conditions,
                    fieldIndex: (int)QuestLogEntry_FieldIndex.Conditions,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)QuestLogEntry_FieldIndex.Conditions),
            ...
            if ((item.Entry != null)
                && (translationMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.Entry) ?? true))
            {
                Mutagen.Bethesda.Xml.TranslatedStringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Entry),
                    item: item.Entry,
                    fieldIndex: (int)QuestLogEntry_FieldIndex.Entry,
                    errorMask: errorMask);
            }
            if ((item.NextQuest.FormKey != null)
                && (translationMask?.GetShouldTranslate((int)QuestLogEntry_FieldIndex.NextQuest) ?? true))
            {
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.QuestLogEntry");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.QuestLogEntry");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class QuestLogEntryXmlCreateTranslation
    {
        public readonly static QuestLogEntryXmlCreateTranslation Instance = new QuestLogEntryXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Flags":
                    errorMask?.PushIndex((int)QuestLogEntry_FieldIndex.Flags);
                    try
                    {
                        item.Flags = EnumXmlTranslation<QuestLogEntry.Flag>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "Conditions":
                    ...
                    break;
                case "Entry":
                    errorMask?.PushIndex((int)QuestLogEntry_FieldIndex.Entry);
                    try
                    {
                    ...
                    break;
                case "NextQuest":
                    errorMask?.PushIndex((int)QuestLogEntry_FieldIndex.NextQuest);
                    try
                    {
                        item.NextQuest = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class QuestLogEntryXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((QuestLogEntryXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IQuestLogEntryGetter
    {
        ...
        public QuestLogEntry.Flag? Flags => _FlagsLocation.HasValue ? (QuestLogEntry.Flag)HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)[0] : default(QuestLogEntry.Flag?);
        #endregion
        #region Conditions
