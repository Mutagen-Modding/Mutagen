...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        protected virtual object XmlWriteTranslator => ANpcSoundDefinitionXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ANpcSoundDefinitionXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static ANpcSoundDefinition CreateFromXml(
            XElement node,
            ANpcSoundDefinition.TranslationMask? translationMask = null)
        {
        ...
        public static ANpcSoundDefinition CreateFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            if (!LoquiXmlTranslation.Instance.TryCreate<ANpcSoundDefinition>(node, out var ret, errorMask, translationMask))
            {
                throw new ArgumentException($"Unknown ANpcSoundDefinition subclass: {node.Name.LocalName}");
            }
            ((ANpcSoundDefinitionSetterCommon)((IANpcSoundDefinitionGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class ANpcSoundDefinitionMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ANpcSoundDefinitionSetterCommon)((IANpcSoundDefinitionGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ANpcSoundDefinitionXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static ANpcSoundDefinitionXmlWriteTranslation Instance = new ANpcSoundDefinitionXmlWriteTranslation();
        ...
        public virtual void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ANpcSoundDefinition");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ANpcSoundDefinition");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ANpcSoundDefinitionXmlCreateTranslation
    {
        public readonly static ANpcSoundDefinitionXmlCreateTranslation Instance = new ANpcSoundDefinitionXmlCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ANpcSoundDefinitionXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ANpcSoundDefinitionXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
