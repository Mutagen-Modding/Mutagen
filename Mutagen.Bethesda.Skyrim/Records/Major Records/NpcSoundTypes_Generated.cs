...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        INpcSoundTypes
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((NpcSoundTypesCommon)((INpcSoundTypesGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(INpcSoundTypesGetter? obj)
        {
            return ((NpcSoundTypesCommon)((INpcSoundTypesGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => NpcSoundTypesCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class NpcSoundTypesCommon : ANpcSoundDefinitionCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)NpcSoundTypes_FieldIndex.Types) ?? true))
            {
                if (!lhs.Types.SequenceEqual(rhs.Types, (l, r) => ((NpcSoundTypeCommon)((INpcSoundTypeGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)NpcSoundTypes_FieldIndex.Types)))) return false;
            }
            return true;
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(INpcSoundTypesGetter obj, bool iterateNestedRecords = true)
        {
            foreach (var item in base.EnumerateFormLinks(obj, iterateNestedRecords))
            {
                yield return item;
            }
            foreach (var item in obj.Types.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    {
        public new static readonly NpcSoundTypesBinaryWriteTranslation Instance = new();
