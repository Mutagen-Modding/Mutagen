...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Ingredient>
    {
        ...
        #endregion
        #region Flags
        public Ingredient.Flag Flags { get; set; } = default(Ingredient.Flag);
        #endregion
        #region Effects
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class IngredientSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void Clear(IIngredientInternal item)
        {
            ...
            item.Flags = default(Ingredient.Flag);
            item.Effects.Clear();
            base.Clear(item);
        }
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IIngredientGetter
    {
        ...
        public IFormLinkNullableGetter<IEquipTypeGetter> EquipType => FormKeyBinaryTranslation.Instance.OverlayNullableHelper<IEquipTypeGetter>(_EquipTypeLocation, _package, _recordData);
        #endregion
        #region PickUpSound
        ...
        public Int32 IngredientValue => _IngredientValue_IsSet ? BinaryPrimitives.ReadInt32LittleEndian(_recordData.Slice(_IngredientValueLocation, 4)) : default(Int32);
        #endregion
        #region Flags
