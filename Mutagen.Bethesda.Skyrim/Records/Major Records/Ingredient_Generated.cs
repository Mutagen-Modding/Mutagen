...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Ingredient>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => IngredientCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => IngredientSetterCommon.Instance.RemapListedAssetLinks(this, mapping);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Skyrim.Internals.RecordTypeInts.INGR)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class IngredientSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IIngredient obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
    ...
    internal partial class IngredientCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IIngredientGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
