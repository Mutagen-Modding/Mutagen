...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPackageAdapter
    {
            ...
            IMask<TItem>
        {
            ...
            public void ToString(StructuredStringBuilder sb, PackageAdapter.Mask<bool>? printMask = null)
            {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> ContainedFormLinks => PackageAdapterCommon.Instance.GetContainedFormLinks(this);
    ...
    internal partial class PackageAdapterCommon : AVirtualMachineAdapterCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)PackageAdapter_FieldIndex.ScriptFragments) ?? true))
            {
                ...
                {
                    if (!((PackageScriptFragmentsCommon)((IPackageScriptFragmentsGetter)lhsScriptFragments).CommonInstance()!).Equals(lhsScriptFragments, rhsScriptFragments, crystal?.GetSubCrystal((int)PackageAdapter_FieldIndex.ScriptFragments))) return false;
                }
