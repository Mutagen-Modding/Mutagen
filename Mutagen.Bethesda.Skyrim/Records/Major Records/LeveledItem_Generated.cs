...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.EnumBinaryTranslation<LeveledItem.Flag>.Instance.Write(
                writer,
                item.Flags,
                length: 1,
            ...
            Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<ILeveledItemEntryGetter>.Instance.WriteWithCounter(
                writer: writer,
                items: item.Entries,
    ...
    public partial class LeveledItemBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Entries = 
                        Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<LeveledItemEntry>.Instance.ParsePerItem(
                            reader: frame,
                            countLengthLength: 1,
