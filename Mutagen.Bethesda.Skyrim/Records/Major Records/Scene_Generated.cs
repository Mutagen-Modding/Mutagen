...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => SceneXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((SceneXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new Scene CreateFromXml(
            XElement node,
            Scene.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static Scene CreateFromXml(
            XElement node,
        ...
        public new static Scene CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new Scene();
            ((SceneSetterCommon)((ISceneGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class SceneMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((SceneSetterCommon)((ISceneGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class Scene_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(SceneXmlWriteTranslation);
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    FillPrivateElementXml(
                        ...
                        errorMask: errorMask,
                        translationMask: translationMask);
                    SceneXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
    ...
    public partial class SceneCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(ISceneGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class SceneXmlWriteTranslation :
        SkyrimMajorRecordXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static SceneXmlWriteTranslation Instance = new SceneXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((item.VirtualMachineAdapter != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                if (item.VirtualMachineAdapter.TryGet(out var VirtualMachineAdapterItem))
                {
                    ((SceneAdapterXmlWriteTranslation)((IXmlItem)VirtualMachineAdapterItem).XmlWriteTranslator).Write(
                        item: VirtualMachineAdapterItem,
                        node: node,
                        name: nameof(item.VirtualMachineAdapter),
                        fieldIndex: (int)Scene_FieldIndex.VirtualMachineAdapter,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.VirtualMachineAdapter));
                }
            }
            if ((item.Flags != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Flags) ?? true))
            {
                EnumXmlTranslation<Scene.Flag>.Instance.Write(
                    node: node,
                    name: nameof(item.Flags),
                    item: item.Flags,
                    fieldIndex: (int)Scene_FieldIndex.Flags,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Phases) ?? true))
            {
                ListXmlTranslation<IScenePhaseGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.Phases),
                    item: item.Phases,
                    fieldIndex: (int)Scene_FieldIndex.Phases,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Phases),
                    transl: (XElement subNode, IScenePhaseGetter subItem, ErrorMaskBuilder? listSubMask, TranslationCrystal? listTranslMask) =>
                    {
                        var Item = subItem;
                        ((ScenePhaseXmlWriteTranslation)((IXmlItem)Item).XmlWriteTranslator).Write(
                            item: Item,
                            node: subNode,
                            name: null,
            ...
            if ((translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Actors) ?? true))
            {
                ListXmlTranslation<ISceneActorGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.Actors),
                    item: item.Actors,
                    fieldIndex: (int)Scene_FieldIndex.Actors,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Actors),
                    transl: (XElement subNode, ISceneActorGetter subItem, ErrorMaskBuilder? listSubMask, TranslationCrystal? listTranslMask) =>
                    {
                        var Item = subItem;
                        ((SceneActorXmlWriteTranslation)((IXmlItem)Item).XmlWriteTranslator).Write(
                            item: Item,
                            node: subNode,
                            name: null,
                            errorMask: listSubMask,
            ...
            if ((translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Actions) ?? true))
            {
                ListXmlTranslation<ISceneActionGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.Actions),
                    item: item.Actions,
                    fieldIndex: (int)Scene_FieldIndex.Actions,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Actions),
                    transl: (XElement subNode, ISceneActionGetter subItem, ErrorMaskBuilder? listSubMask, TranslationCrystal? listTranslMask) =>
                    {
                        var Item = subItem;
                        ((SceneActionXmlWriteTranslation)((IXmlItem)Item).XmlWriteTranslator).Write(
                            item: Item,
                            node: subNode,
                            name: null,
                            errorMask: listSubMask,
            ...
            if ((item.Unused != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Unused) ?? true))
            {
                if (item.Unused.TryGet(out var UnusedItem))
                {
                    ((ScenePhaseUnusedDataXmlWriteTranslation)((IXmlItem)UnusedItem).XmlWriteTranslator).Write(
                        ...
                        fieldIndex: (int)Scene_FieldIndex.Unused,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Unused));
                }
            }
            if ((item.Unused2 != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Unused2) ?? true))
            {
                if (item.Unused2.TryGet(out var Unused2Item))
                {
                    ((ScenePhaseUnusedDataXmlWriteTranslation)((IXmlItem)Unused2Item).XmlWriteTranslator).Write(
                        ...
                        fieldIndex: (int)Scene_FieldIndex.Unused2,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Unused2));
                }
            }
            if ((item.Quest.FormKey != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Quest) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Quest),
                    item: item.Quest.FormKey,
                    fieldIndex: (int)Scene_FieldIndex.Quest,
                    errorMask: errorMask);
            }
            if ((item.LastActionIndex != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.LastActionIndex) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.LastActionIndex),
                    item: item.LastActionIndex.Value,
                    fieldIndex: (int)Scene_FieldIndex.LastActionIndex,
                    errorMask: errorMask);
            }
            if ((item.VNAM != null)
                && (translationMask?.GetShouldTranslate((int)Scene_FieldIndex.VNAM) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.VNAM),
                    item: item.VNAM.Value,
                    fieldIndex: (int)Scene_FieldIndex.VNAM,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)Scene_FieldIndex.Conditions) ?? true))
            {
                ListXmlTranslation<IConditionGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.Conditions),
                    item: item.Conditions,
                    fieldIndex: (int)Scene_FieldIndex.Conditions,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.Conditions),
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.Scene");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.Scene");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class SceneXmlCreateTranslation : SkyrimMajorRecordXmlCreateTranslation
    {
        public new readonly static SceneXmlCreateTranslation Instance = new SceneXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                case "VirtualMachineAdapter":
                    ...
                    try
                    {
                        item.VirtualMachineAdapter = LoquiXmlTranslation<SceneAdapter>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)Scene_FieldIndex.VirtualMachineAdapter));
                    }
                    ...
                    break;
                case "Flags":
                    errorMask?.PushIndex((int)Scene_FieldIndex.Flags);
                    try
                    {
                        item.Flags = EnumXmlTranslation<Scene.Flag>.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                ...
                case "Phases":
                    ...
                    try
                    {
                        if (ListXmlTranslation<ScenePhase>.Instance.Parse(
                            node: node,
                            enumer: out var PhasesItem,
                            transl: LoquiXmlTranslation<ScenePhase>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.Phases.SetTo(PhasesItem);
                        }
                        else
                        {
                            item.Phases.Clear();
                ...
                case "Actors":
                    ...
                    try
                    {
                        if (ListXmlTranslation<SceneActor>.Instance.Parse(
                            node: node,
                            enumer: out var ActorsItem,
                            transl: LoquiXmlTranslation<SceneActor>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.Actors.SetTo(ActorsItem);
                        }
                        else
                        {
                            item.Actors.Clear();
                ...
                case "Actions":
                    ...
                    try
                    {
                        if (ListXmlTranslation<SceneAction>.Instance.Parse(
                            node: node,
                            enumer: out var ActionsItem,
                            transl: LoquiXmlTranslation<SceneAction>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.Actions.SetTo(ActionsItem);
                        }
                        else
                        {
                            item.Actions.Clear();
                ...
                case "Unused2":
                    ...
                    break;
                case "Quest":
                    errorMask?.PushIndex((int)Scene_FieldIndex.Quest);
                    try
                    {
                    ...
                    break;
                case "LastActionIndex":
                    errorMask?.PushIndex((int)Scene_FieldIndex.LastActionIndex);
                    try
                    {
                        item.LastActionIndex = UInt32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "VNAM":
                    errorMask?.PushIndex((int)Scene_FieldIndex.VNAM);
                    try
                    {
                        item.VNAM = ByteArrayXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class SceneXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((SceneXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        ISceneGetter
    {
        ...
        public Scene.Flag? Flags => _FlagsLocation.HasValue ? (Scene.Flag)BinaryPrimitives.ReadInt32LittleEndian(HeaderTranslation.ExtractSubrecordSpan(_data, _FlagsLocation!.Value, _package.MetaData.Constants)) : default(Scene.Flag?);
        #endregion
