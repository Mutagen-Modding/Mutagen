...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ISceneInternal
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType) => SceneCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        public override IEnumerable<IAssetLink> EnumerateListedAssetLinks() => SceneSetterCommon.Instance.EnumerateListedAssetLinks(this);
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => SceneSetterCommon.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => SceneSetterCommon.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class SceneSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public IEnumerable<IAssetLink> EnumerateListedAssetLinks(IScene obj)
        {
    ...
    internal partial class SceneCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(ISceneGetter obj, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType)
        {
    ...
    internal partial class SceneSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class SceneBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.VirtualMachineAdapter = Mutagen.Bethesda.Skyrim.SceneAdapter.CreateFromBinary(
                        frame: frame,
