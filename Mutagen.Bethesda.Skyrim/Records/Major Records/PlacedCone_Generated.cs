...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        IFormLink<IProjectileGetter> IPlacedConeGetter.Projectile => this.Projectile;
        #endregion
        ...
        public bool Equals(PlacedCone? obj)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override object XmlWriteTranslator => PlacedConeXmlWriteTranslation.Instance;
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((PlacedConeXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new PlacedCone CreateFromXml(
            XElement node,
            PlacedCone.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static PlacedCone CreateFromXml(
            XElement node,
        ...
        public new static PlacedCone CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new PlacedCone();
            ((PlacedConeSetterCommon)((IPlacedConeGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override IEnumerable<FormKey> LinkFormKeys => PlacedConeCommon.Instance.GetLinkFormKeys(this);
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IEnumerable<FormKey> ILinkedFormKeyContainer.LinkFormKeys => PlacedConeCommon.Instance.GetLinkFormKeys(this);
        ...
        public PlacedCone(IMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public PlacedCone(IMod mod, string editorID)
        ...
        [DebuggerStepThrough]
        public static new PlacedCone CreateFromBinary(MutagenFrame frame)
        {
        ...
        IMask<bool> IEqualsMask.GetEqualsIMask(object rhs, EqualsMaskHelper.Include include) => this.GetEqualsMask((IPlacedConeGetter)rhs, include);
    ...
    public partial interface IPlacedConeGetter :
        ...
        IBinaryItem
    {
        static ILoquiRegistration Registration => PlacedCone_Registration.Instance;
    ...
    public static partial class PlacedConeMixIn
    {
        ...
        public static bool HasBeenSet(
            this IPlacedConeGetter item,
            PlacedCone.Mask<bool?> checkMask)
        {
            return ((PlacedConeCommon)((IPlacedConeGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static PlacedCone.Mask<bool> GetHasBeenSetMask(this IPlacedConeGetter item)
        {
            var ret = new PlacedCone.Mask<bool>(false);
            ((PlacedConeCommon)((IPlacedConeGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((PlacedConeSetterCommon)((IPlacedConeGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class PlacedCone_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "PROJECTILE":
                    return (ushort)PlacedCone_FieldIndex.Projectile;
                default:
                    return null;
            }
        }
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    FillPrivateElementXml(
                        ...
                        errorMask: errorMask,
                        translationMask: translationMask);
                    PlacedConeXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
    ...
    public partial class PlacedConeCommon : APlacedTrapCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IPlacedConeGetter obj)
        {
        ...
        {
            var ret = new PlacedCone(getNextFormKey());
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class PlacedConeXmlWriteTranslation :
        APlacedTrapXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static PlacedConeXmlWriteTranslation Instance = new PlacedConeXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            APlacedTrapXmlWriteTranslation.WriteToNodeXml(
                ...
                errorMask: errorMask,
                translationMask: translationMask);
            if ((translationMask?.GetShouldTranslate((int)PlacedCone_FieldIndex.Projectile) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Projectile),
                    item: item.Projectile.FormKey,
                    fieldIndex: (int)PlacedCone_FieldIndex.Projectile,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.PlacedCone");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.PlacedCone");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class PlacedConeXmlCreateTranslation : APlacedTrapXmlCreateTranslation
    {
        public new readonly static PlacedConeXmlCreateTranslation Instance = new PlacedConeXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Projectile":
                    errorMask?.PushIndex((int)PlacedCone_FieldIndex.Projectile);
                    try
                    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class PlacedConeXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((PlacedConeXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
