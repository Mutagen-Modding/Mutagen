...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IPerkScriptFlag
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((PerkScriptFlagCommon)((IPerkScriptFlagGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IPerkScriptFlagGetter? obj)
        {
            return ((PerkScriptFlagCommon)((IPerkScriptFlagGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        ILoquiObject<IPerkScriptFlagGetter>
    {
        ...
        static ILoquiRegistration StaticRegistration => PerkScriptFlag_Registration.Instance;
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class PerkScriptFlagCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PerkScriptFlag_FieldIndex.Flags) ?? true))
            {
                if (lhs.Flags != rhs.Flags) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PerkScriptFlag_FieldIndex.FragmentIndex) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPerkScriptFlagGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
