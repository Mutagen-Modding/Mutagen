...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((TextureSetCommon)((ILoquiObject)this).CommonInstance).Equals(this, rhs);
        }

        public bool Equals(TextureSet obj)
        {
            return ((TextureSetCommon)((ILoquiObject)this).CommonInstance).Equals(this, obj);
        }

        public override int GetHashCode() => ((TextureSetCommon)((ILoquiObject)this).CommonInstance).GetHashCode(this);
            ...
            bool doMasks = true)
        {
            ...
            TextureSetCommon.CopyFieldsFrom(
                item: this,
                rhs: rhs,
                def: def,
                errorMask: errorMaskBuilder,
        ...
        {
            TextureSetCommon.Instance.Clear(this);
        }
    ...
    public static class TextureSetMixIn
    {
        ...
        {
            ((TextureSetCommon)((ILoquiObject)item).CommonInstance).Clear(item: item);
        }
        ...
        {
            return ((TextureSetCommon)((ILoquiObject)item).CommonInstance).GetEqualsMask(
                item: item,
                rhs: rhs,
                include: include);
        }
        ...
        {
            return ((TextureSetCommon)((ILoquiObject)item).CommonInstance).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            TextureSet_Mask<bool> printMask = null)
        {
            ((TextureSetCommon)((ILoquiObject)item).CommonInstance).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
        ...
        {
            return ((TextureSetCommon)((ILoquiObject)item).CommonInstance).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }
        ...
        public static TextureSet_Mask<bool> GetHasBeenSetMask(this ITextureSetInternalGetter item)
        {
            ...
            ((TextureSetCommon)((ILoquiObject)item).CommonInstance).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static bool Equals(
            ...
            ITextureSetInternalGetter rhs)
        {
            return ((TextureSetCommon)((ILoquiObject)item).CommonInstance).Equals(
                lhs: item,
                rhs: rhs);
        }
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public class TextureSet_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type CommonType = typeof(TextureSetCommon);
    ...
    {
        public static readonly TextureSetCommon Instance = new TextureSetCommon();
        ...
        {
            var ret = new TextureSet_Mask<bool>();
            ((TextureSetCommon)((ILoquiObject)item).CommonInstance).FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
                include: include);
