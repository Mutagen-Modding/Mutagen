...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => LocationAliasReferenceXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((LocationAliasReferenceXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static LocationAliasReference CreateFromXml(
            XElement node,
            LocationAliasReference.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((LocationAliasReferenceSetterCommon)((ILocationAliasReferenceGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class LocationAliasReferenceMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((LocationAliasReferenceSetterCommon)((ILocationAliasReferenceGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public partial class LocationAliasReferenceSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    LocationAliasReferenceXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class LocationAliasReferenceXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static LocationAliasReferenceXmlWriteTranslation Instance = new LocationAliasReferenceXmlWriteTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            if ((item.AliasIndex != null)
                && (translationMask?.GetShouldTranslate((int)LocationAliasReference_FieldIndex.AliasIndex) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.AliasIndex),
                    item: item.AliasIndex.Value,
                    fieldIndex: (int)LocationAliasReference_FieldIndex.AliasIndex,
                    errorMask: errorMask);
            }
            if ((item.Keyword.FormKey != null)
                && (translationMask?.GetShouldTranslate((int)LocationAliasReference_FieldIndex.Keyword) ?? true))
            {
            ...
            if ((item.RefType.FormKey != null)
                && (translationMask?.GetShouldTranslate((int)LocationAliasReference_FieldIndex.RefType) ?? true))
            {
                FormKeyXmlTranslation.Instance.Write(
                    node: node,
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.LocationAliasReference");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.LocationAliasReference");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class LocationAliasReferenceXmlCreateTranslation
    {
        public readonly static LocationAliasReferenceXmlCreateTranslation Instance = new LocationAliasReferenceXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "AliasIndex":
                    errorMask?.PushIndex((int)LocationAliasReference_FieldIndex.AliasIndex);
                    try
                    {
                    ...
                    break;
                case "Keyword":
                    errorMask?.PushIndex((int)LocationAliasReference_FieldIndex.Keyword);
                    try
                    {
                        item.Keyword = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "RefType":
                    errorMask?.PushIndex((int)LocationAliasReference_FieldIndex.RefType);
                    try
                    {
                        item.RefType = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class LocationAliasReferenceXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((LocationAliasReferenceXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
