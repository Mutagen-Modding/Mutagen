...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<HeadPart>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => HeadPartCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => HeadPartSetterCommon.Instance.RemapListedAssetLinks(this, mapping);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Skyrim.Internals.RecordTypeInts.HDPT)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class HeadPartSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IHeadPart obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
    ...
    internal partial class HeadPartCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IHeadPartGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
    ...
    internal partial class HeadPartSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class HeadPartBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
