...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            RegionDataXmlWriteTranslation.WriteToNodeXml(
                ...
                translationMask: translationMask);
            if ((item.Name != null)
                && (translationMask?.GetShouldTranslate((int)RegionMap_FieldIndex.Name) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Name),
                    item: item.Name,
                    fieldIndex: (int)RegionMap_FieldIndex.Name,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.RegionMap");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.RegionMap");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class RegionMapXmlCreateTranslation : RegionDataXmlCreateTranslation
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Name":
                    errorMask?.PushIndex((int)RegionMap_FieldIndex.Name);
                    try
                    {
