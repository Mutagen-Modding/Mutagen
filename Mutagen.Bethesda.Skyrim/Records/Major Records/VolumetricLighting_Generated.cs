...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((item.Intensity != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.Intensity) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Intensity),
                    item: item.Intensity.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.Intensity,
                    errorMask: errorMask);
            }
            if ((item.CustomColorContribution != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.CustomColorContribution) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.CustomColorContribution),
                    item: item.CustomColorContribution.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.CustomColorContribution,
                    errorMask: errorMask);
            }
            if ((item.ColorR != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.ColorR) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ColorR),
                    item: item.ColorR.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.ColorR,
                    errorMask: errorMask);
            }
            if ((item.ColorG != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.ColorG) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ColorG),
                    item: item.ColorG.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.ColorG,
                    errorMask: errorMask);
            }
            if ((item.ColorB != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.ColorB) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ColorB),
                    item: item.ColorB.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.ColorB,
                    errorMask: errorMask);
            }
            if ((item.DensityContribution != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.DensityContribution) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DensityContribution),
                    item: item.DensityContribution.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.DensityContribution,
                    errorMask: errorMask);
            }
            if ((item.DensitySize != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.DensitySize) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DensitySize),
                    item: item.DensitySize.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.DensitySize,
                    errorMask: errorMask);
            }
            if ((item.DensityWindSpeed != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.DensityWindSpeed) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DensityWindSpeed),
                    item: item.DensityWindSpeed.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.DensityWindSpeed,
                    errorMask: errorMask);
            }
            if ((item.DensityFallingSpeed != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.DensityFallingSpeed) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DensityFallingSpeed),
                    item: item.DensityFallingSpeed.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.DensityFallingSpeed,
                    errorMask: errorMask);
            }
            if ((item.PhaseFunctionContribution != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.PhaseFunctionContribution) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PhaseFunctionContribution),
                    item: item.PhaseFunctionContribution.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.PhaseFunctionContribution,
                    errorMask: errorMask);
            }
            if ((item.PhaseFunctionScattering != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.PhaseFunctionScattering) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PhaseFunctionScattering),
                    item: item.PhaseFunctionScattering.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.PhaseFunctionScattering,
                    errorMask: errorMask);
            }
            if ((item.SamplingRepartitionRangeFactor != null)
                && (translationMask?.GetShouldTranslate((int)VolumetricLighting_FieldIndex.SamplingRepartitionRangeFactor) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.SamplingRepartitionRangeFactor),
                    item: item.SamplingRepartitionRangeFactor.Value,
                    fieldIndex: (int)VolumetricLighting_FieldIndex.SamplingRepartitionRangeFactor,
                    errorMask: errorMask);
            }
        }
    ...
    public partial class VolumetricLightingXmlCreateTranslation : SkyrimMajorRecordXmlCreateTranslation
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Intensity":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.Intensity);
                    try
                    {
                        item.Intensity = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "CustomColorContribution":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.CustomColorContribution);
                    try
                    {
                        item.CustomColorContribution = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "ColorR":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.ColorR);
                    try
                    {
                        item.ColorR = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "ColorG":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.ColorG);
                    try
                    {
                        item.ColorG = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "ColorB":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.ColorB);
                    try
                    {
                        item.ColorB = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "DensityContribution":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.DensityContribution);
                    try
                    {
                        item.DensityContribution = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "DensitySize":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.DensitySize);
                    try
                    {
                        item.DensitySize = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "DensityWindSpeed":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.DensityWindSpeed);
                    try
                    {
                        item.DensityWindSpeed = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "DensityFallingSpeed":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.DensityFallingSpeed);
                    try
                    {
                        item.DensityFallingSpeed = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "PhaseFunctionContribution":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.PhaseFunctionContribution);
                    try
                    {
                        item.PhaseFunctionContribution = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "PhaseFunctionScattering":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.PhaseFunctionScattering);
                    try
                    {
                        item.PhaseFunctionScattering = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "SamplingRepartitionRangeFactor":
                    errorMask?.PushIndex((int)VolumetricLighting_FieldIndex.SamplingRepartitionRangeFactor);
                    try
                    {
                        item.SamplingRepartitionRangeFactor = FloatXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
