...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => ScenePhaseXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((ScenePhaseXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static ScenePhase CreateFromXml(
            XElement node,
            ScenePhase.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((ScenePhaseSetterCommon)((IScenePhaseGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        #region Mutagen
        public new static readonly RecordType GrupRecordType = ScenePhase_Registration.TriggeringRecordType;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    public static partial class ScenePhaseMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((ScenePhaseSetterCommon)((IScenePhaseGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ScenePhase_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type XmlWriteTranslation = typeof(ScenePhaseXmlWriteTranslation);
    ...
    public partial class ScenePhaseSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    ScenePhaseXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
    ...
    public partial class ScenePhaseCommon
    {
        ...
        public void RemapLinks(IScenePhaseGetter obj, IReadOnlyDictionary<FormKey, FormKey> mapping) => throw new NotImplementedException();
        #endregion
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class ScenePhaseXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static ScenePhaseXmlWriteTranslation Instance = new ScenePhaseXmlWriteTranslation();
        ...
        {
            if ((item.Name != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.Name) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Name),
                    item: item.Name,
                    fieldIndex: (int)ScenePhase_FieldIndex.Name,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.StartConditions) ?? true))
            {
                ListXmlTranslation<IConditionGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.StartConditions),
                    item: item.StartConditions,
                    fieldIndex: (int)ScenePhase_FieldIndex.StartConditions,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.StartConditions),
            ...
            if ((translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.CompletionConditions) ?? true))
            {
                ListXmlTranslation<IConditionGetter>.Instance.Write(
                    node: node,
                    name: nameof(item.CompletionConditions),
                    item: item.CompletionConditions,
                    fieldIndex: (int)ScenePhase_FieldIndex.CompletionConditions,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.CompletionConditions),
                    transl: (XElement subNode, IConditionGetter subItem, ErrorMaskBuilder? listSubMask, TranslationCrystal? listTranslMask) =>
                    {
                        var Item = subItem;
                        ((ConditionXmlWriteTranslation)((IXmlItem)Item).XmlWriteTranslator).Write(
            ...
            if ((item.Unused != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.Unused) ?? true))
            {
                if (item.Unused.TryGet(out var UnusedItem))
                {
                    ((ScenePhaseUnusedDataXmlWriteTranslation)((IXmlItem)UnusedItem).XmlWriteTranslator).Write(
                        item: UnusedItem,
                        node: node,
                        name: nameof(item.Unused),
                        fieldIndex: (int)ScenePhase_FieldIndex.Unused,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.Unused));
                }
            }
            if ((item.Unused2 != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.Unused2) ?? true))
            {
                if (item.Unused2.TryGet(out var Unused2Item))
                {
                    ((ScenePhaseUnusedDataXmlWriteTranslation)((IXmlItem)Unused2Item).XmlWriteTranslator).Write(
                        item: Unused2Item,
                        node: node,
                        name: nameof(item.Unused2),
                        fieldIndex: (int)ScenePhase_FieldIndex.Unused2,
                        errorMask: errorMask,
                        translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.Unused2));
                }
            }
            if ((item.EditorWidth != null)
                && (translationMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.EditorWidth) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.EditorWidth),
                    item: item.EditorWidth.Value,
                    fieldIndex: (int)ScenePhase_FieldIndex.EditorWidth,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.ScenePhase");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.ScenePhase");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class ScenePhaseXmlCreateTranslation
    {
        public readonly static ScenePhaseXmlCreateTranslation Instance = new ScenePhaseXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Name":
                    errorMask?.PushIndex((int)ScenePhase_FieldIndex.Name);
                    try
                    {
                ...
                case "StartConditions":
                    ...
                    try
                    {
                        if (ListXmlTranslation<Condition>.Instance.Parse(
                            node: node,
                            enumer: out var StartConditionsItem,
                            transl: LoquiXmlTranslation<Condition>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.StartConditions.SetTo(StartConditionsItem);
                        }
                        else
                        {
                            item.StartConditions.Clear();
                ...
                case "CompletionConditions":
                    ...
                    try
                    {
                        if (ListXmlTranslation<Condition>.Instance.Parse(
                            node: node,
                            enumer: out var CompletionConditionsItem,
                            transl: LoquiXmlTranslation<Condition>.Instance.Parse,
                            errorMask: errorMask,
                            translationMask: translationMask))
                        {
                            item.CompletionConditions.SetTo(CompletionConditionsItem);
                        }
                        else
                        {
                            item.CompletionConditions.Clear();
                ...
                case "Unused":
                    ...
                    try
                    {
                        item.Unused = LoquiXmlTranslation<ScenePhaseUnusedData>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.Unused));
                    }
                ...
                case "Unused2":
                    ...
                    try
                    {
                        item.Unused2 = LoquiXmlTranslation<ScenePhaseUnusedData>.Instance.Parse(
                            node: node,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)ScenePhase_FieldIndex.Unused2));
                    }
                    ...
                    break;
                case "EditorWidth":
                    errorMask?.PushIndex((int)ScenePhase_FieldIndex.EditorWidth);
                    try
                    {
                        item.EditorWidth = UInt32XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class ScenePhaseXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((ScenePhaseXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
