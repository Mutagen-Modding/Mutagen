...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class ColorRecordCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IColorRecordGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.BooleanBinaryTranslation.Instance.Write(
                writer: writer,
                item: item.Playable,
    ...
    public partial class ColorRecordBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Playable = Mutagen.Bethesda.Records.Binary.Translations.BooleanBinaryTranslation.Instance.Parse(
                        frame: frame.SpawnWithLength(contentLength),
                        byteLength: 4);
