...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class SoundMarkerCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(ISoundMarkerGetter obj)
        {
    ...
    public partial class SoundMarkerSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
            ...
            TranslationCrystal? copyMask)
        {
            ...
            {
                item.SoundDescriptor = rhs.SoundDescriptor.FormKey;
            }
        }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "SoundDescriptor":
                    ...
                    try
                    {
                        item.SoundDescriptor = FormKeyXmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
