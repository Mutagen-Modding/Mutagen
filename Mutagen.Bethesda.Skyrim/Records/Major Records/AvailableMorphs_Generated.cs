...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    internal partial class AvailableMorphsCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAvailableMorphsGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    {
        public static readonly AvailableMorphsBinaryWriteTranslation Instance = new();
