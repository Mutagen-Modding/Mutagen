...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class WorldspaceParentCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IWorldspaceParentGetter obj)
        {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class WorldspaceParentBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.EnumBinaryTranslation<WorldspaceParent.Flag>.Instance.Write(
                writer,
                item.Flags,
                length: 2,
    ...
    public partial class WorldspaceParentBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<WorldspaceParent.Flag>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
