...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IWorldspaceGridReferenceGetter
    {
        ...
        #region References
        public IReadOnlyList<IWorldspaceReferenceGetter> References => BinaryOverlayList<WorldspaceReferenceBinaryOverlay>.FactoryByCountLength(_data.Slice(0x4), _package, 8, countLength: 4, (s, p) => WorldspaceReferenceBinaryOverlay.WorldspaceReferenceFactory(s, p));
