...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IMountData
    {
            ...
            IMask<TItem>
        {
            ...
            public string Print(MountData.Mask<bool>? printMask = null)
            {
            ...
            public void Print(StructuredStringBuilder sb, MountData.Mask<bool>? printMask = null)
            {
                sb.AppendLine($"{nameof(MountData.Mask<TItem>)} =>");
                using (sb.Brace())
                {
                    if (printMask?.MountOffset ?? true)
                    {
                        sb.AppendItem(MountOffset, "MountOffset");
                    }
                    if (printMask?.DismountOffset ?? true)
                    {
                        sb.AppendItem(DismountOffset, "DismountOffset");
                    }
                    if (printMask?.MountCameraOffset ?? true)
                    {
                        sb.AppendItem(MountCameraOffset, "MountCameraOffset");
                    }
                }
            }
            #endregion
    ...
    public static partial class MountDataMixIn
    {
        ...
        {
            return ((MountDataCommon)((IMountDataGetter)item).CommonInstance()!).Print(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void Print(
            ...
            MountData.Mask<bool>? printMask = null)
        {
            ((MountDataCommon)((IMountDataGetter)item).CommonInstance()!).Print(
                item: item,
                sb: sb,
                name: name,
                printMask: printMask);
...
{
    #region Field Index
    internal enum MountData_FieldIndex
    {
        MountOffset = 0,
        DismountOffset = 1,
        MountCameraOffset = 2,
    ...
    #region Registration
    internal partial class MountData_Registration : ILoquiRegistration
    {
    ...
    #region Common
    internal partial class MountDataSetterCommon
    {
    ...
    internal partial class MountDataCommon
    {
            ...
            MountData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                sb.AppendLine($"MountData =>");
            }
            else
            {
                sb.AppendLine($"{name} (MountData) =>");
            }
            using (sb.Brace())
            {
                ToStringFields(
            ...
            MountData.Mask<bool>? printMask = null)
        {
            if (printMask?.MountOffset ?? true)
            {
                sb.AppendItem(item.MountOffset, "MountOffset");
            }
            if (printMask?.DismountOffset ?? true)
            {
                sb.AppendItem(item.DismountOffset, "DismountOffset");
            }
            if (printMask?.MountCameraOffset ?? true)
            {
                sb.AppendItem(item.MountCameraOffset, "MountCameraOffset");
            }
        }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMountDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Skyrim
{
    public partial class MountData
    {
        ...
        public static ILoquiRegistration StaticRegistration => MountData_Registration.Instance;
        [DebuggerStepThrough]
...
namespace Mutagen.Bethesda.Skyrim
{
    internal partial class MountDataBinaryOverlay :
        PluginBinaryOverlay,
        IMountDataGetter
    {
        #region Common Routing
        ...
        public P3Float MountOffset => P3FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0x0, 0xC));
        public P3Float DismountOffset => P3FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0xC, 0xC));
        public P3Float MountCameraOffset => P3FloatBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0x18, 0xC));
