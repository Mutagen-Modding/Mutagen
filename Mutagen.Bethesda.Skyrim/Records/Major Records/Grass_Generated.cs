...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<Grass>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => GrassCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Skyrim.Internals.RecordTypeInts.GRAS)]
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class GrassSetterCommon : SkyrimMajorRecordSetterCommon
    {
        ...
        public void RemapListedAssetLinks(IGrass obj, IReadOnlyDictionary<IAssetLinkGetter, string> mapping)
        {
    ...
    internal partial class GrassCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(IGrassGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
    ...
    internal partial class GrassSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
