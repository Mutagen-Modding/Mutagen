...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class MovementTypeCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetLinkFormKeys(IMovementTypeGetter obj)
        {
        ...
        {
            var ret = new MovementType(getNextFormKey(), ((IMovementTypeGetter)item).FormVersion);
