...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected object XmlWriteTranslator => WorldspaceMaxHeightXmlWriteTranslation.Instance;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((WorldspaceMaxHeightXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static WorldspaceMaxHeight CreateFromXml(
            XElement node,
            WorldspaceMaxHeight.TranslationMask? translationMask = null)
        {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            ((WorldspaceMaxHeightSetterCommon)((IWorldspaceMaxHeightGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
    ...
    public static partial class WorldspaceMaxHeightMixIn
    {
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((WorldspaceMaxHeightSetterCommon)((IWorldspaceMaxHeightGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public partial class WorldspaceMaxHeight_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "MIN":
                    return (ushort)WorldspaceMaxHeight_FieldIndex.Min;
                case "MAX":
                    return (ushort)WorldspaceMaxHeight_FieldIndex.Max;
                case "CELLDATA":
                    return (ushort)WorldspaceMaxHeight_FieldIndex.CellData;
                default:
                    return null;
            }
        }
    ...
    public partial class WorldspaceMaxHeightSetterCommon
    {
            ...
            TranslationCrystal? translationMask)
        {
            try
            {
                ...
                {
                    WorldspaceMaxHeightXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class WorldspaceMaxHeightXmlWriteTranslation : IXmlWriteTranslator
    {
        public readonly static WorldspaceMaxHeightXmlWriteTranslation Instance = new WorldspaceMaxHeightXmlWriteTranslation();
        ...
        public static void WriteToNodeXml(
            ...
            TranslationCrystal? translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)WorldspaceMaxHeight_FieldIndex.Min) ?? true))
            {
                P2Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Min),
                    item: item.Min,
                    fieldIndex: (int)WorldspaceMaxHeight_FieldIndex.Min,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)WorldspaceMaxHeight_FieldIndex.Max) ?? true))
            {
                P2Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Max),
                    item: item.Max,
                    fieldIndex: (int)WorldspaceMaxHeight_FieldIndex.Max,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)WorldspaceMaxHeight_FieldIndex.CellData) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.CellData),
                    item: item.CellData,
                    fieldIndex: (int)WorldspaceMaxHeight_FieldIndex.CellData,
                    errorMask: errorMask);
            }
        }
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.WorldspaceMaxHeight");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.WorldspaceMaxHeight");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class WorldspaceMaxHeightXmlCreateTranslation
    {
        public readonly static WorldspaceMaxHeightXmlCreateTranslation Instance = new WorldspaceMaxHeightXmlCreateTranslation();
            ...
            TranslationCrystal? translationMask)
        {
            ...
            {
                case "Min":
                    errorMask?.PushIndex((int)WorldspaceMaxHeight_FieldIndex.Min);
                    try
                    {
                        item.Min = P2Int16XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "Max":
                    errorMask?.PushIndex((int)WorldspaceMaxHeight_FieldIndex.Max);
                    try
                    {
                        item.Max = P2Int16XmlTranslation.Instance.Parse(
                            node: node,
                            errorMask: errorMask);
                    }
                    catch (Exception ex)
                    ...
                    break;
                case "CellData":
                    errorMask?.PushIndex((int)WorldspaceMaxHeight_FieldIndex.CellData);
                    try
                    {
                        item.CellData = ByteArrayXmlTranslation.Instance.Parse(
                            node: node,
                            fallbackLength: 0,
                            errorMask: errorMask);
                    }
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class WorldspaceMaxHeightXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((WorldspaceMaxHeightXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
