...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEqualsMask
    {
        ...
        void IXmlItem.WriteToXml(
            ...
            string? name = null)
        {
            ((MaterialObjectXmlWriteTranslation)this.XmlWriteTranslator).Write(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static new MaterialObject CreateFromXml(
            XElement node,
            MaterialObject.TranslationMask? translationMask = null)
        {
        ...
        [DebuggerStepThrough]
        public static MaterialObject CreateFromXml(
            XElement node,
        ...
        public new static MaterialObject CreateFromXml(
            XElement node,
            ErrorMaskBuilder? errorMask,
            TranslationCrystal? translationMask)
        {
            var ret = new MaterialObject();
            ((MaterialObjectSetterCommon)((IMaterialObjectGetter)ret).CommonSetterInstance()!).CopyInFromXml(
                item: ret,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
        ...
        public MaterialObject(IMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public MaterialObject(IMod mod, string editorID)
        ...
        [DebuggerStepThrough]
        public static new MaterialObject CreateFromBinary(MutagenFrame frame)
        {
    ...
    public static partial class MaterialObjectMixIn
    {
        ...
        {
            return ((MaterialObjectCommon)((IMaterialObjectGetter)item).CommonInstance()!).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static MaterialObject.Mask<bool> GetHasBeenSetMask(this IMaterialObjectGetter item)
        {
            var ret = new MaterialObject.Mask<bool>(false);
            ((MaterialObjectCommon)((IMaterialObjectGetter)item).CommonInstance()!).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static void CopyInFromXml(
            ...
            TranslationCrystal? translationMask)
        {
            ((MaterialObjectSetterCommon)((IMaterialObjectGetter)item).CommonSetterInstance()!).CopyInFromXml(
                item: item,
                node: node,
                errorMask: errorMask,
                translationMask: translationMask);
...
{
    #region Field Index
    public enum MaterialObject_FieldIndex
    {
    ...
    #region Registration
    public partial class MaterialObject_Registration : ILoquiRegistration
    {
    ...
    #region Common
    public partial class MaterialObjectSetterCommon : SkyrimMajorRecordSetterCommon
    {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    FillPrivateElementXml(
                        ...
                        errorMask: errorMask,
                        translationMask: translationMask);
                    MaterialObjectXmlCreateTranslation.FillPublicElementXml(
                        item: item,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
    ...
    public partial class MaterialObjectCommon : SkyrimMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormKey> GetLinkFormKeys(IMaterialObjectGetter obj)
        {
        ...
        partial void PostDuplicate(MaterialObject obj, MaterialObject rhs, Func<FormKey> getNextFormKey, IList<(IMajorRecordCommon Record, FormKey OriginalFormKey)>? duplicatedRecords);
        
        public override IMajorRecordCommon Duplicate(IMajorRecordCommonGetter item, Func<FormKey> getNextFormKey, IList<(IMajorRecordCommon Record, FormKey OriginalFormKey)>? duplicatedRecords)
        {
            var ret = new MaterialObject(getNextFormKey());
            ret.DeepCopyIn((MaterialObject)item);
            duplicatedRecords?.Add((ret, item.FormKey));
            PostDuplicate(ret, (MaterialObject)item, getNextFormKey, duplicatedRecords);
            return ret;
        }
    ...
    public partial class MaterialObjectSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    public partial class MaterialObjectXmlWriteTranslation :
        SkyrimMajorRecordXmlWriteTranslation,
        IXmlWriteTranslator
    {
        public new readonly static MaterialObjectXmlWriteTranslation Instance = new MaterialObjectXmlWriteTranslation();
        ...
        public void Write(
            ...
            string? name = null)
        {
            var elem = new XElement(name ?? "Mutagen.Bethesda.Skyrim.MaterialObject");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Mutagen.Bethesda.Skyrim.MaterialObject");
            }
            WriteToNodeXml(
                item: item,
                node: elem,
    ...
    public partial class MaterialObjectXmlCreateTranslation : SkyrimMajorRecordXmlCreateTranslation
    {
        public new readonly static MaterialObjectXmlCreateTranslation Instance = new MaterialObjectXmlCreateTranslation();
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    public static class MaterialObjectXmlTranslationMixIn
    {
        ...
        {
            ErrorMaskBuilder errorMaskBuilder = new ErrorMaskBuilder();
            ((MaterialObjectXmlWriteTranslation)item.XmlWriteTranslator).Write(
                item: item,
                name: name,
                node: node,
                errorMask: errorMaskBuilder,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            using (HeaderExport.Header(
                writer: writer,
                record: recordTypeConverter.ConvertToCustom(MaterialObject_Registration.MATO_HEADER),
    ...
    public partial class MaterialObjectBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
        public new readonly static MaterialObjectBinaryCreateTranslation Instance = new MaterialObjectBinaryCreateTranslation();

        public override RecordType RecordType => MaterialObject_Registration.MATO_HEADER;
