        ...
        IEquatable<ImageSpaceAdapter>
    {
            ...
            ITranslationMask
        {
            ...
            protected override void GetCrystal(List<(bool On, TranslationCrystal? SubCrystal)> ret)
            {
                ...
                ret.Add((BlurRadius != null || DefaultOn, BlurRadius?.GetCrystal()));
                ret.Add((DoubleVisionStrength != null || DefaultOn, DoubleVisionStrength?.GetCrystal()));
                ret.Add((TintColor != null || DefaultOn, TintColor?.GetCrystal()));
                ret.Add((FadeColor != null || DefaultOn, FadeColor?.GetCrystal()));
                ret.Add((RadialBlurStrength != null || DefaultOn, RadialBlurStrength?.GetCrystal()));
                ret.Add((RadialBlurRampUp != null || DefaultOn, RadialBlurRampUp?.GetCrystal()));
                ret.Add((RadialBlurStart != null || DefaultOn, RadialBlurStart?.GetCrystal()));
                ret.Add((RadialBlurRampDown != null || DefaultOn, RadialBlurRampDown?.GetCrystal()));
                ret.Add((RadialBlurDownStart != null || DefaultOn, RadialBlurDownStart?.GetCrystal()));
                ret.Add((DepthOfFieldStrength != null || DefaultOn, DepthOfFieldStrength?.GetCrystal()));
                ret.Add((DepthOfFieldDistance != null || DefaultOn, DepthOfFieldDistance?.GetCrystal()));
                ret.Add((DepthOfFieldRange != null || DefaultOn, DepthOfFieldRange?.GetCrystal()));
                ret.Add((MotionBlurStrength != null || DefaultOn, MotionBlurStrength?.GetCrystal()));
                ret.Add((HdrEyeAdaptSpeedMult != null || DefaultOn, HdrEyeAdaptSpeedMult?.GetCrystal()));
                ret.Add((HdrEyeAdaptSpeedAdd != null || DefaultOn, HdrEyeAdaptSpeedAdd?.GetCrystal()));
                ret.Add((HdrBloomBlurRadiusMult != null || DefaultOn, HdrBloomBlurRadiusMult?.GetCrystal()));
                ret.Add((HdrBloomBlurRadiusAdd != null || DefaultOn, HdrBloomBlurRadiusAdd?.GetCrystal()));
                ret.Add((HdrBloomThresholdMult != null || DefaultOn, HdrBloomThresholdMult?.GetCrystal()));
                ret.Add((HdrBloomThresholdAdd != null || DefaultOn, HdrBloomThresholdAdd?.GetCrystal()));
                ret.Add((HdrBloomScaleMult != null || DefaultOn, HdrBloomScaleMult?.GetCrystal()));
                ret.Add((HdrBloomScaleAdd != null || DefaultOn, HdrBloomScaleAdd?.GetCrystal()));
                ret.Add((HdrTargetLumMinMult != null || DefaultOn, HdrTargetLumMinMult?.GetCrystal()));
                ret.Add((HdrTargetLumMinAdd != null || DefaultOn, HdrTargetLumMinAdd?.GetCrystal()));
                ret.Add((HdrTargetLumMaxMult != null || DefaultOn, HdrTargetLumMaxMult?.GetCrystal()));
                ret.Add((HdrTargetLumMaxAdd != null || DefaultOn, HdrTargetLumMaxAdd?.GetCrystal()));
                ret.Add((HdrSunlightScaleMult != null || DefaultOn, HdrSunlightScaleMult?.GetCrystal()));
                ret.Add((HdrSunlightScaleAdd != null || DefaultOn, HdrSunlightScaleAdd?.GetCrystal()));
                ret.Add((HdrSkyScaleMult != null || DefaultOn, HdrSkyScaleMult?.GetCrystal()));
                ret.Add((HdrSkyScaleAdd != null || DefaultOn, HdrSkyScaleAdd?.GetCrystal()));
                ret.Add((Unknown08 != null || DefaultOn, Unknown08?.GetCrystal()));
                ret.Add((Unknown48 != null || DefaultOn, Unknown48?.GetCrystal()));
                ret.Add((Unknown09 != null || DefaultOn, Unknown09?.GetCrystal()));
                ret.Add((Unknown49 != null || DefaultOn, Unknown49?.GetCrystal()));
                ret.Add((Unknown0A != null || DefaultOn, Unknown0A?.GetCrystal()));
                ret.Add((Unknown4A != null || DefaultOn, Unknown4A?.GetCrystal()));
                ret.Add((Unknown0B != null || DefaultOn, Unknown0B?.GetCrystal()));
                ret.Add((Unknown4B != null || DefaultOn, Unknown4B?.GetCrystal()));
                ret.Add((Unknown0C != null || DefaultOn, Unknown0C?.GetCrystal()));
                ret.Add((Unknown4C != null || DefaultOn, Unknown4C?.GetCrystal()));
                ret.Add((Unknown0D != null || DefaultOn, Unknown0D?.GetCrystal()));
                ret.Add((Unknown4D != null || DefaultOn, Unknown4D?.GetCrystal()));
                ret.Add((Unknown0E != null || DefaultOn, Unknown0E?.GetCrystal()));
                ret.Add((Unknown4E != null || DefaultOn, Unknown4E?.GetCrystal()));
                ret.Add((Unknown0F != null || DefaultOn, Unknown0F?.GetCrystal()));
                ret.Add((Unknown4F != null || DefaultOn, Unknown4F?.GetCrystal()));
                ret.Add((Unknown10 != null || DefaultOn, Unknown10?.GetCrystal()));
                ret.Add((Unknown50 != null || DefaultOn, Unknown50?.GetCrystal()));
                ret.Add((CinematicSaturationMult != null || DefaultOn, CinematicSaturationMult?.GetCrystal()));
                ret.Add((CinematicSaturationAdd != null || DefaultOn, CinematicSaturationAdd?.GetCrystal()));
                ret.Add((CinematicBrightnessMult != null || DefaultOn, CinematicBrightnessMult?.GetCrystal()));
                ret.Add((CinematicBrightnessAdd != null || DefaultOn, CinematicBrightnessAdd?.GetCrystal()));
                ret.Add((CinematicContrastMult != null || DefaultOn, CinematicContrastMult?.GetCrystal()));
                ret.Add((CinematicContrastAdd != null || DefaultOn, CinematicContrastAdd?.GetCrystal()));
                ret.Add((Unknown14 != null || DefaultOn, Unknown14?.GetCrystal()));
                ret.Add((Unknown54 != null || DefaultOn, Unknown54?.GetCrystal()));
