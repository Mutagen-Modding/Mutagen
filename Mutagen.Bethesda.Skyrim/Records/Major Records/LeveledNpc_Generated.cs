...
namespace Mutagen.Bethesda.Skyrim.Internals
{
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            ...
            Mutagen.Bethesda.Records.Binary.Translations.EnumBinaryTranslation<LeveledNpc.Flag>.Instance.Write(
                writer,
                item.Flags,
                length: 1,
            ...
            Mutagen.Bethesda.Records.Binary.Translations.ListBinaryTranslation<ILeveledNpcEntryGetter>.Instance.WriteWithCounter(
                writer: writer,
                items: item.Entries,
    ...
    public partial class LeveledNpcBinaryCreateTranslation : SkyrimMajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.Flags = EnumBinaryTranslation<LeveledNpc.Flag>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
