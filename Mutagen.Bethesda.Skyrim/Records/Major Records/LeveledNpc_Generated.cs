...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILoquiObjectSetter<LeveledNpc>
    {
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType) => LeveledNpcCommon.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
...
namespace Mutagen.Bethesda.Skyrim
{
    ...
    #region Common
    internal partial class LeveledNpcSetterCommon : SkyrimMajorRecordSetterCommon
    {
    ...
    internal partial class LeveledNpcCommon : SkyrimMajorRecordCommon
    {
        ...
        public IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(ILeveledNpcGetter obj, AssetLinkQuery queryCategories, ILinkCache? linkCache, Type? assetType)
        {
    ...
    internal partial class LeveledNpcSetterTranslationCommon : SkyrimMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        ILeveledNpcGetter
    {
        ...
        public LeveledNpc.Flag Flags => _FlagsLocation.HasValue ? (LeveledNpc.Flag)HeaderTranslation.ExtractSubrecordMemory(_recordData, _FlagsLocation!.Value, _package.MetaData.Constants)[0] : default(LeveledNpc.Flag);
        #endregion
        #region Global
