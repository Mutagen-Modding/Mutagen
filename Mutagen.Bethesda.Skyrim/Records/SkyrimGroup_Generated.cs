...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        where T : class, ISkyrimMajorRecordInternal, IBinaryItem
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => SkyrimGroupCommon<T>.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public override IEnumerable<IAssetLinkGetter> EnumerateAssetLinks(AssetLinkQuery queryCategories, IAssetLinkCache? linkCache, Type? assetType) => SkyrimGroupCommon<T>.Instance.EnumerateAssetLinks(this, queryCategories, linkCache, assetType);
        ...
        public override void RemapAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping, AssetLinkQuery queryCategories, IAssetLinkCache? linkCache) => SkyrimGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, linkCache, queryCategories);
        public override void RemapListedAssetLinks(IReadOnlyDictionary<IAssetLinkGetter, string> mapping) => SkyrimGroupSetterCommon<T>.Instance.RemapAssetLinks(this, mapping, null, AssetLinkQuery.Listed);
        #endregion
...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        where T : class, ISkyrimMajorRecordInternal, IBinaryItem
    {
        ...
        public IEnumerable<IMajorRecord> EnumerateMajorRecordsLoopLogic(ISkyrimGroup<T> obj)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumeratePotentiallyTypedMajorRecords(
            ...
            bool throwIfUnknown)
        {
            if (type == null) return SkyrimGroupCommon<T>.Instance.EnumerateMajorRecords(obj);
            return SkyrimGroupCommon<T>.Instance.EnumerateMajorRecords(obj, type, throwIfUnknown);
        }
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(
            ...
            bool throwIfUnknown)
        {
            foreach (var item in SkyrimGroupCommon<T>.Instance.EnumerateMajorRecordsLoopLogic(obj, type, throwIfUnknown))
            {
                yield return item;
            }
        }
        ...
        {
            PluginUtilityTranslation.GroupParse<ISkyrimGroup<T>, T>(
                record: item,
                frame: frame,
                translationParams: translationParams,
                expectedRecordType: SkyrimGroup<T>.T_RecordType,
        ...
        where T : class, ISkyrimMajorRecordGetter, IBinaryItem
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISkyrimGroupGetter<T> obj, bool iterateNestedRecords = true)
        {
        ...
        public IEnumerable<IMajorRecordGetter> EnumerateMajorRecordsLoopLogic(ISkyrimGroupGetter<T> obj)
        {
