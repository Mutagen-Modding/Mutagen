...
namespace Mutagen.Bethesda.Skyrim
{
        ...
        IEquatable<SkyrimMod>
    {
        ...
        public static Task<SkyrimMod> Create_Xml_Folder(
            DirectoryPath dir,
            ModKey modKey)
        {
        ...
        public static async Task<(SkyrimMod Mod, SkyrimMod_ErrorMask ErrorMask)> Create_Xml_Folder_WithErrors(
            DirectoryPath dir,
            ModKey modKey)
        {
        ...
        public static async Task<SkyrimMod> Create_Xml_Folder(
            DirectoryPath dir,
            ModKey modKey,
            ErrorMaskBuilder errorMask)
        {
        ...
        public async Task<SkyrimMod_ErrorMask> Write_XmlFolder(
            DirectoryPath dir,
            bool doMasks = true)
        {
        ...
        [DebuggerStepThrough]
        public static async Task<SkyrimMod> Create_Binary(
            MutagenFrame frame,
            ModKey modKey,
        ...
        [DebuggerStepThrough]
        public static async Task<(SkyrimMod Object, SkyrimMod_ErrorMask ErrorMask)> Create_Binary_Error(
            MutagenFrame frame,
            ModKey modKey,
            bool doMasks = true,
            GroupMask importMask = null)
        ...
        public void CopyFieldsFrom(ISkyrimModGetter rhs)
        {
            this.CopyFieldsFrom(
                rhs: (ISkyrimModGetter)rhs,
                def: null,
                doMasks: false,
...
namespace Mutagen.Bethesda.Skyrim.Internals
{
    ...
    public static partial class SkyrimModCommon
    {
            ...
            SkyrimMod_Mask<bool> printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"{nameof(SkyrimMod)} =>");
            }
            else
            {
                fg.AppendLine($"{name} ({nameof(SkyrimMod)}) =>");
            }
            fg.AppendLine("[");
    ...
    #region Binary Translation
    public partial class SkyrimModBinaryTranslation
    {
