...
namespace Mutagen.Bethesda.Tests.Internals
{
    ...
    public partial class Target_Registration : ILoquiRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "NICKNAME":
                    return (ushort)Target_FieldIndex.Nickname;
                case "INTEREST":
    ...
    public partial class TargetCommon
    {
            ...
            Target.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.Nickname ?? true)
            {
                fg.AppendItem(item.Nickname, "Nickname");
            }
            if (printMask?.Interest?.Overall ?? true)
            {
    ...
    public partial class TargetSetterTranslationCommon
    {
            ...
            TranslationCrystal? copyMask)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Target_FieldIndex.Nickname) ?? true))
            {
...
namespace Mutagen.Bethesda.Tests.Internals
{
    public partial class TargetXmlWriteTranslation : IXmlWriteTranslator
    {
            ...
            TranslationCrystal? translationMask)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)Target_FieldIndex.Nickname) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Nickname),
                    item: item.Nickname,
                    fieldIndex: (int)Target_FieldIndex.Nickname,
                    errorMask: errorMask);
            }
            ...
            TranslationCrystal? translationMask)
        {
            switch (name)
            {
                ...
                case "Nickname":
                    if ((translationMask?.GetShouldTranslate((int)Target_FieldIndex.Nickname) ?? true))
                    {
                        errorMask?.PushIndex((int)Target_FieldIndex.Nickname);
                        try
                        {
                            item.Nickname = StringXmlTranslation.Instance.Parse(
                                node: node,
                                errorMask: errorMask);
                        }
                        catch (Exception ex)
