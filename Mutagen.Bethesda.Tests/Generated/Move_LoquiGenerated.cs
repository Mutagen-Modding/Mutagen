...
namespace Mutagen.Bethesda.Tests
{
        ...
        IEquatable<Move>
    {
        ...
        public static Move Create_Xml(
            XElement root,
            Move_TranslationMask translationMask = null)
        {
            return Create_Xml(
                root: root,
                errorMask: null,
        ...
        public void CopyIn_Xml(
            string path,
            out Move_ErrorMask errorMask,
            Move_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var root = XDocument.Load(path).Root;
...
namespace Mutagen.Bethesda.Tests.Internals
{
    ...
    public static partial class MoveCommon
    {
            ...
            string name = null)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)Move_FieldIndex.SectionToMove) ?? true))
            {
            ...
            if ((translationMask?.GetShouldTranslate((int)Move_FieldIndex.LocationToMove) ?? true))
            {
    ...
    public class Move_TranslationMask : ITranslationMask
    {
        #region Members
        ...
        {
            ret.Add((SectionToMove, null));
            ret.Add((LocationToMove, null));
        }
    }
    #endregion
