...
namespace Mutagen.Bethesda.Tests
{
        ...
        IEquatable<DataTarget>
    {
        ...
        public static DataTarget Create_Xml(
            XElement root,
            DataTarget_TranslationMask translationMask = null)
        {
            return Create_Xml(
                root: root,
                errorMask: null,
        ...
        public void CopyIn_Xml(
            string path,
            out DataTarget_ErrorMask errorMask,
            DataTarget_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var root = XDocument.Load(path).Root;
...
namespace Mutagen.Bethesda.Tests.Internals
{
    ...
    public static partial class DataTargetCommon
    {
            ...
            string name = null)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)DataTarget_FieldIndex.Location) ?? true))
            {
            ...
            if ((translationMask?.GetShouldTranslate((int)DataTarget_FieldIndex.Data) ?? true))
            {
    ...
    public class DataTarget_TranslationMask : ITranslationMask
    {
        #region Members
