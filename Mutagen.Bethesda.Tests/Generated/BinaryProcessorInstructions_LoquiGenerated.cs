...
namespace Mutagen.Bethesda.Tests
{
        ...
        IEquatable<BinaryProcessorInstructions>
    {
        ...
        public static BinaryProcessorInstructions Create_Xml(
            XElement root,
            BinaryProcessorInstructions_TranslationMask translationMask = null)
        {
            return Create_Xml(
                root: root,
                errorMask: null,
        ...
        public void CopyIn_Xml(
            string path,
            out BinaryProcessorInstructions_ErrorMask errorMask,
            BinaryProcessorInstructions_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var root = XDocument.Load(path).Root;
                ...
                case "Instruction":
                    try
                    {
                        ...
                        if (LoquiXmlTranslation<Instruction>.Instance.Parse(
                            root: root,
                            item: out Instruction InstructionParse,
                            errorMask: errorMask,
                            translationMask: translationMask?.GetSubCrystal((int)BinaryProcessorInstructions_FieldIndex.Instruction)))
                        {
                            item.Instruction = InstructionParse;
                        }
                        else
                        {
...
namespace Mutagen.Bethesda.Tests.Internals
{
    ...
    public static partial class BinaryProcessorInstructionsCommon
    {
            ...
            string name = null)
        {
            ...
            if ((translationMask?.GetShouldTranslate((int)BinaryProcessorInstructions_FieldIndex.CompressionInstructions) ?? true))
            {
                try
                {
                    errorMask?.PushIndex((int)BinaryProcessorInstructions_FieldIndex.CompressionInstructions);
                    KeyedDictXmlTranslation<FormID, RecordInstruction>.Instance.Write(
                        ...
                        translationMask: translationMask,
                        errorMask: errorMask,
                        valTransl: (XElement subNode, RecordInstruction subItem, ErrorMaskBuilder dictSubMask, TranslationCrystal dictTranslMask) =>
                        {
            ...
            if ((translationMask?.GetShouldTranslate((int)BinaryProcessorInstructions_FieldIndex.Instruction) ?? true))
            {
    ...
    public class BinaryProcessorInstructions_TranslationMask : ITranslationMask
    {
        #region Members
        private TranslationCrystal _crystal;
        public MaskItem<bool, RecordInstruction_TranslationMask> CompressionInstructions;
        public MaskItem<bool, Instruction_TranslationMask> Instruction;
        #endregion
        ...
        {
            ret.Add((CompressionInstructions?.Overall ?? true, CompressionInstructions?.Specific?.GetCrystal()));
            ret.Add((Instruction?.Overall ?? true, Instruction?.Specific?.GetCrystal()));
        }
    }
    #endregion
