...
public class ExtraDataTests
{
        ...
        DirectoryPath existingTempDir)
    {
        ...
        var masterMod = new StarfieldMod(masterModKey, StarfieldRelease.Starfield);
        ...
        var pluginMod = new StarfieldMod(pluginModKey, StarfieldRelease.Starfield);
        ...
        using var readMod = StarfieldMod.Create(StarfieldRelease.Starfield)
            .FromPath(pluginPath)
