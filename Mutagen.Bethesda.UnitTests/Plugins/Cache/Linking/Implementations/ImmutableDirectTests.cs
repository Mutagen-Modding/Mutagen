...
public class ImmutableResolveDirectTests : ImmutableOverlayTests
{
    public ImmutableResolveDirectTests(LinkingTestInit testInit)
        : base(testInit)
    {
    }
...
public class ImmutableContextResolveDirectTests : ImmutableOverlayTests
{
    public ImmutableContextResolveDirectTests(LinkingTestInit testInit)
        : base(testInit)
    {
    }
