...
public class Fallout4MultiModOverlayTests
{
        ...
        Fallout4Mod mod2)
    {
        ...
        var master1 = new ModKey("Fallout4", ModType.Master);
        var master2 = new ModKey("DLCRobot", ModType.Plugin);
        ...
        var master3 = new ModKey("DLCCoast", ModType.Plugin);
        ...
        Fallout4Mod mod2)
    {
        ...
        // Cells property should now work (returns IFallout4ListGroupGetter<ICellBlockGetter>)
