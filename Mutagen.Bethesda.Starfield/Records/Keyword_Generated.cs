...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<Keyword>
    {
        ...
        String? IKeywordGetter.BFCB => this.BFCB;
        #endregion
        #region BFCE
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IKeywordGetter.BFCE => this.BFCE;
        #endregion
        #region Color
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case Keyword_FieldIndex.BFCB:
                        return BFCB;
                    case Keyword_FieldIndex.BFCE:
                        return BFCE;
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class KeywordCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Keyword_FieldIndex.BFCB) ?? true))
            {
                if (!string.Equals(lhs.BFCB, rhs.BFCB)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Keyword_FieldIndex.BFCE) ?? true))
            {
    ...
    internal partial class KeywordSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)Keyword_FieldIndex.BFCB) ?? true))
            {
                item.BFCB = rhs.BFCB;
            }
            if ((copyMask?.GetShouldTranslate((int)Keyword_FieldIndex.BFCE) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.BFCB:
                {
                    ...
                    return (int)Keyword_FieldIndex.BFCB;
                }
                case RecordTypeInts.BFCE:
                {
                    ...
                    return (int)Keyword_FieldIndex.BFCE;
                }
