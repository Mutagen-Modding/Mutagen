...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<GameSettingString>
    {
        ...
        public GameSettingString(IStarfieldMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public GameSettingString(IStarfieldMod mod, string editorID)
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class GameSettingString_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "0427f4de-269b-4497-a1bf-cdff384ca943";
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.GameSettingString";
    ...
    internal partial class GameSettingStringCommon : GameSettingCommon
    {
        ...
        public static new GameSettingString_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
