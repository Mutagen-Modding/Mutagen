        ...
        IQuestReferenceAlias
    {
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.TerminalMenus = new MaskItem<TItem, IEnumerable<(int Index, TItem Value)>?>(initialValue, []);
            }
            ...
            : base()
            {
                ...
                this.TerminalMenus = new MaskItem<TItem, IEnumerable<(int Index, TItem Value)>?>(TerminalMenus, []);
            }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                {
                    obj.TerminalMenus = new MaskItem<R, IEnumerable<(int Index, R Value)>?>(eval(this.TerminalMenus.Overall), []);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class QuestReferenceAliasCommon : AQuestAliasCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IQuestReferenceAliasGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in FindMatchingRefNearAliasItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
