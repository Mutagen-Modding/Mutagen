...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILeveledItemEntryGetter
    {
        ...
        public IFormLinkGetter<IItemGetter> Reference => FormLinkBinaryTranslation.Instance.OverlayFactory<IItemGetter>(_package, _recordData.Span.Slice(_ReferenceLocation, 0x4), isSet: _Reference_IsSet);
        #endregion
        #region Count
