...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<LeveledItemEntry>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IConditionGetter> ILeveledItemEntryGetter.Conditions => _Conditions;
        #endregion
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case LeveledItemEntry_FieldIndex.Level:
                        return Level;
                    case LeveledItemEntry_FieldIndex.Unused:
                        return Unused;
                    case LeveledItemEntry_FieldIndex.Reference:
                        return Reference;
                    case LeveledItemEntry_FieldIndex.Count:
                        return Count;
                    case LeveledItemEntry_FieldIndex.ChanceNone:
                        return ChanceNone;
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LeveledItemEntry_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.LeveledItemEntry";
    ...
    internal partial class LeveledItemEntryCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.Unused) ?? true))
            {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.ChanceNone) ?? true))
            {
                if (!lhs.ChanceNone.Equals(rhs.ChanceNone)) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.Unused2) ?? true))
            {
    ...
    internal partial class LeveledItemEntrySetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.Unused) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)LeveledItemEntry_FieldIndex.ChanceNone) ?? true))
            {
            ...
            {
                errorMask?.PushIndex((int)LeveledItemEntry_FieldIndex.Conditions);
                try
                {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.CTDA:
                {
                    ...
                    return (int)LeveledItemEntry_FieldIndex.Conditions;
                }
                default:
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILeveledItemEntryGetter
    {
        ...
        public IFormLinkGetter<IItemGetter> Reference => _Reference_IsSet ? new FormLink<IItemGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_recordData.Span.Slice(_ReferenceLocation, 0x4)))) : FormLink<IItemGetter>.Null;
        #endregion
        #region Count
