...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<FindMatchingRefNearAlias>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<ILocationReferenceTypeGetter> IFindMatchingRefNearAliasGetter.RefType => this.RefType;
        #endregion
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case FindMatchingRefNearAlias_FieldIndex.Type:
                        return Type;
                    case FindMatchingRefNearAlias_FieldIndex.RefType:
                        return RefType;
                    default:
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => FindMatchingRefNearAliasCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => FindMatchingRefNearAliasSetterCommon.Instance.RemapLinks(this, mapping);
        #endregion
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class FindMatchingRefNearAlias_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.FindMatchingRefNearAlias";
    ...
    internal partial class FindMatchingRefNearAliasCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)FindMatchingRefNearAlias_FieldIndex.RefType) ?? true))
            {
    ...
    internal partial class FindMatchingRefNearAliasSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)FindMatchingRefNearAlias_FieldIndex.RefType) ?? true))
            {
    ...
    public partial class FindMatchingRefNearAliasBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            FormLinkBinaryTranslation.Instance.WriteNullable(
                writer: writer,
                item: item.RefType,
                header: translationParams.ConvertToCustom(RecordTypes.ALNR));
        }
    ...
    internal partial class FindMatchingRefNearAliasBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)FindMatchingRefNearAlias_FieldIndex.RefType, translationParams)) return ParseResult.Stop;
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.RefType.SetTo(FormLinkBinaryTranslation.Instance.Parse(reader: frame));
                    return (int)FindMatchingRefNearAlias_FieldIndex.RefType;
                }
                default:
