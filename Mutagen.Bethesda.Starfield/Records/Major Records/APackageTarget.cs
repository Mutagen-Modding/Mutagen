...
partial class APackageTarget
{
    ...
    public static APackageTarget CreateFromBinary(MutagenFrame frame)
    {
        APackageTarget target = ((APackageTarget.Type)frame.ReadUInt32()) switch
        {
            ...
            {
                Reference = new FormLink<IStarfieldMajorRecordGetter>(FormKeyBinaryTranslation.Instance.Parse(frame))
            },
    ...
    public static void WriteCustom(MutagenWriter writer, IAPackageTargetGetter item)
    {
        switch (item)
        {
            ...
            case PackageTargetKeyword r:
                ...
                FormKeyBinaryTranslation.Instance.Write(writer, r.Keyword.FormKey);
                break;
