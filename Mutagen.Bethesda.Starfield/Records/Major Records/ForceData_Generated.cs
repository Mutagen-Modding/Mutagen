...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ForceDataCommon : StarfieldMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IForceDataGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IForceDataGetter
    {
        ...
        protected override Type LinkType => typeof(IForceDataGetter);
