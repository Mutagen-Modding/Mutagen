...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPlacedConeInternal
    {
        ...
        public PlacedCone(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public PlacedCone(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.PCON)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class PlacedCone_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.PlacedCone";
    ...
    internal partial class PlacedConeCommon : APlacedTrapCommon
    {
        ...
        public static new PlacedCone_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
