        ...
        ILoquiObjectSetter<LeveledBaseForm>
    {
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.Entries = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, LeveledBaseFormEntry.Mask<TItem>?>>?>(initialValue, []);
                ...
                StarfieldMajorRecordFlags: StarfieldMajorRecordFlags)
            {
                ...
                this.Entries = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, LeveledBaseFormEntry.Mask<TItem>?>>?>(Entries, []);
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Entries != null)
                {
                    obj.Entries = new MaskItem<R, IEnumerable<MaskItemIndexed<R, LeveledBaseFormEntry.Mask<R>?>>?>(eval(this.Entries.Overall), []);
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => LeveledBaseFormCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LeveledBaseFormCommon : StarfieldMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILeveledBaseFormGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILeveledBaseFormGetter
    {
        ...
        protected override Type LinkType => typeof(ILeveledBaseFormGetter);
