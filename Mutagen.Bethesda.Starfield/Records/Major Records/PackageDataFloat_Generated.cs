...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class PackageDataFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.PackageDataFloat";
    ...
    internal partial class PackageDataFloatCommon : APackageDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPackageDataFloatGetter obj, bool iterateNestedRecords = true)
        {
