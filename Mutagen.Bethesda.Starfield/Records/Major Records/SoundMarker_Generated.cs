...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ISoundMarkerInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? ISoundMarkerGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt64? ISoundMarkerGetter.XALG => this.XALG;
        #endregion
        #region Keywords
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case SoundMarker_FieldIndex.VirtualMachineAdapter:
                        return VirtualMachineAdapter;
                    case SoundMarker_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case SoundMarker_FieldIndex.DirtinessScale:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class SoundMarkerCommon : StarfieldMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISoundMarkerGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in SMLSItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
    ...
    internal partial class SoundMarkerSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)SoundMarker_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)SoundMarker_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)SoundMarker_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)SoundMarker_FieldIndex.DirtinessScale) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)SoundMarker_FieldIndex.VirtualMachineAdapter;
                }
                ...
                case RecordTypeInts.SMLS:
                {
                    ...
                    item.SMLS = Mutagen.Bethesda.Starfield.SoundReference.CreateFromBinary(frame: frame.SpawnWithLength(contentLength));
