...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPackageInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IFormLinkNullableGetter<IKeywordGetter> IPackageGetter.AnimationFlavor => this.AnimationFlavor;
        #endregion
        ...
        #endregion
        #region PackageGroup
        public Package.Group PackageGroup { get; set; } = default(Package.Group);
        #endregion
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.PackageGroup = initialValue;
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.PackageGroup, rhs.PackageGroup)) return false;
            ...
            public override bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.PackageGroup)) return false;
            ...
            public override bool Any(Func<TItem, bool> eval)
            {
                ...
                if (eval(this.PackageGroup)) return true;
                if (this.ProcedureTree != null)
                {
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                obj.PackageGroup = eval(this.PackageGroup);
            ...
            public void Print(StructuredStringBuilder sb, Package.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.PackageGroup ?? true)
                    {
                        sb.AppendItem(PackageGroup, "PackageGroup");
                    }
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Package_FieldIndex.OwnerQuest:
                        return OwnerQuest;
                    case Package_FieldIndex.AnimationFlavor:
                    ...
                    case Package_FieldIndex.Data:
                        return Data;
                    case Package_FieldIndex.PackageGroup:
                        return PackageGroup;
            ...
            public override void SetNthMask(int index, object obj)
            {
                ...
                switch (enu)
                {
                    ...
                    case Package_FieldIndex.Data:
                        ...
                        break;
                    case Package_FieldIndex.PackageGroup:
                        this.PackageGroup = (Exception?)obj;
                        break;
                    case Package_FieldIndex.ProcedureTree:
            ...
            public override bool IsInError()
            {
                ...
                if (PackageGroup != null) return true;
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.PackageGroup = this.PackageGroup.Combine(rhs.PackageGroup);
        ...
        IStarfieldMajorRecordInternal
    {
        ...
        new Package.Group PackageGroup { get; set; }
        ...
        IMapsToGetter<IPackageGetter>
    {
        ...
        Package.Group PackageGroup { get; }
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class PackageSetterCommon : StarfieldMajorRecordSetterCommon
    {
        ...
        public void Clear(IPackageInternal item)
        {
            ...
            item.Data.Clear();
            item.PackageGroup = default(Package.Group);
    ...
    internal partial class PackageCommon : StarfieldMajorRecordCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.Data = EqualsMaskHelper.DictEqualsHelper(
                ...
                include: include);
            ret.PackageGroup = item.PackageGroup == rhs.PackageGroup;
            ...
            Package.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.PackageGroup ?? true)
            {
                sb.AppendItem(item.PackageGroup, "PackageGroup");
            }
            if (printMask?.ProcedureTree?.Overall ?? true)
            {
                sb.AppendLine("ProcedureTree =>");
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Package_FieldIndex.AnimationFlavor) ?? true))
            {
    ...
    internal partial class PackageSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Package_FieldIndex.AnimationFlavor) ?? true))
            {
            ...
            if ((copyMask?.GetShouldTranslate((int)Package_FieldIndex.PackageGroup) ?? true))
            {
                item.PackageGroup = rhs.PackageGroup;
            }
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            PackageBinaryWriteTranslation.WriteBinaryPackageTemplate(
                writer: writer,
                item: item);
            EnumBinaryTranslation<Package.Group, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.PackageGroup,
                length: 1,
                header: translationParams.ConvertToCustom(RecordTypes.XNAM));
            PackageBinaryWriteTranslation.WriteBinaryProcedureTree(
                writer: writer,
                item: item);
            if (item.OnBegin is {} OnBeginItem)
            {
        ...
        public static partial void WriteBinaryProcedureTreeCustom(
            MutagenWriter writer,
            IPackageGetter item);

        public static void WriteBinaryProcedureTree(
            MutagenWriter writer,
            IPackageGetter item)
        {
            WriteBinaryProcedureTreeCustom(
                writer: writer,
                item: item);
        }
    ...
    internal partial class PackageBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.VirtualMachineAdapter = Mutagen.Bethesda.Starfield.PackageAdapter.CreateFromBinary(
                        frame: frame,
                ...
                {
                    item.IdleAnimations = Mutagen.Bethesda.Starfield.PackageIdles.CreateFromBinary(
                        frame: frame,
                ...
                case RecordTypeInts.FLAV:
                {
                    ...
                    return (int)Package_FieldIndex.AnimationFlavor;
                }
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.PackageGroup = EnumBinaryTranslation<Package.Group, MutagenFrame, MutagenWriter>.Instance.Parse(
                        reader: frame,
                        length: contentLength);
                    return (int)Package_FieldIndex.PackageGroup;
                }
                case RecordTypeInts.ANAM:
                {
                    PackageBinaryCreateTranslation.FillBinaryProcedureTreeCustom(
                        frame: frame.SpawnWithLength(frame.MetaData.Constants.SubConstants.HeaderLength + contentLength),
                        item: item,
                        lastParsed: lastParsed);
                    return (int)Package_FieldIndex.ProcedureTree;
                }
                case RecordTypeInts.POBA:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength + contentLength; // Skip marker
                    item.OnBegin = Mutagen.Bethesda.Starfield.PackageEvent.CreateFromBinary(
                        frame: frame,
                        translationParams: translationParams.DoNotShortCircuit());
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength + contentLength; // Skip marker
                    item.OnEnd = Mutagen.Bethesda.Starfield.PackageEvent.CreateFromBinary(
                        frame: frame,
                        translationParams: translationParams.DoNotShortCircuit());
                ...
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength + contentLength; // Skip marker
                    item.OnChange = Mutagen.Bethesda.Starfield.PackageEvent.CreateFromBinary(
                        frame: frame,
                        translationParams: translationParams.DoNotShortCircuit());
        ...
        public static partial void FillBinaryProcedureTreeCustom(
            MutagenFrame frame,
            IPackageInternal item,
            PreviousParse lastParsed);
        ...
        IPackageGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.XNAM:
                {
                    _PackageGroupLocation = (stream.Position - offset);
                    return (int)Package_FieldIndex.PackageGroup;
                }
                case RecordTypeInts.ANAM:
                {
                    ProcedureTreeCustomParse(
                        stream: stream,
                        finalPos: finalPos,
                        offset: offset,
                        type: type,
