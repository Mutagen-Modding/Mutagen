...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<LensFlare>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? ILensFlareGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case LensFlare_FieldIndex.VirtualMachineAdapter:
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => LensFlareCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        public override void RemapLinks(IReadOnlyDictionary<FormKey, FormKey> mapping) => LensFlareSetterCommon.Instance.RemapLinks(this, mapping);
        public LensFlare(
            FormKey formKey,
        ...
        public LensFlare(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public LensFlare(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.LENS)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal enum LensFlare_FieldIndex
    {
        ...
        ColorInfluence = 8,
        FadeDistanceRadiusScale = 9,
        ExposureInfluence = 10,
        MinEV100 = 11,
        MaxEV100 = 12,
        Sprites = 13,
    }
    ...
    internal partial class LensFlare_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.LensFlare";
    ...
    #region Common
    internal partial class LensFlareSetterCommon : StarfieldMajorRecordSetterCommon
    {
    ...
    internal partial class LensFlareCommon : StarfieldMajorRecordCommon
    {
        ...
        public static LensFlare_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class LensFlareSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)LensFlare_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)LensFlare_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)LensFlare_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LensFlareBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)LensFlare_FieldIndex.VirtualMachineAdapter;
                }
