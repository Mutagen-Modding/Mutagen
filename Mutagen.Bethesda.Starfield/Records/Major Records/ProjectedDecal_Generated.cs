...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IProjectedDecalInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? IProjectedDecalGetter.ObjectPlacementDefaults => this.ObjectPlacementDefaults;
        #endregion
        #region Components
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    internal partial class ProjectedDecalCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ProjectedDecal_FieldIndex.ObjectPlacementDefaults) ?? true))
            {
                ...
                {
                    if (!((ObjectPaletteDefaultsCommon)((IObjectPaletteDefaultsGetter)lhsObjectPlacementDefaults).CommonInstance()!).Equals(lhsObjectPlacementDefaults, rhsObjectPlacementDefaults, equalsMask?.GetSubCrystal((int)ProjectedDecal_FieldIndex.ObjectPlacementDefaults))) return false;
                }
