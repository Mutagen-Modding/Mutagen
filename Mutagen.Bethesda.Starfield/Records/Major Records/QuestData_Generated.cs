...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class QuestData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.QuestData";
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IQuestDataGetter
    {
        ...
        public Quest.Flag Flags => (Quest.Flag)BinaryPrimitives.ReadInt32LittleEndian(_structData.Span.Slice(0x0, 0x4));
        public Byte Priority => _structData.Span[0x4];
