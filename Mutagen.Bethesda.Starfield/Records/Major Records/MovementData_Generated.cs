...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class MovementData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "677daedf-cb74-4ce3-833c-9a0a8e7c8e7c";
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.MovementData";
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class MovementDataBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.Left = Mutagen.Bethesda.Starfield.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Right = Mutagen.Bethesda.Starfield.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Forward = Mutagen.Bethesda.Starfield.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Back = Mutagen.Bethesda.Starfield.MovementDirectionData.CreateFromBinary(frame: frame);
            item.Pitch = Mutagen.Bethesda.Starfield.MovementRotationData.CreateFromBinary(frame: frame);
            item.Roll = Mutagen.Bethesda.Starfield.MovementRotationData.CreateFromBinary(frame: frame);
            item.Yaw = Mutagen.Bethesda.Starfield.MovementRotationData.CreateFromBinary(frame: frame);
