...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<CollisionLayer>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? ICollisionLayerGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        String? ICollisionLayerGetter.ContextNotes => this.ContextNotes;
        #endregion
        #region Index
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case CollisionLayer_FieldIndex.VirtualMachineAdapter:
                        return VirtualMachineAdapter;
                    case CollisionLayer_FieldIndex.Description:
                        return Description;
                    case CollisionLayer_FieldIndex.ContextNotes:
                        return ContextNotes;
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => CollisionLayerCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class CollisionLayerCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)CollisionLayer_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.VirtualMachineAdapter, rhs.VirtualMachineAdapter, out var lhsVirtualMachineAdapter, out var rhsVirtualMachineAdapter, out var isVirtualMachineAdapterEqual))
                {
                    if (!((VirtualMachineAdapterCommon)((IVirtualMachineAdapterGetter)lhsVirtualMachineAdapter).CommonInstance()!).Equals(lhsVirtualMachineAdapter, rhsVirtualMachineAdapter, equalsMask?.GetSubCrystal((int)CollisionLayer_FieldIndex.VirtualMachineAdapter))) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)CollisionLayer_FieldIndex.ContextNotes) ?? true))
            {
    ...
    internal partial class CollisionLayerSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)CollisionLayer_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)CollisionLayer_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)CollisionLayer_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)CollisionLayer_FieldIndex.ContextNotes) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)CollisionLayer_FieldIndex.VirtualMachineAdapter;
                }
                ...
                case RecordTypeInts.NLDT:
                {
                    ...
                    item.ContextNotes = StringBinaryTranslation.Instance.Parse(
                        ...
                        stringBinaryType: StringBinaryType.NullTerminate,
                        parseWhole: true);
                    return (int)CollisionLayer_FieldIndex.ContextNotes;
                }
