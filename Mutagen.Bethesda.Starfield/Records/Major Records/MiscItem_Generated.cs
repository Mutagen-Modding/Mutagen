...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IMiscItemInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? IMiscItemGetter.ObjectPaletteDefaults => this.ObjectPaletteDefaults;
        #endregion
        #region Transforms
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case MiscItem_FieldIndex.ObjectPaletteDefaults:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class MiscItemCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MiscItem_FieldIndex.ObjectPaletteDefaults) ?? true))
            {
                ...
                {
                    if (!((ObjectPaletteDefaultsCommon)((IObjectPaletteDefaultsGetter)lhsObjectPaletteDefaults).CommonInstance()!).Equals(lhsObjectPaletteDefaults, rhsObjectPaletteDefaults, equalsMask?.GetSubCrystal((int)MiscItem_FieldIndex.ObjectPaletteDefaults))) return false;
                }
    ...
    internal partial class MiscItemSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)MiscItem_FieldIndex.ObjectPaletteDefaults) ?? true))
            {
                errorMask?.PushIndex((int)MiscItem_FieldIndex.ObjectPaletteDefaults);
                try
                {
                    if(rhs.ObjectPaletteDefaults is {} rhsObjectPaletteDefaults)
                    {
                        item.ObjectPaletteDefaults = rhsObjectPaletteDefaults.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)MiscItem_FieldIndex.ObjectPaletteDefaults));
                    }
                    else
                    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.OPDS:
                {
                    ...
                    return (int)MiscItem_FieldIndex.ObjectPaletteDefaults;
                }
