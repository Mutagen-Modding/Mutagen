...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ColorData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.ColorData";
    ...
    internal partial class ColorDataCommon : AColorRecordDataCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IColorDataGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
