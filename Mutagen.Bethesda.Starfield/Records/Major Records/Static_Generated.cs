            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case Static_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case Static_FieldIndex.DirtinessScale:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class StaticSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Static_FieldIndex.DirtinessScale) ?? true))
            {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)Static_FieldIndex.DirtinessScale;
                }
