...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IScenePhase
    {
        ...
        #region SPMV
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected MemorySlice<Byte>? _SPMV;
        public MemorySlice<Byte>? SPMV
        {
            get => this._SPMV;
            set => this._SPMV = value;
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ReadOnlyMemorySlice<Byte>? IScenePhaseGetter.SPMV => this.SPMV;
        #endregion
            ...
            IMask<TItem>
        {
            ...
            public bool Equals(Mask<TItem>? rhs)
            {
                ...
                if (!object.Equals(this.SPMV, rhs.SPMV)) return false;
                return true;
            }
            ...
            public bool All(Func<TItem, bool> eval)
            {
                ...
                if (!eval(this.SPMV)) return false;
                return true;
            }
            #endregion
            ...
            public void Print(StructuredStringBuilder sb, ScenePhase.Mask<bool>? printMask = null)
            {
                ...
                using (sb.Brace())
                {
                    ...
                    if (printMask?.SPMV ?? true)
                    {
                        sb.AppendItem(SPMV, "SPMV");
                    }
                }
            }
            #endregion
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case ScenePhase_FieldIndex.SPMV:
                        return SPMV;
                    default:
            ...
            public ErrorMask Combine(ErrorMask? rhs)
            {
                ...
                ret.SPMV = this.SPMV.Combine(rhs.SPMV);
                return ret;
            }
        ...
        IScenePhaseGetter
    {
        ...
        new MemorySlice<Byte>? SPMV { get; set; }
    }
        ...
        INamedRequiredGetter
    {
        ...
        ReadOnlyMemorySlice<Byte>? SPMV { get; }
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ScenePhase_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.ScenePhase";
    ...
    internal partial class ScenePhaseCommon
    {
            ...
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            ...
            ret.PhaseSetParentQuestStage = EqualsMaskHelper.EqualsHelper(
                ...
                include);
            ret.SPMV = MemorySliceExt.SequenceEqual(item.SPMV, rhs.SPMV);
        }
            ...
            ScenePhase.Mask<bool>? printMask = null)
        {
            ...
            if ((printMask?.SPMV ?? true)
                && item.SPMV is {} SPMVItem)
            {
                sb.AppendLine($"SPMV => {SpanExt.ToHexString(SPMVItem)}");
            }
        }
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.SPMV) ?? true))
            {
                if (!MemorySliceExt.SequenceEqual(lhs.SPMV, rhs.SPMV)) return false;
            }
            return true;
        }
        ...
        {
            foreach (var item in obj.StartConditions.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
                yield return FormLinkInformation.Factory(item);
            }
            foreach (var item in obj.CompletionConditions.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
                yield return FormLinkInformation.Factory(item);
            }
            yield break;
    ...
    internal partial class ScenePhaseSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)ScenePhase_FieldIndex.SPMV) ?? true))
            {
                if(rhs.SPMV is {} SPMVrhs)
                {
                    item.SPMV = SPMVrhs.ToArray();
                }
                else
                {
                    item.SPMV = default;
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.HNAM:
                {
                    ...
                    else if (lastParsed.ParsedIndex.Value <= (int)ScenePhase_FieldIndex.SPMV)
                    {
                        frame.ReadSubrecord();
                ...
                {
                    item.PhaseSetParentQuestStage = Mutagen.Bethesda.Starfield.SceneSetParentQuestStage.CreateFromBinary(frame: frame);
                    return (int)ScenePhase_FieldIndex.PhaseSetParentQuestStage;
                }
                case RecordTypeInts.SPMV:
                {
                    frame.Position += frame.MetaData.Constants.SubConstants.HeaderLength;
                    item.SPMV = ByteArrayBinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(reader: frame.SpawnWithLength(contentLength));
                    return (int)ScenePhase_FieldIndex.SPMV;
                }
                default:
                    return ParseResult.Stop;
            }
        ...
        IScenePhaseGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.SPMV:
                {
                    _SPMVLocation = (stream.Position - offset);
                    return (int)ScenePhase_FieldIndex.SPMV;
                }
                default:
                    return ParseResult.Stop;
