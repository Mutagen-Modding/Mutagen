...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<GameSettingFloat>
    {
        ...
        public GameSettingFloat(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public GameSettingFloat(IStarfieldMod mod, string editorID)
            : this(
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class GameSettingFloat_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.GameSettingFloat";
    ...
    internal partial class GameSettingFloatCommon : GameSettingCommon
    {
        ...
        public static new GameSettingFloat_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IGameSettingFloatGetter obj, bool iterateNestedRecords = true)
        {
