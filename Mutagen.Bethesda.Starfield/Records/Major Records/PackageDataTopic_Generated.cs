...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IPackageDataTopic
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return ((PackageDataTopicCommon)((IPackageDataTopicGetter)this).CommonInstance()!).Equals(this, rhs, equalsMask: null);
        }

        public bool Equals(IPackageDataTopicGetter? obj)
        {
            return ((PackageDataTopicCommon)((IPackageDataTopicGetter)this).CommonInstance()!).Equals(this, obj, equalsMask: null);
        }
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => PackageDataTopicCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class PackageDataTopic_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.PackageDataTopic";
    ...
    internal partial class PackageDataTopicCommon : APackageDataCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)PackageDataTopic_FieldIndex.Topics) ?? true))
            {
                if (!lhs.Topics.SequenceEqual(rhs.Topics, (l, r) => ((ATopicReferenceCommon)((IATopicReferenceGetter)l).CommonInstance()!).Equals(l, r, equalsMask?.GetSubCrystal((int)PackageDataTopic_FieldIndex.Topics)))) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)PackageDataTopic_FieldIndex.TPIC) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IPackageDataTopicGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    {
        public new static readonly PackageDataTopicBinaryWriteTranslation Instance = new();
