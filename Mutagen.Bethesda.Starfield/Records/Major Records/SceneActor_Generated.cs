...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class SceneActor_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.SceneActor";
    ...
    internal partial class SceneActorCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ISceneActorGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Starfield
{
    public partial class SceneActorBinaryWriteTranslation : IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            ...
            EnumBinaryTranslation<SceneActor.Flag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.Flags,
                length: 4,
                header: translationParams.ConvertToCustom(RecordTypes.LNAM));
            EnumBinaryTranslation<SceneActor.BehaviorFlag, MutagenFrame, MutagenWriter>.Instance.Write(
                writer,
                item.BehaviorFlags,
                length: 4,
