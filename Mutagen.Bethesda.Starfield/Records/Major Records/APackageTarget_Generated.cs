...
namespace Mutagen.Bethesda.Starfield
{
    #region Class
    /// <summary>
    /// Implemented by: [PackageTargetInterruptData, PackageTargetKeyword, PackageTargetLinkedReference, PackageTargetObjectID, PackageTargetObjectType, PackageTargetSpecificReference, PackageTargetUnknown]
    /// </summary>
        ...
        ILoquiObjectSetter<APackageTarget>
    {
        ...
        #region Mutagen
        public virtual IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => APackageTargetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class APackageTarget_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.APackageTarget";
    ...
    internal partial class APackageTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAPackageTargetGetter obj, bool iterateNestedRecords = true)
        {
            yield break;
        }
