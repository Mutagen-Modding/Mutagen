...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class Rank_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.Rank";
    ...
    internal partial class RankCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)Rank_FieldIndex.Number) ?? true))
            {
                if (lhs.Number != rhs.Number) return false;
            }
            if ((equalsMask?.GetShouldTranslate((int)Rank_FieldIndex.Title) ?? true))
            {
