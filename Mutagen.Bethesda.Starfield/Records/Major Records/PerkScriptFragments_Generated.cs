        ...
        IPerkScriptFragments
    {
            ...
            IMask<TItem>
        {
            ...
            public Mask(TItem initialValue)
            {
                ...
                this.Fragments = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>?>(initialValue, Enumerable.Empty<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>());
            }
                ...
                TItem Fragments)
            {
                ...
                this.Fragments = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>?>(Fragments, Enumerable.Empty<MaskItemIndexed<TItem, PerkScriptFragment.Mask<TItem>?>>());
            }
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Fragments != null)
                {
                    obj.Fragments = new MaskItem<R, IEnumerable<MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>>?>(eval(this.Fragments.Overall), Enumerable.Empty<MaskItemIndexed<R, PerkScriptFragment.Mask<R>?>>());
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class PerkScriptFragments_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.PerkScriptFragments";
