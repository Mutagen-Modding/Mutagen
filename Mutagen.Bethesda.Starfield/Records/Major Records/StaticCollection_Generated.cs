...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IStaticCollectionInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Single? IStaticCollectionGetter.ODTY => this.ODTY;
        #endregion
        #region SnapTemplate
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case StaticCollection_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case StaticCollection_FieldIndex.ODTY:
                        return ODTY;
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class StaticCollection_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "c165c588-c264-45c0-bfc0-22c15885dc3e";
    ...
    internal partial class StaticCollectionCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)StaticCollection_FieldIndex.ODTY) ?? true))
            {
    ...
    internal partial class StaticCollectionSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)StaticCollection_FieldIndex.ODTY) ?? true))
            {
                item.ODTY = rhs.ODTY;
            }
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    return (int)StaticCollection_FieldIndex.ODTY;
                }
