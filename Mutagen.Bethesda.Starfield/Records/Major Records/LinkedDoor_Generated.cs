        ...
        ILoquiObjectSetter<LinkedDoor>
    {
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case LinkedDoor_FieldIndex.Type:
                        return Type;
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LinkedDoor_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.LinkedDoor";
    ...
    internal partial class LinkedDoorCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LinkedDoor_FieldIndex.Type) ?? true))
            {
    ...
    internal partial class LinkedDoorSetterTranslationCommon
    {
        ...
        public void DeepCopyIn(
            ...
            bool deepCopy)
        {
            if ((copyMask?.GetShouldTranslate((int)LinkedDoor_FieldIndex.Type) ?? true))
            {
                item.Type = rhs.Type;
            }
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILinkedDoorGetter
    {
        ...
        public UInt32 Type => BinaryPrimitives.ReadUInt32LittleEndian(_structData.Slice(0x0, 0x4));
