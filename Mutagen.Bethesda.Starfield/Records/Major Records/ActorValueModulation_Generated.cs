        ...
        ILoquiObjectSetter<ActorValueModulation>
    {
            ...
            IMask<TItem>
        {
            ...
            : base(initialValue)
            {
                ...
                this.Entries = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ActorValueModulationEntry.Mask<TItem>?>>?>(initialValue, []);
                ...
                StarfieldMajorRecordFlags: StarfieldMajorRecordFlags)
            {
                ...
                this.YNAM = YNAM;
                this.TNAM = TNAM;
                this.Entries = new MaskItem<TItem, IEnumerable<MaskItemIndexed<TItem, ActorValueModulationEntry.Mask<TItem>?>>?>(Entries, []);
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Entries != null)
                {
                    obj.Entries = new MaskItem<R, IEnumerable<MaskItemIndexed<R, ActorValueModulationEntry.Mask<R>?>>?>(eval(this.Entries.Overall), []);
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ActorValueModulationCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ActorValueModulationCommon : StarfieldMajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IActorValueModulationGetter obj, bool iterateNestedRecords = true)
        {
