...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<LeveledPackIn>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? ILeveledPackInGetter.ObjectPaletteDefaults => this.ObjectPaletteDefaults;
        #endregion
        #region Components
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt64? ILeveledPackInGetter.XALG => this.XALG;
        #endregion
        #region ChanceNone
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case LeveledPackIn_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case LeveledPackIn_FieldIndex.DirtinessScale:
                        return DirtinessScale;
                    case LeveledPackIn_FieldIndex.ObjectPaletteDefaults:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LeveledPackInSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)LeveledPackIn_FieldIndex.DirtinessScale) ?? true))
            {
                item.DirtinessScale = rhs.DirtinessScale;
            }
            if ((copyMask?.GetShouldTranslate((int)LeveledPackIn_FieldIndex.ObjectPaletteDefaults) ?? true))
            {
                errorMask?.PushIndex((int)LeveledPackIn_FieldIndex.ObjectPaletteDefaults);
                try
                {
                    if(rhs.ObjectPaletteDefaults is {} rhsObjectPaletteDefaults)
                    {
                        item.ObjectPaletteDefaults = rhsObjectPaletteDefaults.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)LeveledPackIn_FieldIndex.ObjectPaletteDefaults));
                    }
                    else
                    {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)LeveledPackIn_FieldIndex.DirtinessScale;
                }
                case RecordTypeInts.OPDS:
                {
                    ...
                    return (int)LeveledPackIn_FieldIndex.ObjectPaletteDefaults;
                }
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILeveledPackInGetter
    {
        ...
        public LeveledPackIn.Flag Flags => EnumBinaryTranslation<LeveledPackIn.Flag, MutagenFrame, MutagenWriter>.Instance.ParseRecord(_FlagsLocation, _recordData, _package, 2);
        #endregion
