...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<ConstructibleObject>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? IConstructibleObjectGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case ConstructibleObject_FieldIndex.VirtualMachineAdapter:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal enum ConstructibleObject_FieldIndex
    {
        ...
        MenuArtObject = 24,
        LearnedFrom = 25,
        BaseReturnScaleTable = 26,
        LearnChance = 27,
        MaxBuildCountGlobal = 28,
        RecipeFilters = 29,
        InstantiationFilterKeyword = 30,
        Flags = 31,
    }
    #endregion
    ...
    internal partial class ConstructibleObjectCommon : StarfieldMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IConstructibleObjectGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in ConstructableComponentsItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
                    yield return FormLinkInformation.Factory(item);
                }
            }
            ...
            {
                foreach (var item in RepairComponentsItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
                    yield return FormLinkInformation.Factory(item);
                }
            }
    ...
    internal partial class ConstructibleObjectSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)ConstructibleObject_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)ConstructibleObject_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)ConstructibleObject_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)ConstructibleObject_FieldIndex.VirtualMachineAdapter;
                }
