...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ISnapTemplateNodeInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? ISnapTemplateNodeGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case SnapTemplateNode_FieldIndex.VirtualMachineAdapter:
                        return VirtualMachineAdapter;
                    case SnapTemplateNode_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case SnapTemplateNode_FieldIndex.DirtinessScale:
    ...
    internal partial class SnapTemplateNodeSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)SnapTemplateNode_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)SnapTemplateNode_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)SnapTemplateNode_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)SnapTemplateNode_FieldIndex.DirtinessScale) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)SnapTemplateNode_FieldIndex.VirtualMachineAdapter;
                }
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)SnapTemplateNode_FieldIndex.DirtinessScale;
                }
