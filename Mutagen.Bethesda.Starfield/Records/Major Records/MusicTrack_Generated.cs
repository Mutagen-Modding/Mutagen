...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IMusicTrackInternal
    {
        ...
        public MusicTrack(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public MusicTrack(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.MUST)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class MusicTrack_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.MusicTrack";
    ...
    #region Common
    internal partial class MusicTrackSetterCommon : StarfieldMajorRecordSetterCommon
    {
    ...
    internal partial class MusicTrackCommon : StarfieldMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IMusicTrackGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in MTSHItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
    ...
    internal partial class MusicTrackSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class MusicTrackBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
