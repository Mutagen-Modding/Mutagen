...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<AnimationSoundTagSet>
    {
        ...
        public AnimationSoundTagSet(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public AnimationSoundTagSet(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.STAG)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class AnimationSoundTagSet_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.AnimationSoundTagSet";
    ...
    #region Common
    internal partial class AnimationSoundTagSetSetterCommon : StarfieldMajorRecordSetterCommon
    {
    ...
    internal partial class AnimationSoundTagSetCommon : StarfieldMajorRecordCommon
    {
            ...
            AnimationSoundTagSet.Mask<bool>? printMask = null)
        {
                ...
                && item.Tags is {} TagsItem)
            {
                ...
                using (sb.Brace())
                {
                    foreach (var subItem in TagsItem)
                    {
                        using (sb.Brace())
                        {
        ...
        public static AnimationSoundTagSet_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IAnimationSoundTagSetGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in TagsItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
    ...
    internal partial class AnimationSoundTagSetSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
                ...
                try
                {
                    if ((rhs.Tags != null))
                    {
                        item.Tags = 
                            ...
                            .ToExtendedList<AnimationSoundTag>();
                    }
                    else
                    {
                        item.Tags = null;
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class AnimationSoundTagSetBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Tags = 
                        Mutagen.Bethesda.Plugins.Binary.Translations.ListBinaryTranslation<AnimationSoundTag>.Instance.ParsePerItem(
                            reader: frame,
                            countLengthLength: 4,
                            countRecord: RecordTypes.STMS,
        ...
        IAnimationSoundTagSetGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                case RecordTypeInts.STMS:
                {
                    this.Tags = BinaryOverlayList.FactoryByCountPerItem<IAnimationSoundTagGetter>(
                        stream: stream,
                        package: _package,
                        countLength: 4,
                        trigger: AnimationSoundTag_Registration.TriggerSpecs,
                        countType: RecordTypes.STMS,
                        translationParams: translationParams,
