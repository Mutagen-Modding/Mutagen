...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<Debris>
    {
        ...
        public Debris(IStarfieldMod mod)
            : this(mod.GetNextFormKey())
        {
        }

        public Debris(IStarfieldMod mod, string editorID)
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.DEBR)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class Debris_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "32f9124e-527b-40b5-a8fa-200718ca047c";
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.Debris";
    ...
    #region Common
    internal partial class DebrisSetterCommon : StarfieldMajorRecordSetterCommon
    {
            ...
            AssetLinkQuery queryCategories)
        {
            ...
            obj.Models.ForEach(x => x.RemapAssetLinks(mapping, queryCategories, linkCache));
        }
    ...
    internal partial class DebrisCommon : StarfieldMajorRecordCommon
    {
        ...
        public static Debris_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
    ...
    internal partial class DebrisSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class DebrisBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
