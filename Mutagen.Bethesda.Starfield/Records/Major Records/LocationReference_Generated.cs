...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<LocationReference>
    {
            ...
            public object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case LocationReference_FieldIndex.Grid:
                        return Grid;
                    case LocationReference_FieldIndex.Unknown:
                        return Unknown;
                    default:
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => LocationReferenceCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LocationReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.LocationReference";
    ...
    internal partial class LocationReferenceCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)LocationReference_FieldIndex.Unknown) ?? true))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILocationReferenceGetter obj, bool iterateNestedRecords = true)
        {
    ...
    internal partial class LocationReferenceSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)LocationReference_FieldIndex.Unknown) ?? true))
            {
