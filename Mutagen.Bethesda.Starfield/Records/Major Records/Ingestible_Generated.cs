...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<Ingestible>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? IIngestibleGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? IIngestibleGetter.ObjectPaletteDefaults => this.ObjectPaletteDefaults;
        #endregion
        #region Transforms
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        UInt64? IIngestibleGetter.XALG => this.XALG;
        #endregion
        #region Name
        /// <summary>
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case Ingestible_FieldIndex.VirtualMachineAdapter:
                        return VirtualMachineAdapter;
                    case Ingestible_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case Ingestible_FieldIndex.DirtinessScale:
                        return DirtinessScale;
                    case Ingestible_FieldIndex.ObjectPaletteDefaults:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class IngestibleCommon : StarfieldMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IIngestibleGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in PickupSoundItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in DropdownSoundItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in CraftingSoundItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in ResourcesItem.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
                {
                    yield return FormLinkInformation.Factory(item);
                }
            }
            yield return FormLinkInformation.Factory(obj.Addiction);
            foreach (var item in obj.ConsumeSound.EnumerateFormLinks(iterateNestedRecords))
            {
                yield return item;
            }
    ...
    internal partial class IngestibleSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)Ingestible_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)Ingestible_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Ingestible_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)Ingestible_FieldIndex.DirtinessScale) ?? true))
            {
                item.DirtinessScale = rhs.DirtinessScale;
            }
            if ((copyMask?.GetShouldTranslate((int)Ingestible_FieldIndex.ObjectPaletteDefaults) ?? true))
            {
                errorMask?.PushIndex((int)Ingestible_FieldIndex.ObjectPaletteDefaults);
                try
                {
                    if(rhs.ObjectPaletteDefaults is {} rhsObjectPaletteDefaults)
                    {
                        item.ObjectPaletteDefaults = rhsObjectPaletteDefaults.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Ingestible_FieldIndex.ObjectPaletteDefaults));
                    }
                    else
                    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)Ingestible_FieldIndex.VirtualMachineAdapter;
                }
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)Ingestible_FieldIndex.DirtinessScale;
                }
                case RecordTypeInts.OPDS:
                {
                    ...
                    return (int)Ingestible_FieldIndex.ObjectPaletteDefaults;
                }
