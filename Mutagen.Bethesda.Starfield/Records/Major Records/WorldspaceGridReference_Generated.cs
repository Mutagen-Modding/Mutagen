...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class WorldspaceGridReference_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.WorldspaceGridReference";
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class WorldspaceGridReferenceBinaryCreateTranslation
    {
        ...
        public static void FillBinaryStructs(
            ...
            MutagenFrame frame)
        {
            item.GridPosition = P2Int16BinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Parse(
                reader: frame,
                swapCoords: true);
            item.References.SetTo(
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IWorldspaceGridReferenceGetter
    {
        ...
        public P2Int16 GridPosition => P2Int16BinaryTranslation<MutagenFrame, MutagenWriter>.Instance.Read(_structData.Slice(0x0, 0x4), swapCoords: true);
        #region References
