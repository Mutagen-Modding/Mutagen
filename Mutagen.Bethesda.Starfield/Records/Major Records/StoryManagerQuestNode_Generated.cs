...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IStoryManagerQuestNodeInternal
    {
        ...
        public StoryManagerQuestNode(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public StoryManagerQuestNode(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.SMQN)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class StoryManagerQuestNode_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.StoryManagerQuestNode";
    ...
    internal partial class StoryManagerQuestNodeCommon : AStoryManagerNodeCommon
    {
        ...
        public static new StoryManagerQuestNode_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
