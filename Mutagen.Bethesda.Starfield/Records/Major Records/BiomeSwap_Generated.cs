...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<BiomeSwap>
    {
        ...
        public BiomeSwap(FormKey formKey)
        {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class BiomeSwap_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "20f84e54-61fe-42da-9e33-a44332dbf062";
    ...
    internal partial class BiomeSwapCommon : StarfieldMajorRecordCommon
    {
        ...
        public BiomeSwap Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new BiomeSwap(formKey);
        ...
        IBinaryWriteTranslator
    {
            ...
            TypedWriteParams translationParams)
        {
            using (HeaderExport.Record(
                writer: writer,
                record: translationParams.ConvertToCustom(RecordTypes.OSWP)))
            {
                try
                {
