...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<InstanceNamingRules>
    {
        ...
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => InstanceNamingRulesCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
        ...
        public InstanceNamingRules(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public InstanceNamingRules(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.INNR)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class InstanceNamingRules_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.InstanceNamingRules";
    ...
    #region Common
    internal partial class InstanceNamingRulesSetterCommon : StarfieldMajorRecordSetterCommon
    {
    ...
    internal partial class InstanceNamingRulesCommon : StarfieldMajorRecordCommon
    {
        ...
        public static InstanceNamingRules_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IInstanceNamingRulesGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in RuleslinkCont.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
    ...
    internal partial class InstanceNamingRulesSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class InstanceNamingRulesBinaryCreateTranslation : StarfieldMajorRecordBinaryCreateTranslation
    {
