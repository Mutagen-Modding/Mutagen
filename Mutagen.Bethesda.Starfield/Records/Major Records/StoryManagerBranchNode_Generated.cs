...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IStoryManagerBranchNodeInternal
    {
        ...
        public StoryManagerBranchNode(IStarfieldMod mod)
            : this(
                mod.GetNextFormKey(),
        ...
        public StoryManagerBranchNode(IStarfieldMod mod, string editorID)
            : this(
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Starfield.Internals.RecordTypeInts.SMBN)]
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class StoryManagerBranchNode_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.StoryManagerBranchNode";
    ...
    internal partial class StoryManagerBranchNodeCommon : AStoryManagerNodeCommon
    {
        ...
        public static new StoryManagerBranchNode_FieldIndex ConvertFieldIndex(StarfieldMajorRecord_FieldIndex index)
        {
            switch (index)
            {
