...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<IdleMarker>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IVirtualMachineAdapterGetter? IIdleMarkerGetter.VirtualMachineAdapter => this.VirtualMachineAdapter;
        #region Aspects
            ...
            IErrorMask<ErrorMask>
        {
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    case IdleMarker_FieldIndex.VirtualMachineAdapter:
                        return VirtualMachineAdapter;
                    case IdleMarker_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case IdleMarker_FieldIndex.DirtinessScale:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class IdleMarkerCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)IdleMarker_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                if (EqualsMaskHelper.RefEquality(lhs.VirtualMachineAdapter, rhs.VirtualMachineAdapter, out var lhsVirtualMachineAdapter, out var rhsVirtualMachineAdapter, out var isVirtualMachineAdapterEqual))
                {
                    if (!((VirtualMachineAdapterCommon)((IVirtualMachineAdapterGetter)lhsVirtualMachineAdapter).CommonInstance()!).Equals(lhsVirtualMachineAdapter, rhsVirtualMachineAdapter, equalsMask?.GetSubCrystal((int)IdleMarker_FieldIndex.VirtualMachineAdapter))) return false;
                }
            ...
            if ((equalsMask?.GetShouldTranslate((int)IdleMarker_FieldIndex.DirtinessScale) ?? true))
            {
    ...
    internal partial class IdleMarkerSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            base.DeepCopyIn(
                ...
                copyMask,
                deepCopy: deepCopy);
            if ((copyMask?.GetShouldTranslate((int)IdleMarker_FieldIndex.VirtualMachineAdapter) ?? true))
            {
                errorMask?.PushIndex((int)IdleMarker_FieldIndex.VirtualMachineAdapter);
                try
                {
                    if(rhs.VirtualMachineAdapter is {} rhsVirtualMachineAdapter)
                    {
                        item.VirtualMachineAdapter = rhsVirtualMachineAdapter.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)IdleMarker_FieldIndex.VirtualMachineAdapter));
                    }
                    else
                    {
            ...
            if ((copyMask?.GetShouldTranslate((int)IdleMarker_FieldIndex.DirtinessScale) ?? true))
            {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                case RecordTypeInts.VMAD:
                {
                    ...
                    return (int)IdleMarker_FieldIndex.VirtualMachineAdapter;
                }
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)IdleMarker_FieldIndex.DirtinessScale;
                }
