...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<Light>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? ILightGetter.ObjectPaletteDefaults => this.ObjectPaletteDefaults;
        #endregion
        #region Transforms
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            ...
            public override object? GetNthMask(int index)
            {
                ...
                switch (enu)
                {
                    ...
                    case Light_FieldIndex.ObjectBounds:
                        return ObjectBounds;
                    case Light_FieldIndex.DirtinessScale:
                        return DirtinessScale;
                    case Light_FieldIndex.ObjectPaletteDefaults:
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LightSetterCommon : StarfieldMajorRecordSetterCommon
    {
        ...
        public void Clear(ILightInternal item)
        {
            ...
            item.FalloffExponent = Light.FalloffExponentDefault;
            item.FOV = Light.FOVDefault;
    ...
    internal partial class LightCommon : StarfieldMajorRecordCommon
    {
        ...
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILightGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in SoundReferenceItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
    ...
    internal partial class LightSetterTranslationCommon : StarfieldMajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            if ((copyMask?.GetShouldTranslate((int)Light_FieldIndex.DirtinessScale) ?? true))
            {
                item.DirtinessScale = rhs.DirtinessScale;
            }
            if ((copyMask?.GetShouldTranslate((int)Light_FieldIndex.ObjectPaletteDefaults) ?? true))
            {
                errorMask?.PushIndex((int)Light_FieldIndex.ObjectPaletteDefaults);
                try
                {
                    if(rhs.ObjectPaletteDefaults is {} rhsObjectPaletteDefaults)
                    {
                        item.ObjectPaletteDefaults = rhsObjectPaletteDefaults.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Light_FieldIndex.ObjectPaletteDefaults));
                    }
                    else
                    {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                case RecordTypeInts.ODTY:
                {
                    ...
                    item.DirtinessScale = PercentBinaryTranslation.Parse(
                        reader: frame,
                        integerType: FloatIntegerType.UInt);
                    return (int)Light_FieldIndex.DirtinessScale;
                }
                case RecordTypeInts.OPDS:
                {
                    ...
                    return (int)Light_FieldIndex.ObjectPaletteDefaults;
                }
