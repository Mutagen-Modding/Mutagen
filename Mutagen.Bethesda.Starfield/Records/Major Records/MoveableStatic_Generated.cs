...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IMoveableStaticInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObjectPaletteDefaultsGetter? IMoveableStaticGetter.ObjectPlacementDefaults => this.ObjectPlacementDefaults;
        #endregion
        #region Transforms
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    internal partial class MoveableStaticCommon : StarfieldMajorRecordCommon
    {
            ...
            TranslationCrystal? equalsMask)
        {
            ...
            if ((equalsMask?.GetShouldTranslate((int)MoveableStatic_FieldIndex.ObjectPlacementDefaults) ?? true))
            {
                ...
                {
                    if (!((ObjectPaletteDefaultsCommon)((IObjectPaletteDefaultsGetter)lhsObjectPlacementDefaults).CommonInstance()!).Equals(lhsObjectPlacementDefaults, rhsObjectPlacementDefaults, equalsMask?.GetSubCrystal((int)MoveableStatic_FieldIndex.ObjectPlacementDefaults))) return false;
                }
