...
namespace Mutagen.Bethesda.Starfield
{
        ...
        INavigationMeshObstacleManagerSubObject
    {
        ...
        #region DATAs
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private SliceList<byte> _DATAs = new SliceList<byte>();
        public SliceList<byte> DATAs
        {
            get => this._DATAs;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<ReadOnlyMemorySlice<Byte>> INavigationMeshObstacleManagerSubObjectGetter.DATAs => _DATAs;
        #endregion
        ...
        ILoquiObject<INavigationMeshObstacleManagerSubObjectGetter>
    {
        ...
        UInt32? Index { get; }
        IReadOnlyList<ReadOnlyMemorySlice<Byte>> DATAs { get; }
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class NavigationMeshObstacleManagerSubObject_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.NavigationMeshObstacleManagerSubObject";
        ...
        INavigationMeshObstacleManagerSubObjectGetter
    {
            ...
            TypedParseParams translationParams = default)
        {
            ...
            switch (type.TypeInt)
            {
                ...
                {
                    if (lastParsed.ShortCircuit((int)NavigationMeshObstacleManagerSubObject_FieldIndex.DATAs, translationParams)) return ParseResult.Stop;
                    this.DATAs = BinaryOverlayList.FactoryByArray<ReadOnlyMemorySlice<Byte>>(
