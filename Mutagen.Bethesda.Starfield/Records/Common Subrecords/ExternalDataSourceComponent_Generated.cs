...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<ExternalDataSourceComponent>
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => ExternalDataSourceComponentCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ExternalDataSourceComponentCommon : AComponentCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IExternalDataSourceComponentGetter obj, bool iterateNestedRecords = true)
        {
            ...
            foreach (var item in obj.Sources.SelectMany(f => f.EnumerateFormLinks(iterateNestedRecords)))
            {
