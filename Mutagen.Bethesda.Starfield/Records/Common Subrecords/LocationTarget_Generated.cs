...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILoquiObjectSetter<LocationTarget>
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => LocationTargetCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class LocationTarget_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.LocationTarget";
    ...
    internal partial class LocationTargetCommon : ALocationTargetCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(ILocationTargetGetter obj, bool iterateNestedRecords = true)
        {
...
namespace Mutagen.Bethesda.Starfield
{
        ...
        ILocationTargetGetter
    {
        ...
        public IFormLinkGetter<IPlacedGetter> Link => FormLinkBinaryTranslation.Instance.OverlayFactory<IPlacedGetter>(_package, _structData.Span.Slice(0x0, 0x4));
