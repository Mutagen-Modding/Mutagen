...
namespace Mutagen.Bethesda.Starfield
{
        ...
        IVehicleConfigComponent
    {
        ...
        #region Mutagen
        public override IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true) => VehicleConfigComponentCommon.Instance.EnumerateFormLinks(this, iterateNestedRecords);
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class VehicleConfigComponentCommon : AComponentCommon
    {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> EnumerateFormLinks(IVehicleConfigComponentGetter obj, bool iterateNestedRecords = true)
        {
            ...
            {
                foreach (var item in WWiseItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
            ...
            {
                foreach (var item in MaterialItems.EnumerateFormLinks(iterateNestedRecords))
                {
                    yield return item;
                }
            }
