...
namespace Mutagen.Bethesda.Starfield
{
        ...
        where T : struct, Enum
    {
        ...
        #endregion
        #region LevelMin
        public UInt16 LevelMin { get; set; } = default(UInt16);
        #endregion
        #region LevelMax
        public UInt16 LevelMax { get; set; } = default(UInt16);
        #endregion
        #region Default
        ...
        where T : struct, Enum
    {
        ...
        new UInt16 LevelMin { get; set; }
        new UInt16 LevelMax { get; set; }
...
namespace Mutagen.Bethesda.Starfield
{
    ...
    internal partial class ObjectTemplate_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.Bethesda.Starfield.ObjectTemplate";
        ...
        where T : struct, Enum
    {
        ...
        public void Clear(IObjectTemplate<T> item)
        {
            ...
            item.LevelMin = default(UInt16);
            item.LevelMax = default(UInt16);
