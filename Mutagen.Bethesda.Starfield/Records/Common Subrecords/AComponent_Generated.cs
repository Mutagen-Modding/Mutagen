...
namespace Mutagen.Bethesda.Starfield
{
    #region Class
    /// <summary>
    /// Implemented by: [ActivityTrackerComponent, AdaptiveTriggerDataComponent, AddToInventoryOnDestroyComponent, AnimationGraphComponent, AttachParentArrayComponent, BlockCellHeightGridComponent, BlockEditorMetaDataComponent, BlockHeightAdjustmentComponent, BlueprintComponent, BodyPartInfoComponent, CityMapsUsageComponent, ContactShadowComponent, ContainerComponent, CrowdComponent, DestructibleObjectComponent, DisplayCaseComponent, EffectSequenceComponent, ExternalDataSourceComponent, ForcedLocRefTypeComponent, FormLinkDataComponent, FullNameComponent, HoudiniDataComponent, ImageSpaceModifiableFormComponent, KeywordFormComponent, LensFlareAttachmentFormComponent, LightAnimFormComponent, LightAttachmentFormComponent, LinkedVoiceTypeComponent, LodOwnerComponent, MagicTargetFormComponent, MaterialPropertyComponent, ModelComponent, ObjectPaletteDefaultsComponent, ObjectWindowFilterComponent, OrbitalDataComponent, OrbitedDataComponent, OverlayDesignatedPlacementInfoComponent, PapyrusScriptsComponent, ParticleSystemComponent, PathingDataComponent, PlanetContentManagerContentPropertiesComponent, PlanetModelComponent, PrimitiveComponent, PropertySheetComponent, QualityUpgradeComponent, ReflectionProbesComponent, ScannableComponent, ShipManagementComponent, SkinFormComponent, SoundTagComponent, SpacePhysicsComponent, SpaceshipAIActorComponent, SpaceshipEquipmentComponent, SpaceshipHullCodeComponent, SpaceshipWeaponBindingsComponent, SpawnOnDestroyComponent, StarDataComponent, StoredTraversalsComponent, SurfaceTreePatternSwapInfoComponent, UniqueOverlayListComponent, UniquePatternPlacementInfoComponent, VehicleConfigComponent, VehicleManagementComponent, VolumesComponent, WorkshopItemColorComponent, WorldSpaceOverlayComponent]
    /// </summary>
