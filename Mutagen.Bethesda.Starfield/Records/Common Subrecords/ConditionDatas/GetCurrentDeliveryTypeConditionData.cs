...
public partial class GetCurrentDeliveryTypeConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetCurrentDeliveryType;
