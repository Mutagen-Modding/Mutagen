...
public partial class HasValidRumorTopicConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.HasValidRumorTopic;
