...
public partial class GetVATSRightTargetVisibleConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSRightTargetVisible;
