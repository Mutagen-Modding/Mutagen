...
public partial class GetVATSBackRightTargetVisibleConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSBackRightTargetVisible;
