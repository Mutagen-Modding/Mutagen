...
public partial class LevelMinusPCLevelConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.LevelMinusPCLevel;
