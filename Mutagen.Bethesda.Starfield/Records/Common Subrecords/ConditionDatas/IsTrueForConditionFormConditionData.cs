...
public partial class IsTrueForConditionFormConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsTrueForConditionForm;
