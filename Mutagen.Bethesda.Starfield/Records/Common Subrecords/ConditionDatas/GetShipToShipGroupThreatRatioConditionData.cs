...
public partial class GetShipToShipGroupThreatRatioConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetShipToShipGroupThreatRatio;
