...
public partial class IsTimeSpanAnyDayConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsTimeSpanAnyDay;
