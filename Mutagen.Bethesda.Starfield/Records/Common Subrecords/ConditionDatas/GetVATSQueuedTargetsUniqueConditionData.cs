...
public partial class GetVATSQueuedTargetsUniqueConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSQueuedTargetsUnique;
