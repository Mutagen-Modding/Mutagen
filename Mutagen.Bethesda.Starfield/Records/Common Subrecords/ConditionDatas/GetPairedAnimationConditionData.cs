...
public partial class GetPairedAnimationConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetPairedAnimation;
