...
public partial class GetFactionCombatReactionConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetFactionCombatReaction;
