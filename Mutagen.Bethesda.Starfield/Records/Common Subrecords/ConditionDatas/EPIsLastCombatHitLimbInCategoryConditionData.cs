...
public partial class EPIsLastCombatHitLimbInCategoryConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.EPIsLastCombatHitLimbInCategory;
