...
public partial class GetLastPlayerActionConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetLastPlayerAction;
