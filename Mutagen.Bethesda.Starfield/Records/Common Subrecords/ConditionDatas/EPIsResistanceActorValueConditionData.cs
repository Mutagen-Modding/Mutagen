...
public partial class EPIsResistanceActorValueConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.EPIsResistanceActorValue;
