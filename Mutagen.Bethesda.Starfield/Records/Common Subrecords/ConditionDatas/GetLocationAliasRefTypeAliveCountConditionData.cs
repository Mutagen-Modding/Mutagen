...
public partial class GetLocationAliasRefTypeAliveCountConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetLocationAliasRefTypeAliveCount;
