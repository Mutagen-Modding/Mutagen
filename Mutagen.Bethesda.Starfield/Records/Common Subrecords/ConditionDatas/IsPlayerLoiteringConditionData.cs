...
public partial class IsPlayerLoiteringConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsPlayerLoitering;
