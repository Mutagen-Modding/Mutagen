...
public partial class GetIsAlignmentConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetIsAlignment;
