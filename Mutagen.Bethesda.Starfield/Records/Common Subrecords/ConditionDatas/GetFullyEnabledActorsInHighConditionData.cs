...
public partial class GetFullyEnabledActorsInHighConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetFullyEnabledActorsInHigh;
