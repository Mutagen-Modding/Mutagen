...
public partial class GetCrimeGoldViolentConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetCrimeGoldViolent;
