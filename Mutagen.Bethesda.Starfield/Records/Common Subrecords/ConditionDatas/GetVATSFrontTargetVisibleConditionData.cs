...
public partial class GetVATSFrontTargetVisibleConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSFrontTargetVisible;
