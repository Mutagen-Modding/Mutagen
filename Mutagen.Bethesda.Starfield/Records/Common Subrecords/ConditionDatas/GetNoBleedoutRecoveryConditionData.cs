...
public partial class GetNoBleedoutRecoveryConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetNoBleedoutRecovery;
