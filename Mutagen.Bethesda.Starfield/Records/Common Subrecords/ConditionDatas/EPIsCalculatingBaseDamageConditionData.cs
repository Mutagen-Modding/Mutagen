...
public partial class EPIsCalculatingBaseDamageConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.EPIsCalculatingBaseDamage;
