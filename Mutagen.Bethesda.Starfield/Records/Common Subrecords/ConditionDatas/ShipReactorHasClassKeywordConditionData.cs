...
public partial class ShipReactorHasClassKeywordConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.ShipReactorHasClassKeyword;
