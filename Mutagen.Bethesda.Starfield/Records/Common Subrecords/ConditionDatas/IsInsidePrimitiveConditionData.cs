...
public partial class IsInsidePrimitiveConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInsidePrimitive;
