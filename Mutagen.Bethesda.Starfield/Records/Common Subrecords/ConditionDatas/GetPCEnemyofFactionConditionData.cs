...
public partial class GetPCEnemyofFactionConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetPCEnemyofFaction;
