...
public partial class CurrentShipLandedConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.CurrentShipLanded;
