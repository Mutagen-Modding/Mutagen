...
public partial class GetRefTypeAliveCountConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetRefTypeAliveCount;
