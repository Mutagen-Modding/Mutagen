...
public partial class GetActorInShipPilotSeatConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetActorInShipPilotSeat;
