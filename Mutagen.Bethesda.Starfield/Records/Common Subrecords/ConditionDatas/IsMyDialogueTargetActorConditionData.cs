...
public partial class IsMyDialogueTargetActorConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsMyDialogueTargetActor;
