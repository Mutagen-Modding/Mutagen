...
public partial class GetIsCreatureTypeConditionData : IConditionParameters
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetIsCreatureType;
