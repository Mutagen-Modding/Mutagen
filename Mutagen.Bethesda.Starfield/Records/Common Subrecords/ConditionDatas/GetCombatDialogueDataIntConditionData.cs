...
public partial class GetCombatDialogueDataIntConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetCombatDialogueDataInt;
