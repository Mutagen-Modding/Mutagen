...
public partial class ShipHasActorInPilotSeatConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.ShipHasActorInPilotSeat;
