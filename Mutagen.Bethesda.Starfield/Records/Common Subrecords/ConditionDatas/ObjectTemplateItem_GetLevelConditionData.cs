...
public partial class ObjectTemplateItem_GetLevelConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.ObjectTemplateItem_GetLevel;
