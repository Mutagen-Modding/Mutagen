...
public partial class BodyIsTemperatureTypeConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.BodyIsTemperatureType;
