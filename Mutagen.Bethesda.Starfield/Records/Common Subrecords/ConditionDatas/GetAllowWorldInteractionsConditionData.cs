...
public partial class GetAllowWorldInteractionsConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetAllowWorldInteractions;
