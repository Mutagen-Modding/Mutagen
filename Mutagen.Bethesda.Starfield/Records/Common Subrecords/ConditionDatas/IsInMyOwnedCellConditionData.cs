...
public partial class IsInMyOwnedCellConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsInMyOwnedCell;
