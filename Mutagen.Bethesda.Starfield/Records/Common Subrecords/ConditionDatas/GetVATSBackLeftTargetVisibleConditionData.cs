...
public partial class GetVATSBackLeftTargetVisibleConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSBackLeftTargetVisible;
