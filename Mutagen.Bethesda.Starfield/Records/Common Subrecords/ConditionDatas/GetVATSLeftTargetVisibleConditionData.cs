...
public partial class GetVATSLeftTargetVisibleConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSLeftTargetVisible;
