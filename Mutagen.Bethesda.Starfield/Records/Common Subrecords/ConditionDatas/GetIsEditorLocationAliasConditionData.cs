...
public partial class GetIsEditorLocationAliasConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetIsEditorLocationAlias;
