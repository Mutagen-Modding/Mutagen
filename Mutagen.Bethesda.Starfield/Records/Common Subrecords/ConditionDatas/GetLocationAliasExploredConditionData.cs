...
public partial class GetLocationAliasExploredConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetLocationAliasExplored;
