...
public partial class IsPlayerMovingIntoNewSpaceConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsPlayerMovingIntoNewSpace;
