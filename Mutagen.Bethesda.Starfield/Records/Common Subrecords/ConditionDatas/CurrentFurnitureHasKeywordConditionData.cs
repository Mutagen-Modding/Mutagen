...
public partial class CurrentFurnitureHasKeywordConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.CurrentFurnitureHasKeyword;
