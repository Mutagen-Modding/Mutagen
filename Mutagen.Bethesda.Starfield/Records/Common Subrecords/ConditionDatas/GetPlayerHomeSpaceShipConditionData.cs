...
public partial class GetPlayerHomeSpaceShipConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetPlayerHomeSpaceShip;
