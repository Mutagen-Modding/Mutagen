...
public partial class GetKeywordDataForLocationConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetKeywordDataForLocation;
