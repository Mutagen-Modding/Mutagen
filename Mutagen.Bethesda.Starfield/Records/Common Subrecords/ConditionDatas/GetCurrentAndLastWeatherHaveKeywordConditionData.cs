...
public partial class GetCurrentAndLastWeatherHaveKeywordConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetCurrentAndLastWeatherHaveKeyword;
