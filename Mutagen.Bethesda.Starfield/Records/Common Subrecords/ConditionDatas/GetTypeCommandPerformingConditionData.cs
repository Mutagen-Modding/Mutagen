...
public partial class GetTypeCommandPerformingConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetTypeCommandPerforming;
