...
public partial class CountAquiredPerkRanksByTypeConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.CountAquiredPerkRanksByType;
