...
public partial class IsLocationAliasLoadedConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsLocationAliasLoaded;
