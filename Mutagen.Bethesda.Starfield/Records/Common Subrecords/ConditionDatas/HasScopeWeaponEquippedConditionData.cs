...
public partial class HasScopeWeaponEquippedConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.HasScopeWeaponEquipped;
