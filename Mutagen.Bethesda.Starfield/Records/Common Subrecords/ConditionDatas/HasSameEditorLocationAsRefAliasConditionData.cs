...
public partial class HasSameEditorLocationAsRefAliasConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.HasSameEditorLocationAsRefAlias;
