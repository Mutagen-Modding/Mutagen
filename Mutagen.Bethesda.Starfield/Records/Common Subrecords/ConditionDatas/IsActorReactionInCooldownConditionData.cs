...
public partial class IsActorReactionInCooldownConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.IsActorReactionInCooldown;
