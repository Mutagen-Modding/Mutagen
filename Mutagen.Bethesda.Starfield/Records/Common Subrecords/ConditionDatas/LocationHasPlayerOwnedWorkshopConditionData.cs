...
public partial class LocationHasPlayerOwnedWorkshopConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.LocationHasPlayerOwnedWorkshop;
