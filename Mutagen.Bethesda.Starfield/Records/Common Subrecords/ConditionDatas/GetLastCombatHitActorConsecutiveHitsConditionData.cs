...
public partial class GetLastCombatHitActorConsecutiveHitsConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetLastCombatHitActorConsecutiveHits;
