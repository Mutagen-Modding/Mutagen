...
public partial class GetVATSRightMinusLeftAreaFreeConditionData : IConditionStringParameter
{
    ...
    Condition.Function IConditionDataGetter.Function => Condition.Function.GetVATSRightMinusLeftAreaFree;
