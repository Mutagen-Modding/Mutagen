...
internal class StarfieldMultiModOverlay : IStarfieldModDisposableGetter
{
    ...
    private readonly MergedStarfieldModHeader _modHeader;
        ...
        IReadOnlyList<IMasterReferenceGetter> mergedMasters)
    {
        ...
        _modHeader = new MergedStarfieldModHeader(sourceList.Select(s => s.ModHeader).ToList(), mergedMasters);
    }

    public ModKey ModKey => _modKey;
    public IStarfieldModHeaderGetter ModHeader => _modHeader;
    ...
    public IEnumerable<IMajorRecordGetter> EnumerateMajorRecords()
        => StarfieldModCommon.Instance.EnumerateMajorRecords(this);

    public IEnumerable<T> EnumerateMajorRecords<T>(bool throwIfUnknown = true) where T : class, IMajorRecordQueryableGetter
        => StarfieldModCommon.Instance.EnumerateMajorRecords(this, typeof(T), throwIfUnknown).Select(m => (T)m);

    public IEnumerable<IMajorRecordGetter> EnumerateMajorRecords(Type type, bool throwIfUnknown = true)
        => StarfieldModCommon.Instance.EnumerateMajorRecords(this, type, throwIfUnknown);
    ...
    public uint GetRecordCount()
        => StarfieldModCommon.Instance.GetRecordCount(this);
    ...
    public void Print(StructuredStringBuilder sb, string? name = null)
        => StarfieldModCommon.Instance.Print(this, sb, name);

    public IMask<bool> GetEqualsMask(object rhs, EqualsMaskHelper.Include include)
        => StarfieldModCommon.Instance.GetEqualsMask(this, (IStarfieldModGetter)rhs, include);
...
/// </summary>
internal class MergedStarfieldModHeader : IStarfieldModHeaderGetter
{
    private readonly IReadOnlyList<IStarfieldModHeaderGetter> _sources;
    private readonly IReadOnlyList<IMasterReferenceGetter> _masters;
    private readonly MergedModStats _stats;

    private static readonly StarfieldModHeader.TranslationMask _mustMatchMask = new StarfieldModHeader.TranslationMask(defaultOn: true)
    {
    ...
    public MergedStarfieldModHeader(IReadOnlyList<IStarfieldModHeaderGetter> sources, IReadOnlyList<IMasterReferenceGetter> masters)
    {
        _sources = sources;
        _masters = masters;
    ...
    private void ValidateConsistency()
    {
        ...
        for (int i = 1; i < _sources.Count; i++)
        {
            if (!first.Equals(_sources[i], _mustMatchMask))
            {
                throw new System.IO.InvalidDataException($"MergedStarfieldModHeader: source mod {i} disagrees with source mod 0 on must-match fields.");
            }
        }
    }

    public StarfieldModHeader.HeaderFlag Flags => _sources[0].Flags;
    ...
    public IReadOnlyList<IMasterReferenceGetter> MasterReferences => _masters;
    public IReadOnlyList<IFormLinkGetter<IStarfieldMajorRecordGetter>>? OverriddenForms
    {
        get
        {
    ...
    public String? Branch => _sources[0].Branch;
    public Int32? INTV => _sources[0].INTV;
    public Int32? InteriorCellCount => _sources[0].InteriorCellCount;
    public ReadOnlyMemorySlice<Byte>? CHGL => _sources[0].CHGL;

    public ILoquiRegistration Registration => IStarfieldModHeaderGetter.StaticRegistration;
    public object CommonInstance() => StarfieldModHeaderCommon.Instance;
    public object? CommonSetterInstance() => null;
    public object CommonSetterTranslationInstance() => _sources[0].CommonSetterTranslationInstance();
    public void Print(StructuredStringBuilder sb, string? name = null) => _sources[0].Print(sb, name);
    object IBinaryItem.BinaryWriteTranslator => StarfieldModHeaderBinaryWriteTranslation.Instance;
    void IBinaryItem.WriteToBinary(MutagenWriter writer, TypedWriteParams translationParams)
        => ((StarfieldModHeaderBinaryWriteTranslation)((IBinaryItem)this).BinaryWriteTranslator).Write(item: this, writer: writer, translationParams: translationParams);
    ...
    where TGetter : class, IStarfieldMajorRecordGetter, IBinaryItem
{
    ...
    object IBinaryItem.BinaryWriteTranslator => StarfieldGroupBinaryWriteTranslation.Instance;
    void IBinaryItem.WriteToBinary(MutagenWriter writer, TypedWriteParams translationParams)
        => StarfieldGroupBinaryWriteTranslation.Instance.Write(writer: writer, item: this, translationParams: translationParams);
...
internal class MergedListGroup : IStarfieldListGroupGetter<ICellBlockGetter>
{
    ...
    void IBinaryItem.WriteToBinary(MutagenWriter writer, TypedWriteParams translationParams)
        => StarfieldListGroupBinaryWriteTranslation.Instance.Write(writer: writer, item: this, translationParams: translationParams);

    public IEnumerable<IFormLinkGetter> EnumerateFormLinks(bool iterateNestedRecords = true)
        => StarfieldListGroupCommon<ICellBlockGetter>.Instance.EnumerateFormLinks(this, iterateNestedRecords);

    public IEnumerable<IMajorRecordGetter> EnumerateMajorRecords()
        => StarfieldListGroupCommon<ICellBlockGetter>.Instance.EnumerateMajorRecords(this);

    IEnumerable<T> IMajorRecordGetterEnumerable.EnumerateMajorRecords<T>(bool throwIfUnknown)
        => StarfieldListGroupCommon<ICellBlockGetter>.Instance.EnumerateMajorRecords(this, typeof(T), throwIfUnknown).Select(m => (T)m);

    public IEnumerable<IMajorRecordGetter> EnumerateMajorRecords(Type type, bool throwIfUnknown = true)
        => StarfieldListGroupCommon<ICellBlockGetter>.Instance.EnumerateMajorRecords(this, type, throwIfUnknown);
}
...
internal class MergedWorldspace : IWorldspaceGetter
{
    ...
    ushort IStarfieldMajorRecordGetter.FormVersion => _primary.FormVersion;
    ...
    public StarfieldMajorRecord.StarfieldMajorRecordFlag StarfieldMajorRecordFlags => _primary.StarfieldMajorRecordFlags;
    ...
    public IReadOnlyList<IAComponentGetter> Components => _primary.Components;
    ...
    public IFormLinkNullableGetter<ILocationGetter> EncounterLocation => _primary.EncounterLocation;
    public IFormLinkNullableGetter<ILocationGetter> Location => _primary.Location;
    public IFormLinkNullableGetter<IBiomeGetter> Biome => _primary.Biome;
    ...
    public String? NAM7 => _primary.NAM7;
    ...
    public IWorldspaceWorldMapOffsetGetter? WorldMapOffset => _primary.WorldMapOffset;
    public Single? DistantLodMultiplier => _primary.DistantLodMultiplier;
    public Worldspace.Flag? Flags => _primary.Flags;
    public ReadOnlyMemorySlice<Byte>? FNAM => _primary.FNAM;
    ...
    public IFormLinkNullableGetter<IAmbienceSetGetter> AmbienceSet => _primary.AmbienceSet;
    public String? EnvironmentMap => _primary.EnvironmentMap;
    public String? WaterEnvironmentMap => _primary.WaterEnvironmentMap;
    public Single? GNAM => _primary.GNAM;
    public IReadOnlyList<IFormLinkGetter<ILandscapeTextureGetter>> LandscapeTextures => _primary.LandscapeTextures;
    public IReadOnlyList<P2Int16>? CellWaterHeightLocations => _primary.CellWaterHeightLocations;
    public IReadOnlyList<Single>? WaterHeights => _primary.WaterHeights;
    public ReadOnlyMemorySlice<Byte>? HNAM => _primary.HNAM;
...
internal class MergedWorldspaceCell : ICellGetter
{
    ...
    public IFormLinkNullableGetter<ILightingTemplateGetter> LightingTemplate => _primary.LightingTemplate;
    public Single? WaterHeight => _primary.WaterHeight;
    public Single? XILS => _primary.XILS;
    public IReadOnlyList<ICellXCLAItemGetter> XCLAs => _primary.XCLAs;
    public ReadOnlyMemorySlice<Byte>? WaterData => _primary.WaterData;
    public IFormLinkNullableGetter<IRegionGetter> CellSkyRegion => _primary.CellSkyRegion;
    public IOwnershipGetter? Ownership => _primary.Ownership;
    public IFormLinkNullableGetter<ILocationGetter> Location => _primary.Location;
    public IFormLinkNullableGetter<IWaterGetter> Water => _primary.Water;
    public String? WaterType => _primary.WaterType;
    public IReadOnlyList<ICellShipBlueprintSnapLinkGetter>? ShipBlueprintSnapLinks => _primary.ShipBlueprintSnapLinks;
    ...
    public String? WaterEnvironmentMap => _primary.WaterEnvironmentMap;
    public IFormLinkNullableGetter<IFormListGetter> LockList => _primary.LockList;
    public IFormLinkNullableGetter<IMusicTypeGetter> Music => _primary.Music;
    public String? GlobalDirtLayerMaterial => _primary.GlobalDirtLayerMaterial;
    public Boolean? GlobalDirtLayerInheritBiomeLayer => _primary.GlobalDirtLayerInheritBiomeLayer;
    public IFormLinkNullableGetter<ITimeOfDayRecordGetter> TimeOfDay => _primary.TimeOfDay;
    public IReadOnlyList<ILinkedReferencesGetter> LinkedReferences => _primary.LinkedReferences;
    public Boolean IsLinkedRefTransient => _primary.IsLinkedRefTransient;
    public String? EnvironmentMap => _primary.EnvironmentMap;
    public IReadOnlyList<ITraversalReferenceGetter>? Traversals => _primary.Traversals;
    public UInt32 NumTraversalFluffBytes => _primary.NumTraversalFluffBytes;
