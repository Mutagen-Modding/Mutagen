...
internal static class ModContextExt
{
    ...
    public static IEnumerable<IModContext<IStarfieldMod, IStarfieldModGetter, IMajorRecord, IMajorRecordGetter>> EnumerateMajorRecordContexts(
        this IStarfieldListGroupGetter<ICellBlockGetter> cellBlocks,
        ...
        bool throwIfUnknown)
    {
        foreach (var readOnlyBlock in cellBlocks.Records)
        {
            ...
            foreach (var readOnlySubBlock in readOnlyBlock.SubBlocks)
            {
                ...
                {
                    Func<IStarfieldMod, ICellGetter, bool, string?, FormKey?, ICell> cellGetter = (mod, copyCell, dup, edid, newForm) =>
                    {
                    ...
                    {
                        yield return new ModContext<IStarfieldMod, IStarfieldModGetter, IMajorRecord, IMajorRecordGetter>(
                            modKey: modKey,
                            record: readOnlyCell,
