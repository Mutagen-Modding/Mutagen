...
namespace Mutagen.Bethesda.Examples
{
        ...
        IEqualsMask
    {
        ...
        {
            if (!(obj is IMainVMGetter rhs)) return false;
            return ((MainVMCommon)((IMainVMGetter)this).CommonInstance()).Equals(this, rhs);
        }

        public bool Equals(MainVM obj)
        {
            return ((MainVMCommon)((IMainVMGetter)this).CommonInstance()).Equals(this, obj);
        }

        public override int GetHashCode() => ((MainVMCommon)((IMainVMGetter)this).CommonInstance()).GetHashCode(this);
            ...
            MissingCreate missing = MissingCreate.New)
        {
            ...
            var ret = new MainVM();
            ((MainVMSetterCommon)((IMainVMGetter)ret).CommonSetterInstance()).CopyInFromXml(
                item: ret,
                missing: missing,
                node: node,
                errorMask: errorMask,
    ...
    {
        public static void Clear(this IMainVM item)
        {
            ((MainVMSetterCommon)((IMainVMGetter)item).CommonSetterInstance()).Clear(item: item);
        }
        ...
        {
            return ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).GetEqualsMask(
                item: item,
                rhs: rhs,
                include: include);
        }
        ...
        {
            return ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            MainVM_Mask<bool> printMask = null)
        {
            ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
        ...
        {
            return ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).HasBeenSet(
                item: item,
                checkMask: checkMask);
        }

        public static MainVM_Mask<bool> GetHasBeenSetMask(this IMainVMGetter item)
        {
            var ret = new MainVM_Mask<bool>();
            ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).FillHasBeenSetMask(
                item: item,
                mask: ret);
            return ret;
        }
        ...
        public static bool Equals(
            ...
            IMainVMGetter rhs)
        {
            return ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).Equals(
                lhs: item,
                rhs: rhs);
        }
        ...
        public static void CopyInFromXml(
            ...
            MissingCreate missing = MissingCreate.New)
        {
            ((MainVMSetterCommon)((IMainVMGetter)item).CommonSetterInstance()).CopyInFromXml(
                item: item,
                missing: missing,
                node: node,
                errorMask: errorMask,
...
namespace Mutagen.Bethesda.Examples.Internals
{
    ...
    public partial class MainVMCommon
    {
        ...
        {
            var ret = new MainVM_Mask<bool>();
            ((MainVMCommon)((IMainVMGetter)item).CommonInstance()).FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
                include: include);
        ...
        public virtual int GetHashCode(IMainVMGetter item)
        {
            int ret = 0;
