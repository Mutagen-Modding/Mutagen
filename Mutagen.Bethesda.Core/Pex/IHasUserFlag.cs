...
namespace Mutagen.Bethesda.Pex
{
    ...
    {
        public static IEnumerable<NullableUserFlag> GetActiveFlags(this IHasUserFlags hasFlags, IPexFileCommonGetter pexFile)
        {
        ...
        public static void SetFlag(this IHasUserFlags hasFlags, IPexFileCommonGetter pexFile, UserFlag flag, bool on)
        {
        ...
        public static bool HasFlag(this IHasUserFlags hasFlags, IPexFileCommonGetter pexFile, UserFlag flag)
        {
            if (pexFile.UserFlags[flag.Index] != flag.Name)
            {
                throw new ArgumentException("Tried to set a flag that was not registered in the reference pex file.");
