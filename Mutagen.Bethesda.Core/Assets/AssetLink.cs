...
/// </summary>
public class AssetLinkGetter<TAssetType> : IComparable<AssetLinkGetter<TAssetType>>, INullable, IAssetLinkGetter where TAssetType : IAssetType {
    ...
    public string DataRelativePath => RawPath.StartsWith(AssetType.BaseFolder) ? RawPath : Path.Combine(AssetType.BaseFolder, RawPath);
...
/// Asset referenced by a record
/// </summary>
public class AssetLink<TAssetType> : AssetLinkGetter<TAssetType>, IComparable<AssetLink<TAssetType>>, IAssetLink where TAssetType : IAssetType {
    ...
    public new string DataRelativePath => RawPath.StartsWith(AssetType.BaseFolder) ? RawPath : Path.Combine(AssetType.BaseFolder, RawPath);
