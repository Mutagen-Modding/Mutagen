...
namespace Mutagen.Internals
{
    ...
    public class GenderedBodyData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.GenderedBodyData";
    ...
    #region Extensions
    public static class GenderedBodyDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.GenderedBodyData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.GenderedBodyData");
                    }
