...
namespace Mutagen.Internals
{
    ...
    public class SoundData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.SoundData";
    ...
    public static partial class SoundDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.SoundData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.SoundData");
                    }
