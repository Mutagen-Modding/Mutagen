...
namespace Mutagen.Internals
{
    ...
    public class FaceGenData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.FaceGenData";
    ...
    public static class FaceGenDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.FaceGenData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.FaceGenData");
                    }
