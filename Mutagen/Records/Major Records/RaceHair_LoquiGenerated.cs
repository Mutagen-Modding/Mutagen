...
namespace Mutagen.Internals
{
    ...
    public class RaceHair_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.RaceHair";
    ...
    public static class RaceHairCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.RaceHair"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.RaceHair");
                    }
    ...
    public class RaceHair_ErrorMask : IErrorMask
    {
        #region Members
