...
namespace Mutagen.Internals
{
    ...
    public class BodyPart_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.BodyPart";
    ...
    #region Extensions
    public static class BodyPartCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.BodyPart"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.BodyPart");
                    }
    ...
    public class BodyPart_ErrorMask : IErrorMask
    {
        #region Members
