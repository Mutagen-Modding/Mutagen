...
namespace Mutagen.Internals
{
    ...
    public class RaceStats_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.RaceStats";
    ...
    public static class RaceStatsCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.RaceStats"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.RaceStats");
                    }
    ...
    public class RaceStats_ErrorMask : IErrorMask
    {
        #region Members
