                ...
                case "Skill":
                    {
                        ...
                        item._Skill.SetIfSucceeded(tryGet);
...
namespace Mutagen.Internals
{
    ...
    public class SkillBoost_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.SkillBoost";
    ...
    public static class SkillBoostCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.SkillBoost"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.SkillBoost");
                    }
    ...
    public class SkillBoost_ErrorMask : IErrorMask
    {
        #region Members
