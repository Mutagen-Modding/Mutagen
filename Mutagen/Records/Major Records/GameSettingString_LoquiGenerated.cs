    ...
    public partial class GameSettingString : GameSetting, IGameSettingString, ILoquiObjectSetter, IEquatable<GameSettingString>
    {
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiXmlTranslation<GameSettingString, GameSettingString_ErrorMask>.Instance.CopyIn(
                ...
                skipProtected: true,
                doMasks: false,
                mask: out GameSettingString_ErrorMask errorMask,
                cmds: cmds);
        }
            ...
            string name = null)
        {
            GameSettingStringCommon.Write_XML(
                ...
                item: this,
                doMasks: false,
                errorMask: out GameSettingString_ErrorMask errorMask);
        }
        ...
        public new static GameSettingString Create_OblivionBinary(BinaryReader reader)
        {
        ...
        public static GameSettingString Create_OblivionBinary(
            BinaryReader reader,
            out GameSettingString_ErrorMask errorMask)
        {
            return Create_OblivionBinary(
        ...
        public static GameSettingString Create_OblivionBinary(string path)
        {
        ...
        public static GameSettingString Create_OblivionBinary(Stream stream)
        {
        ...
        public virtual void Write_OblivionBinary(
            ...
            out GameSettingString_ErrorMask errorMask)
        {
            GameSettingStringCommon.Write_OblivionBinary(
                writer: writer,
                item: this,
                doMasks: true,
                errorMask: out errorMask);
        ...
        private static GameSettingString Create_OblivionBinary_Internal(
            BinaryReader reader,
            bool doMasks,
            Func<GameSettingString_ErrorMask> errorMask)
        {
    ...
    public static class GameSettingStringCommon
    {
            ...
            NotifyingFireParameters? cmds)
        {
            ...
            if (copyMask?.Data ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)GameSettingString_FieldIndex.Data, ex);
                }
            }
        }
            ...
            Func<GameSettingString_ErrorMask> errorMask)
        {
                ...
                errorMask: errorMask);
            {
                ...
                Mutagen.Binary.StringBinaryTranslation.Instance.Write(
                    ...
                    doMasks: doMasks,
                    errorMask: out subMask,
                    header: GameSettingString.DATA_HEADER,
                    nullable: false);
                if (doMasks && subMask != null)
                {
                    errorMask().Data = subMask;
