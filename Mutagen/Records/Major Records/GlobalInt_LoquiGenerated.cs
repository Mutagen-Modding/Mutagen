    ...
    public partial class GlobalInt : Global, IGlobalInt, ILoquiObjectSetter, IEquatable<GlobalInt>
    {
            ...
            string name = null)
        {
            GlobalIntCommon.Write_XML(
                ...
                item: this,
                doMasks: false,
                errorMask: out GlobalInt_ErrorMask errorMask);
        }
        ...
        public new static GlobalInt Create_Binary(BinaryReader reader)
        {
        ...
        public override void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<GlobalInt, GlobalInt_ErrorMask>.Instance.CopyIn(
                reader: reader,
                item: this,
                skipProtected: true,
                doMasks: false,
...
namespace Mutagen.Internals
{
    ...
    public class GlobalInt_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.GlobalInt";
    ...
    #region Extensions
    public static class GlobalIntCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.GlobalInt"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.GlobalInt");
                    }
                }
            }
            catch (Exception ex)
