...
namespace Mutagen
{
    ...
    public partial class LocalVariableData : ILocalVariableData, ILoquiObjectSetter, IEquatable<LocalVariableData>
    {
        ...
        #region Data
        protected readonly INotifyingItem<Byte[]> _Data = NotifyingItem.Factory<Byte[]>(
            markAsSet: false,
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (LocalVariableData_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
        ...
        public void CopyIn_Binary(
            ...
            NotifyingFireParameters? cmds = null)
        {
            LoquiBinaryTranslation<LocalVariableData, LocalVariableData_ErrorMask>.Instance.CopyIn(
                frame: frame,
                item: this,
                skipProtected: true,
                doMasks: false,
        ...
        public virtual void Write_Binary(
            ...
            out LocalVariableData_ErrorMask errorMask)
        {
            errorMask = (LocalVariableData_ErrorMask)this.Write_Binary_Internal(
                writer: writer,
                doMasks: true);
        }
            ...
            ILocalVariableDataGetter def = null)
        {
            ...
            {
                ret = (LocalVariableData)Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
...
namespace Mutagen.Internals
{
    ...
    public class LocalVariableData_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.LocalVariableData";
    ...
    public static partial class LocalVariableDataCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.LocalVariableData"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.LocalVariableData");
                    }
