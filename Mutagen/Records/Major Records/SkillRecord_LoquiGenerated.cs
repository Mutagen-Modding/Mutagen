...
namespace Mutagen.Internals
{
    ...
    public class SkillRecord_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Mutagen.SkillRecord";
    ...
    public static partial class SkillRecordCommon
    {
                            ...
                            switch (copyMask?.Data.Overall ?? CopyOption.Reference)
                            {
                                ...
                                case CopyOption.CopyIn:
                                    SkillDataCommon.CopyFieldsFrom(
                                        ...
                                        errorMask: (doErrorMask ? new Func<SkillData_ErrorMask>(() =>
                                        {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Mutagen.SkillRecord"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Mutagen.SkillRecord");
                    }
