...
namespace Mutagen.Binary
{
    public class BinaryTranslationCaster<T, M> : IBinaryTranslation<Object, Object>
    {
        ...
        void IBinaryTranslation<object, object>.Write(BinaryWriter writer, object item, ContentLength length, bool doMasks, out object maskObj)
        {
            Source.Write(writer, (T)item, length, doMasks, out var subMaskObj);
            maskObj = subMaskObj;
        }

        TryGet<object> IBinaryTranslation<object, object>.Parse(BinaryReader reader, ContentLength length, bool doMasks, out object maskObj)
        {
